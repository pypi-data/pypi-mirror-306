...
class PostInstallCommand(install):
    ...
    def get_latest_release_version(self):
        try:
            api_url = "https://api.github.com/repos/spacejar-labs/spacejar-cli/releases/latest"
            response = requests.get(api_url)
            response.raise_for_status()
            release = response.json()  # This is now a single release object, not a list
            
            latest_release = release['tag_name']  # Get tag_name directly
