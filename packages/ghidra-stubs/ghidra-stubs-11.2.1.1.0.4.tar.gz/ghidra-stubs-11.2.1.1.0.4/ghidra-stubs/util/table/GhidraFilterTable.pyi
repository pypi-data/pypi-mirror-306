...
class GhidraFilterTable(docking.widgets.table.GFilterTable):
    ...
    @overload
    def installNavigation(self, goToService: ghidra.app.services.GoToService) -> None: ...

    @overload
    def installNavigation(self, provider: ghidra.framework.plugintool.ServiceProvider) -> None: ...

    @overload
    def installNavigation(self, goToService: ghidra.app.services.GoToService, nav: ghidra.app.nav.Navigatable) -> None: ...
    ...
    def setAccessibleNamePrefix(self, prefix: unicode) -> None:
        """
    ...
    def setNavigateOnSelectionEnabled(self, b: bool) -> None: ...
    ...
    @property
    def navigateOnSelectionEnabled(self) -> None: ...  # No getter available.

    @navigateOnSelectionEnabled.setter
    def navigateOnSelectionEnabled(self, value: bool) -> None: ...
