...
class DynamicHash(object):
    ...
    @overload
    def __init__(self, op: ghidra.program.model.pcode.PcodeOp, slot: int, fd: ghidra.program.model.pcode.PcodeSyntaxTree):
        """
    ...
    @staticmethod
    def findOp(fd: ghidra.program.model.pcode.PcodeSyntaxTree, addr: ghidra.program.model.address.Address, h: long) -> ghidra.program.model.pcode.PcodeOp: ...
    ...
    @staticmethod
    def gatherOpsAtAddress(__a0: java.util.ArrayList, __a1: ghidra.program.model.pcode.PcodeSyntaxTree, __a2: ghidra.program.model.address.Address) -> None: ...
