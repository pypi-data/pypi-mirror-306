...
class DataTypeConflictHandler(object):
    """
    DataTypeConflictHandler provides the DataTypeManager with a handler that is 
     used to provide a disposition when a datatype conflict is detected during 
     DataTypeManager#resolve(DataType, DataTypeConflictHandler) processing.
    ...
    DEFAULT_HANDLER: ghidra.program.model.data.DataTypeConflictHandler
    KEEP_HANDLER: ghidra.program.model.data.DataTypeConflictHandler
    REPLACE_EMPTY_STRUCTS_OR_RENAME_AND_ADD_HANDLER: ghidra.program.model.data.DataTypeConflictHandler
