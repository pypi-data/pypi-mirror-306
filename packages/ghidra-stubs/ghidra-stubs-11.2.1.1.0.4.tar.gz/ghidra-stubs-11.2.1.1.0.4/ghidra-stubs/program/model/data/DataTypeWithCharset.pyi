...
class DataTypeWithCharset(ghidra.program.model.data.DataType, object):
    ...
    def encodeCharacterRepresentation(self, repr: unicode, buf: ghidra.program.model.mem.MemBuffer, settings: ghidra.docking.settings.Settings) -> List[int]:
        """
    ...
    def encodeCharacterValue(self, value: object, buf: ghidra.program.model.mem.MemBuffer, settings: ghidra.docking.settings.Settings) -> List[int]:
        """
