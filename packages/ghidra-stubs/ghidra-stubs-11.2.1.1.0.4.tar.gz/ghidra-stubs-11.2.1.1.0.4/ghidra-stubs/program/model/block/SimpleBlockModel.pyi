...
class SimpleBlockModel(object, ghidra.program.model.block.CodeBlockModel):
    """
    ...
    NAME: unicode = u'Simple Block'
    emptyBlockArray: List[ghidra.program.model.block.CodeBlock]
