...
class SymbolType(object):
    ...
    CLASS: ghidra.program.model.symbol.SymbolType
    CODE: ghidra.program.model.symbol.SymbolType
    FUNCTION: ghidra.program.model.symbol.SymbolType
    GLOBAL: ghidra.program.model.symbol.SymbolType
    GLOBAL_VAR: ghidra.program.model.symbol.SymbolType
    LABEL: ghidra.program.model.symbol.SymbolType
    LIBRARY: ghidra.program.model.symbol.SymbolType
    LOCAL_VAR: ghidra.program.model.symbol.SymbolType
    NAMESPACE: ghidra.program.model.symbol.SymbolType
    PARAMETER: ghidra.program.model.symbol.SymbolType
