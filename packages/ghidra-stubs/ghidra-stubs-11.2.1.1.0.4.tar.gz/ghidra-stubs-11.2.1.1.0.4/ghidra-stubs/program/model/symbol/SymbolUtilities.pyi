...
class SymbolUtilities(object):
    ...
    @overload
    @staticmethod
    def getUniqueSymbol(program: ghidra.program.model.listing.Program, name: unicode) -> ghidra.program.model.symbol.Symbol:
        """
    ...
    @overload
    @staticmethod
    def getUniqueSymbol(program: ghidra.program.model.listing.Program, name: unicode, namespace: ghidra.program.model.symbol.Namespace) -> ghidra.program.model.symbol.Symbol:
        """
    ...
    @staticmethod
    def isPossibleDefaultExternalName(name: unicode) -> bool:
        """
    ...
    @staticmethod
    def isPossibleDefaultLocalOrParamName(name: unicode) -> bool:
        """
