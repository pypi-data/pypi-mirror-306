...
class StubListing(object, ghidra.program.model.listing.Listing):
    ...
    def createInstruction(self, addr: ghidra.program.model.address.Address, prototype: ghidra.program.model.lang.InstructionPrototype, memBuf: ghidra.program.model.mem.MemBuffer, context: ghidra.program.model.lang.ProcessorContextView, forcedLengthOverride: int) -> ghidra.program.model.listing.Instruction: ...
