...
class MemoryMapDB(object, ghidra.program.model.mem.Memory, ghidra.program.database.ManagerDB, ghidra.program.model.mem.LiveMemoryListener):
    ...
    def __init__(self, handle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMapDB, openMode: ghidra.framework.data.OpenMode, isBigEndian: bool, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor):
        """
