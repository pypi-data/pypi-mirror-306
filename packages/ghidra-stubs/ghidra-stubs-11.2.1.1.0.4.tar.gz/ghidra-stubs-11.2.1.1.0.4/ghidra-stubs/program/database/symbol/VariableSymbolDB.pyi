...
class VariableSymbolDB(ghidra.program.database.symbol.SymbolDB):
    ...
    def __init__(self, symbolMgr: ghidra.program.database.symbol.SymbolManager, cache: ghidra.program.database.DBObjectCache, type: ghidra.program.model.symbol.SymbolType, variableMgr: ghidra.program.database.symbol.VariableStorageManagerDB, address: ghidra.program.model.address.Address, record: db.DBRecord):
        """
