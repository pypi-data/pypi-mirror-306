...
class VoidPropertyMapDB(ghidra.program.database.properties.PropertyMapDB, ghidra.program.model.util.VoidPropertyMap):
    ...
    def __init__(self, dbHandle: db.DBHandle, openMode: ghidra.framework.data.OpenMode, errHandler: db.util.ErrorHandler, changeMgr: ghidra.program.util.ChangeManager, addrMap: ghidra.program.database.map.AddressMap, name: unicode, monitor: ghidra.util.task.TaskMonitor):
        """
    ...
    def get(self, addr: ghidra.program.model.address.Address) -> bool: ...
