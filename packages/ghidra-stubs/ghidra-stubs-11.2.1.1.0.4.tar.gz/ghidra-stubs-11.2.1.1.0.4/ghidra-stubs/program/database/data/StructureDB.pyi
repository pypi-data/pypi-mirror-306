...
class StructureDB(ghidra.program.database.data.CompositeDB, ghidra.program.model.data.StructureInternal):
    """
    ...
    def getComponent(self, ordinal: int) -> ghidra.program.database.data.DataTypeComponentDB: ...
