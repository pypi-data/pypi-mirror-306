...
class DataTypeReferenceFinder(ghidra.util.classfinder.ExtensionPoint, object):
    ...
    @overload
    def findReferences(self, program: ghidra.program.model.listing.Program, fieldMatcher: ghidra.app.services.FieldMatcher, callback: java.util.function.Consumer, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    @overload
    def findReferences(self, program: ghidra.program.model.listing.Program, dataType: ghidra.program.model.data.DataType, fieldName: unicode, callback: java.util.function.Consumer, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Finds references in the current program to specific field of the given {@link Composite} type
         in a manner appropriate with the given implementation.
         <p>
