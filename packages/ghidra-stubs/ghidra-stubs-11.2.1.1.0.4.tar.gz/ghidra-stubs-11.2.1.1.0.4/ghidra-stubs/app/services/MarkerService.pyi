...
class MarkerService(object):
    ...
    @overload
    def createPointMarker(self, name: unicode, markerDescription: unicode, program: ghidra.program.model.listing.Program, priority: int, showMarkers: bool, showNavigation: bool, colorBackground: bool, color: java.awt.Color, icon: javax.swing.Icon) -> ghidra.app.services.MarkerSet:
        """
    ...
    @overload
    def createPointMarker(self, name: unicode, markerDescription: unicode, program: ghidra.program.model.listing.Program, priority: int, showMarkers: bool, showNavigation: bool, colorBackground: bool, color: java.awt.Color, icon: javax.swing.Icon, isPreferred: bool) -> ghidra.app.services.MarkerSet:
        """
        Create a Marker display which shows point type markers.
        @param name name of the navigation markers
        @param markerDescription description of the navigation markers
    ...
    def isActiveMarkerForGroup(self, groupName: unicode, markerSet: ghidra.app.services.MarkerSet, program: ghidra.program.model.listing.Program) -> bool:
        """
    ...
    def setMarkerClickedListener(self, listener: ghidra.app.util.viewer.listingpanel.MarkerClickedListener) -> None:
        """
    ...
    @property
    def markerClickedListener(self) -> None: ...  # No getter available.

    @markerClickedListener.setter
    def markerClickedListener(self, value: ghidra.app.util.viewer.listingpanel.MarkerClickedListener) -> None: ...