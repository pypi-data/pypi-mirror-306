...
class TableChooserDialog(docking.DialogComponentProvider, ghidra.app.nav.NavigatableRemovalListener):
    ...
    def contains(self, rowObject: ghidra.app.tablechooser.AddressableRowObject) -> bool:
        """
    ...
    def setSortColumn(self, index: int) -> None:
        """
    ...
    def setSortState(self, state: docking.widgets.table.TableSortState) -> None:
        """
    ...
    @property
    def sortColumn(self) -> None: ...  # No getter available.

    @sortColumn.setter
    def sortColumn(self, value: int) -> None: ...

    @property
    def sortState(self) -> None: ...  # No getter available.

    @sortState.setter
    def sortState(self, value: docking.widgets.table.TableSortState) -> None: ...