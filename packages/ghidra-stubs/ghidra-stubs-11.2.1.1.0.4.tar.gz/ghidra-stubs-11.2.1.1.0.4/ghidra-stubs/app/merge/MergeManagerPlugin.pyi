...
class MergeManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.ProgramaticUseOnly, ghidra.framework.model.DomainObjectListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: ghidra.app.merge.MergeManager, domainObject: ghidra.framework.model.DomainObject):
        """
    ...
    @overload
    def closeDomainObject(self, domainObject: ghidra.framework.model.DomainObject, ignoreChanges: bool) -> bool: ...
    ...
    def getAllOpenDomainObjects(self) -> List[ghidra.framework.model.DomainObject]: ...
    ...
    @overload
    def openDomainObject(self, domainObject: ghidra.framework.model.DomainObject) -> None: ...

    @overload
    def openDomainObject(self, df: ghidra.framework.model.DomainFile, version: int) -> ghidra.program.model.listing.Program: ...

    @overload
    def openDomainObject(self, domainObject: ghidra.framework.model.DomainObject, state: int) -> None: ...

    @overload
    def openDomainObject(self, domainObject: ghidra.framework.model.DomainObject, current: bool) -> None: ...
    ...
    def releaseDomainObject(self, domainObject: ghidra.framework.model.DomainObject, persistentOwner: object) -> None: ...
    ...
    def setCurrentDomainObject(self, domainObject: ghidra.framework.model.DomainObject) -> None: ...

    def setPersistentOwner(self, domainObject: ghidra.framework.model.DomainObject, owner: object) -> bool: ...

    def setSearchPriority(self, domainObject: ghidra.framework.model.DomainObject, priority: int) -> None: ...
    ...
    @property
    def allOpenDomainObjects(self) -> List[ghidra.framework.model.DomainObject]: ...

    @property
    def currentDomainObject(self) -> ghidra.framework.model.DomainObject: ...

    @currentDomainObject.setter
    def currentDomainObject(self, value: ghidra.framework.model.DomainObject) -> None: ...