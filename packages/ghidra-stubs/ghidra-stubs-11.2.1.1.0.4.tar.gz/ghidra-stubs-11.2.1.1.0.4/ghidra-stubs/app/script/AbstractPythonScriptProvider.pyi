...
class AbstractPythonScriptProvider(ghidra.app.script.GhidraScriptProvider):
    """
    An abstract GhidraScriptProvider used to provide common functionality to different
