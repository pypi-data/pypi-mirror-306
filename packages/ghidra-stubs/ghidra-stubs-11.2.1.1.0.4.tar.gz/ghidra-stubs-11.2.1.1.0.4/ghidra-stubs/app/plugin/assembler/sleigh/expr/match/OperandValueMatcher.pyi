...
class OperandValueMatcher(ghidra.app.plugin.assembler.sleigh.expr.match.AbstractExpressionMatcher):
    """
    ...
    def __init__(self, defMatcher: ghidra.app.plugin.assembler.sleigh.expr.match.ExpressionMatcher): ...
