...
class FieldSizeMatcher(ghidra.app.plugin.assembler.sleigh.expr.match.AbstractExpressionMatcher):
    """
    ...
    def __init__(self, sizeMatcher: ghidra.app.plugin.assembler.sleigh.expr.match.ExpressionMatcher): ...
