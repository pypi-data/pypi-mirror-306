...
class AssemblyResolutionResults(org.apache.commons.collections4.set.AbstractSetDecorator):
    ...
    class Applicator(object):
        ...
        def combine(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns: ...

        def combineBackfill(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedBackfill) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns: ...

        def combineConstructor(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns: ...

        def describeError(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution) -> unicode: ...

        def equals(self, __a0: object) -> bool: ...

        def finish(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution: ...

        def getClass(self) -> java.lang.Class: ...

        def getPatterns(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> java.lang.Iterable: ...
        ...
        def setDescription(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns: ...

        def setRight(self, __a0: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a1: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns: ...
