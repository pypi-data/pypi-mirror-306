...
class MaskedLong(object, java.lang.Comparable):
    ...
    ONES: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong
    UNKS: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong
    ZERO: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong
