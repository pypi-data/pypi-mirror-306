...
class DecisionNode(object):
    ...
    def decode(self, decoder: ghidra.program.model.pcode.Decoder, par: ghidra.app.plugin.processors.sleigh.DecisionNode, sub: ghidra.app.plugin.processors.sleigh.symbol.SubtableSymbol) -> None: ...
