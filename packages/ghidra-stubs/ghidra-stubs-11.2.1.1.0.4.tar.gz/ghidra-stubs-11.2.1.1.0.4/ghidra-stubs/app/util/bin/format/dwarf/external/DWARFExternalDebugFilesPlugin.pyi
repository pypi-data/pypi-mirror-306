...
class DWARFExternalDebugFilesPlugin(ghidra.framework.plugintool.Plugin):
    ...
    @staticmethod
    def getExternalDebugFilesService(context: ghidra.app.util.bin.format.dwarf.external.SearchLocationCreatorContext) -> ghidra.app.util.bin.format.dwarf.external.ExternalDebugFilesService:
        """
    ...
    @staticmethod
    def saveExternalDebugFilesService(service: ghidra.app.util.bin.format.dwarf.external.ExternalDebugFilesService) -> None:
        """
