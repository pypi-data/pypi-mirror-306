...
class DWARFDataTypeImporter(object):
    ...
    def __init__(self, prog: ghidra.app.util.bin.format.dwarf.DWARFProgram, dwarfDTM: ghidra.app.util.bin.format.dwarf.DWARFDataTypeManager):
        """
    ...
    def getDDTByInstance(self, dtInstance: ghidra.program.model.data.DataType) -> ghidra.app.util.bin.format.dwarf.DWARFDataTypeImporter.DWARFDataType: ...

    def getDataType(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate, defaultValue: ghidra.app.util.bin.format.dwarf.DWARFDataTypeImporter.DWARFDataType) -> ghidra.app.util.bin.format.dwarf.DWARFDataTypeImporter.DWARFDataType:
        """
