...
class DWARFExpressionEvaluator(object):
    ...
    @overload
    def evaluate(self, exprBytes: List[int]) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionResult: ...

    @overload
    def evaluate(self, _expr: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionResult: ...

    @overload
    def evaluate(self, _expr: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression, stackArgs: List[long]) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionResult:
        """
        @param _expr
    ...
    def readExpr(self, exprBytes: List[int]) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpression: ...
