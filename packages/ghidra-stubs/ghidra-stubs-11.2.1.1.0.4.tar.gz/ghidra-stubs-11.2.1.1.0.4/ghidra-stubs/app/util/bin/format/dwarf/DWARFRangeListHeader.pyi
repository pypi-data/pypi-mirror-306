...
class DWARFRangeListHeader(ghidra.app.util.bin.format.dwarf.DWARFIndirectTableHeader):
    """
    Header found at the start of a set of DWARFRangeList entries, which are stored sequentially
     in the DWARFSectionNames#DEBUG_RNGLISTS section.
    """
    ...
    @staticmethod
    def read(reader: ghidra.app.util.bin.BinaryReader, defaultIntSize: int) -> ghidra.app.util.bin.format.dwarf.DWARFRangeListHeader: ...
