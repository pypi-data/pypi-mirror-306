...
class DWARFExpression(object):
    ...
    @staticmethod
    def exprToString(exprBytes: List[int], diea: ghidra.app.util.bin.format.dwarf.DIEAggregate) -> unicode: ...
    ...
    def getOp(self, i: int) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionOperation: ...
    ...
    @overload
    @staticmethod
    def read(reader: ghidra.app.util.bin.BinaryReader, addrSize: int, intSize: int) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpression: ...

    @overload
    @staticmethod
    def read(exprBytes: List[int], addrSize: int, isLittleEndian: bool, intSize: int) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpression: ...
