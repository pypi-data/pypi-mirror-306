...
class CliSigField(ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig):
    ...
    def getType(self) -> ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig.CliParam: ...
    ...
    @property
    def type(self) -> ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig.CliParam: ...