...
class NamespacePath(object, java.lang.Comparable):
    ...
    ROOT: ghidra.app.util.bin.format.dwarf.NamespacePath
    ...
    @overload
    def compareTo(self, otherPath: ghidra.app.util.bin.format.dwarf.NamespacePath) -> int: ...

    @overload
    def compareTo(self, __a0: object) -> int: ...

    @staticmethod
    def create(parent: ghidra.app.util.bin.format.dwarf.NamespacePath, name: unicode, type: ghidra.program.model.symbol.SymbolType) -> ghidra.app.util.bin.format.dwarf.NamespacePath:
        """
    ...
    def getParent(self) -> ghidra.app.util.bin.format.dwarf.NamespacePath:
        """
    ...
    def getParts(self) -> List[unicode]:
        """
    ...
    @property
    def parent(self) -> ghidra.app.util.bin.format.dwarf.NamespacePath: ...
