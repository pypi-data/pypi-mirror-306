...
class MachoPrelinkUtils(object):
    ...
    @staticmethod
    def parsePrelinkXml(provider: ghidra.app.util.bin.ByteProvider, monitor: ghidra.util.task.TaskMonitor) -> List[ghidra.app.util.bin.format.macho.prelink.MachoPrelinkMap]:
        """
