...
class PeLoader(ghidra.app.util.opinion.AbstractPeDebugLoader):
    ...
    class CompilerOpinion(object):
        ...
        @staticmethod
        def getOpinion(__a0: ghidra.app.util.bin.format.pe.PortableExecutable, __a1: ghidra.app.util.bin.ByteProvider, __a2: ghidra.program.model.listing.Program, __a3: ghidra.util.task.TaskMonitor, __a4: ghidra.app.util.importer.MessageLog) -> ghidra.app.util.opinion.PeLoader.CompilerOpinion.CompilerEnum: ...
