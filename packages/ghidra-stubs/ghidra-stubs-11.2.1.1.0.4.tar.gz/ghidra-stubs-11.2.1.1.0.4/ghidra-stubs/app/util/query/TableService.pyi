...
class TableService(object):
    ...
    def showTableWithMarkers(self, componentProviderTitle: unicode, tableTypeName: unicode, model: ghidra.util.table.GhidraProgramTableModel, markerColor: java.awt.Color, markerIcon: javax.swing.Icon, windowSubMenu: unicode, navigatable: ghidra.app.nav.Navigatable) -> ghidra.app.plugin.core.table.TableComponentProvider:
        """
