...
class NamespaceUtils(object):
    ...
    @staticmethod
    def getNamespaceParts(namespace: ghidra.program.model.symbol.Namespace) -> List[ghidra.program.model.symbol.Namespace]:
        """
    ...
    @overload
    @staticmethod
    def getSymbols(symbolPath: unicode, program: ghidra.program.model.listing.Program, searchWithinAllLibraries: bool) -> List[ghidra.program.model.symbol.Symbol]:
        """
    ...
    @overload
    @staticmethod
    def getSymbols(symbolPath: ghidra.app.util.SymbolPath, program: ghidra.program.model.listing.Program, searchWithinAllLibraries: bool) -> List[ghidra.program.model.symbol.Symbol]:
        """
