...
class ListingPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldMouseListener, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, docking.widgets.fieldpanel.listener.LayoutListener):
    ...
    def addFocusListener(self, l: java.awt.event.FocusListener) -> None: ...
    ...
    def removeFocusListener(self, l: java.awt.event.FocusListener) -> None: ...
    ...
    def setLiveProgramSelectionListener(self, listener: ghidra.app.util.viewer.listingpanel.ProgramSelectionListener) -> None:
        """
    ...
    @property
    def liveProgramSelectionListener(self) -> None: ...  # No getter available.

    @liveProgramSelectionListener.setter
    def liveProgramSelectionListener(self, value: ghidra.app.util.viewer.listingpanel.ProgramSelectionListener) -> None: ...
