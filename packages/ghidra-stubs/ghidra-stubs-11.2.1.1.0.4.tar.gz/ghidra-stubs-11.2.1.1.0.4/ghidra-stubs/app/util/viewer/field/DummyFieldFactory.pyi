...
class DummyFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, hlProvdier: ghidra.app.util.ListingHighlightProvider, options: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
