...
class MemoryBlockOffsetFieldFactory(ghidra.app.util.viewer.field.AbstractOffsetFieldFactory):
    """
    ...
    def getOffsetValue(self, cu: ghidra.program.model.listing.CodeUnit) -> unicode: ...
