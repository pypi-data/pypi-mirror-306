...
class MemoryMatchtToFunctionTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    """
    Maps MemoryMatch objects (search result) to functions to pick up function based 
     table columns.
    """
    ...
    @overload
    def map(self, rowObject: ghidra.features.base.memsearch.searcher.MemoryMatch, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.listing.Function: ...
