...
class MemoryMatchToAddressTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    """
    Maps MemoryMatch objects (search result) to an address to pick up address based 
     table columns.
    """
    ...
    @overload
    def map(self, rowObject: ghidra.features.base.memsearch.searcher.MemoryMatch, data: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.address.Address: ...
