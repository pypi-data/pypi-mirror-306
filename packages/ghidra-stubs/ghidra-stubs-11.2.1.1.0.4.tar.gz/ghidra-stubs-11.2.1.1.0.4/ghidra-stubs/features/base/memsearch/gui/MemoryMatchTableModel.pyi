...
class MemoryMatchTableModel(ghidra.util.table.AddressBasedTableModel):
    """
    ...
    class MatchValueColumn(docking.widgets.table.DynamicTableColumnExtensionPoint):




        def __init__(self, __a0: ghidra.features.base.memsearch.gui.MemoryMatchTableModel): ...
        ...
        @overload
        def getValue(self, __a0: ghidra.features.base.memsearch.searcher.MemoryMatch, __a1: ghidra.docking.settings.Settings, __a2: ghidra.program.model.listing.Program, __a3: ghidra.framework.plugintool.ServiceProvider) -> unicode: ...
    ...
    class MatchBytesColumn(docking.widgets.table.DynamicTableColumnExtensionPoint):
    ...
    @overload
    def addInitialLoadListener(self, completedLoadingConsumer: java.util.function.Consumer) -> None:
        """
