...
class RemoteDatabaseItem(ghidra.framework.store.remote.RemoteFolderItem, ghidra.framework.store.DatabaseItem):
    ...
    @overload
    def open(self, fileVersion: int) -> db.buffers.ManagedBufferFileAdapter: ...

    @overload
    def open(self, fileVersion: int, minChangeDataVer: int) -> db.buffers.ManagedBufferFileAdapter: ...

    def openForUpdate(self, checkoutId: long) -> db.buffers.ManagedBufferFileAdapter: ...

    def output(self, outputFile: java.io.File, fileVersion: int, monitor: ghidra.util.task.TaskMonitor) -> None: ...
