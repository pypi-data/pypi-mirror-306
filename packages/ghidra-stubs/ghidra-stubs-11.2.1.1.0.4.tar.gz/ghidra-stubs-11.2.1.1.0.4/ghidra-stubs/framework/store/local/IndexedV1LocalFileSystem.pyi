...
class IndexedV1LocalFileSystem(ghidra.framework.store.local.IndexedLocalFileSystem):
    """
    ...
    @overload
    def getItem(self, fileID: unicode) -> ghidra.framework.store.local.LocalFolderItem: ...
    ...
    @overload
    def getItemNames(self, folderPath: unicode, includeHiddenFiles: bool) -> List[unicode]: ...

    def getItems(self, folderPath: unicode) -> List[ghidra.framework.store.local.LocalFolderItem]: ...
