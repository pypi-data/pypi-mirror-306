...
class GraphViewer(edu.uci.ics.jung.visualization.VisualizationViewer):
    """
    ...
    def __init__(self, layout: ghidra.graph.viewer.layout.VisualGraphLayout, size: java.awt.Dimension): ...
    ...
    def setGraphLayout(self, layout: edu.uci.ics.jung.algorithms.layout.Layout) -> None: ...
    ...
    def setVertexFocusPathHighlightMode(self, focusMode: ghidra.graph.viewer.PathHighlightMode) -> None: ...

    def setVertexHoverPathHighlightMode(self, hoverMode: ghidra.graph.viewer.PathHighlightMode) -> None: ...

    def setVertexToolTipTransformer(self, __a0: com.google.common.base.Function) -> None: ...

    def setVertexTooltipProvider(self, vertexTooltipProvider: ghidra.graph.viewer.event.mouse.VertexTooltipProvider) -> None: ...

    def setViewerInitializedListener(self, listener: java.util.function.Consumer) -> None: ...
    ...
    @property
    def GPickedVertexState(self) -> ghidra.graph.viewer.event.picking.GPickedState: ...

    @property
    def center(self) -> java.awt.geom.Point2D: ...

    @property
    def graphLayout(self) -> edu.uci.ics.jung.algorithms.layout.Layout: ...

    @graphLayout.setter
    def graphLayout(self, value: edu.uci.ics.jung.algorithms.layout.Layout) -> None: ...
    ...
    @property
    def vertexTooltipProvider(self) -> None: ...  # No getter available.

    @vertexTooltipProvider.setter
    def vertexTooltipProvider(self, value: ghidra.graph.viewer.event.mouse.VertexTooltipProvider) -> None: ...

    @property
    def viewUpdater(self) -> ghidra.graph.viewer.VisualGraphViewUpdater: ...

    @property
    def viewerInitializedListener(self) -> None: ...  # No getter available.

    @viewerInitializedListener.setter
    def viewerInitializedListener(self, value: java.util.function.Consumer) -> None: ...

    @property
    def visualGraph(self) -> ghidra.graph.VisualGraph: ...

    @property
    def visualGraphLayout(self) -> ghidra.graph.viewer.layout.VisualGraphLayout: ...