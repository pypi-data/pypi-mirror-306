...
class FileSystemBrowserPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.ApplicationLevelPlugin, ghidra.framework.model.ProjectListener, ghidra.app.services.FileSystemBrowserService):
    ...
    def createNewFileSystemBrowser(self, fsRef: ghidra.formats.gfilesystem.FileSystemRef, show: bool) -> None:
        """
    ...
    def setLastExportDirectory(self, lastExportDirectory: java.io.File) -> None: ...
    ...
    def lastExportDirectory(self, value: java.io.File) -> None: ...