...
class FSBRootNode(ghidra.plugins.fsbrowser.FSBNode):
    ...
    @staticmethod
    def createNodeFromFile(file: ghidra.formats.gfilesystem.GFile, monitor: ghidra.util.task.TaskMonitor) -> ghidra.plugins.fsbrowser.FSBFileNode:
        """
    ...
    def getContainerName(self) -> unicode: ...
    ...
    def getGFileFSBNode(self, file: ghidra.formats.gfilesystem.GFile, monitor: ghidra.util.task.TaskMonitor) -> ghidra.plugins.fsbrowser.FSBNode: ...
    ...
    def refreshNode(self, monitor: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    def setCryptoStatusUpdated(self, cryptoStatusUpdated: bool) -> None: ...
    ...
    def swapBackPrevModelNodeAndDispose(self) -> None: ...
    ...
    @property
    def containerName(self) -> unicode: ...

    @property
    def cryptoStatusUpdated(self) -> None: ...  # No getter available.

    @cryptoStatusUpdated.setter
    def cryptoStatusUpdated(self, value: bool) -> None: ...
