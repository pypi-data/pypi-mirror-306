...
class FSRL(object):
    ...
    FSRL_OPTION_NAME: unicode = u'FSRL'
    ...
    @staticmethod
    def fromProgram(program: ghidra.program.model.listing.Program) -> ghidra.formats.gfilesystem.FSRL:
        """
    ...
    @staticmethod
    def writeToProgramInfo(program: ghidra.program.model.listing.Program, fsrl: ghidra.formats.gfilesystem.FSRL) -> None:
        """
