...
class EmuProcessExitedException(ghidra.pcode.emu.sys.EmuSystemException):
    ...
    def __init__(self, arithmetic: ghidra.pcode.exec.PcodeArithmetic, status: object):
        """
    ...
    @staticmethod
    def tryConcereteToString(arithmetic: ghidra.pcode.exec.PcodeArithmetic, status: object) -> unicode:
        """
