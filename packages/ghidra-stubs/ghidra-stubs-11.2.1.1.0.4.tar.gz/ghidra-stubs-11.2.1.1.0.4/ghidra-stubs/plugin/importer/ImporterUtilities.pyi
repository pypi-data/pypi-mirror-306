...
class ImporterUtilities(object):
    ...
    CONTAINER_FILES_FILTER: ghidra.util.filechooser.GhidraFileFilter
    LOADABLE_FILES_FILTER: ghidra.util.filechooser.GhidraFileFilter
    ...
    @staticmethod
    def showImportSingleFileDialog(fsrl: ghidra.formats.gfilesystem.FSRL, destinationFolder: ghidra.framework.model.DomainFolder, suggestedPath: unicode, tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
