...
class FileSystemIndexHelper(object):
    ...
    def storeSymlink(self, __a0: unicode, __a1: long, __a2: unicode, __a3: long, __a4: object) -> ghidra.formats.gfilesystem.GFile: ...

    def storeSymlinkWithParent(self, __a0: unicode, __a1: ghidra.formats.gfilesystem.GFile, __a2: long, __a3: unicode, __a4: long, __a5: object) -> ghidra.formats.gfilesystem.GFile: ...
