...
@overload
def askProgram(title: unicode, upgradeIfNeeded: bool) -> ghidra.program.model.listing.Program:
    """
...
def askValues(title: unicode, optionalMessage: unicode, values: ghidra.features.base.values.GhidraValuesMap) -> ghidra.features.base.values.GhidraValuesMap:
    """
...
this: ghidra.jython.JythonScript