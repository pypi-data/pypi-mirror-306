...
class SpecExtensionPanel(javax.swing.JPanel):
    ...
    class Status(java.lang.Enum):
        CORE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_ERROR: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_INSTALL: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_OVERPENDING: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_OVERRIDE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_REMOVE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
        EXTENSION_REPLACE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status
