...
class AssemblyConstructStateGenerator(ghidra.app.plugin.assembler.sleigh.sem.AbstractAssemblyStateGenerator):
    ...
    def __init__(self, resolver: ghidra.app.plugin.assembler.sleigh.sem.AbstractAssemblyTreeResolver, node: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseBranch, fromLeft: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns):
        """
