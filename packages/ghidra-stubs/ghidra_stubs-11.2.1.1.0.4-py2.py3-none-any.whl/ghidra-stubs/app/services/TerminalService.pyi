...
class TerminalService(object):
    ...
    A service that provides for the creation and management of DEC VT100 terminal emulators.
     ...
     about the details. You set , and they just use whatever codes the feel like.
     ...
     become more disciplined, but as it stands, our TerminalPlugin takes the ad hoc
     ...
     codes. Where the documentation lacks specificity or otherwise seems incorrect, we experiment
     with a reference implementation to discern and replicate its behavior. The clearest way we know
     to do this is to run the  command from the reference terminal to get its
     pseudo-terminal (pty) file name. Then, we use Python from a separate terminal to write test
     sequences to it and/or read sequences from it. We use the  command to prevent Bash
     ...
     The applications we've tested with include, without regard to version:
      ...
      (from our Debugger training exercises)
     ...
     by . Historically, these charsets are used to encode international characters.
    ...
    @overload
    def createNullTerminal(self, charset: java.nio.charset.Charset, outputCb: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.services.Terminal:
        """
    ...
    @overload
    def createNullTerminal(self, helpPlugin: ghidra.framework.plugintool.Plugin, charset: java.nio.charset.Charset, outputCb: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.services.Terminal:
        """
    ...
    @overload
    def createWithStreams(self, charset: java.nio.charset.Charset, in_: java.io.InputStream, out: java.io.OutputStream) -> ghidra.app.services.Terminal:
        """
    ...
    @overload
    def createWithStreams(self, helpPlugin: ghidra.framework.plugintool.Plugin, charset: java.nio.charset.Charset, in_: java.io.InputStream, out: java.io.OutputStream) -> ghidra.app.services.Terminal:
        """
