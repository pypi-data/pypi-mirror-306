...
class PseudoDisassembler(object):
    ...
    @overload
    def checkValidSubroutine(self, entryPoint: ghidra.program.model.address.Address, allowExistingInstructions: bool, mustTerminate: bool, requireContiguous: bool) -> bool:
        """
    ...
    @overload
    def checkValidSubroutine(self, entryPoint: ghidra.program.model.address.Address, procContext: ghidra.app.util.PseudoDisassemblerContext, allowExistingInstructions: bool, mustTerminate: bool, requireContiguous: bool) -> bool:
        """
        Check if there is a valid subroutine at the target address
        @param entryPoint address to check
        @param procContext processor context to use when pseudo disassembling instructions
    ...
    @property
    def lastCheckValidInstructionCount(self) -> int: ...
