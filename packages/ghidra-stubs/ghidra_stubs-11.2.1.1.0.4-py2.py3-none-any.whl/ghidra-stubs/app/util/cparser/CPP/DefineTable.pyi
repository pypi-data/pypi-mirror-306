...
class DefineTable(object):
    ...
    @overload
    def expand(self, __a0: unicode, __a1: bool, __a2: java.util.ArrayList) -> unicode: ...

    def expandDefine(self, defName: unicode) -> unicode: ...
    ...
    @staticmethod
    def getCValue(strValue: unicode) -> long:
        """
    ...
    def populateDefineEquate(self, openDTMgrs: List[ghidra.program.model.data.DataTypeManager], dtMgr: ghidra.program.model.data.DataTypeManager, category: unicode, prefix: unicode, defName: unicode, value: long) -> None: ...

    def populateDefineEquates(self, openDTMgrs: List[ghidra.program.model.data.DataTypeManager], dtMgr: ghidra.program.model.data.DataTypeManager) -> None:
        """
