...
class FunctionXrefsTableModel(ghidra.util.table.ReferencesFromTableModel):
    ...
    def __init__(self, function: ghidra.program.model.listing.Function, directRefs: java.util.Collection, sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program): ...
