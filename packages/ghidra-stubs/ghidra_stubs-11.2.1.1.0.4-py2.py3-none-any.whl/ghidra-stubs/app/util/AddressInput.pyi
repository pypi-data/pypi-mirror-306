...
class AddressInput(javax.swing.JPanel, docking.widgets.table.FocusableEditor):
    ...
    INCLUDE_ALL_MEMORY_SPACES: java.util.function.Predicate
    INCLUDE_LOADED_MEMORY_SPACES: java.util.function.Predicate
    ...
    def setAccessibleName(self, name: unicode) -> None:
        """
    ...
    @property
    def accessibleName(self) -> None: ...  # No getter available.

    @accessibleName.setter
    def accessibleName(self, value: unicode) -> None: ...
