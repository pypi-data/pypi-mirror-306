...
class AbstractOffsetFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    ...
    def __init__(self, offsetDescription: unicode):
        """
    ...
    def getOffsetValue(self, codeUnit: ghidra.program.model.listing.CodeUnit) -> unicode:
        """
