...
class EolCommentFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    DEFAULT_COLOR: java.awt.Color
    ENABLE_PREPEND_REF_ADDRESS_KEY: unicode = u'EOL Comments Field.Prepend Address to References'
    ENABLE_SHOW_SEMICOLON_KEY: unicode = u'EOL Comments Field.Prepend Semicolon'
    ENABLE_WORD_WRAP_KEY: unicode = u'EOL Comments Field.Enable Word Wrapping'
    EXTRA_COMMENT_KEY: unicode = u'EOL Comments Field.Auto Comments'
    FIELD_NAME: unicode = u'EOL Comment'
    MAX_DISPLAY_LINES_KEY: unicode = u'EOL Comments Field.Maximum Lines'
