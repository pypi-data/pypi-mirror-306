...
class ErrorListingField(ghidra.app.util.viewer.field.ListingTextField):
    ...
    @overload
    @staticmethod
    def createMultilineTextField(__a0: ghidra.app.util.viewer.field.FieldFactory, __a1: ghidra.app.util.viewer.proxy.ProxyObj, __a2: List[object], __a3: int, __a4: int, __a5: ghidra.app.util.ListingHighlightProvider) -> ghidra.app.util.viewer.field.ListingTextField: ...

    @overload
    @staticmethod
    def createMultilineTextField(__a0: ghidra.app.util.viewer.field.FieldFactory, __a1: ghidra.app.util.viewer.proxy.ProxyObj, __a2: List[object], __a3: int, __a4: int, __a5: int, __a6: ghidra.app.util.ListingHighlightProvider) -> ghidra.app.util.viewer.field.ListingTextField: ...
