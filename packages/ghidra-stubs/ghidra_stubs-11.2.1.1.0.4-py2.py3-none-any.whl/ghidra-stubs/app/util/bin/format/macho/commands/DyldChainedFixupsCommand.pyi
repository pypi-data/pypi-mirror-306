...
class DyldChainedFixupsCommand(ghidra.app.util.bin.format.macho.commands.LinkEditDataCommand):
    ...
    def getChainedFixups(self, reader: ghidra.app.util.bin.BinaryReader, imagebase: long, symbolTable: ghidra.program.model.symbol.SymbolTable, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> List[ghidra.app.util.bin.format.macho.dyld.DyldFixup]:
        """
