...
class DWARFRegisterMappingsManager(object):
    ...
    @staticmethod
    def getMappingForLang(lang: ghidra.program.model.lang.Language) -> ghidra.app.util.bin.format.dwarf.DWARFRegisterMappings:
        """
    ...
    @staticmethod
    def readMappingForLang(lang: ghidra.program.model.lang.Language) -> ghidra.app.util.bin.format.dwarf.DWARFRegisterMappings:
        """
    ...
    @staticmethod
    def readMappingFrom(rootElem: org.jdom.Element, lang: ghidra.program.model.lang.Language) -> ghidra.app.util.bin.format.dwarf.DWARFRegisterMappings:
        """
