...
class DebugDirectoryParser(object, ghidra.app.util.bin.format.pe.OffsetValidator):
    """
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, ptr: long, size: int, sizeOfImage: long):
        """
