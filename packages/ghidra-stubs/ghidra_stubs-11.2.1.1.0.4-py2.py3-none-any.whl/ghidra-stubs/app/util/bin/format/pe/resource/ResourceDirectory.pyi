...
class ResourceDirectory(object, ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: int, resourceBase: int, isFirstLevel: bool, ntHeader: ghidra.app.util.bin.format.pe.NTHeader): ...
