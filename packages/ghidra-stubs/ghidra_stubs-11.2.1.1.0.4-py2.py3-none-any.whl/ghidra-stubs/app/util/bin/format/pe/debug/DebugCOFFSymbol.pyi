...
class DebugCOFFSymbol(object, ghidra.app.util.bin.StructConverter):
    ...
    @overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: int, stringTableIndex: long): ...

    @overload
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader, index: int, symbolTable: ghidra.app.util.bin.format.pe.debug.DebugCOFFSymbolTable): ...
