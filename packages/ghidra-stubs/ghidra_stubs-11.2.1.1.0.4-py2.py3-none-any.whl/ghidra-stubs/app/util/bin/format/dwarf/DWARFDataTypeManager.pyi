...
class DWARFDataTypeManager(object):
    ...
    def __init__(self, prog: ghidra.app.util.bin.format.dwarf.DWARFProgram, dataTypeManager: ghidra.program.model.data.DataTypeManager):
        """
    ...
    def addDataType(self, offset: long, dataType: ghidra.program.model.data.DataType, dsi: ghidra.app.util.bin.format.dwarf.DWARFSourceInfo) -> None: ...

    def doGetDataType(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate) -> ghidra.program.model.data.DataType:
        """
    ...
    @overload
    def getBaseType(self, name: unicode, dwarfSize: int, dwarfEncoding: int, isBigEndian: bool, isExplictSize: bool) -> ghidra.program.model.data.DataType:
        """
    ...
    @overload
    def getDataType(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate, defaultValue: ghidra.program.model.data.DataType) -> ghidra.program.model.data.DataType:
        """
    ...
    def getDataTypeForVariable(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate) -> ghidra.program.model.data.DataType: ...

    def getFunctionSignature(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate) -> ghidra.program.model.data.FunctionDefinition:
        """
    ...
    @overload
    def getPtrTo(self, dt: ghidra.program.model.data.DataType, ptrSize: int) -> ghidra.program.model.data.DataType: ...

    def getSourceInfo(self, dataType: ghidra.program.model.data.DataType) -> ghidra.app.util.bin.format.dwarf.DWARFSourceInfo: ...

    def getSpecificDataType(self, diea: ghidra.app.util.bin.format.dwarf.DIEAggregate, dataTypeClazz: java.lang.Class) -> object: ...
