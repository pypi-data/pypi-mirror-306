...
class DWARFExpressionOpCodes(object):
    ...
    BLOBONLY_OPERANDTYPES: List[ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionOperandType]
    DW_OP_abs: int = 25
    DW_OP_addr: int = 3
    DW_OP_addrx: int = 161
    DW_OP_and: int = 26
    ...
    DW_OP_const_type: int = 164
    DW_OP_consts: int = 17
    DW_OP_constu: int = 16
    DW_OP_constx: int = 162
    DW_OP_convert: int = 168
    DW_OP_deref: int = 6
    DW_OP_deref_size: int = 148
    DW_OP_deref_type: int = 166
    DW_OP_div: int = 27
    DW_OP_drop: int = 19
    DW_OP_dup: int = 18
    DW_OP_entry_value: int = 163
    DW_OP_eq: int = 41
    DW_OP_fbreg: int = 145
    ...
    DW_OP_implicit_pointer: int = 160
    ...
    DW_OP_reg8: int = 88
    DW_OP_reg9: int = 89
    DW_OP_regval_type: int = 165
    DW_OP_regx: int = 144
    DW_OP_reinterpret: int = 169
    DW_OP_rot: int = 23
    DW_OP_shl: int = 36
    DW_OP_shr: int = 37
    DW_OP_shra: int = 38
    ...
    DW_OP_xderef_type: int = 167
    DW_OP_xor: int = 39
    EMPTY_OPERANDTYPES: List[ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionOperandType]
    UNSUPPORTED_OPCODES: java.util.Set
    UNSUPPORTED_OPCODES_LIST: List[int]
    ...
    @staticmethod
    def getOperandTypesFor(opcode: int) -> List[ghidra.app.util.bin.format.dwarf.expression.DWARFExpressionOperandType]: ...
