...
class DWARFExpressionException(java.lang.Exception):
    ...
    @overload
    def __init__(self, message: unicode, expr: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression, step: int): ...

    @overload
    def __init__(self, message: unicode, expr: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression, step: int, cause: java.lang.Throwable): ...
    ...
    def getExpression(self) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpression: ...
    ...
    def setExpression(self, expr: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression) -> None: ...
    ...
    @property
    def expression(self) -> ghidra.app.util.bin.format.dwarf.expression.DWARFExpression: ...

    @expression.setter
    def expression(self, value: ghidra.app.util.bin.format.dwarf.expression.DWARFExpression) -> None: ...
