...
import ghidra.app.util.bin.format.dwarf.DataTypeGraphComparator
...
class DataTypeGraphComparator(object):
    ...
    @staticmethod
    def compare(preDT: ghidra.program.model.data.DataType, postDT: ghidra.program.model.data.DataType, observer: ghidra.app.util.bin.format.dwarf.DataTypeGraphComparator.DataTypePairObserver) -> None:
        """
