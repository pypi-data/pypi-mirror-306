...
class ElfRelocationHandler(object, ghidra.util.classfinder.ExtensionPoint):
    """
    NOTE: ELF relocation handler implementations should extend AbstractElfRelocationHandler 
     which now uses ElfRelocationType enum values instead of simple constants.  This class may 
