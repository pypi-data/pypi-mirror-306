...
class ElfRelocationTable(object, ghidra.app.util.bin.format.elf.ElfFileSection):
    ...
    class TableFormat(java.lang.Enum):
        ANDROID: ghidra.app.util.bin.format.elf.ElfRelocationTable.TableFormat
        DEFAULT: ghidra.app.util.bin.format.elf.ElfRelocationTable.TableFormat
        RELR: ghidra.app.util.bin.format.elf.ElfRelocationTable.TableFormat
