...
class ByteCopier(object):
    ...
    BYTE_STRING_NO_SPACE_TYPE: ghidra.app.util.ClipboardType
    BYTE_STRING_TYPE: ghidra.app.util.ClipboardType
    CPP_BYTE_ARRAY_FLAVOR: java.awt.datatransfer.DataFlavor
    CPP_BYTE_ARRAY_TYPE: ghidra.app.util.ClipboardType
    PYTHON_BYTE_STRING_FLAVOR: java.awt.datatransfer.DataFlavor
    PYTHON_BYTE_STRING_TYPE: ghidra.app.util.ClipboardType
    PYTHON_LIST_FLAVOR: java.awt.datatransfer.DataFlavor
    PYTHON_LIST_TYPE: ghidra.app.util.ClipboardType
