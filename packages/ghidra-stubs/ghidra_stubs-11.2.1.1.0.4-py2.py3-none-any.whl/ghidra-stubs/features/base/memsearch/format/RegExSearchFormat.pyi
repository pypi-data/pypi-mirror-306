...
class RegExSearchFormat(ghidra.features.base.memsearch.format.SearchFormat):
    """
    SearchFormat for parsing input as a regular expression. This format can't generate
