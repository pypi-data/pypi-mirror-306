...
class BinarySearchFormat(ghidra.features.base.memsearch.format.SearchFormat):
    """
    SearchFormat for parsing and display bytes in a binary format. This format only
