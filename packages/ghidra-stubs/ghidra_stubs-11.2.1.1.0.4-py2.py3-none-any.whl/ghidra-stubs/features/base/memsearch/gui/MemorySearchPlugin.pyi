...
class MemorySearchPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.MemorySearchService):
    ...
    def setShowOptionsPanel(self, show: bool) -> None: ...

    def setShowScanPanel(self, show: bool) -> None: ...
    ...
    @property
    def showOptionsPanel(self) -> None: ...  # No getter available.

    @showOptionsPanel.setter
    def showOptionsPanel(self, value: bool) -> None: ...

    @property
    def showScanPanel(self) -> None: ...  # No getter available.

    @showScanPanel.setter
    def showScanPanel(self, value: bool) -> None: ...