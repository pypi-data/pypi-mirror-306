...
class MemorySearchProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.DockingContextListener, ghidra.app.nav.NavigatableRemovalListener, ghidra.framework.model.DomainObjectClosedListener):
    ...
    def __init__(self, plugin: ghidra.features.base.memsearch.gui.MemorySearchPlugin, navigatable: ghidra.app.nav.Navigatable, settings: ghidra.features.base.memsearch.gui.SearchSettings, options: ghidra.features.base.memsearch.gui.MemorySearchOptions, history: ghidra.features.base.memsearch.gui.SearchHistory): ...
    ...
    @overload
    def contextChanged(self, context: docking.ActionContext) -> None: ...
    ...
    def getByteString(self) -> unicode: ...
    ...
    def getSearchInput(self) -> unicode: ...

    def getSearchResults(self) -> List[ghidra.features.base.memsearch.searcher.MemoryMatch]: ...
    ...
    def scan(self, scanner: ghidra.features.base.memsearch.scan.Scanner) -> None:
        """
    ...
    def setCustomSubTitle(self, subTitle: unicode) -> None:
        """
    ...
    def setCustomTabText(self, tabText: unicode) -> None:
        """
    ...
    def setCustomTitle(self, title: unicode) -> None:
        """
    ...
    def setSearchInput(self, input: unicode) -> None: ...

    def setSearchSelectionOnly(self, b: bool) -> None: ...

    def setSettings(self, settings: ghidra.features.base.memsearch.gui.SearchSettings) -> None: ...
    ...
    def showOptions(self, b: bool) -> None: ...

    def showScanPanel(self, b: bool) -> None: ...

    def showSearchPanel(self, b: bool) -> None: ...
    ...
    @property
    def byteString(self) -> unicode: ...

    @property
    def component(self) -> javax.swing.JComponent: ...

    @property
    def searchInput(self) -> unicode: ...

    @searchInput.setter
    def searchInput(self, value: unicode) -> None: ...

    @property
    def searchResults(self) -> List[object]: ...

    @property
    def searchSelection(self) -> bool: ...

    @property
    def searchSelectionOnly(self) -> None: ...  # No getter available.

    @searchSelectionOnly.setter
    def searchSelectionOnly(self, value: bool) -> None: ...

    @property
    def settings(self) -> None: ...  # No getter available.
