...
class MemoryMatchToProgramLocationTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    """
    Maps MemoryMatch objects (search result) to program locations to pick up 
    ...
    @overload
    def map(self, rowObject: ghidra.features.base.memsearch.searcher.MemoryMatch, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.util.ProgramLocation: ...
