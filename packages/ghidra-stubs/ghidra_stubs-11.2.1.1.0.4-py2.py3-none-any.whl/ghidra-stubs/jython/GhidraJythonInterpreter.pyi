...
class GhidraJythonInterpreter(org.python.util.InteractiveInterpreter):
    ...
    def execFile(self, file: generic.jar.ResourceFile, script: ghidra.jython.JythonScript) -> None:
        """
    ...
    @overload
    @staticmethod
    def get() -> ghidra.jython.GhidraJythonInterpreter:
        """
    ...
    def push(self, line: unicode, script: ghidra.jython.JythonScript) -> bool:
        """
