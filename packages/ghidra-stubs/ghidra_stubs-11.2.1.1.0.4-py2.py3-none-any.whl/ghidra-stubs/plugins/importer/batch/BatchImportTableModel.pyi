...
class BatchImportTableModel(docking.widgets.table.AbstractSortedTableModel):
    ...
    class COLS(java.lang.Enum):
        FILES: ghidra.plugins.importer.batch.BatchImportTableModel.COLS
        FILETYPE: ghidra.plugins.importer.batch.BatchImportTableModel.COLS
        LANG: ghidra.plugins.importer.batch.BatchImportTableModel.COLS
        LOADER: ghidra.plugins.importer.batch.BatchImportTableModel.COLS
        SELECTED: ghidra.plugins.importer.batch.BatchImportTableModel.COLS
