...
class FSBComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.formats.gfilesystem.FileSystemEventListener, docking.actions.PopupActionProvider):
    ...
    def __init__(self, plugin: ghidra.plugins.fsbrowser.FileSystemBrowserPlugin, fsRef: ghidra.formats.gfilesystem.FileSystemRef):
        """
    ...
    def afterAddedToTool(self) -> None: ...
    ...
    def ensureFileAccessable(self, fsrl: ghidra.formats.gfilesystem.FSRL, node: ghidra.plugins.fsbrowser.FSBNode, monitor: ghidra.util.task.TaskMonitor) -> bool: ...
    ...
    def getPlugin(self) -> ghidra.plugins.fsbrowser.FileSystemBrowserPlugin: ...

    def getPopupActions(self, tool: docking.Tool, context: docking.ActionContext) -> List[docking.action.DockingActionIf]: ...
    ...
    def openFileSystem(self, node: ghidra.plugins.fsbrowser.FSBNode, nested: bool) -> bool: ...
    ...
    def setProject(self, project: ghidra.framework.model.Project) -> None: ...
    ...
    @property
    def defaultWindowPosition(self) -> docking.WindowPosition: ...

    @property
    def name(self) -> unicode: ...

    @property
    def plugin(self) -> ghidra.plugins.fsbrowser.FileSystemBrowserPlugin: ...

    @property
    def project(self) -> None: ...  # No getter available.

    @project.setter
    def project(self, value: ghidra.framework.model.Project) -> None: ...
