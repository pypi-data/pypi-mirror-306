...
class OpenVersionedFileDialog(ghidra.framework.main.AbstractDataTreeDialog):
    """
    ...
    @overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: unicode, domainObjectClass: java.lang.Class, openDomainObjects: List[object]):
        """
        Constructor
        @param tool tool where the file is being opened.
        @param title title to use
