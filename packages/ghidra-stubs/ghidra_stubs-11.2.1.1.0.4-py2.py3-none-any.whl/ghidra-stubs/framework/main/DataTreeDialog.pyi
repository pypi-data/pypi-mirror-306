...
class DataTreeDialog(ghidra.framework.main.AbstractDataTreeDialog):
    """
    Dialog to open or save domain data items to a new location or name.
    """

    CHOOSE_FOLDER: ghidra.framework.main.DataTreeDialogType
    CREATE: ghidra.framework.main.DataTreeDialogType
    OPEN: ghidra.framework.main.DataTreeDialogType
    SAVE: ghidra.framework.main.DataTreeDialogType



    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, type: ghidra.framework.main.DataTreeDialogType):
        """
    ...
    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, type: ghidra.framework.main.DataTreeDialogType, filter: ghidra.framework.model.DomainFileFilter):
        """
    ...
    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, type: ghidra.framework.main.DataTreeDialogType, filter: ghidra.framework.model.DomainFileFilter, project: ghidra.framework.model.Project):
        """
    ...
    def setAccessibleDescription(self, description: unicode) -> None:
        """
    ...
    def setSearchText(self, s: unicode) -> None: ...
