...
class Options(object):
    ...
    def getActionTrigger(self, optionName: unicode, defaultValue: ghidra.framework.options.ActionTrigger) -> ghidra.framework.options.ActionTrigger:
        """
    ...
    @staticmethod
    def hasSameOptionsAndValues(options1: ghidra.framework.options.Options, options2: ghidra.framework.options.Options) -> bool:
        """
    ...
    def setActionTrigger(self, optionName: unicode, value: ghidra.framework.options.ActionTrigger) -> None:
        """
