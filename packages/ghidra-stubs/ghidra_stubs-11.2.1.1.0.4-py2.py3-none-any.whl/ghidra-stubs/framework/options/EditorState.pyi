...
class EditorState(object, java.beans.PropertyChangeListener):
    ...
    def applyNonDefaults(self, save: ghidra.framework.options.Options) -> None: ...
    ...
    def hasSameValue(self, compareTo: ghidra.framework.options.Options) -> bool: ...

    def hashCode(self) -> int: ...

    def isValueChanged(self) -> bool: ...

    def loadFrom(self, loadFrom: ghidra.framework.options.Options) -> None: ...
