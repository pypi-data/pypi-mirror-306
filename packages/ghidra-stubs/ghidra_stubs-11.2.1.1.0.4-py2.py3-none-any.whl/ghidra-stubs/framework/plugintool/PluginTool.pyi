...
class PluginTool(docking.AbstractDockingTool):
    ...
    @overload
    def execute(self, __a0: unicode, __a1: ghidra.framework.model.DomainObject, __a2: java.lang.Runnable) -> None: ...

    @overload
    def execute(self, __a0: unicode, __a1: ghidra.framework.model.DomainObject, __a2: java.util.function.Function) -> bool: ...

    def executeBackgroundCommand(self, __a0: ghidra.framework.cmd.BackgroundCommand, __a1: ghidra.framework.model.DomainObject) -> None: ...
    ...
    def getGlobalActions(self) -> java.util.Set: ...
    ...
    def getLocalActions(self, provider: docking.ComponentProvider) -> java.util.Set: ...
    ...
    @property
    def pluginsConfiguration(self) -> ghidra.framework.plugintool.PluginsConfiguration: ...
