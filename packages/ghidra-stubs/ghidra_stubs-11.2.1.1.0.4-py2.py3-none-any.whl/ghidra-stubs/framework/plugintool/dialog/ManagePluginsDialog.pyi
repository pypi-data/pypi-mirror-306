...
class ManagePluginsDialog(docking.ReusableDialogComponentProvider):
    ...
    @overload
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, pluginConfigurationModel: ghidra.framework.plugintool.PluginConfigurationModel, addSaveActions: bool, isNewTool: bool): ...
