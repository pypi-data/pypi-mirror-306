...
class GhidraClassLoader(java.net.URLClassLoader):
    ...
    CP: unicode = u'java.class.path'
    CP_EXT: unicode = u'java.class.path.ext'
    ENABLE_RESTRICTED_EXTENSIONS_PROPERTY: unicode = u'ghidra.extensions.classpath.restricted'
    ...
    @staticmethod
    def getClasspath(propertyName: unicode) -> List[unicode]:
        """
