...
class SearchInfo(object):
    ...
    @overload
    def __init__(self, searchData: ghidra.app.plugin.core.searchmem.SearchData, searchLimit: int, searchSelection: bool, forwardSearch: bool, alignment: int, includeNonLoadedBlocks: bool, codeUnitSearchInfo: ghidra.util.search.memory.CodeUnitSearchInfo, listener: ghidra.util.task.TaskListener): ...
    ...
    def setSearchLimit(self, searchLimit: int) -> None: ...
    ...
    @searchLimit.setter
    def searchLimit(self, value: int) -> None: ...