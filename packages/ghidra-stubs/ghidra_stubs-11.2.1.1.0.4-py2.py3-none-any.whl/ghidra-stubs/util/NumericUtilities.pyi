...
class NumericUtilities(object):
    ...
    @staticmethod
    def decodeBigInteger(s: unicode) -> long:
        """
    ...
    @staticmethod
    def parseHexBigInteger(s: unicode) -> long:
        """
    ...
    @staticmethod
    def parseHexLong(s: unicode) -> long:
        """
    ...
    @overload
    @staticmethod
    def parseNumber(s: unicode, defaultValue: long) -> long:
        """
        Parses the given string as a numeric value, detecting whether or not it begins with a hex
         prefix, and if not, parses as a long int value.
        @param s the string to parse
