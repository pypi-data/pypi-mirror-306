...
class HTMLUtilities(object):
    ...
    HTML_NEW_LINE: unicode = u'<br>'
    HTML_SPACE: unicode = u'&nbsp;'
    ...
    @overload
    @staticmethod
    def escapeHTML(text: unicode, makeSpacesNonBreaking: bool) -> unicode:
        """
        Escapes any HTML special characters in the specified text.
         <p>
    ...
    @overload
    @staticmethod
    def friendlyEncodeHTML(text: unicode, skipLeadingWhitespace: bool) -> unicode:
        """
    ...
    @staticmethod
    def isUnbreakableHTML(text: unicode) -> bool:
        """
    ...
    @staticmethod
    def styleText(attributes: javax.swing.text.SimpleAttributeSet, text: unicode) -> unicode:
        """
