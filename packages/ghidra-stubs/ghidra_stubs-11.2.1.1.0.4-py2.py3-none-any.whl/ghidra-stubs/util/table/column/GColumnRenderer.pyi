...
class GColumnRenderer(javax.swing.table.TableCellRenderer, object):
    ...
    class ColumnConstraintFilterMode(java.lang.Enum):
        ALLOW_ALL_FILTERS: ghidra.util.table.column.GColumnRenderer.ColumnConstraintFilterMode
        ALLOW_CONSTRAINTS_FILTER_ONLY: ghidra.util.table.column.GColumnRenderer.ColumnConstraintFilterMode
        ALLOW_RENDERER_STRING_FILTER_ONLY: ghidra.util.table.column.GColumnRenderer.ColumnConstraintFilterMode
