...
class DataTypeNameComparator(object, java.util.Comparator):
    """
    DataTypeNameComparator provides the preferred named-based comparison of DataType
     which handles both some degree of case-insensity as well as proper grouping and ordering of
     conflict datatypes.
    """

    INSTANCE: ghidra.program.model.data.DataTypeNameComparator
    ...
    @overload
    def compare(self, dt1Name: unicode, dt2Name: unicode) -> int: ...
