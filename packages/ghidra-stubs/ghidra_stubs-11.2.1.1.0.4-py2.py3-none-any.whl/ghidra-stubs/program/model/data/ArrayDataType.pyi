...
class ArrayDataType(ghidra.program.model.data.DataTypeImpl, ghidra.program.model.data.Array):
    ...
    Basic implementation of the Array interface.
     ...
     NOTE: The use of FactoryDataType and Dynamic, where 
    ...
    @overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, numElements: int):
        """
    ...
    @overload
    def __init__(self, dataType: ghidra.program.model.data.DataType, numElements: int, elementLength: int, dataMgr: ghidra.program.model.data.DataTypeManager):
        """
