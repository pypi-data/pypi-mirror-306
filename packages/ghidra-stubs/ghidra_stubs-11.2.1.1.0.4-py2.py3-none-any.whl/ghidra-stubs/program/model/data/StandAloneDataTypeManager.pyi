...
class StandAloneDataTypeManager(ghidra.program.database.data.DataTypeManagerDB, java.io.Closeable):
    ...
    class LanguageUpdateOption(java.lang.Enum):
        CLEAR: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption
        TRANSLATE: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption
        UNCHANGED: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption
    ...
    class ArchiveWarning(java.lang.Enum):
        COMPILER_SPEC_NOT_FOUND: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        DATA_ORG_CHANGED: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        LANGUAGE_NOT_FOUND: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        LANGUAGE_UPGRADE_REQURED: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        NONE: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        UPGRADED_LANGUAGE_VERSION: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning
        ...
        def level(self) -> ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel: ...
    ...
    class ArchiveWarningLevel(java.lang.Enum):
        ERROR: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel
        INFO: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel
        WARN: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel: ...
        ...
        @staticmethod
        def values() -> List[ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarningLevel]: ...
