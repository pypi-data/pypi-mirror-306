...
class CycleGroup(object):
    ...
    ALL_CYCLE_GROUPS: List[object]
    BYTE_CYCLE_GROUP: ghidra.program.model.data.CycleGroup
    FLOAT_CYCLE_GROUP: ghidra.program.model.data.CycleGroup
    STRING_CYCLE_GROUP: ghidra.program.model.data.CycleGroup
