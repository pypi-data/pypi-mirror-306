...
class DataTypeComparator(object, java.util.Comparator):
    """
    DataTypeComparator provides the preferred named-based comparison of DataType
     which utilizes the DataTypeNameComparator for a primary DataType#getName() 
     comparison followed by sub-ordering on DataTypeManager name and CategoryPath.
    """

    INSTANCE: ghidra.program.model.data.DataTypeComparator
    ...
    @overload
    def compare(self, dt1: ghidra.program.model.data.DataType, dt2: ghidra.program.model.data.DataType) -> int: ...
