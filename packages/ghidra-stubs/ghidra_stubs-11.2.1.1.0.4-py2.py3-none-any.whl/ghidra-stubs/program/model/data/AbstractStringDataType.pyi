...
class AbstractStringDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic, ghidra.program.model.data.DataTypeWithCharset):
    ...
    COMMON_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition]
    COMMON_WITH_CHARSET_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition]
    ...
    USE_CHARSET_DEF_DEFAULT: unicode
