...
class AddressSpace(java.lang.Comparable, object):
    ...
    DEFAULT_REGISTER_SPACE: ghidra.program.model.address.AddressSpace
    EXTERNAL_SPACE: ghidra.program.model.address.AddressSpace
    HASH_SPACE: ghidra.program.model.address.AddressSpace
    ID_SIZE_MASK: int = 112
    ID_SIZE_SHIFT: int = 4
    ID_TYPE_MASK: int = 15
    ID_UNIQUE_SHIFT: int = 7
    OTHER_SPACE: ghidra.program.model.address.AddressSpace
    TYPE_CODE: int = 2
    TYPE_CONSTANT: int = 0
    TYPE_DELETED: int = 13
    ...
    VARIABLE_SPACE: ghidra.program.model.address.AddressSpace
