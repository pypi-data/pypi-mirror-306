...
class FollowFlow(object):
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, doNotFollow: List[ghidra.program.model.symbol.FlowType]):
        """
        Constructor
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSetView, doNotFollow: List[ghidra.program.model.symbol.FlowType], followIntoFunctions: bool):
        """
        Constructor
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address, doNotFollow: List[ghidra.program.model.symbol.FlowType], followIntoFunctions: bool, includeData: bool, restrictSingleAddressSpace: bool):
        """
        Constructor
        @param program the program whose flow we are following.
