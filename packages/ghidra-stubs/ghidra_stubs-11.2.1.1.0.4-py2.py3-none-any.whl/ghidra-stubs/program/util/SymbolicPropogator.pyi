...
class SymbolicPropogator(object):
    ...
    @overload
    def makeReference(self, varnodeContext: ghidra.program.util.VarnodeContext, instruction: ghidra.program.model.listing.Instruction, opIndex: int, vt: ghidra.program.model.pcode.Varnode, dataType: ghidra.program.model.data.DataType, refType: ghidra.program.model.symbol.RefType, pcodeop: int, knownReference: bool, monitor: ghidra.util.task.TaskMonitor) -> ghidra.program.model.address.Address:
        """
    ...
    @overload
    def makeReference(self, vContext: ghidra.program.util.VarnodeContext, instruction: ghidra.program.model.listing.Instruction, opIndex: int, knownSpaceID: long, wordOffset: long, size: int, dataType: ghidra.program.model.data.DataType, refType: ghidra.program.model.symbol.RefType, pcodeop: int, knownReference: bool, preExisting: bool, monitor: ghidra.util.task.TaskMonitor) -> ghidra.program.model.address.Address:
        """
    ...
    def setParamPointerRefCheck(self, checkParamRefsOption: bool) -> None:
        """
    ...
    @property
    def paramPointerRefCheck(self) -> None: ...  # No getter available.

    @paramPointerRefCheck.setter
    def paramPointerRefCheck(self, value: bool) -> None: ...
