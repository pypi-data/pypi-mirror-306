...
class DiffUtility(ghidra.program.util.SimpleDiffUtility):
    ...
    @overload
    @staticmethod
    def getCompatibleAddressSet(range: ghidra.program.model.address.AddressRange, otherProgram: ghidra.program.model.listing.Program, exactMatchOnly: bool) -> ghidra.program.model.address.AddressSet:
        """
