...
class OffsetFieldLocation(ghidra.program.util.CodeUnitLocation):
    """
    ...
    @overload
    def __init__(self, type: ghidra.program.util.OffsetFieldType):
        """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: List[int], charOffset: int, type: ghidra.program.util.OffsetFieldType):
        """
    ...
    def getType(self) -> ghidra.program.util.OffsetFieldType:
        """
    ...
    @property
    def type(self) -> ghidra.program.util.OffsetFieldType: ...