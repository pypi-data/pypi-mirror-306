...
class FunctionManagerDB(object, ghidra.program.model.listing.FunctionManager):
    """
    ...
    def createExternalFunction(self, extSpaceAddr: ghidra.program.model.address.Address, name: unicode, nameSpace: ghidra.program.model.symbol.Namespace, extData: unicode, source: ghidra.program.model.symbol.SourceType) -> ghidra.program.model.listing.Function:
        """
