...
class ObjectPropertyMapDB(ghidra.program.database.properties.PropertyMapDB, ghidra.program.model.util.ObjectPropertyMap):
    ...
    def __init__(self, dbHandle: db.DBHandle, openMode: ghidra.framework.data.OpenMode, errHandler: db.util.ErrorHandler, changeMgr: ghidra.program.util.ChangeManager, addrMap: ghidra.program.database.map.AddressMap, name: unicode, saveableObjectClass: java.lang.Class, monitor: ghidra.util.task.TaskMonitor, supportsPrivate: bool):
        """
    ...
    @overload
    def add(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.util.Saveable) -> None: ...
