...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_labels=None, pulp_href=None, prn=None, content_guard=None, base_url=None, hidden=False, no_content_change_since=None, pulp_created=None, name=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
