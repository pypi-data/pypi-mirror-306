...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_last_updated=None, hidden=False, pulp_href=None, content_guard=None, name=None, base_path=None, pulp_labels=None, base_url=None, local_vars_configuration=None):  # noqa: E501
