...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, hidden=False, pulp_labels=None, content_guard=None, base_path=None, pulp_created=None, pulp_href=None, name=None, local_vars_configuration=None):  # noqa: E501
