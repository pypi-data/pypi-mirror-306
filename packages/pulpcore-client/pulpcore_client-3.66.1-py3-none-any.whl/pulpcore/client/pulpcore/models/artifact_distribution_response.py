...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_created=None, base_url=None, content_guard=None, no_content_change_since=None, prn=None, base_path=None, pulp_labels=None, name=None, pulp_href=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
