...
from dojo.config.data.aave_config import aave_supported_tokens as aave_supported_tokens, defaultStrategy as defaultStrategy
...
from dojo.market_models.aaveV3 import AaveV3DefaultModel as AaveV3DefaultModel
...
class AAVEv3Env(BaseEnvironment[BaseAaveAction, AAVEv3Observation]):
    ...
    obs: Incomplete
    market_model: Incomplete
    def __init__(self, chain: Chain, agents: list[AgentT], date_range: tuple[datetime, datetime], backend_type: Literal['forked', 'local', 'live'] = 'forked', port: int | None = None, token_data: dict[str, dict[datetime, Decimal]] | None = None, market_impact: Literal['default'] = 'default') -> None: ...
