...
new frame plots over the previous plot, thereby avoiding filling the terminal
history with all of the previous plots. After the loop is done, a final
interactive plot is generated on top of the previous plot.
"""
