...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.SECURITY, Tags.MANUAL, Tags.AST)
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.SECURITY, Tags.AST, Tags.MANUAL)
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.SECURITY, Tags.AST, Tags.MANUAL)
def check_for_ms_windows_specific_services(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.SECURITY)
