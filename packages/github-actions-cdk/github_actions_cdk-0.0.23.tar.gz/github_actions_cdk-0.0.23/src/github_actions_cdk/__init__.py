...
class ISynthesisSession(typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="skipDiffProtection")
    def skip_diff_protection(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Indicates whether to skip diff protection, ensuring workflow consistency.
...
class _ISynthesisSessionProxy:
    ...
    def skip_diff_protection(self) -> typing.Optional[builtins.bool]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[builtins.bool], jsii.get(self, "skipDiffProtection"))
...
class Job(Component, metaclass=jsii.JSIIMeta, jsii_type="github-actions-cdk.Job"):
    ...
    @jsii.member(jsii_name="configurePermissions")
    def configure_permissions(
        self,
        permissions: typing.Union[typing.Union["PermissionsEvent", typing.Dict[builtins.str, typing.Any]], builtins.str],
    ) -> None:
        '''(experimental) Sets job permissions.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9ffa80c4d31bb0a4152ebe03ef8b446a4385c2e0837c8e0d6138221fc3256332)
            check_type(argname="argument permissions", value=permissions, expected_type=type_hints["permissions"])
        return typing.cast(None, jsii.invoke(self, "configurePermissions", [permissions]))
    ...
    def permissions(
        ...
        '''(experimental) Retrieves job permissions.
...
class Project(
    ...
    def add_workflow(
        ...
        *,
        ...
        '''(experimental) Adds a new workflow to the project.
    ...
    def _create_synthesis_session(self) -> ISynthesisSession:
        '''(experimental) Creates a synthesis session object with configuration for synthesis.

        :return: A configured ``ISynthesisSession`` object.
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "outdir": "outdir",
        "skip_diff_protection": "skipDiffProtection",
...
class ProjectProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument outdir", value=outdir, expected_type=type_hints["outdir"])
            check_type(argname="argument skip_diff_protection", value=skip_diff_protection, expected_type=type_hints["skip_diff_protection"])
        ...
        if skip_diff_protection is not None:
            self._values["skip_diff_protection"] = skip_diff_protection
        if skip_validation is not None:
            self._values["skip_validation"] = skip_validation

    @builtins.property
    def additional_checks(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Enables additional checks, such as version verification for external actions.
    ...
    @builtins.property
    def continue_on_error_annotations(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Allows continuation on error annotations if set to true.
    ...
    def outdir(self) -> typing.Optional[builtins.str]:
        '''(experimental) Directory for storing synthesized workflow files.
    ...
    @builtins.property
    def skip_diff_protection(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Skips protection against workflow file diffs if set to true.

        :default: false

        :stability: experimental
        '''
        result = self._values.get("skip_diff_protection")
        return typing.cast(typing.Optional[builtins.bool], result)

    @builtins.property
    def skip_validation(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Skips workflow validation if set to true.
...
class Runner(metaclass=jsii.JSIIMeta, jsii_type="github-actions-cdk.Runner"):
    '''(experimental) Represents a GitHub Actions runner environment for executing jobs.
    ...
    def self_hosted(cls, labels: typing.Sequence[builtins.str]) -> "Runner":
        '''(experimental) Configures a self-hosted runner with specified labels.

        :param labels: - Array of labels for targeting self-hosted runners. - If the first label is not ``self-hosted``, it will be prepended automatically to ensure compatibility with GitHub Actions.

        :return: A ``Runner`` instance configured for a self-hosted environment.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4b7a9909b7a395e4832552f5ec9493450cdf531f1fdf573681a67070e36b35d9)
    ...
    def MACOS_LATEST(cls) -> "Runner":
        '''(experimental) GitHub-hosted runner for ``macos-latest``.
    ...
    def UBUNTU_LATEST(cls) -> "Runner":
        '''(experimental) GitHub-hosted runner for ``ubuntu-latest``.
    ...
    def WINDOWS_LATEST(cls) -> "Runner":
        '''(experimental) GitHub-hosted runner for ``windows-latest``.
    ...
    @jsii.member(jsii_name="runsOn")
    def runs_on(self) -> typing.Union[builtins.str, typing.List[builtins.str]]:
        '''(experimental) Returns the ``runs-on`` configuration for this runner.
        ...
        :return: The ``runs-on`` configuration for the GitHub Actions job.
...
class WorkflowSynthesizer(
    ...
    @jsii.member(jsii_name="diffProtection")
    def _diff_protection(
        self,
        filename: builtins.str,
        yaml_content: builtins.str,
    ) -> None:
        '''(experimental) Ensures that the workflow file has not been modified during synthesis.

        :param filename: - The path of the workflow YAML file.
        :param yaml_content: - The generated YAML content to compare.

        :stability: experimental
        :throws: {Error} if the existing content differs from the generated content.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b560c3130d9e406569b9a4cb661a8dc3e01ed98716c73e5b3d0da6f4a08a3f01)
            check_type(argname="argument filename", value=filename, expected_type=type_hints["filename"])
            check_type(argname="argument yaml_content", value=yaml_content, expected_type=type_hints["yaml_content"])
        return typing.cast(None, jsii.invoke(self, "diffProtection", [filename, yaml_content]))
...
def _typecheckingstub__9ffa80c4d31bb0a4152ebe03ef8b446a4385c2e0837c8e0d6138221fc3256332(
    permissions: typing.Union[typing.Union[PermissionsEvent, typing.Dict[builtins.str, typing.Any]], builtins.str],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__4b7a9909b7a395e4832552f5ec9493450cdf531f1fdf573681a67070e36b35d9(
...
def _typecheckingstub__b560c3130d9e406569b9a4cb661a8dc3e01ed98716c73e5b3d0da6f4a08a3f01(
    filename: builtins.str,
    yaml_content: builtins.str,
) -> None:
    """Type checking stubs"""
