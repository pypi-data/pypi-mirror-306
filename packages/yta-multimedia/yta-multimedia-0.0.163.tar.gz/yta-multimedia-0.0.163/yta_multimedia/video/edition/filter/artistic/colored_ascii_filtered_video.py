...
class ColoredAsciiFilteredVideo:
    def __init__(self, input_filename, output_filename, font_size = 12, color_lvl = 8):
        pg.init()
...
def to_colored_ascii(video_filename: str, output_filename: str, kwargs = {}):
    """
    Gets the provided 'video_filename' video, turns it into colored ascii
    video and stores the result in a new video as 'output_filename'.

    Optional parameters are 'font_size' (default value is 12) and 
    ...
    app = ColoredAsciiFilteredVideo(video_filename, output_filename, font_size, color_level)
    app.run()

    # TODO: This is failing and audio is missing
