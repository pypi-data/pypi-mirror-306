...
class MoveSinusoidPositionMoviepyEffect(BasePositionMoviepyEffect):
    ...
    @classmethod
    def apply(cls, video: Union[str, VideoFileClip, VideoClip, CompositeVideoClip, ImageClip, ColorClip], initial_position: Union[MoviepyPosition, CoordinateCorner, CoordinateCenter] = MoviepyPosition.OUT_LEFT, final_position: Union[MoviepyPosition, CoordinateCorner, CoordinateCenter] = MoviepyPosition.CENTER):
        """
