...
from moviepy.editor import ColorClip, VideoFileClip, CompositeVideoClip, ImageClip, VideoClip
...
class BasePositionMoviepyEffect(VideoEffect):
    ...
    @classmethod
    def validate_position(cls, position: Union[MoviepyPosition, CoordinateCorner, CoordinateCenter]):
        """
        Validates that the provided 'position' is an MoviepyPosition, a
