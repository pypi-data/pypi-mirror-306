...
from yta_general_utils.image.color.picker import get_most_common_green_rgb_color_and_similars
...
def get_greenscreen_areas_details(image: Union[str, Any]):
    ...
    green_rgb_color, similar_greens = get_most_common_green_rgb_color_and_similars(image)
