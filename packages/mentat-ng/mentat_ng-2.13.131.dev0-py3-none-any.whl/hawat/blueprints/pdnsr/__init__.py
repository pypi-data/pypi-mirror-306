...
class PDNSRBlueprint(HawatBlueprint):
    ...
    def register_app(self, app):
        ...
        app.set_csag(
            ...
            tr_('Search for hostname <strong>%(name)s</strong> locally in PassiveDNS service'),
            SearchView,
            URLParamsBuilder({'submit': tr_('Search')}).add_rule('search')
        )
        app.set_csag_url(
        ...
        app.set_oads(
            ...
            SnippetSearchView,
            URLParamsBuilder({'submit': tr_('Search'), 'sortby': 'count.desc'}).add_rule('search').add_kwrule('render',
                                                                                                              False,
                                                                                                              True)
        )
        app.set_oads(
            ...
            SnippetSearchView,
            URLParamsBuilder({'submit': tr_('Search')}).add_rule('search').add_kwrule('render',
                                                                                                              False,
                                                                                                              True)
        )
        app.set_oads(
