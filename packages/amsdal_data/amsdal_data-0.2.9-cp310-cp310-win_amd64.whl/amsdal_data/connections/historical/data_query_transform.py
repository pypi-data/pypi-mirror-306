...
json_object(
    'next_version', {METADATA_TABLE_ALIAS}.next_version,
    'address', json({METADATA_TABLE_ALIAS}.address),
    ...
    'class_schema_type', {METADATA_TABLE_ALIAS}.class_schema_type,
...
json_build_object(
    'next_version', json_agg({METADATA_TABLE_ALIAS}."next_version")->0,
    'address', json_agg(to_json({METADATA_TABLE_ALIAS}.address))->0,
    ...
    'class_schema_type', json_agg({METADATA_TABLE_ALIAS}.class_schema_type)->0,
