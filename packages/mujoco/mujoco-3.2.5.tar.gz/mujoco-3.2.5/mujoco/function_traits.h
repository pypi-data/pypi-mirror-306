...
struct mj_saveXMLString {
  ...
  static constexpr char doc[] = "Save spec to XML string, return 1 on success, 0 otherwise.";
...
struct mj_saveXML {
  ...
  static constexpr char doc[] = "Save spec to XML file, return 1 on success, 0 otherwise.";
...
struct mjs_delete {
  ...
  static constexpr char doc[] = "Delete object corresponding to the given element.";
  using type = void (mjsElement *);
