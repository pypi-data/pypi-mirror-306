...
class TestJson(unittest.TestCase):
    def test_ref_dict(self):
        ref = o.Ref(ref_type=o.RefType.Flow, id="co2", name="CO2")
    ...
    def test_process(self):
        p1 = o.Process(
            name="a process", process_type=o.ProcessType.UNIT_PROCESS
        )
    ...
    def test_type_tag(self):
        flow = o.Flow()
        self.assertEqual(o.RefType.Flow, flow.to_ref().ref_type)
