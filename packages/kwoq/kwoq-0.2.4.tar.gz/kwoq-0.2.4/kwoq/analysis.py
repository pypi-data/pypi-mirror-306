...
import inspect"""
        ...
        if task_function is not None:
            ...
            # Remove the 'def' line and leading spaces from each line
            function_body = "\n".join(line[8:] if line.startswith('    ') else line for line in code_lines[1:])

            return function_body.strip()  # Return the cleaned-up function body
        else:
