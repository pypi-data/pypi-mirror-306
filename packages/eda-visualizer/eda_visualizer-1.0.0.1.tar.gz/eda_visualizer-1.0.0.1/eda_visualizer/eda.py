...
class eda_visualizer:
    ...
    def univariate_analysis(self, num_plot_type='hist', cat_plot_type='bar'):
        ...
        for col in numerical_cols:
            ...
            column_data = self.data[col].dropna().values.flatten()  # Explicitly ensure 1D array
        ...
        for col in categorical_cols:
            ...
            plt.figure(figsize=(8, 6))
            column_data = self.data[col].dropna()  # Use Series directly for categorical data
            ...
            if cat_plot_type == 'bar':
                ...
                # Plot the pie chart directly from value counts
