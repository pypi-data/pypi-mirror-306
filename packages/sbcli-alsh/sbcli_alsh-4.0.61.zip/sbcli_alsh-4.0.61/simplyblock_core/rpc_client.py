...
class RPCClient:
    ...
    def __init__(self, ip_address, port, username, password, timeout=36000, retry=3):
    ...
    def _request2(self, method, params=None):
        ...
        try:
            logger.debug("Requesting method: %s, params: %s, timeout: %s", method, params, self.timeout)
