...
class ThemeOptions(typing.TypedDict):
    hideCode: Optional[bool]


class CriterionOptions(typing.TypedDict):
    hideCode: Optional[bool]
    hideFromHierarchy: Optional[bool]


class TaskGroupOptions(typing.TypedDict):
    hideCode: Optional[bool]
    hideFromHierarchy: Optional[bool]


class TaskOptions(typing.TypedDict):
    hideCode: Optional[bool]


class TaskItemOptions(typing.TypedDict):
    hideCode: Optional[bool]
