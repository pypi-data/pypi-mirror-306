...
async def read(site_name: str, identifier: str):
    database_api = UAClient.database_api
...
async def read_bulk(site_name: str, identifiers: str):
    database_api = UAClient.database_api
...
async def update_sex(site_name: str, identifier: int | str, sex: str):
    database_api = UAClient.database_api
    async with database_api.create_site_api(site_name) as db_site_api:
        user = await db_site_api.get_user(identifier)
        if user:
...
async def get_auth(site_name: str, identifier: int | str):
    database_api = UAClient.database_api
