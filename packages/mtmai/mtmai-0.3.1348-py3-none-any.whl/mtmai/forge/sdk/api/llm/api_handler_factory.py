...
from mtmai.forge.sdk.api.llm.config_registry import LLMConfigRegistry
...
from mtmai.forge.sdk.api.llm.models import LLMAPIHandler, LLMConfig, LLMRouterConfig
from mtmai.forge.sdk.api.llm.utils import llm_messages_builder, parse_api_response
from mtmai.forge.sdk.artifact.models import ArtifactType
        ...
        async def llm_api_handler_with_router_and_fallback(
            ...
            if step:
                ...
                await app.DATABASE.update_step(
                    ...
                    incremental_input_tokens=prompt_tokens
                    if prompt_tokens > 0
                    else None,
                    incremental_output_tokens=completion_tokens
