...
from mtmai.forge.sdk.api.llm.exceptions import (  # MissingLLMProviderEnvVarsError,; NoProviderEnabledError,
    DuplicateLLMConfigError, InvalidLLMConfigError)
from mtmai.forge.sdk.api.llm.models import (LiteLLMParams, LLMConfig,
                                            LLMRouterConfig)
...
LLMConfigRegistry.register_config(
    "TOGETHER_LLAMA_31_70B_INSTRUCT_TURBO",
    LLMConfig(
