...
from WaldurSA_TUI_package import configured_offerings
from WaldurSA_TUI_package import dashboard
from WaldurSA_TUI_package import logs

from WaldurSA_TUI_package import quit
from WaldurSA_TUI_package import error
...
class WaldurSATUIApp(App):
    ...
    def action_request_error(self) -> None:
        # show error message
        self.app.push_screen(error.ErrorPopup("An unexpected error occurred!", "Test error"))
