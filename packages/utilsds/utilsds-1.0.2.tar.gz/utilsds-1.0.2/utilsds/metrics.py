...
class Metrics:
    ...
    Parameters:
        classifier(Classifier): Classifier to be evaulated.
    ...
    def custom_fbeta_score(self, y_test, y_pred):
        ...
        Args:
            y_test (pd.Series): Target variable of test data
            y_pred (pd.Series): Target variable of prediction model
    ...
    def calculate_metrics(self):
        ...
        Returns:
            dict: Dictionary containing {'key- name': value_of_given_metric}
        """
        metrics = {}
        if self.classifier.is_binary_class:
    ...
    def __calculate_own_metrics(self):
        ...
        Returns:
            dict: Dictionary with all previous metrics and all new own metrics.
        """
    ...
    def set_main_metric(self, metric_name):
        ...
        Args:
            metric_name (str): Name of metrics to be set as default. Choose from specificity_score, accuracy_score, precision_score, recall_score, f_beta_score OR any of own metrics.

        Raises:
            ValueError: Wrong name of metrics. Not existing in metrics dictionary.
        """
        print("Previous main_metric: ", self.main_metric)
        self.calculate_metrics()
    ...
    def get_main_metric(self):
        ...
        Returns:
            Dictionary: {'name': name_of_main_metric, 'score': score_of_main_metric.}
        """
