...
def train_test_validation_split(
    ...
    Returns
        data_train, data_test, data_val : Dataframes containing the three splits.
    ...
    if col_target is None and col_order is None:
        raise ValueError("col_target or col_order must not be None")
