...
class DataProcessor:
    ...
    def resample_X_y(
        ...
        Args:
            ...
            params (dict): Dictionary of params for celected sampler.
    ...
    def get_transformed_data(
        ...
        Args:
            ...
            sqrt_col (list, optional): Columns to perform sqrt_col transformation. Defaults to [].
            log_default (list, optional): Columns to perform log_default transformation.
                Defaults to [].
            ihs (list, optional): Columns to perform ihs transformation. Defaults to [].
            extensive_log (list, optional): Columns to perform extensive_log transformation.
                Defaults to [].
            neglog (list, optional): Columns to perform neglog transformation. Defaults to [].
            boxcox_zero (list, optional): Columns to perform boxcox_zero transformation.
                Defaults to [].
            log_x_divide_2 (list, optional): Columns to perform log_x_divide_2 transformation.
                Defaults to [].
