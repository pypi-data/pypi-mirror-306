...
class Hyperopt:
    ...
    Parameters:
        classifier(Classifier): Classifier to optimize.
        metricser(Metrics): Metrics object that contains main_metric to be optimized.
        is_loss_function(bool): Defines if main_metric is loss_function
            or it needs to be adjusted as loss function.
    """
