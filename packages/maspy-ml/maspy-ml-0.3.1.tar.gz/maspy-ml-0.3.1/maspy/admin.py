...
class Admin(metaclass=AdminMeta):
    ...
    def dict_to_excel(self, data_dict: Dict, output_file):
        ...
        df = pd.DataFrame(rows, columns=["Time", "Instance", "Cycle", "Decision", "Data", "Received Msgs", "Event", "Retrieved Plans", "Events","Intentions", "Completed Goal", "Connected Envs", "Connected Chs", "Beliefs", "Goals"])
    ...
    def connect_to(self, agents: list[TAgent] | TAgent, targets: list[TEnv | Environment | TChannel | Channel] | Environment | Channel) -> None:
