...
class Benchmarking:
    ...
    def generate_plots(self, runs_plots_scores, s="M", v="N", save_dir="./report"):
        """
    ...
    def comprehensive_evaluation(self, datasets=[], optimizers=[], algorithms=[], scenarios=[], x_axis=[0.05, 0.1, 0.2, 0.4, 0.6, 0.8], save_dir="./report", already_optimized=False):
        """
