...
from ..core.model import CapibaraENT
...
def test_config() -> CapibaraConfig:
    """
    Provides a test configuration for the CapibaraENT model.
...
def capibara_model(test_config: CapibaraConfig) -> CapibaraENT:
    """
    Provides a fresh instance of the CapibaraENT model for each test.

    Args:
        test_config: The test configuration fixture

    Returns:
        CapibaraENT: A new model instance
    """
    try:
