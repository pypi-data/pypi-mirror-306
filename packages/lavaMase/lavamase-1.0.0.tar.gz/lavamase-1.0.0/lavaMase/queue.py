...
class Queue:
    """The default custom lava Queue designed specifically for :class:`lava.Player`.

    .. note::

        :class:`~lava.Player` implements this queue by default.
        You can access it via :attr:`lava.Player.queue`.
    ...
    def mode(self) -> QueueMode:
        """Property which returns a :class:`~lava.QueueMode` indicating which mode the
        :class:`~lava.Queue` is in.

        This property can be set with any :class:`~lava.QueueMode`.
        """
        return self._mode
    ...
    def get(self) -> Playable:
        ...
        .. warning::
            ...
            You can use :meth:`lava.Player.skip` with ``force=True`` to skip the current track.

            Do **NOT** use this method to remove tracks from the queue, use either:

            - ``del queue[index]``
            - :meth:`lava.Queue.remove`
            - :meth:`lava.Queue.delete`
    ...
    def put_at(self, index: int, value: Playable, /) -> None:
        ...
        value: :class:`lava.Playable`
            The track to put.

        Raises
        ------
        TypeError
            The track was not a :class:`lava.Playable`.
        """
    ...
    async def get_wait(self) -> Playable:
        """This method returns the first :class:`lava.Playable` if one is present or
    ...
    def put(self, item: list[Playable] | Playable | Playlist, /, *, atomic: bool = True) -> int:
        ...
        Accepts a :class:`lava.Playable`, :class:`lava.Playlist` or list[:class:`lava.Playble`].

        Parameters
        ----------
        item: :class:`lava.Playable` | :class:`lava.Playlist` | list[:class:`lava.Playble`]
        ...
        """
        if isinstance(item, Iterable) or isinstance(item, list):
            if atomic:
    ...
    async def put_wait(self, item: list[Playable] | Playable | Playlist, /, *, atomic: bool = True) -> int:
        ...
        Accepts a :class:`lava.Playable` or :class:`lava.Playlist` or list[:class:`lava.Playable`].
        ...
        Parameters
        ----------
        item: :class:`lava.Playable` | :class:`lava.Playlist` | list[:class:`lava.Playable`]
    ...
    def index(self, item: Playable, /) -> int:
        """Return the index of the first occurence of a :class:`lava.Playable` in the queue.

        Parameters
        ----------
        item: :class:`lava.Playable`
    ...
    def reset(self) -> None:
        ...
        .. note::
            ...
            This will cancel any waiting futures on the queue. E.g. :meth:`lava.Queue.get_wait`.
    ...
    def loaded(self) -> Playable | None:
        """The currently loaded track that will repeat when the queue is set to :attr:`lava.QueueMode.loop`.

        This track will be retrieved when using :meth:`lava.Queue.get` if the queue is in loop mode.
        You can unload the track by setting this property to ``None`` or by using :meth:`lava.Player.skip` with
        ``force=True``.

        Setting this property to a new :class:`lava.Playable` will replace the currently loaded track, but will not
        add it to the queue; or history until the track is played.

        Returns
        -------
        :class:`lava.Playable` | None
            The currently loaded track or ``None`` if there is no track ready to repeat.

        Raises
        ------
        TypeError
            The track was not a :class:`lava.Playable` or ``None``.
        """
        return self._loaded
