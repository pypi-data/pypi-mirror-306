...
if find_spec("taipy.core"):
    class scenario_selector(_Control):
        ...
        def __init__(
            ...
            *,
            ...
            scenarios: Optional[list[Scenario | Cycle]] = None,
            multiple: bool = False,
            filter: (
                bool
                | str
                | "taipy.gui_core.filters.ScenarioFilter"
                | list[str | "taipy.gui_core.filters.ScenarioFilter"]
            ) = "*",
    ...
    class scenario(_Control):
        ...
        def __init__(
            self,
            scenario: Optional[Scenario | list[Scenario]] = None,
            *,
            active: bool = True,
    ...
    class data_node_selector(_Control):
        ...
        def __init__(
            self,
            value: Optional[DataNode | list[DataNode]] = None,
            *,
            display_cycles: bool = True,
            show_primary_flag: bool = True,
            on_change: Optional[Union[str, Callable]] = None,
            ...
            show_pins: bool = True,
            scenario: Optional[Scenario | list[Scenario]] = None,
            datanodes: Optional[list[DataNode | Scenario | Cycle]] = None,
            multiple: bool = False,
            filter: (
                bool
                | str
                | "taipy.gui_core.filters.DataNodeFilter"
                | list[str | "taipy.gui_core.filters.DataNodeFilter"]
            ) = "*",
            show_search: bool = True,
            sort: (
                bool
            ...
            """Creates a data_node_selector element.\n\nParameters\n----------\n\nvalue (dynamic)\n  Bound to the selected `DataNode^`(s), or None if there is none.\n\ndisplay_cycles\n  If False, the cycles are not shown in the selector.\n\nshow_primary_flag\n  If False, the primary scenarios are not identified with specific visual hint.\n\non_change\n  A function or the name of a function that is triggered when a data node is selected.  \n  The parameters of that function are all optional:\n  * state (`State^`): the state instance.\n  * var_name (str): the variable name.\n  * value (`DataNode^`): the selected data node.\n  \n\nheight\n  The maximum height, in CSS units, of the control.\n\nshow_pins\n  If True, a pin is shown on each item of the selector and allows to restrict the number of displayed items.\n\nscenario (dynamic)\n  TODO: If the `Scenario^` is set, the selector will only show datanodes owned by this scenario.\n\ndatanodes (dynamic)\n  TODO: The list of `DataNode^`/`Scenario^`/`Cycle^` to show. Shows all Cycle/Scenario/DataNode if value is None.\n\nmultiple\n  TODO: If True, the user can select multiple datanodes.\n\nfilter\n  TODO: a list of `DataNode^` attributes to filter on. If False, do not allow filter.\n\nshow_search\n  TODO: If True, allows the user to search locally on label.\n\nsort\n  TODO: a list of `DataNode^` attributes to sort on. If False, do not allow sort.\n\nid\n  The identifier that will be assigned to the rendered HTML component.\n\nclass_name (dynamic)\n  The list of CSS class names associated with the generated HTML Element.  \n  These class names will be added to the default `taipy_gui_core-data_node_selector`.\n\n"""  # noqa: E501
            ...
    ...
    class data_node(_Control):
        ...
        def __init__(
            self,
            data_node: Optional[DataNode | list[DataNode]] = None,
            *,
            show_data: bool = True,
            show_properties: bool = True,
    ...
    class job_selector(_Control):
        ...
        def __init__(
            self,
            value: Optional[Job | list[Job]] = None,
            *,
            show_id: bool = True,
