...
from ..core.utils import cmd_shell_exec, ask_user_input_YN
...
class Base(Controller):
    ...
    def update(self):
        ...
        if proc.returncode != 0:
            if '--break-system-packages' in proc.stderr:
                if ask_user_input_YN('gcli update unsuccessful. Do you want to force update using `--break-system-packages`?') == 'Y':
