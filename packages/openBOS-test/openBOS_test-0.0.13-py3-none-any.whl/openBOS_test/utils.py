...
def get_gladstone_dale_constant(temperature, pressure, humidity):
    ...
    density = density(pressure * units.hPa, temperature * units.degC, humidity * units.percent)

    n_air = 1.0003  # Refractive index of air
    G = (n_air - 1) / density  # Calculate the Gladstone-Dale constant based on the relation
