...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, pulp_labels=None, repository=None, content_guard=None, prn=None, name=None, hidden=False, pulp_href=None, no_content_change_since=None, pulp_last_updated=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
