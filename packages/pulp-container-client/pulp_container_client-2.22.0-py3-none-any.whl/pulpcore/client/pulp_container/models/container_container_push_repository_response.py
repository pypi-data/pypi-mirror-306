...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, description=None, pulp_labels=None, versions_href=None, prn=None, name=None, retain_repo_versions=None, manifest_signing_service=None, pulp_href=None, latest_version_href=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
