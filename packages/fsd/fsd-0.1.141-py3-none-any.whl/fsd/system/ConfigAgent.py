...
class ConfigAgent:
    ...
    async def get_config_request(self, instruction, main_path):
        ...
        system_prompt = """You are an ELITE DevOps engineering specialist working as a dependency config agent. You will receive detailed instructions to work on. Follow these guidelines strictly:
                ...
                9. Do not include any config markdown formatting or syntax highlighting.

                10. Do not hallucinate or make assumptions about config - only provide actual config changes.

                11. Only include plain config without any additional formatting or annotations.
