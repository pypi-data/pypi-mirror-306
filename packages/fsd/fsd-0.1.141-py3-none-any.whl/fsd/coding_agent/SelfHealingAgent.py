    ...
    def initial_setup(self, role):
        ...
        prompt = f"""You are an expert software engineer. Follow these guidelines strictly when responding to instructions:
                ...
                **Response Guidelines:**
                ...
                9. Do not include any code markdown formatting or syntax highlighting.

                10. Do not hallucinate or make assumptions about code - only provide actual code changes.

                11. Only include plain code without any additional formatting or annotations.
