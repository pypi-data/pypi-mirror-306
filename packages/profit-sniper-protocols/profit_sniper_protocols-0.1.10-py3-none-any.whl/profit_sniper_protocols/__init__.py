...
AssetType = Literal["us_equity", "us_option", "us_futures", "crypto", "forex", "cfd"]
"""
AssetType represents the different types of financial assets.
...
Usage:
    def process_asset(asset_type: AssetType):
