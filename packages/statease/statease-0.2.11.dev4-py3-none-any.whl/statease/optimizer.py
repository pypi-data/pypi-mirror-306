...
class Optimizer:
    ...
    def add_criteria(self, criteria):
        ...
        if criteria.restrict_discrete==True:
            ...
            if (criteria.__factor.type!="Numeric") or (criteria.__factor.type=="Numeric" and criteria.__factor.subtype!="Discrete"):
