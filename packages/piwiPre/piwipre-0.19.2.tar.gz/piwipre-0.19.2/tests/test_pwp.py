...
class PwpTester:
    ...
    def copy_forest(vector: PwpVector):
        return vector.add([
            {'in-source': "PICTURES/Forêt-de-la-Corbière/20230611_162816.jpg",  # noqa
             ...
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h28-17-Forêt-de-la-Corbière.jpg",
             # noqa
             'orientation': '1',
            ...
            {'in-source': "PICTURES/Forêt-de-la-Corbière/2023-06-11-17h02-40-Forêt-de-la-Corbière.png",  # noqa
             ...
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-17h02-40-Forêt-de-la-Corbière.jpg",
             # noqa
            ...
            {'in-source': "PICTURES/Forêt-de-la-Corbière/20230611_170225.jpg",  # noqa
             ...
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-17h02-25-Forêt-de-la-Corbière.jpg"},
            # noqa

            {'in-source': "PICTURES/Forêt-de-la-Corbière/20230611_162803.jpg",  # noqa
             'in-triage': "Forêt-de-la-Corbière/Foret03.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h28-04-Forêt-de-la-Corbière.jpg"},
            # noqa

            {'in-source': "PICTURES/Forêt-de-la-Corbière/20230611_162811.jpg",  # noqa
             'in-triage': "Forêt-de-la-Corbière/Foret04.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h28-11-Forêt-de-la-Corbière.jpg"},
            # noqa

            {'in-source': "PICTURES/Forêt-de-la-Corbière/20230611_170215.jpg",  # noqa
             'in-triage': "Forêt-de-la-Corbière/Foret05.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-17h02-16-Forêt-de-la-Corbière.jpg"},
            # noqa

            {'in-source': "PICTURES/Forêt-de-la-Corbière/IMG20230611162736.jpg",  # noqa
             'in-triage': "Forêt-de-la-Corbière/Foret06.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg"},
            # noqa
        ])
    ...
    def program_30(self):
        ...
        vector = PwpVector(cmdline, [
            ...
            {'in-source': "PICTURES/Forêt-de-la-Corbière/IMG20230611164005-new.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h40-05-Forêt-de-la-Corbière.jpg"},
            # noqa

            {'in-source': "PICTURES/Forêt-de-la-Corbière/IMG20230611163210-new.jpg",  # noqa
             'in-album': "2023/2023-06-Juin-11-Forêt-de-la-Corbière/2023-06-11-16h32-10-Forêt-de-la-Corbière.jpg"},
            # noqa
    ...
    def program_907(self):
        ...
        ACTOR.rmtree("tests/results")
        ACTOR.mkdirs("tests/results")
        # NB: we HAVE to build rests/results, because --base checks for the existence of BASE
        LOGGER.test_msg(f'--------------- starting {mn}')
        LOGGER.test_msg('')
        ...
        pwp_main(arguments=[
            '--quiet', 'true',
            '--base', os.getcwd() + "/tests/results/tmp",
            "--home", os.getcwd() + "/tests/results",
            "--gui", "true"],  # CAVEAT: --gui true only to call Configurator, but its UI will never be displayed
    ...
    #                                     # home is computed AFTER base, so either a path relative to base, or abspath
    #                                     '--base', 'tests/results/tmp'])
