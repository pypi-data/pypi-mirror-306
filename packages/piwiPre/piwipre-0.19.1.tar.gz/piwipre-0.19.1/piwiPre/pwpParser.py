...
4. Dans BASE, c'est à dire le répertoire d'où est lancé piwiPre.
...
- **BASE** est le répertoire dans lequel piwiPre s'exécute. 
...
- valeur = 'répertoire' : le répertoire racine pour les miniatures
  ...
  Une valeur typique quand le répertoire est local : THUMBNAILS
...
""")
        ...
        - value = 'directory' : Sets the BACKUP directory, where backup-ed files are saved before any modification.
          ...
          """,
                      fr_config="""
        - valeur = 'répertoire' : là où sont sauvegardés les fichiers à sauvegarder

          Ce répertoire PEUT être effacé par l'utilisateur lorsque piwiPre a terminé.      
        """)
...
This is something you do NOT do in normal situation, only for test
                      """,
                      fr_config="""
Ce drapeau n'est en principe utilisé que dans le cas du test
"""
                      )
...
""")
        ...
        self.add_item("allow-create-base",
        ...
        self.add_item('base-last',
                      ...
                      fr_help="Comme --base, mais change l'historique du DERNIER répertoire d'où piwiPré a été lancé,",
                      pwp_type=PwpArgType.BOOL,
                      choices=['true', 'false'],
                      default='false',
                      setups=[ServerSetup(pwp_type=PwpArgType.BOOL, )],
