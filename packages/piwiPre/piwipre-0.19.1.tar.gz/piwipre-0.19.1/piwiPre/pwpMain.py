...
# TODO REQ 0316: PiwiPre configurator, [Write Config] is disabled unless the config has changed OR .lnk is lacking
# TODO REQ 0317: BUG ??? : why, executing program_33, the directory BACKUP is not filled with modified pictures ?
...
# TODO REQ 3125: BUG: 'en' index contains some french statements !
# TODO REQ 3126: BUG: en & fr doc is not finished
# TODO REQ 3127: test automatically REQ 0312
# REQ 3128: BUG: there is a race condition in program 908. If UI finishes too early, piwiPre stops.
...
class PwpMain:
    ...
    def run(self, test_scenario=None):
        ...
        if self.parser_config['gui'] and not do_exit:
            ...
            # then ThreadConfigurator starts run_or_display(), so returns ony when the UI is closed
            pass
