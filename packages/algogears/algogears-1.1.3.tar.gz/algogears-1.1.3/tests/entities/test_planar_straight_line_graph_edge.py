import pytest
from algogears.core import Point, PlanarStraightLineGraphEdge


def test_planar_straight_line_graphh_edge_creation():
...
def test_planar_straight_line_graph_edge_hash():
...
def test_planar_straight_line_graph_edge_other_node():
    edge = PlanarStraightLineGraphEdge(first=Point.new(1, 1), second=Point.new(2, 2), weight=1)
