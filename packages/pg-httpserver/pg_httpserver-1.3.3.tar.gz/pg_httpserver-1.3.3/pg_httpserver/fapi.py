...
__all__ = [
           "run", "app", "CODE_VERSION", "get_session_user", "get_context"
           ]
...
def get_context(req: Request)->Context:
    return req.scope[config.get_conf(ENV_CONTEXT_KEY, "_context_")]
