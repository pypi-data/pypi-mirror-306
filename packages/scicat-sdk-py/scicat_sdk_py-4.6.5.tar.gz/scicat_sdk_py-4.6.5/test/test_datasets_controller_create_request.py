    ...
    def make_instance(self, include_optional) -> DatasetsControllerCreateRequest:
        ...
        if include_optional:
            return DatasetsControllerCreateRequest(
                ...
                is_published = True,
                techniques = [
                    scicat-sdk-py.models.technique_class.TechniqueClass(
                        pid = '', 
                        name = '', )
                    ],
                shared_with = [
                ...
                relationships = [
                    scicat-sdk-py.models.relationship_class.RelationshipClass(
                        pid = '', 
                        relationship = '', )
                    ],
                datasetlifecycle = scicat-sdk-py.models.lifecycle_class.LifecycleClass(
                    archivable = True, 
                    retrievable = True, 
                    publishable = True, 
                    ...
                    archive_return_message = scicat-sdk-py.models.archive_return_message.archiveReturnMessage(), 
                    retrieve_return_message = scicat-sdk-py.models.retrieve_return_message.retrieveReturnMessage(), 
                    exported_to = '', 
                    retrieve_integrity_check = True, ),
                scientific_metadata = scicat-sdk-py.models.scientific_metadata.scientificMetadata(),
                comment = '',
                ...
                job_parameters = scicat-sdk-py.models.job_parameters.jobParameters(),
                job_log_data = ''
            )
        else:
            return DatasetsControllerCreateRequest(
