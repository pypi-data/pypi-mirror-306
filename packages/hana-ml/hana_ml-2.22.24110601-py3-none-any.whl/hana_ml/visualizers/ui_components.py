...
class JSONViewer(EmbeddedUI):
    def __init__(self, data):
        ...
        self.html_str = self.get_resource_template('json.html').render(data_json_dict=data)
...
class XMLViewer(EmbeddedUI):
    def __init__(self, data):
        ...
        self.html_str = self.get_resource_template('xml.html').render(data_xml_dict=data)
