...
class GeminiOptimizer(OptimizerWrapper):
    ...
    def __init__(
        ...
        **defaults: Any,
        ...
        self.collect_states_on_cpu = defaults.pop("collect_states_on_cpu", False)
    ...
    def collect_states(self, param_id: int, only_rank_0: bool = True) -> dict:
        ...
        device = None if self.collect_states_on_cpu else get_accelerator().get_current_device()
        compacted_states = self.pack_optimizer_states_to_tensor(param_id, state_names, device=device) if own_param else None
