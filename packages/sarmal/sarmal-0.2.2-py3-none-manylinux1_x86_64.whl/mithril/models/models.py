...
class Pool1D(Model):
    ...
    def __init__(
        self,
        kernel_size: int | DataObject,
        stride: int | None | DataObject = None,
        padding: int | PaddingType | tuple[int, int] | DataObject = (0, 0),
        dilation: int | DataObject = 1,
    ) -> None:
        super().__init__()
...
class Pool2D(Model):
    ...
    def __init__(
        self,
        kernel_size: int | tuple[int, int] | DataObject,
        stride: int | None | tuple[int, int] | DataObject = None,
        padding: int | PaddingType | tuple[int, int] | DataObject = (0, 0),
        dilation: int | DataObject = 1,
    ) -> None:
        super().__init__()
...
class Convolution1D(Model):
    ...
    def __init__(
        ...
        stride: int | DataObject = 1,
        padding: int | PaddingType | tuple[int, int] | DataObject = 0,
        dilation: int | DataObject = 1,
        use_bias: bool = True,
    ) -> None:
        super().__init__()
...
class Convolution2D(Model):
    ...
    def __init__(
        ...
        out_channels: int | None = None,
        stride: int | tuple[int, int] | DataObject = (1, 1),
        padding: int
        | PaddingType
        | tuple[int, int]
        | tuple[tuple[int, int], tuple[int, int]]
        | DataObject = (0, 0),
        dilation: int | tuple[int, int] | DataObject = (1, 1),
        use_bias=True,
    ) -> None:
        super().__init__()
