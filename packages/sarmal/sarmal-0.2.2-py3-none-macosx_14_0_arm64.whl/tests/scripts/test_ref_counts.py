...
def test_deleted_repr_ref_count_2():
    ...
    buffer1.set_shapes({"input": ["a", "b", ("Var1", ...)]})
    all_reprs |= get_all_reprs(model)
    buffer1.set_shapes({"input": ["a", ("Var1", ...), "b"]})
    all_reprs |= get_all_reprs(model)
    buffer1.set_shapes({"input": [("Var1", ...), "a", "b"]})
    all_reprs |= get_all_reprs(model)
...
def test_deleted_node_ref_count_2():
    ...
    buffer3.set_shapes({"input": ["a", ("Var1", ...)]})
    buffer2.set_shapes({"output": [("Var1", ...), "a"]})
...
def test_deleted_node_ref_count_4():
    ...
    model.set_shapes({"input1": ["a", ("Var1", ...)], "input2": ["a", ("Var1", ...)]})
...
def test_deleted_uni_record_ref_count_3():
    ...
    sigmoid1.set_shapes({"input": ["a", "b", 4]})
    all_record |= get_all_uniadic_record(sigmoid1)

    sigmoid1.set_shapes({"input": [4, 4, 4]})
    all_record |= get_all_uniadic_record(sigmoid1)
...
def test_deleted_uni_record_ref_count_4():
    ...
    sigmoid1.set_shapes({"input": [1, ("V1", ...)]})
    all_record |= get_all_uniadic_record(sigmoid1)

    sigmoid1.set_shapes({"input": [("V1", ...), "a"]})
    all_record |= get_all_uniadic_record(sigmoid1)

    sigmoid1.set_shapes({"input": [("V1", ...), 1]})
    all_record |= get_all_uniadic_record(sigmoid1)
...
def test_deleted_uni_record_ref_count_5():
    ...
    sigmoid1.set_shapes({"input": ["b", ("V1", ...)]})
    all_record |= get_all_uniadic_record(sigmoid1)

    sigmoid1.set_shapes({"input": [("V1", ...), "a"]})
    all_record |= get_all_uniadic_record(sigmoid1)

    sigmoid1.set_shapes({"input": [1, ("V1", ...), 1]})
