...
def test_data_store_1():
    ...
    assert (pm.data_store._cached_data[key].value == value).all()  # type: ignore[reportAttributeAccessIssue]
...
def test_data_store_3():
    ...
    assert (
        ...
        == backend.array(6.0)
    ).all()  # type: ignore[reportAttributeAccessIssue]
    assert pm.data_store._runtime_static_keys == set()
    assert pm.data_store._intermediate_non_differentiables._table == dict()
...
def test_data_store_7():
    ...
    assert (pm.data_store._cached_data["output"].value == value).all()  # type: ignore[reportAttributeAccessIssue]
    assert pm.data_store._runtime_static_keys == set()
    assert pm.data_store._intermediate_non_differentiables._table == dict()
    assert pm.data_store.unused_keys == set()
...
def test_data_store_8():
    ...
    assert (pm.data_store._cached_data["output1"].value == backend.sigmoid(value)).all()  # type: ignore[reportAttributeAccessIssue]
    assert (pm.data_store._cached_data["output2"].value == backend.sigmoid(value)).all()  # type: ignore[reportAttributeAccessIssue]
    assert pm.data_store._runtime_static_keys == set()
    assert pm.data_store._intermediate_non_differentiables._table == dict()
...
def test_data_store_10():
    ...
    assert (pm.data_store._cached_data["output1"].value == value).all()  # type: ignore[reportAttributeAccessIssue]
    assert (pm.data_store._cached_data["output2"].value == backend.sigmoid(value)).all()  # type: ignore[reportAttributeAccessIssue]
    assert pm.data_store._runtime_static_keys == set()
    assert pm.data_store._intermediate_non_differentiables._table == dict()
    assert pm.data_store.unused_keys == set()
