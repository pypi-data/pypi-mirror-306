...
from mithril.framework.common import ShapeRepr, ShapeTemplateType, Tensor, Uniadic
    ...
    if isinstance(input, list):
        ...
        for key, value in input.items():
            if isinstance(value, list):
                ...
                random_output = np.random.randn(*shapes)
...
def check_shapes_semantically(
    ...
    assignments_1: dict | None = None,
    assignments_2: dict | None = None,
) -> None:
    """
