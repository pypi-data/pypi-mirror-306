...
def get_deterministic_shape(node):
    uni, var = {}, {}
...
def test_variadic_contradiction():
    ...
    with pytest.raises(ValueError):
        ce.set_shapes(
            {"output": [8, ("V1", ...)], "input": [8, 4, ("V1", ...), 64, 128]}
        )
...
def test_cross_entropy_shapes_11():
    model = Model()
    ce = CrossEntropy()
    ce.set_shapes({"output": [8, ("V1", ...)], "input": [8, 4, ("V2", ...), 64, 128]})
    model += ce(input="input", target="target", output=IOKey(name="output"))
    logical_ref = {
        "input": [8, 4, "(V1, ...)", 64, 128],
        "output": [8, "(V1, ...)", 64, 128],
...
def test_shape_1():
    ...
    buff1 = Buffer()
    buff2 = Buffer()
    buff1.set_shapes({"input": [("V1", ...), "a", "b"]})
    buff2.set_shapes({"input": ["c", "d", ("V1", ...)]})
...
def test_variadic_naming_2():
    for _ in range(100):
        ...
        model.set_shapes(
            {"input1": [("Var1", ...), "a"], "input3": [("Var1", ...), "b"]}
        )
        model.set_shapes(
            {"input1": ["a", ("Var1", ...)], "input2": ["a", ("Var1", ...)]}
            # "input3": ["b", ("Var2", ...)]
        )
...
def test_unresolved_merge_10():
    ...
    m1 = MyVariadic11()
    m2 = Sigmoid()
    m2.set_shapes({"output": [("Var1", ...), "u1", "u2"]})
    m2.set_shapes({"output": ["u1", ("Var1", ...), "u2"]})
    m2.set_shapes({"output": ["u1", "u2", ("Var1", ...)]})
    model += m2
    model += m1
    ref_shapes = {
        "$_Sigmoid_0_output": [
...
def test_variadic_naming_20():
    ...
    model += add_model_4
    model += add_model_5(left="", output=IOKey(name="output"))
    model.set_shapes({"output": ["a", ("Var1", ...), "b"]})
    model.set_shapes({"output": ["a", "b", ("Var1", ...)]})
    model.set_shapes(
        {"left": [("Var1", ...), "a", "b", "c"], "output": [("Var1", ...), "a", "b"]}
    )
...
def test_variadic_naming_22():
    ...
    sig_model = Sigmoid()
    red_model.set_shapes({"input": [("V1", ...), "a", "b"]})
    sig_model.set_shapes({"input": ["a", ("V1", ...)]})
    sig_model.set_shapes({"input": [("V1", ...), "a"]})
    model = Model()
...
def test_variadic_naming_23():
    ...
    model.set_shapes({"output1": [("V1", ...), "a", "b"]})
    model.set_shapes({"output1": ["a", ("V1", ...), "b"]})
...
def test_same_uniadic_3():
    ...
    buffer1.set_shapes({"input": [1, 1, ("V1", ...)]})
    buffer2.set_shapes({"input": [1, ("V1", ...), 2]})
    buffer3.set_shapes({"input": [1, ("V1", ...), 1]})
...
def test_same_uniadic_4():
    ...
    buffer1.set_shapes({"input": [1, 1, ("V1", ...)]})
    buffer2.set_shapes({"input": [1, ("V1", ...), 2]})
    model.set_shapes({"input3": [1, ("V1", ...), 1]})
...
def test_cartesian_call():
    ...
    sig_1 = Sigmoid()
    sig_2 = Sigmoid()
    sig_1.set_shapes({"input": [3, ("Var1", ...)]})
    sig_2.set_shapes({"input": [("Var2", ...), 4]})
    model1 = Model()
...
def test_check_shapes_semantically_7():
    shape_1 = {"input": ["u1", "u2", "u1"], "input2": ["u2", "u3", 3]}

    shape_2 = {"input": ["u2", "u1", "u2"], "input2": ["u1", "u4", 3]}
...
def test_check_shapes_semantically_17():
    shape_1 = {"w1": [["u1", "u2"], ["u1", "u4"]], "w2": ["u1"]}
    shape_2 = {"w1": [["u5", "u6"], ["u5", "u8"]], "w2": ["u5"]}
    check_shapes_semantically(shape_1, shape_2)


def test_check_shapes_semantically_18():
    shape_1 = {"w1": [["u1", "u2"], ["u1", "u4"]], "w2": ["u1"]}
    shape_2 = {"w1": [["u5", "u6"], ["u5", "u8"]], "w2": ["u9"]}
    with pytest.raises(AssertionError):
        check_shapes_semantically(shape_1, shape_2)


def test_check_shapes_semantically_19():
    shape_1 = {"w1": [["u1", "u2"], ["u1", "u4"], ["u1", "u2"]], "w2": ["u1"]}
    shape_2 = {"w1": [["u5", "u6"], ["u5", "u8"]], "w2": ["u9"]}
    with pytest.raises(AssertionError):
        check_shapes_semantically(shape_1, shape_2)
...
def test_check_shapes_semantically_20():
    shape_1 = {"w1": [["u1", "u2"], ["u1", "u4"], ["u1", "u2"]], "w2": ["u1"]}
    shape_2 = {"w1": [["u5", "u6"], ["u5", "u8"], ["sfdsad"]], "w2": ["u9"]}
    with pytest.raises(AssertionError):
        check_shapes_semantically(shape_1, shape_2)
...
def test_total_repr_count_1():
    ...
    all_primitives_dict = (
        primitives.__dict__ | mithril.framework.essential_primitives.__dict__
    )
    all_primitives = primitives.__all__ + mithril.framework.essential_primitives.__all__
    all_primitives_dict = {
...
def test_high_layer_cascaded_models_3():
    model = Model()
    sig_model = Sigmoid()
    sig_model.set_shapes({"input": ["u1", "u2", ("Var1", ...)]})
    sig_model.set_shapes({"input": ["u1", ("Var1", ...), "u2"]})
    sig_model.set_shapes({"input": [("Var1", ...), "u1", "u2"]})
    for _ in range(400):
...
def test_numeric_compatibility_inference_1():
    ...
    model.set_shapes({"input": [("Var1", ...), 2]})
    model.set_shapes({"input": [("Var1", ...), 3, 2]})
    ref_shapes = {
        "input": [1, "(V1, ...)", 3, 2],
        "output": [1, "(V1, ...)", 3, 2],
    }
...
def test_numeric_compatibility_inference_2():
    model = Model()
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [("Var1", ...), 2, 3, 4]})
    model.set_shapes({"input": [1, 2, 3, ("Var1", ...)]})
    ref_shapes = {
...
def test_numeric_compatibility_inference_4():
    ...
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [1, 2, 3, ("Var1", ...)]})
    model.set_shapes({"input": [("Var1", ...), 2, 3, 4, 5]})
    ref_shapes = {
...
def test_numeric_compatibility_inference_6():
    model = Model()
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [("Var1", ...), 3, 4]})
    model.set_shapes({"input": [1, 2, ("Var1", ...)]})
    ref_shapes = {
        "input": [1, 2, "(V1, ...)", 3, 4],
        "output": [1, 2, "(V1, ...)", 3, 4],
    }
...
def test_numeric_compatibility_inference_7():
    model = Model()
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [("Var1", ...), 2, 3]})
    model.set_shapes({"input": [1, 2, ("Var1", ...)]})
    ref_shapes = {
...
def test_numeric_compatibility_inference_8():
    model = Model()
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [("Var1", ...), "a", 1]})
    model.set_shapes({"input": ["b", 3, ("Var1", ...)]})
    ref_shapes = {
...
def test_numeric_compatibility_inference_9():
    model = Model()
    model += Buffer()(input="input", output=IOKey(name="output"))
    model.set_shapes({"input": [("Var1", ...), 1, 1]})
    model.set_shapes({"input": [1, 1, ("Var1", ...)]})
    ref_shapes = {
        "input": [[1, 1, "(V1, ...)"], ["(V2, ...)", 1, 1]],
...
def test_numeric_compatibility_inference_10():
    ...
    model.set_shapes({"input": [2, ("Var1", ...)]})
    model.set_shapes({"input": [("Var1", ...), 5, 4, 3, 1]})
    ref_shapes = {
        "input": [2, "(V1, ...)", 5, 4, 3, 1],
        "output": [2, "(V1, ...)", 5, 4, 3, 1],
    }
...
def test_node_count_4():
    ...
    buff_model = Buffer()
    model += buff_model
    buff_model.set_shapes({"input": ["a", ("Var1", ...)]})
    model += Buffer()
    model += Buffer()
    model += Buffer()
    model += test_model
...
def test_node_count_12():
    ...
    model.set_shapes({"input1": ["x", "y", 1], "input2": ["x", "y", 1]})
...
def test_node_count_13():
    ...
    model += buff_model1(input="input1", output=IOKey(name="output1"))
    model += buff_model2(input="input2", output=IOKey(name="output2"))
    model.set_shapes({"input1": [("Var1", ...), "a"], "input2": [("Var1", ...), "a"]})
    all_nodes = get_all_nodes(model)
    ref_all_nodes = {model.input1.metadata.data.shape}  # type: ignore
    assert all_nodes == ref_all_nodes
...
def test_uniadic_repr_count_2():
    ...
    model.set_shapes(
        {"input1": [1, "u1", "u2"], "input2": [1, "u1", "u2"], "input3": [1, "u1"]}
    )
...
def test_possible_uniadic_values_1():
    ...
    model.set_shapes({"o1": [4], "l1": [None], "r1": [None], "o2": [5], "r2": [None]})
...
def test_update_possible_values_31():
    ...
    var = repr.root  # var is updated by extract variadic
    assert var is not None
    assert uni1.metadata.vars_dict[var] == {0}
    assert uni2.metadata.vars_dict[var] == {0}
    assert uni3.metadata.vars_dict[var] == {0}
    assert my_uni.metadata.vars_dict[var] == {0}

    var2 = Variadic()
    var2.update_possible_values(PossibleValues((Uniadic(), Uniadic(), Uniadic())))
    var2.match(new_root=var)
...
def test_bcast_left():
    model = Add()
    model.set_shapes({"left": [2, 1, ("V1", ...)], "right": [2, 1, ("V2", ...)]})
