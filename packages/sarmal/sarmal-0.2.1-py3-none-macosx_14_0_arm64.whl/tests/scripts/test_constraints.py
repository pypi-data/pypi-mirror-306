...
VariadicPossiblesType = list[tuple[int | str, ...]]
VariadicTemplateType = tuple[str, EllipsisType]

AssignmentType = (
    dict[str, set[int]]
    | dict[VariadicTemplateType, VariadicPossiblesType]
    | dict[str | VariadicTemplateType, set[int] | VariadicPossiblesType]
)
...
def extract_variadic_possibles(
    ...
    assert var.possible_values is not None
    all_possible_values: dict[int, PossibleValues] = var.possible_values
...
def assert_shape_results(
    ...
    for key, value in data.items():
        if isinstance(value, Tensor):
            ...
            if (
                root := shape_repr.root
            ) is not None and root.possible_values is not None:
...
def test_bcast_error_1():
    ...
    """
    shapes = {"output": [("Var3", ...), "x", "z"], "left": [4, 3], "right": [3, 3]}
...
def test_bcast_error_2():
    ...
    """
    shapes = {"output": ["x", "y", "z"], "left": [4, 3], "right": [4, 3]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, bcast, True, set())
    assert (
        str(err_info.value)
...
def test_bcast_error_3():
    ...
    is not consistent with the inputs.
    """
    shapes = {"output": ["x", "y", "z"], "left": [4, 3, 3, 3], "right": [4, 3]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, bcast, True, set())
    assert (
        str(err_info.value)
...
def test_bcast_error_4():
    ...
    """
    shapes = {"output": [3, 4, 5], "left": ["a", 3, "b"], "right": [1, "c", 5]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, bcast, True, set())
...
def test_bcast_error_5():
    ...
    left to output.
    """
    shapes = {"output": [3, ("Var", ...), 5], "left": ["a", 1, "a"], "right": [4, 1]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, bcast, True, set())
    assert str(err_info.value) == "Possible values mismatch!"
...
def test_bcast_forward_1():
    ...
    shapes = {"output": [("Var3", ...), "x", "z"], "left": [4, 3], "right": [3]}
...
def test_bcast_forward_2():
    """Should work with no problem."""
    shapes = {"output": [("Var3", ...), "x", "z"], "left": [3], "right": [4, 3]}
...
def test_bcast_forward_3():
    """Should work with no problem."""
    shapes = {"output": [("Var3", ...), "x", "z"], "left": [1], "right": [4, 3]}
...
def test_bcast_forward_4():
    """Should work with no problem."""
    shapes = {"output": ["x", ("Var3", ...), "z"], "left": [1], "right": [4, 3]}
    final_shapes = {"output": [4, 3], "left": [1], "right": [4, 3]}
    assert_constraint_results(shapes, {}, final_shapes, {}, bcast, True, {"output"})
...
def test_bcast_forward_6():
    """Should work with no problem."""
    shapes = {"output": ["x", "y"], "left": [4, 1], "right": [1]}
...
def test_bcast_forward_8():
    ...
    "x"'s to 3 and other one of the "x"'s to 4.
    """
    shapes = {"output": ["x", "x", "x", "y"], "left": [4, 4, 3, 3], "right": [1]}
...
def test_bcast_forward_9():
    ...
    """
    shapes = {"output": ["x", "x", "x", "x"], "left": [1], "right": [2, ("Var1", ...)]}
...
@pytest.mark.skip(
    "Known Bug, update Variadic system (extract uniadic if it exists in all "
    "possible values)."
)
def test_bcast_forward_11_2():
    ...
    assert_constraint_results(
        shapes, {}, final_shapes, {}, bcast, False, {"output", "left"}
    )
...
def test_bcast_forward_14():
    shapes = {"output": [("Var1", ...)], "left": [], "right": [("Var2", ...)]}
...
def test_bcast_backward_12():
    ...
    """
    shapes = {"output": [], "left": [("Var1", ...)], "right": [("Var2", ...)]}
    final_shapes = {"output": [], "left": [], "right": []}
    assert_constraint_results(
...
def test_bcast_backward_13():
    ...
    """
    shapes = {"output": [3, 4, 5, 6], "left": [("Var1", ...)], "right": [("Var1", ...)]}
...
def test_bcast_backward_19():
    ...
    This test should work without a problem
    """
    shapes = {"output": [2, 3, 3], "left": ["x", "y", "z"], "right": ["y", "z", "z"]}
...
def test_bcast_backward_20():
    ...
    This test should work without a problem
    """
    shapes = {"output": ["x", "y"], "left": [1], "right": ["a", "b"]}
...
def test_bcast_backward_21():
    ...
    This test should work without a problem
    """
    shapes = {"output": ["a", "e", "c", "d"], "left": [1], "right": ["d", "c", "a", 4]}
...
def test_bcast_backward_22():
    ...
    This test should work without a problem
    """
    shapes = {"output": [1, "z", "c"], "left": ["x", 5, "z"], "right": ["y", "x", "y"]}
...
def test_bcast_backward_1():
    """Should work with no problem."""
    shapes = {"output": [3, 4], "left": ["a", "b"], "right": [1, 1]}
...
def test_bcast_backward_2():
    ...
    """
    shapes = {"output": [3, 4, 5], "left": ["a", 1, "b"], "right": [1, "c", 5]}
    assignments = {}
...
def test_bcast_backward_error():
    ...
    """
    shapes = {"output": [3, 4, 5], "left": ["a", 4, "b"], "right": [1, 3, 5]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, bcast, True, set())
    assert (
        str(err_info.value)
...
def test_bcast_forward_backward_1():
    ...
    all symbols.
    """
    shapes = {"output": [3, "c", 5], "left": ["a", 1, "b"], "right": [1, 4, 1]}
...
def test_bcast_forward_backward_2():
    ...
    all symbols.
    """
    shapes = {"output": [3, ("Var", ...), 5], "left": ["a", 1, "b"], "right": [4, 1]}
...
def test_bcast_forward_backward_variadic_1():
    ...
    """
    shapes = {"output": ["b", 5], "left": [1, "a"], "right": [("Var_right", ...), 2, 1]}
...
def test_bcast_forward_backward_variadic_2():
    ...
    evolve to None, "b" = 2 and "a" = 5.
    """
    shapes = {"output": [3, 5], "left": ["a"], "right": [("Var_right", ...), 1]}
...
def test_reduce_forward_2():
    ...
    shapes = {"output": ["a", "b"], "input": [3, 4, 5, 6]}
...
def test_reduce_forward_4():
    """Should work with no problem with axis = (-1, 1)."""
    shapes = {"output": ["x", ("Var1", ...), "y"], "input": [3, 4, 5, 6]}
    final_shapes = {"output": [3, 5], "input": [3, 4, 5, 6], "axis": []}
    scalar_info = {"axis": Scalar(value=(-1, 1))}
    assert_constraint_results(
        shapes, {}, final_shapes, {}, reduce_constraints, True, {"output"}, scalar_info
...
def test_reduce_forward_5():
    shapes = {"output": ["u1", ("V1", ...), 10], "input": ["u3", ("V2", ...), "u5", 10]}
    final_shapes = {
        "output": ["u1", "(V1, ...)", 10],
        "input": ["u3", "(V2, ...)", "u5", 10],
        "axis": [],
...
def test_reduce_forward_12():
    shapes = {"output": [("V1", ...)], "input": ["a", "b", "c", ("V2", ...)]}
    final_shapes = {
        "output": ["(V1, ...)", "d", "e"],
        "input": ["a", "b", "c", "(V2, ...)", "d", "e"],
        "axis": [],
...
def test_reduce_forward_error_1():
    ...
    3 for axis = 1.
    """
    shapes = {"output": ["a", "b", "c"], "input": [3, 4, 5]}
...
def test_reduce_backward_error_1():
    ...
    3 for axis = (1, 2).
    """
    shapes = {"output": [3, 4, 5], "input": ["a", "b", "c"]}
    scalar_info = {"axis": Scalar(value=(1))}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, {}, {}, reduce_constraints, False, set(), scalar_info
...
def test_reduce_backward_1():
    ...
    shapes = {"output": [3, 4, 5], "input": ["a", "b", "c", "d"]}
...
def test_reduce_backward_2():
    ...
    shapes = {"output": [3, 4, 5], "input": ["a", "b", "c", "d", "e"]}
...
def test_reduce_forward_backward_1():
    ...
    """
    shapes = {"output": [3, "b", 5], "input": ["a", 2, "c", "d", "e"]}
...
def test_reduce_forward_backward_error_1():
    ...
    """
    shapes = {"output": [3, "b", 5], "input": ["a", 2, "c", "d", "e", "f"]}
    scalar_info = {"axis": Scalar(value=(-2, 2))}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, {}, {}, reduce_constraints, False, set(), scalar_info
...
def test_reduce_keep_dim_1():
    ...
    shapes = {"output": [("Var1", ...)], "input": [1, 2, 3, 4, 5, 6, 7]}
    final_shapes = {
...
def test_reduce_backward_3():
    ...
    shapes = {"output": ["u1", "u2", "u3", "u4"], "input": [("Var", ...)]}
    final_shapes = {
        "" "output": ["u1", "u2", "u3", "u4"],
...
def test_reduce_backward_5():
    """Test multiple positive/negative axis"""
    shapes = {"output": [4, 1, 1, 7], "input": [("Var", ...)]}
    final_shapes = {
        "output": [4, 1, 1, 7],
        "input": [4, "a", "b", 7],
        "axis": [],
...
def test_reduce_backward_5_error():
    ...
    """
    shapes = {"output": [4, 2, 1, 7], "input": [("Var", ...)]}
    scalar_info = {"axis": Scalar(value=(1, -2)), "keepdim": Scalar(value=True)}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
...
def test_arange_8():
    ...
    """
    shapes = {"output": []}
    final_shapes = {"output": [], "start": [], "stop": [], "step": []}
    scalar_info = {
        "start": Scalar(value=1),
        "stop": Scalar(value=1),
        "step": Scalar(value=1),
...
def test_max_pool_1():
    shapes = {"output": [10, 20, "c", "d"], "input": [10, 10, 10, 10]}
    final_shapes = {
        "output": [10, 20, 8, 8],
        "input": [10, 10, 10, 10],
        "stride": [],
...
def test_max_pool_8():
    shapes = {"output": [("Var1", ...), "c", "d"], "input": [("Var1", ...), 10, 10]}
    final_shapes = {
        "output": ["(Var1, ...)", 3, 12],
        "input": ["(Var1, ...)", 10, 10],
        "stride": [],
...
def test_max_pool_10():
    shapes = {"output": [("Var1", ...), "c", "d"], "input": ["a", "b", 10, 10]}
    final_shapes = {
        "output": ["(Var1, ...)", 4, 8],
        "input": ["a", "b", 10, 10],
        "stride": [],
...
def test_max_pool_11():
    shapes = {"output": [("Var1", ...)], "input": ["a", "b", "c", "d"]}
    final_shapes = {
        "output": ["(Var1, ...)"],
        "input": ["a", "b", "c", "d"],
        "stride": [],
...
def test_max_pool_12():
    shapes = {"output": [("Var1", ...)], "input": [("Var2", ...), "d"]}
    final_shapes = {
        "output": ["(Var1, ...)"],
        "input": ["(Var2, ...)", "d"],
        "stride": [],
...
def test_max_pool_13():
    shapes = {"output": [("Var1", ...)], "input": ["a", ("Var2", ...), "d"]}
    final_shapes = {
        "output": ["(Var1, ...)"],
        "input": ["a", "(Var2, ...)", "d"],
        "stride": [],
...
def test_reshape_8():
    ...
    value.
    """
    shapes = {"output": [("Var", ...)], "input": [1, 2, 3, 4, 5, 6]}
...
def test_reshape_error_2():
    ...
    """
    shapes = {"output": ["a", "b", "c"], "input": [1, 2, 3, 4]}
    scalar_info = {"shape": Scalar(value=(2, 5))}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, {}, {}, reshape_constraints, False, set(), scalar_info
...
def test_reshape_error_4():
    ...
    """
    shapes = {"output": ["a", ("V", ...), "b", "c"], "input": [1, 2, 3, 4]}
    scalar_info = {"shape": Scalar(value=(2, 12))}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, {}, {}, reshape_constraints, False, set(), scalar_info
...
def test_reshape_error_5():
    ...
    """
    shapes = {"output": [2, 2], "input": [1, 2, 3, 4]}
    scalar_info = {"shape": Scalar(tuple[int, ...], value=TBD)}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, {}, {}, reshape_constraints, False, set(), scalar_info
...
def test_squeeze_1():
    """Should work with no problem with uniadic output shape."""
    shapes = {"output": ["a", "b", "c"], "input": [1, 2, 3, 1, 5]}
...
def test_squeeze_2():
    ...
    shapes = {"output": [("V", ...)], "input": [1, 2, 3, 1, 5]}
    final_shapes = {"output": [2, 3, 5], "input": [1, 2, 3, 1, 5]}
    assert_constraint_results(
        shapes, {}, final_shapes, {}, squeeze_constraints, True, {"output"}
    )
...
def test_squeeze_3():
    ...
    shapes = {"output": ["a", ("V", ...), "b"], "input": [1, 2, 3, 1, 5]}
    final_shapes = {"output": [2, 3, 5], "input": [1, 2, 3, 1, 5]}
    assert_constraint_results(
        shapes, {}, final_shapes, {}, squeeze_constraints, True, {"output"}
    )
...
def test_squeeze_4():
    ...
    """
    shapes = {"output": [("out", ...)], "input": [1, 2, ("in", ...), 1, 5]}
...
def test_squeeze_6():
    ...
    """
    shapes = {"output": [("out", ...)], "input": [2, ("in", ...), 4]}
...
def test_squeeze_7():
    ...
    where there is no 1s in input shape and it has variadic field.
    """
    shapes = {"output": [2, ("out", ...), 4], "input": [("in", ...)]}
...
def test_squeeze_9():
    shapes = {"output": [("out", ...)], "input": [2, 3, ("in", ...), 4]}
...
def test_squeeze_10():
    shapes = {"output": [("out", ...)], "input": [2, 1, 3, ("in", ...), 4]}
    final_shapes = {
        "output": [2, 3, "(V1, ...)", 4],
        "input": [2, 1, 3, "(V2, ...)", 4],
    }
...
def test_squeeze_11():
    shapes = {"output": [("out", ...)], "input": [2, "u1", 3, ("in", ...), 4]}
    final_shapes = {
        "output": [2, "(V1, ...)", 4],
        "input": [2, "u1", 3, "(V2, ...)", 4],
    }
...
def test_squeeze_12():
    ...
    where there is no 1s in input shape and it has variadic field.
    """
    shapes = {"output": [("out", ...)], "input": [2, ("in", ...), 4, 1, 1]}
...
def test_squeeze_13():
    ...
    where there is no 1s in input shape and it has variadic field.
    """
    shapes = {"output": [("out", ...)], "input": [2, ("in", ...), 1, 1, 4]}
...
def test_squeeze_error_2():
    ...
    """
    shapes = {"output": [2, ("out", ...), 3], "input": [1, 4, ("in", ...), 1, 3]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, squeeze_constraints, False, set())
    assert str(err_info.value) == "Possible values mismatch!"
...
def test_squeeze_error_3():
    ...
    """
    shapes = {"output": [2, ("out", ...), 1, 3], "input": [1, 4, ("in", ...), 1, 3]}
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(shapes, {}, {}, {}, squeeze_constraints, False, set())
    assert str(err_info.value) == (
...
def test_size_11():
    shapes = {"input": ["u1", "u2", "u3", ("Var1", ...), "u4", "u5", "u6"]}
    final_shapes = {
...
def test_swap_axes_5():
    ...
    this stage.
    """
    shapes = {"output": [("out", ...)], "input": ["a", "b", "c", "d"]}
    final_shapes = {
        "output": ["a", "d", "c", "b"],
        "input": ["a", "b", "c", "d"],
        "axis1": [],
...
def test_swap_axes_7():
    ...
    this stage.
    """
    shapes = {"output": ["a", "b", "c", "d"], "input": [("in", ...)]}
    final_shapes = {
        "output": ["a", "b", "c", "d"],
        "input": ["a", "d", "c", "b"],
        "axis1": [],
...
def test_reverse_1():
    """Should work with no problem"""
    shapes = {"output": ["u1", "u1", "u1"], "input": ["u1", "u1", "u1"]}
    final_shapes = {
        "output": ["u1", "u1", "u1"],
        "input": ["u1", "u1", "u1"],
        "axes": [],
...
def test_reverse_2():
    """Should work with no problem"""
    shapes = {"output": [("Var1", ...)], "input": ["u1", "u2", "u3"]}
    final_shapes = {
        "output": ["u3", "u2", "u1"],
        "input": ["u1", "u2", "u3"],
        "axes": [],
...
def test_reverse_4():
    """Should work with no problem"""
    shapes = {"output": ["u1", "u2", "u3"], "input": [("Var1", ...)]}
    final_shapes = {
        "output": ["u1", "u2", "u3"],
        "input": ["u2", "u1", "u3"],
        "axes": [],
...
def test_concat_3():
    shapes = {"output": ["u3"], "axis": [], "input1": [3], "input2": [3], "input3": [1]}
    final_shapes = {
        "output": [7],
        "axis": [],
        "input1": [3],
...
def test_shape_4():
    shapes = {"input": ["u1", "u2", "u3", ("Var1", ...), "u4", "u5"]}
    final_shapes = {"input": [3, 4, 5, 6, 7], "output": []}
    scalar_info = {"output": Scalar(value=(3, 4, 5, 6, 7))}
    final_values = {"output": (3, 4, 5, 6, 7)}
    assert_constraint_results(
...
def test_shape_5():
    shapes = {"input": ["u1", "u2", "u3", ("Var1", ...), "u4", "u4"]}
...
def test_to_tuple_forward():
    shapes = {}
    final_shapes = {"output": [], "input1": [], "input2": [], "input3": []}
    scalar_info = {
...
def test_scalar_item_1():
    shapes = {}
    final_shapes = {"output": [], "input": [], "index": []}
    scalar_info = {
...
def test_tensor_item_constraints_3():
    shapes = {"input": ["u1", "u2", ("Var1", ...)], "output": [("Var2", ...)]}
    final_shapes = {
        "input": ["u1", "u2", "u3", "(V1, ...)"],
        "output": ["(V1, ...)"],
        "index": [],
...
def test_tensor_item_constraints_5():
    shapes = {"input": [10, ("Var1", ...)], "output": [("Var2", ...)]}
...
def test_tensor_item_constraints_6():
    shapes = {"input": ["u1", "u2", "u3"], "output": [("Var1", ...)]}
    final_shapes = {
        "input": ["u1", "u2", "u3"],
        "output": ["u4", "u5", "u3"],
        "index": [],
...
def test_tensor_item_constraints_10():
    shapes = {"input": [8, 9, 10, 11, 12, 13, 14, 15], "output": [("Var1", ...)]}
    final_shapes = {
...
def test_scalar_item_type_constraints_8():
    index_type = int
    input_type = tuple[int, float, float, int]
...
def test_scalar_item_type_constraints_9():
    index_type = int
    input_type = tuple[int, int, int, int]
...
def test_reduce_type_constraint_2():
    shapes = {"input": [("Var1", ...)], "output": [("Var2", ...)]}
    initial_types = {"input": int, "output": int | float | bool}
...
def test_reduce_type_constraint_4():
    shapes = {"input": [("Var1", ...)], "output": [("Var2", ...)]}
    initial_types = {"input": int | float | bool, "output": float}
...
def test_reduce_type_constraint_5():
    shapes = {"input": [("Var1", ...)], "output": [("Var2", ...)]}
    initial_types = {"input": bool, "output": int | float | bool}
...
def test_bcast_with_var_possibles_1():
    shapes = {"output": ["a"], "left": [("V1", ...)], "right": ["b"]}

    assignments = {"a": {7, 8}, ("V1", ...): [(), ("c",)], "b": {1, 2, 3}, "c": {7, 9}}

    final_shapes = {"output": [7], "left": [7], "right": [1]}
...
def test_bcast_with_var_possibles_2():
    ...
    final_shapes = {"output": [7], "left": [("V1", ...)], "right": ["b"]}

    final_assignments = {("V1", ...): [(), ("c",)], "b": {1, 7}, "c": {1, 7}}
...
def test_bcast_with_var_possibles_3():
    shapes = {"output": [3], "left": [("V1", ...)], "right": [3]}
