...
def test_torch_encoder_decoder_var_seq_len():
    ...
    torch_inputs = torch.nn.utils.rnn.pad_sequence(torch_inputs, batch_first=True)
    torch_targets = torch.nn.utils.rnn.pad_sequence(torch_targets, batch_first=True)
