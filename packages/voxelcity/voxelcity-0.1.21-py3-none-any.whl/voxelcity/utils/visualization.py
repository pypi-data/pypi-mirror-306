...
#     #     ctx.add_basemap(ax, crs=web_mercator, source=ctx.providers.OpenStreetMap.Mapnik)
#     # except Exception as e:
#     #     print(f"Error adding basemap with Web Mercator: {e}")
#     #     try:
#     #         # Try with WGS84
#     #         wgs84 = CRS.from_epsg(4326)
#     #         ctx.add_basemap(ax, crs=wgs84, source=ctx.providers.OpenStreetMap.Mapnik)
#     #     except Exception as e:
#     #         print(f"Error adding basemap with WGS84: {e}")
#     #         print("Skipping basemap addition.")
