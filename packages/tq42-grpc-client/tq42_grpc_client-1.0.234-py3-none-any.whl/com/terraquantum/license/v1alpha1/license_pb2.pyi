...
class LicenseProto(_message.Message):
    __slots__ = ("id", "product", "key", "status", "created_at", "expiry")
    ...
    def __init__(self, id: _Optional[str] = ..., product: _Optional[str] = ..., key: _Optional[str] = ..., status: _Optional[_Union[LicenseStatusType, str]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., expiry: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
