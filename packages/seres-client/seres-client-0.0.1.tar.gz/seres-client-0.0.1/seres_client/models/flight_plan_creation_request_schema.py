...
class FlightPlanCreationRequestSchema(BaseModel):
    """
    ...
    parent_flight_plan_creation_request_id: Optional[StrictInt] = None
    ...
    id: StrictInt
    created: StrictStr
    status: FlightPlanCreationRequestStatusEnum
    flight_plan_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["flight_plan_schema_id", "reference", "future_id", "meta_launch_now", "meta_critical_leg_datetime", "meta_critical_leg_id", "meta_landing_datetime", "meta_launch_datetime", "parent_flight_plan_creation_request_id", "primary_bot_id", "primary_bot_schema_id", "primary_payload_id", "primary_payload_schema_id", "resource_assembly_schema_id", "created_by_id", "account_id", "id", "created", "status", "flight_plan_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlightPlanCreationRequestSchema from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_flight_plan_creation_request_id (nullable) is None
        # and model_fields_set contains the field
        if self.parent_flight_plan_creation_request_id is None and "parent_flight_plan_creation_request_id" in self.model_fields_set:
            _dict['parent_flight_plan_creation_request_id'] = None
        ...
        # set to None if flight_plan_id (nullable) is None
        # and model_fields_set contains the field
        if self.flight_plan_id is None and "flight_plan_id" in self.model_fields_set:
            _dict['flight_plan_id'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlightPlanCreationRequestSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "parent_flight_plan_creation_request_id": obj.get("parent_flight_plan_creation_request_id"),
            ...
            "flight_plan_id": obj.get("flight_plan_id")
        })
        return _obj
