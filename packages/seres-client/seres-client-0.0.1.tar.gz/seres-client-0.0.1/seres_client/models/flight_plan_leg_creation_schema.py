...
class FlightPlanLegCreationSchema(BaseModel):
    """
    FlightPlanLegCreationSchema
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["resource_assembly_schema_id", "critical", "starting_datetime", "is_launch_leg", "is_landing_leg", "origin_waypoint_id", "flight_plan_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlightPlanLegCreationSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlightPlanLegCreationSchema from a dict"""
        if obj is None:
            return None
