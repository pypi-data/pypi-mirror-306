...
class WmfImage(aspose.imaging.fileformats.emf.MetaImage):
    ...
    def resize(self, new_width: int, new_height: int, resize_type: aspose.imaging.ResizeType):
        '''Resize the image with the specified resizing type, allowing for flexible
        adjustment of dimensions while preserving aspect ratio or applying specific
        scaling algorithms. Integrate this method into your image processing workflow to
        achieve precise resizing operations tailored to your application's requirements.
    ...
    def resize(self, new_width: int, new_height: int, settings: aspose.imaging.ImageResizeSettings):
        '''Adjust the size of the image based on specified settings, enabling precise control
        over dimensions, aspect ratio, and scaling behavior. Integrate this method into
        your image processing workflow to achieve customized resizing operations tailored
    ...
    def crop(self, rectangle: aspose.imaging.Rectangle):
        '''Crop the image to the specified rectangle, retaining only the selected region
        ...
        the image within your application.
    ...
    def rotate_flip(self, rotate_flip_type: aspose.imaging.RotateFlipType):
        '''Perform rotation, flipping, or a combination of both operations on the image.
        Integrate this method into your image processing workflow to achieve precise
        manipulation of image orientation and alignment within your application.
