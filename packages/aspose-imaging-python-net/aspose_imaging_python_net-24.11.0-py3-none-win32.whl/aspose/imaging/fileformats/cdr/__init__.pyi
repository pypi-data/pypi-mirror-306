...
class CdrImage(aspose.imaging.VectorMultipageImage):
    ...
    def resize(self, new_width: int, new_height: int, resize_type: aspose.imaging.ResizeType):
        '''Effortlessly resize the image to desired dimensions with this intuitive method.
        Perfect for developers seeking to adjust the size of images dynamically,
        ensuring they fit the layout or requirements of their applications seamlessly.
    ...
    @property
    def height(self) -> int:
        '''Retrieve the height of the image effortlessly with this intuitive property.
        Perfect for developers seeking to access the dimensions of their images dynamically,
        ensuring accurate layout and rendering in their applications.'''
        ...
    ...
    @property
    def width(self) -> int:
        '''Retrieve the width of the image seamlessly with this intuitive property.
        Ideal for developers seeking to access the dimensions of their images dynamically,
        ensuring precise layout and rendering in their applications.'''
        ...
