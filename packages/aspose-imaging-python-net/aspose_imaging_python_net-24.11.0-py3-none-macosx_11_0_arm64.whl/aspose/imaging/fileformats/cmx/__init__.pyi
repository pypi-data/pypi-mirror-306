...
class CmxImage(aspose.imaging.VectorMultipageImage):
    ...
    def resize(self, new_width: int, new_height: int, resize_type: aspose.imaging.ResizeType):
        ...
        Perfect for developers seeking to adjust the size of images dynamically, ensuring
        they fit the layout or requirements of their applications seamlessly.
    ...
    def rotate_flip(self, rotate_flip_type: aspose.imaging.RotateFlipType):
        '''Effortlessly adjust the orientation of the image by rotating, flipping, or applying
