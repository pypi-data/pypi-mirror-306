...
class SvgImage(aspose.imaging.VectorImage):
    ...
    def resize(self, new_width: int, new_height: int, settings: aspose.imaging.ImageResizeSettings):
        '''Adjusts the image size according to the specified settings, enabling
        customization of the resizing process to meet specific requirements. This
        method offers flexibility in resizing operations, allowing for precise control
        over aspects such as interpolation methods, aspect ratio preservation, and
        output quality.
    ...
    @property
    def height(self) -> int:
        '''Retrieves the height of the image, indicating its vertical size in pixels. This
        property provides essential information for layout calculations and rendering
        processes, ensuring accurate display and manipulation of the image.'''
        ...
    ...
    @property
    def width(self) -> int:
        '''Returns the width of the image, denoting its horizontal size in pixels. This
        property is crucial for layout computations and display rendering, ensuring
        precise positioning and visualization of the image content.'''
        ...
