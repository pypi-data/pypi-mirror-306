...
class EmfImage(MetaImage):
    ...
    def resize(self, new_width: int, new_height: int, resize_type: aspose.imaging.ResizeType):
        '''Resize your image effortlessly with this function, specifying the desired width,
        height, and type. Perfect for adjusting images to fit specific dimensions while
        maintaining clarity and quality. Ideal for optimizing images for various platforms
        and applications.
    ...
    def resize(self, new_width: int, new_height: int, settings: aspose.imaging.ImageResizeSettings):
        '''Adjust your image size with customizable settings, ensuring optimal dimensions and
        clarity. Perfect for tailoring images to specific requirements while maintaining
        quality.
    ...
    def crop(self, rectangle: aspose.imaging.Rectangle):
        '''Crop the specified rectangle using this function. Ideal for refining image
        composition and focusing on specific areas of interest within the image. Improve
        visual clarity and highlight key details with precise cropping functionality.
