...
try:
    ...
    logger.error(e)
    IB_TURBINE_TYPE, IB_TABLE, IB_USER, IB_PASSWORD, IB_HOST, IB_PORT, IB_DB, IB_FIELD_FORMAT, BASE_USER, BASE_PASSWORD, \
    BASE_HOST, BASE_PORT, BASE_DB, IB_TABLE_FORMAT = (
...
class MyDataTools(object):
    ...
    明阳量云集控数据获取工具
    """
    def __init__(self, map_table_path=os.path.join(".", '点表映射汇总表.csv'), ibdb_info=None, mysqldb_info=None, **kwargs):
    ...
    def get_data(self, farm_code, turbine_code, db_yesr=IB_DB, table_name=IB_TABLE, col_names=None, start_date=None,
        ...
        >>> dt = MyDataTools(map_table_path="D:\project\GearingBoxOilFilterFDModel\点表映射汇总表.csv")
        >>> df = dt.get_data(farm_code='95004', turbine_code='95004001', db_yesr="95004",
        >>>              col_names=['group_current1', 'group_voltage1', 'group_current2', 'group_voltage2'],
        >>>              table_name="t95004001", start_date='2024-10-24', end_date='2024-10-25')
