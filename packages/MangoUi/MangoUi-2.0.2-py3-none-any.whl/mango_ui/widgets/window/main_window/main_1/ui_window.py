...
from mango_ui.models.models import MenusModel, AppConfig
from mango_ui.widgets.menu import MangoLeftMenu
...
from mango_ui.widgets.window.mango_window import MangoWindow
...
class UIWindow(QMainWindow):
    def __init__(self, style: AppConfig, menus: MenusModel, page_dict, l=None, **kwargs):
        ...
        self.central_widget.setStyleSheet(f'''
            font: {self.style.font.text_size}pt "{self.style.font.family}";
        ...
        self.title_bar.add_menus([i.model_dump() for i in self.menus.title_bar_menus])
        ...
        self.load_pages.setup_ui(self.content_area_left_frame, self.page_dict)
        self.load_pages.set_page(kwargs.get('page') if kwargs.get('page') else 'home')
        ...
        self.credits = MangoCredits(
            bg_two=THEME.bg_two,
            copyright=self.style.copyright,
            version=self.style.version,
            font_family=self.style.font.family,
            text_size=self.style.font.text_size,
