...
def set_home_offset(server_ip, home_offset):
    ...
    try:
        ...
        Logger().print_trace_warning(server_ip + " set_linear_count() except")
        Logger().print_trace_warning(e)
        return None
...
def clear_pid_param(server_ip):
    ...
    try:
        ...
        Logger().print_trace_warning(server_ip + " clear_pid_param() except")
        Logger().print_trace_warning(e)
        return None
...
# Return success or failure
def set_control_param(
    server_ip, motor_max_speed, motor_max_acceleration, motor_max_current
):
    data = {
        "method": "SET",
...
def clear_flag_of_operation(server_ip):
    ...
    try:
        ...
        Logger().print_trace_warning(server_ip + " clear_flag_of_operation() except")
        Logger().print_trace_warning(e)
        return None
...
def erase_config(server_ip):
    ...
    try:
        ...
        Logger().print_trace_warning(server_ip + " erase_config() except")
        Logger().print_trace_warning(e)
        return None
...
def fast_set_pid_imm(server_ip, kp, ki, kd):
    tx_messages = struct.pack(">Bfff", 0xA0, kp, ki, kd)
...
def fast_set_friction_FFD(server_ip, SET, DeadSpeedK, DeadSpeed, Fs, Fc, B):
    tx_messages = struct.pack(">BIfffff", 0xA3, SET, DeadSpeedK, DeadSpeed, Fs, Fc, B)
