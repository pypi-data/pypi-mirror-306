...
def set_tcpxo_config(user_request: sky.UserRequest) -> sky.MutatedUserRequest:
    ...
    new_config = sky.skypilot_config._recursive_update(config, k8s_override_config)
    return sky.MutatedUserRequest(task=user_request.task, skypilot_config=new_config)
