...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_841')) else
      _ods_ir.AttrBuilder.get('anonymous_841')(function_type, context=_ods_context))
...
def interface_workgroup_count(dimension, *, loc=None, ip=None) -> _ods_ir.Value:
  return InterfaceWorkgroupCountOp(dimension=dimension, loc=loc, ip=ip).result
...
def interface_workgroup_id(dimension, *, loc=None, ip=None) -> _ods_ir.Value:
  return InterfaceWorkgroupIDOp(dimension=dimension, loc=loc, ip=ip).result
...
def interface_workgroup_size(dimension, *, loc=None, ip=None) -> _ods_ir.Value:
  return InterfaceWorkgroupSizeOp(dimension=dimension, loc=loc, ip=ip).result
