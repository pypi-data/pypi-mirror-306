...
class CEDARScriptPromptsRW(CEDARScriptPromptsBase):
    """
    Variation in which CONTENT blocks don't have to use <relative-indent-prefix>
    """

    def edit_format_name(self):
        return f"{super().edit_format_name()}-raw"
