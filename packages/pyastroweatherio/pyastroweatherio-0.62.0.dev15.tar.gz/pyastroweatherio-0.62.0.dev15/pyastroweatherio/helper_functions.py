...
class AtmosphericRoutines:
    ...
    # #####################################################
    @typechecked
    async def calculate_fog_density(
        self, temp2m, rh2m, dewpoint2m, wind_speed
    ) -> float:
        """
        ...
        # Constants
        k = 0.5  # Normalizing factor for density
        a = 1.5  # Controls sensitivity to temp-dew_point difference
        b = 10  # Controls sensitivity to wind speed
    ...
    @typechecked
    def _calculate_lifting_condensation_level(
        self, w, air_pressure_at_sea_level
    ) -> float:
        """
