...
class SubscriptionService(BaseService):
    ...
    @cast_models
    def complete_subscription_cycle(self, subscription_id: str) -> InlineResponse200_78:
    ...
    @cast_models
    def simulate_start_new_cycle(self, subscription_id: str) -> InlineResponse200_78:
