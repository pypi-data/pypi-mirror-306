...
class BillingReason(Enum):
    ...
    :cvar SUBSCRIPTIONCYCLE: "subscription_cycle"
    :vartype SUBSCRIPTIONCYCLE: str
    :cvar SUBSCRIPTIONCREATE: "subscription_create"
    :vartype SUBSCRIPTIONCREATE: str
    :cvar MANUAL: "manual"
    :vartype MANUAL: str
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, BillingReason._member_map_.values()))


class InvoiceResponseStatus(Enum):
    """An enumeration representing different categories.
    ...
    :cvar VOID: "void"
    :vartype VOID: str
    :cvar UNCOLLECTIBLE: "uncollectible"
    :vartype UNCOLLECTIBLE: str
    """
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, InvoiceResponseStatus._member_map_.values()))
...
class InvoiceResponse(BaseModel):
    ...
    :param attempted: Number of automatic attempts that Rapyd made to retry paying this invoice if it failed., defaults to None
    :type attempted: float, optional
    ...
    :type billing_reason: BillingReason, optional
    ...
    :type status: InvoiceResponseStatus, optional
    ...
    def __init__(
        ...
        billing: str = None,
        billing_reason: BillingReason = None,
        ...
        number: str = None,
        status: InvoiceResponseStatus = None,
        subtotal: float = None,
        tax: float = None,
        total: float = None,
        ...
        self.attempted = self._define_number("attempted", attempted, nullable=True)
        ...
        self.billing_reason = (
            self._enum_matching(billing_reason, BillingReason.list(), "billing_reason")
            if billing_reason
            else None
        )
        ...
        self.status = (
            self._enum_matching(status, InvoiceResponseStatus.list(), "status")
            if status
            else None
        )
