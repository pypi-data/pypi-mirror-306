...
from .services.localization_methods import LocalizationMethodsService
from .services.webhook_methods import WebhookMethodsService
...
class RapydSdk:
    def __init__(
        ...
        self.localization_methods = LocalizationMethodsService(base_url=self._base_url)
        self.webhook_methods = WebhookMethodsService(base_url=self._base_url)
    ...
    def set_base_url(self, base_url: Union[Environment, str]):
        ...
        self.localization_methods.set_base_url(self._base_url)
        self.webhook_methods.set_base_url(self._base_url)
    ...
    def set_timeout(self, timeout: int):
        ...
        self.localization_methods.set_timeout(timeout)
        self.webhook_methods.set_timeout(timeout)
