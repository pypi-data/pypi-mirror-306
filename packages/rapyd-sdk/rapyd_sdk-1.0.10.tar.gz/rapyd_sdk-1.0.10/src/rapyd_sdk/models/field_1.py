...
from .field_1_conditions import Field1Conditions


class Field1Type(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, Field1Type._member_map_.values()))
...
class Field1(BaseModel):
    ...
    :type required_fields: List[Field1], optional
    :param type_: type_, defaults to None
    :type type_: Field1Type, optional
    ...
    :type conditions: List[Field1Conditions], optional
    ...
    def __init__(
        ...
        required_fields: List[Field1] = None,
        type_: Field1Type = None,
        regex: str = None,
        conditions: List[Field1Conditions] = None,
        ...
        self.required_fields = self._define_list(required_fields, Field1)
        self.type_ = (
            self._enum_matching(type_, Field1Type.list(), "type_") if type_ else None
        )
        self.regex = self._define_str("regex", regex, nullable=True)
        self.conditions = self._define_list(conditions, Field1Conditions)
