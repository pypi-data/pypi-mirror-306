...
from .inline_response_200_18_data_transactions import (
    InlineResponse200_18DataTransactions,
)


@JsonMap({"id_": "id"})
class InlineResponse200_18Data(BaseModel):
    ...
    :type transactions: List[InlineResponse200_18DataTransactions], optional
    ...
    def __init__(
        ...
        currency: str = None,
        transactions: List[InlineResponse200_18DataTransactions] = None,
        ...
        self.transactions = self._define_list(
            transactions, InlineResponse200_18DataTransactions
        )
