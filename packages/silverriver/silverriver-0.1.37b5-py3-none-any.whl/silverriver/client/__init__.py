...
class BrowserSession:
    ...
    def _validate_obs(self, transition):
    ...
    def execute(self, code: str) -> BrowserObservation:
        ...
        if self.browser_type == BrowserType.SOTA:
            ...
            logger.warning("BrowserGym does not support remote code execution, the action will be executed remotely.")
...
class Crux:
    ...
    def create_browser_session(self, start_url: str, chat, browser_type: BrowserType = BrowserType.SOTA) -> tuple[BrowserSession, Observation | BrowsergymObservation, dict]:
        """
    ...
    def get_action(self, obs: Observation, mode: SupportedModes, interactive) -> AgentAction:
        """
        ...
        return self.client.agent_get_action(obs, mode, interactive)
