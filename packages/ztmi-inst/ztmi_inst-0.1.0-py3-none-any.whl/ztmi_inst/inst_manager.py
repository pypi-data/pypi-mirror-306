...
from drivers.inst_driver_mapping import INST_DRIVER_MAPPING_GROUP
...
class InstManager:
    ...
    def inst_create(
        ...
        *,
        ...
        new_inst: Driver = inst_device_class(address, port)
    ...
    # def inst_measure(self, *args, **kwargs) -> dict:
    #     pass
    #
    # def inst_trigger(self, *args, **kwargs) -> dict:
    #     pass
    #
    # def inst_channel(self, *args, **kwargs) -> dict:
    #     pass
