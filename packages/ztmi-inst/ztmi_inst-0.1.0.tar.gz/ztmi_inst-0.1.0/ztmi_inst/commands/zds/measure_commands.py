...
class MeasureCommand:
    ...
    def __init__(self, dev, command_syntax: str = ":MEASure"):
        ...
        self._pulsetrain = MeasureEightCommand(dev, f"{command_syntax}:PULSetrain")
        self._pset = MeasureRWCommand(dev, f"{command_syntax}:PULSetrain:PSET")
