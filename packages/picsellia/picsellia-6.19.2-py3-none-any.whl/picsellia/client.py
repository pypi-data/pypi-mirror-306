...
from picsellia.types.enums import Framework, InferenceType, ProcessingType, TagTarget
...
class Client:
    ...
    def get_public_model(self, name: str) -> Model:
        ...
        Returns:
            A (Model) object that you can manipulate
        """
        return self._do_get_model_by_name("/api/public/models/find", name)
    ...
    def list_public_models(
        ...
        return self._do_list_models("/api/public/models", params=params)
    ...
    def list_processings(
        ...
        return list(map(partial(Processing, self.connexion), r["items"]))
