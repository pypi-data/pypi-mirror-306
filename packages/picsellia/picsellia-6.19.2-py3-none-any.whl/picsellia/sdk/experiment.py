...
class Experiment(Dao):
    ...
    def list_artifacts(
        ...
        r = self.connexion.get(
            f"/api/experiment/{self.id}/artifacts", params=params
        ).json()
    ...
    def get_base_experiment(self) -> "Experiment":
        ...
        r = self.connexion.get(f"/api/experiment/{r['base_experiment_id']}").json()
    ...
    def list_logs(
        ...
        params = utils.filter_payload(params)
        r = self.connexion.get(
            f"/api/experiment/{self.id}/logs/extended", params=params
        ).json()
    ...
    def get_log(self, name: str) -> Log:
        ...
        params = {"name": name}
        r = self.connexion.get(
            f"/api/experiment/{self.id}/logs/find", params=params
        ).json()
    ...
    def _do_list_evaluations(
        ...
        r = self.connexion.get(
            f"/api/experiment/{self.id}/evaluations", params=params
        ).json()
        return (
