...
<div class="grid-item"><div class='well' style='background-color: #fcdb92'><p style='color: #2F4F4F; font-size: 10px; margin-top: -10px; padding-bottom: 5px; margin-right: -5px;' class='text-right' >eingestellt am 14.10.2024 00:00:00</p><h4 style='color: #2F4F4F; padding-bottom: 5px;' class=''>Münchner Elternabend Medien</h4><p style='color: #2F4F4F;'>Medienpädagogik</p><p style='color: #2F4F4F;'>Anhang: <a href='aktuelles/get_file/?repo=1&csrf=1234567890abcdef' title='Münchner Elternabend Medien 2024.jpg herunterladen' target='_blank' rel='noopener'><img src='/includes/project/images/paperclip.gif'></a></p></div></div>
<div class="grid-item"><div class='well' style='background-color: #95acd2'><p style='color: #2F4F4F; font-size: 10px; margin-top: -10px; padding-bottom: 5px; margin-right: -5px;' class='text-right' >eingestellt am 06.09.2024 00:00:00</p><h4 style='color: #2F4F4F; padding-bottom: 5px;' class=''>Entschuldigungspraxis</h4><p style='color: #2F4F4F;'>Regelungen zu Krankmeldung, Befreiung und Beurlaubung</p><p style='color: #2F4F4F;'>Anhang: <a href='aktuelles/get_file/?repo=2&csrf=1234567890abcdef' title='Entschuldigungspraxis GYMNF_Stand 06.09.2024.pdf herunterladen' target='_blank' rel='noopener'><img src='/includes/project/images/paperclip.gif'></a></p></div></div>
</div></div></div>
</body>
</html>
"""
...
<span>18.10.2024</span>                            </div>
<!-- abgeschlossen -->
<div class="col-xs-3 text-center">
<span style='pad'>17.10.2024<img class='pull-right' src='/includes/project/images/haken.png' /></span>                            </div>
</div>
...
<body >
<div class="" id="asam_content">
<form class='form-horizontal' action='/includes/nachrichten_dir/umfragen_editor_db_ins.php' method='post'><input type='hidden' name='csrf' value='1234567890abcdef'><div class='form-group'><div class='col-xs-12 col-md-10 col-md-offset-1'><h3 style='padding-bottom: 10px; line-height: 115%;#><span style='text-decoration: underline;'>Elternbeiratswahl 2024</span><a id='umf_file' title='Anhang' href='aktuelles/get_file/?repo=88&csrf=7b0ec63e19360b5a' target='_blank' style='cursor: pointer;' rel='noopener'><img style='margin-bottom: 5px; margin-right: 5px; margin-left: 5px;' src='/includes/project/images/dokumente_grey_20h.png'><span style='font-size:12px'>(Anhang durch Klick herunterladen)</span></a></h3><input type='hidden' name='UMF_ID' value='2'></div></div><div class='form-group'><div class='col-xs-12 col-md-10 col-md-offset-1'>Liebe Eltern und Erziehungsberechtigte,<br />
<br />
hiermit laden wir Sie herzlich zur Elternratswahl 2024 ein. Im Anhang finden Sie die Steckbriefe der elf Kandidatinnen und Kandidaten für den Elternbeirat. Ab sofort bis zum 18. Oktober haben Sie die Möglichkeit, Ihre Stimme abzugeben. Details zur Wahl finden Sie ebenfalls in der angehängten Datei.<br />
<br />
Herzliche Grüße<br />
...
<td>Vocab p.206 (no green boxes)<br />- <i>Zu Erledigen bis: 22.10.2024</i></td>
</tr></tbody></table>
...
<tbody><tr><td>Hausaufgabe</td>
<td>SB S. 215 (Adverbien)<br />- <i>Zu Erledigen bis: 23.10.2024</i></td></tr></tbody></table>
<table class='table table-bordered'><thead><tr><th scope='col' style='width: 20%;'></th>
...
- <i>Zu Erledigen bis: 04.11.2024</i></td></tr>
...
<body>
<div class='' id='asam_content'>
<div class='form-group'><label class='col-lg-3 col-md-3 col-sm-2 col-xs-12 control-label' style=''><img src='/includes/project/images/arrow_down.png' height='16' width='16' border='0' /> 03.11.2024 21:09</label><div class='col-lg-6 col-md-7 col-sm-9 col-xs-12' style=''><a href='meldungen/kommunikation_fachlehrer/10/709' class='btn btn-default btn-block ' style='text-align: left; white-space: normal;' role='button'>Informationen Englisch</a></div></div>
</div>
</body>
</html>
""".replace("#NAME_D#", DEMO_NAME_D)
...
<body >
<div class='' id='asam_content'>
<div class='row'><div class='col-xs-12'><h2><img src='/includes/project/images/meldungen_gruen_20h.png' style='margin-right:10px;margin-bottom:10px;' />Kommunikation mit #NAME_D# im Schuljahr 2024/2025</h2></div></div>
...
<span class='link_buchungen'>#NAME_D#</span>:<br><small style='font-weight: normal'>(25.10.2024)&nbsp;</small></label>
