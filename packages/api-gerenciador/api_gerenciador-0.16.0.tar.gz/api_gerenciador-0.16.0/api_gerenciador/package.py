...
class GerenciadorApi:
    ...
    def find_filas_by_application(self, site: str, server_process: str, container_id: str) -> dict:
        __url = f'{self.__DOMAIN}/fila?site={site}&server_process={server_process}&container_id={container_id}'
