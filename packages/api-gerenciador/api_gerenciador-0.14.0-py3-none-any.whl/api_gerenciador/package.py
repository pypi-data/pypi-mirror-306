...
class GerenciadorApi:
    ...
    def update_container(self, container_identifier: str, configuration_type: str, site_name: str, server_ip: str) -> dict:
        __url = f'{DOMAIN}/container/sync-website?container_identifier={container_identifier}&configuration_type={configuration_type}&site_name={site_name}&server_ip={server_ip}'
