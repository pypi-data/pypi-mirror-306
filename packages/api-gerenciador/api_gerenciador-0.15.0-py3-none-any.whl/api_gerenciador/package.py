...
class GerenciadorApi:
    ...
    def __get_headers(self) -> dict:
        try:
            ...
            response = requests.get(f"https://{PROJECT}.supabase.co/rest/v1/rpc/get_last_token", headers=self.__get_authorization())
    ...
    def find_filas_by_application(self, application: str, server_process: str, container_id: str) -> dict:
        __url = f'{self.__DOMAIN}/fila?application={application}&server_process={server_process}&container_id={container_id}'
    ...
    def update_container(self, container_identifier: str, configuration_type: str, site_name: str, server_ip: str) -> dict:
