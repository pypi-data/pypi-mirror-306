...
class RetryState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_deadletter_after_attempt", b"_deadletter_after_attempt", "_discard_after_attempt", b"_discard_after_attempt", "deadletter_after_attempt", b"deadletter_after_attempt", "discard_after_attempt", b"discard_after_attempt"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_deadletter_after_attempt", b"_deadletter_after_attempt", "_discard_after_attempt", b"_discard_after_attempt", "attempts", b"attempts", "deadletter_after_attempt", b"deadletter_after_attempt", "discard_after_attempt", b"discard_after_attempt", "kind", b"kind"]) -> None: ...
    @typing.overload
