...
def main():
    ...
    parser.add_argument('-s', '--seq_strand', required=False, type=str, default=False,  help="When extracting sequences, it's crucial to determine whether to extract from the sense strand or the antisense strand, as the gene sequences on the negative strand are in the reverse complement orientation", choices=['True', 'False'])
