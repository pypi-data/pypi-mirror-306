...
class GetInfoResponse:
    ...
    def __str__(self):
        return "GetInfoResponse(balance_sat={}, pending_send_sat={}, pending_receive_sat={}, fingerprint={}, pubkey={})".format(self.balance_sat, self.pending_send_sat, self.pending_receive_sat, self.fingerprint, self.pubkey)
...
class PrepareLnUrlPayResponse:
    destination: "SendDestination";fees_sat: "int";success_action: "typing.Optional[SuccessAction]";

    @typing.no_type_check
    def __init__(self, destination: "SendDestination", fees_sat: "int", success_action: "typing.Optional[SuccessAction]" = _DEFAULT):
        self.destination = destination
        self.fees_sat = fees_sat
    ...
    def __str__(self):
        return "PrepareLnUrlPayResponse(destination={}, fees_sat={}, success_action={})".format(self.destination, self.fees_sat, self.success_action)
