...
To use as a package:
```bash
pip install ostis-ai-toolkit
pip install git+https://github.com/tencent-ailab/IP-Adapter.git
pip install git+https://github.com/cozy-creator/sd-scripts.git
pip install git+https://github.com/cozy-creator/LECO.git
```
...
### Tutorial (package edition)

To begin, ensure you configure your config properly. The config used for the training here is for dev. Do well to check the schnell config found under config/examples in the GitHub repo
...
# You can also add a callback function to get updates if you plan on building a UI around this (sample example below)
