...
class DataLoadJobHelper:
    ...
    def __init__(self, config):
        ...
        :param config: Dictionary specifying which attributes are global, which are loop-specific,
                       and any specific data type handling needed for particular attributes.
                       Example:
                       config = {
                            "globalAttributes": ["0000X"],
    ...
    def init(self, dataLoadJob):
        ...
        for item in dataLoadJob:
            ...
            if attributeNo in self.config.get("globalAttributes", []) and attributeSpecifier is None:
                # Global attribute
    ...
    def getValueFromGlobalAttributes(self, attributeNo):
        """
    ...
    def getValuesFromLoopAttributes(self, attributeNo):
        """
