...
class lrt_fixed(lrt.lrt):  #!!!what is this for?
    ...
    #         assert False, "Null model not implemented yet."
    #         (lik1, stat) = self._altModelGLMM_fixed(
    #             G1, altModel["approx"], altModel["link"]
    #         )
    #     else:
    ...
    def _altModelLMM_fixed(self, G1):
        ...
        self.model0[
            "model"
        ].findH2()  # The null model only has a single kernel and only needs to find h2
