<!--
<p align="center">
  <img src="https://github.com/cthoyt/biopragmatics/raw/main/docs/source/logo.png" height="150">
</p>
-->
...
<p align="center">
    <a href="https://github.com/cthoyt/biopragmatics/actions/workflows/tests.yml">
        <img alt="Tests" src="https://github.com/cthoyt/biopragmatics/actions/workflows/tests.yml/badge.svg" /></a>
    <a href="https://pypi.org/project/biopragmatics">
        <img alt="PyPI" src="https://img.shields.io/pypi/v/biopragmatics" /></a>
    <a href="https://pypi.org/project/biopragmatics">
        <img alt="PyPI - Python Version" src="https://img.shields.io/pypi/pyversions/biopragmatics" /></a>
    <a href="https://github.com/cthoyt/biopragmatics/blob/main/LICENSE">
        <img alt="PyPI - License" src="https://img.shields.io/pypi/l/biopragmatics" /></a>
    <a href='https://biopragmatics.readthedocs.io/en/latest/?badge=latest'>
        <img src='https://readthedocs.org/projects/biopragmatics/badge/?version=latest' alt='Documentation Status' /></a>
    <a href="https://codecov.io/gh/cthoyt/biopragmatics/branch/main">
        <img src="https://codecov.io/gh/cthoyt/biopragmatics/branch/main/graph/badge.svg" alt="Codecov status" /></a>  
    <a href="https://github.com/cthoyt/cookiecutter-python-package">
        <img alt="Cookiecutter template from @cthoyt" src="https://img.shields.io/badge/Cookiecutter-snekpack-blue" /></a>
    <a href="https://github.com/astral-sh/ruff">
        <img src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json" alt="Ruff" style="max-width:100%;"></a>
    <a href="https://github.com/cthoyt/biopragmatics/blob/main/.github/CODE_OF_CONDUCT.md">
        <img src="https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg" alt="Contributor Covenant"/></a>
</p>

Biomedical semantics and pragmatics.
...
The biopragmatics command line tool is automatically installed. It can
...
[PyPI](https://pypi.org/project/biopragmatics/) with:

```console
python3 -m pip install biopragmatics
```
-->
...
```console
python3 -m pip install git+https://github.com/cthoyt/biopragmatics.git
```

## 👐 Contributing

Contributions, whether filing an issue, making a pull request, or forking, are appreciated. See
[CONTRIBUTING.md](https://github.com/cthoyt/biopragmatics/blob/master/.github/CONTRIBUTING.md)
...
```console
git clone git+https://github.com/cthoyt/biopragmatics.git
cd biopragmatics
...
[GitHub Action](https://github.com/cthoyt/biopragmatics/actions?query=workflow%3ATests).
...
to https://zenodo.org/account/settings/github/repository/cthoyt/biopragmatics
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to switch the version number in
   the `pyproject.toml`, `CITATION.cff`, `src/biopragmatics/version.py`,
...
1. Navigate
   to https://github.com/cthoyt/biopragmatics/releases/new
