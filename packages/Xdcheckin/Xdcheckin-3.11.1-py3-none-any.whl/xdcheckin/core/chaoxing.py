...
_Chaoxing___init___regex = _compile(r"( \(@Kalimdor\)_.*?)?$")
...
_Chaoxing_config_base = {
	"requests_headers": {
		...
		"like Gecko) Chrome/129.0.0.0 Mobile Safari/537.36 com.chaoxing"
		".mobile.xuezaixidian/ChaoXingStudy_1000149_6.3.7_android_phone"
		"_6005_249"
	},
...
class Chaoxing:
	...
	def __init__(
		...
		if ident:
			headers["User-Agent"] = _Chaoxing___init___regex.sub(
				f" (@Kalimdor)_{ident}", headers["User-Agent"],
				1
			)
