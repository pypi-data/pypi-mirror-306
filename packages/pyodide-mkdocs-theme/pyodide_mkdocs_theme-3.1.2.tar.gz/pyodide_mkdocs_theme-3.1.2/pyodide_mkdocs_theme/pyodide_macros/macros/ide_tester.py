...
from typing import Callable, ClassVar, Dict, Iterator, List, Tuple, TYPE_CHECKING
    ...
    def build_filters(cls):
        ...
        return Html.div(
            "".join(
                ...
                for kind in ('checked','unchecked','correct','incorrect')
            ),
...
'''
    ...
    def _build_one_ide_items(
        ...
        for i,sub_case in enumerate(js_dump.get('subcases',()), 1):
            ...
            yield dive(cls.description(sub_case)) + div_svg + sub_btns + dive('')
