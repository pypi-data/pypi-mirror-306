...
VALID_TYPES = (BaseModel, str, dict, int, float, bool, list)
...
class Trace:
    ...
    @classmethod
    def input(cls, var: Union[BaseModel, str, dict, int, float, bool, list], variable_name: str, origin: Literal["agent", "environment"], annotation: Optional[str] = None):
    ...
    @classmethod
    def output(cls, var: Union[BaseModel, str, dict, int, float, bool, list], variable_name: str, origin: Literal["agent", "environment"], annotation: Optional[str] = None):
        if not isinstance(var, VALID_TYPES):
            raise TypeError(f"Variable must be one of {VALID_TYPES}, got {type(var)}")
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if log_result:
                    trace.output(result, param, origin)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                # Automatically trace function output
                if log_result:
                    async_trace.output(result, param, origin)
