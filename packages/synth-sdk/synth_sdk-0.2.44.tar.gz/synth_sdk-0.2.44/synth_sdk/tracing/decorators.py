from typing import Callable, Optional, Set, Literal, Any, Dict, Tuple
...
class AsyncTrace:
    ...
    def input(cls, var: Any, origin: Literal["agent", "environment"]):
        if trace_initialized_var.get():
            ...
            trace_inputs.append((origin, var))
    ...
    def output(cls, var: Any, origin: Literal["agent", "environment"]):
        if trace_initialized_var.get():
            ...
            trace_outputs.append((origin, var))
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                bound_args.apply_defaults()
                for param, value in bound_args.arguments.items():
                    async_trace.input(value, origin)
                ...
                # Automatically trace function output
                if log_result:
                    async_trace.output(result, origin)
