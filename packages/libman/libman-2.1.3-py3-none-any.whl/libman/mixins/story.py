...
from libman.exceptions import ClientNotFoundError, StoryNotFound, UserNotFound
from libman.extractors import (
    extract_story_gql,
    extract_story_v1,
    extract_user_short,
)
from libman.types import Story, UserShort
...
class StoryMixin:
    ...
    def story_download_by_url(
        ...
        assert fname, (
            ...
            """Read the documentation https://libbots.site/usage-guide/story.html"""
        )
