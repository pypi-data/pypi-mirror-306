...
option_4 = StrOption(name="var1", doc="The first variable", properties=frozenset({"basic", "mandatory"}), informations={'type': 'string'})
option_5 = StrOption(name="var2", doc="The second variable", properties=frozenset({"basic", "mandatory"}), informations={'type': 'string'})
...
option_9 = StrOption(name="var1", doc="The first variable", properties=frozenset({"basic", "mandatory"}), informations={'type': 'string'})
option_10 = StrOption(name="var2", doc="The second variable", properties=frozenset({"basic", "mandatory"}), informations={'type': 'string'})
