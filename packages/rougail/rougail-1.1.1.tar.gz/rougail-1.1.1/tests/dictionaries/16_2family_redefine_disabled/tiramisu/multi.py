...
optiondescription_3 = OptionDescription(name="family", doc="family", children=[option_4], properties=frozenset({"basic", "disabled"}))
...
optiondescription_7 = OptionDescription(name="family", doc="family", children=[option_8], properties=frozenset({"basic", "disabled"}))
