...
option_3 = ChoiceOption(name="variable", doc="a variable", values=("a", "b"), properties=frozenset({"basic", "mandatory"}), informations={'type': 'choice'})
...
option_6 = ChoiceOption(name="variable", doc="a variable", values=("a", "b"), properties=frozenset({"basic", "mandatory"}), informations={'type': 'choice'})
