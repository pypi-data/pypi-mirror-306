...
option_3 = ChoiceOption(name="var", doc="A choice", values=("a", "c"), default="c", properties=frozenset({"mandatory", "standard"}), informations={'type': 'choice'})
...
option_6 = ChoiceOption(name="var", doc="A choice", values=("a", "c"), default="c", properties=frozenset({"mandatory", "standard"}), informations={'type': 'choice'})
