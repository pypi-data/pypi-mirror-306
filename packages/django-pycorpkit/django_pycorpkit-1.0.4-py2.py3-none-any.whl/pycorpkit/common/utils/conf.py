...
def compile_settings():
    ...
    custom_org_model = getattr(
        settings, "CUSTOM_ORGANISATION_MODEL", None
    )
    if custom_org_model is None:
        raise ImproperlyConfigured(
            "CUSTOM_ORGANISATION_MODEL setting is required but not set in your settings file."
        )
    ...
    return {
        ...
        "CUSTOM_ORGANISATION_MODEL": custom_org_model,
    }
