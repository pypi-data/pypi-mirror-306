...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/io/usr/local/cuda-11.8/include/cuda.h",
            "/io/usr/local/cuda-11.8/include/cudaProfiler.h",
            "cuda/bindings"
        ],
        "extra_compile_args": [
            "-std=c++14",
...
/* "cuda/bindings/cydriver.pxd":1900
...
/* "cuda/bindings/cydriver.pxd":1902
 * ctypedef unsigned int GLenum
 * 
 * ctypedef unsigned int GLuint             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1914
...
/* "cuda/bindings/cydriver.pxd":1921
...
/* "cuda/bindings/cydriver.pxd":1923
 * ctypedef uint32_t VdpDevice
 * 
 * ctypedef unsigned long long VdpGetProcAddress             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1925
 * ctypedef unsigned long long VdpGetProcAddress
 * 
 * ctypedef uint32_t VdpVideoSurface             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1927
 * ctypedef uint32_t VdpVideoSurface
 * 
 * ctypedef uint32_t VdpOutputSurface             # <<<<<<<<<<<<<<
 * 
...
/*--- Type declarations ---*/
union __pyx_t_4cuda_8bindings_8cydriver_anon_union11;
struct __pyx_t_4cuda_8bindings_8cydriver_CUeglFrame_st;

/* "cuda/bindings/cydriver.pxd":1730
...
/* "cuda/bindings/cydriver.pxd":1736
...
/* "cuda/bindings/cydriver.pxd":1742
...
/* "cuda/bindings/cydriver.pxd":1886
...
/* "cuda/bindings/cydriver.pxd":1893
...
/* "cuda/bindings/cydriver.pxd":2709
 ...
 */
enum  {
  __pyx_e_4cuda_8bindings_8cydriver_CUDA_VERSION = 0x2B48
};

/* "cuda/bindings/cydriver.pxd":2711
 * cdef enum: CUDA_VERSION = 11080
 * 
 * cdef enum: CU_IPC_HANDLE_SIZE = 64             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2713
 * cdef enum: CU_IPC_HANDLE_SIZE = 64
 * 
 * cdef enum: CU_STREAM_LEGACY = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2719
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_ACCESS_POLICY_WINDOW = 1
 * 
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_COOPERATIVE = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2721
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_COOPERATIVE = 2
 * 
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_DIMENSION = 4             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2723
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_DIMENSION = 4
 * 
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_SCHEDULING_POLICY_PREFERENCE = 5             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2725
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_CLUSTER_SCHEDULING_POLICY_PREFERENCE = 5
 * 
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_PRIORITY = 8             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2727
 * cdef enum: CU_KERNEL_NODE_ATTRIBUTE_PRIORITY = 8
 * 
 * cdef enum: CU_STREAM_ATTRIBUTE_ACCESS_POLICY_WINDOW = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2735
 * cdef enum: CU_MEMHOSTALLOC_DEVICEMAP = 2
 * 
 * cdef enum: CU_MEMHOSTALLOC_WRITECOMBINED = 4             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2737
 * cdef enum: CU_MEMHOSTALLOC_WRITECOMBINED = 4
 * 
 * cdef enum: CU_MEMHOSTREGISTER_PORTABLE = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2739
 * cdef enum: CU_MEMHOSTREGISTER_PORTABLE = 1
 * 
 * cdef enum: CU_MEMHOSTREGISTER_DEVICEMAP = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2741
 * cdef enum: CU_MEMHOSTREGISTER_DEVICEMAP = 2
 * 
 * cdef enum: CU_MEMHOSTREGISTER_IOMEMORY = 4             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2747
 * cdef enum: CU_ARRAY_SPARSE_PROPERTIES_SINGLE_MIPTAIL = 1
 * 
 * cdef enum: CUDA_EXTERNAL_MEMORY_DEDICATED = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2749
 * cdef enum: CUDA_EXTERNAL_MEMORY_DEDICATED = 1
 * 
 * cdef enum: CUDA_EXTERNAL_SEMAPHORE_SIGNAL_SKIP_NVSCIBUF_MEMSYNC = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2751
 * cdef enum: CUDA_EXTERNAL_SEMAPHORE_SIGNAL_SKIP_NVSCIBUF_MEMSYNC = 1
 * 
 * cdef enum: CUDA_EXTERNAL_SEMAPHORE_WAIT_SKIP_NVSCIBUF_MEMSYNC = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2753
 * cdef enum: CUDA_EXTERNAL_SEMAPHORE_WAIT_SKIP_NVSCIBUF_MEMSYNC = 2
 * 
 * cdef enum: CUDA_NVSCISYNC_ATTR_SIGNAL = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2755
 * cdef enum: CUDA_NVSCISYNC_ATTR_SIGNAL = 1
 * 
 * cdef enum: CUDA_NVSCISYNC_ATTR_WAIT = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2757
 * cdef enum: CUDA_NVSCISYNC_ATTR_WAIT = 2
 * 
 * cdef enum: CU_MEM_CREATE_USAGE_TILE_POOL = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2759
 * cdef enum: CU_MEM_CREATE_USAGE_TILE_POOL = 1
 * 
 * cdef enum: CUDA_COOPERATIVE_LAUNCH_MULTI_DEVICE_NO_PRE_LAUNCH_SYNC = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2761
 * cdef enum: CUDA_COOPERATIVE_LAUNCH_MULTI_DEVICE_NO_PRE_LAUNCH_SYNC = 1
 * 
 * cdef enum: CUDA_COOPERATIVE_LAUNCH_MULTI_DEVICE_NO_POST_LAUNCH_SYNC = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2763
 * cdef enum: CUDA_COOPERATIVE_LAUNCH_MULTI_DEVICE_NO_POST_LAUNCH_SYNC = 2
 * 
 * cdef enum: CUDA_ARRAY3D_LAYERED = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2765
 * cdef enum: CUDA_ARRAY3D_LAYERED = 1
 * 
 * cdef enum: CUDA_ARRAY3D_2DARRAY = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2767
 * cdef enum: CUDA_ARRAY3D_2DARRAY = 1
 * 
 * cdef enum: CUDA_ARRAY3D_SURFACE_LDST = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2769
 * cdef enum: CUDA_ARRAY3D_SURFACE_LDST = 2
 * 
 * cdef enum: CUDA_ARRAY3D_CUBEMAP = 4             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2771
 * cdef enum: CUDA_ARRAY3D_CUBEMAP = 4
 * 
 * cdef enum: CUDA_ARRAY3D_TEXTURE_GATHER = 8             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2773
 * cdef enum: CUDA_ARRAY3D_TEXTURE_GATHER = 8
 * 
 * cdef enum: CUDA_ARRAY3D_DEPTH_TEXTURE = 16             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2775
 * cdef enum: CUDA_ARRAY3D_DEPTH_TEXTURE = 16
 * 
 * cdef enum: CUDA_ARRAY3D_COLOR_ATTACHMENT = 32             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2777
 * cdef enum: CUDA_ARRAY3D_COLOR_ATTACHMENT = 32
 * 
 * cdef enum: CUDA_ARRAY3D_SPARSE = 64             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2779
 * cdef enum: CUDA_ARRAY3D_SPARSE = 64
 * 
 * cdef enum: CUDA_ARRAY3D_DEFERRED_MAPPING = 128             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2781
 * cdef enum: CUDA_ARRAY3D_DEFERRED_MAPPING = 128
 * 
 * cdef enum: CU_TRSA_OVERRIDE_FORMAT = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2783
 * cdef enum: CU_TRSA_OVERRIDE_FORMAT = 1
 * 
 * cdef enum: CU_TRSF_READ_AS_INTEGER = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2785
 * cdef enum: CU_TRSF_READ_AS_INTEGER = 1
 * 
 * cdef enum: CU_TRSF_NORMALIZED_COORDINATES = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2787
 * cdef enum: CU_TRSF_NORMALIZED_COORDINATES = 2
 * 
 * cdef enum: CU_TRSF_SRGB = 16             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2789
 * cdef enum: CU_TRSF_SRGB = 16
 * 
 * cdef enum: CU_TRSF_DISABLE_TRILINEAR_OPTIMIZATION = 32             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2791
 * cdef enum: CU_TRSF_DISABLE_TRILINEAR_OPTIMIZATION = 32
 * 
 * cdef enum: CU_TRSF_SEAMLESS_CUBEMAP = 64             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2793
 * cdef enum: CU_TRSF_SEAMLESS_CUBEMAP = 64
 * 
 * cdef enum: CU_LAUNCH_PARAM_END_AS_INT = 0             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2795
 * cdef enum: CU_LAUNCH_PARAM_END_AS_INT = 0
 * 
 * cdef enum: CU_LAUNCH_PARAM_END = 0             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2797
 * cdef enum: CU_LAUNCH_PARAM_END = 0
 * 
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_POINTER_AS_INT = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2799
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_POINTER_AS_INT = 1
 * 
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_POINTER = 1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2801
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_POINTER = 1
 * 
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_SIZE_AS_INT = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2803
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_SIZE_AS_INT = 2
 * 
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_SIZE = 2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2805
 * cdef enum: CU_LAUNCH_PARAM_BUFFER_SIZE = 2
 * 
 * cdef enum: CU_PARAM_TR_DEFAULT = -1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2807
 * cdef enum: CU_PARAM_TR_DEFAULT = -1
 * 
 * cdef enum: CU_DEVICE_CPU = -1             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2809
 * cdef enum: CU_DEVICE_CPU = -1
 * 
 * cdef enum: CU_DEVICE_INVALID = -2             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2811
 * cdef enum: CU_DEVICE_INVALID = -2
 * 
 * cdef enum: MAX_PLANES = 3             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":2813
 * cdef enum: MAX_PLANES = 3
 * 
 * cdef enum: CUDA_EGL_INFINITE_TIMEOUT = 4294967295             # <<<<<<<<<<<<<<
 */
...
/* "cuda/bindings/cydriver.pxd":1734
 *     CU_EGL_FRAME_TYPE_PITCH = 1
 * 
 * ctypedef CUeglFrameType_enum CUeglFrameType             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1740
 *     CU_EGL_RESOURCE_LOCATION_VIDMEM = 1
 * 
 * ctypedef CUeglResourceLocationFlags_enum CUeglResourceLocationFlags             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1859
...
/* "cuda/bindings/cydriver.pxd":1861
 * ctypedef CUeglColorFormat_enum CUeglColorFormat
 * 
 * cdef union anon_union11:             # <<<<<<<<<<<<<<
 *     CUarray pArray[3]
...
/* "cuda/bindings/cydriver.pxd":1865
 *     void* pPitch[3]
 * 
 ...
 */
struct __pyx_t_4cuda_8bindings_8cydriver_CUeglFrame_st {
  union __pyx_t_4cuda_8bindings_8cydriver_anon_union11 frame;
  unsigned int width;
  unsigned int height;
  unsigned int depth;
  unsigned int pitch;
...
/* "cuda/bindings/cydriver.pxd":1877
 *     CUarray_format cuFormat
 * 
...
/* "cuda/bindings/cydriver.pxd":1879
 * ctypedef CUeglFrame_st CUeglFrame_v1
 * 
 * ctypedef CUeglFrame_v1 CUeglFrame             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1884
...
/* "cuda/bindings/cydriver.pxd":1891
...
/* "cuda/bindings/cydriver.pxd":1898
...
/* "cuda/bindings/cydriver.pxd":1907
 *     cdef struct void:
 *         pass
...
/* "cuda/bindings/cydriver.pxd":1912
 *     cdef struct void:
 *         pass
 * ctypedef void* EGLStreamKHR             # <<<<<<<<<<<<<<
 * 
...
/* "cuda/bindings/cydriver.pxd":1919
 *     cdef struct void:
 *         pass
 * ctypedef void* EGLSyncKHR             # <<<<<<<<<<<<<<
 * 
