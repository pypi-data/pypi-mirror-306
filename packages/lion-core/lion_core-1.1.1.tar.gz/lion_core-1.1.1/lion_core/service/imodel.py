...
from lion_core.service.service import Service
from lion_core.service.service_match_util import (
    match_parameters,
    match_service,
    match_task_method,
)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(provider, str):
            ...
            raise ValueError(
                "Invalid provider. Please provide a valid provider"
                " name or valid service object."
            )
        ...
        if len(task_method_list) == 0:
            raise ValueError(
                ...
                "Please refer to the service provider's API to"
        ...
        try:
            ...
            raise ValueError(
                f"{self.task} requires the following to be"
                f" provided as input: {e}."
            )
