...
from lion_core.integrations.ollama_.api_endpoints.api_request import (
    OllamaRequest,
)
from lion_core.integrations.ollama_.api_endpoints.chat_completion.request_body import (
    OllamaChatCompletionRequestBody,
)
from lion_core.integrations.ollama_.api_endpoints.completion.request_body import (
    OllamaCompletionRequestBody,
)
from lion_core.integrations.ollama_.api_endpoints.data_models import (
    OllamaEndpointRequestBody,
)
from lion_core.integrations.ollama_.api_endpoints.embedding.request_body import (
    OllamaEmbeddingRequestBody,
)
from lion_core.integrations.ollama_.api_endpoints.match_response import (
    match_response,
)
from lion_core.service.rate_limiter import RateLimiter
from lion_core.service.service_util import invoke_retry
from lion_core.service.token_calculator import TokenCalculator
...
class OllamaModel(BaseModel):
    ...
    def parse_input(cls, data: dict):
        ...
        if not data.get("text_token_calculator"):
            try:
                from lion_core.service.token_calculator import (
                    TiktokenCalculator,
                )
