...
from lion_core.funcs.parse import to_str
...
class Instruction(RoledMessage):
    ...
    def update_instruction(
        self, instruction: JsonValue = None, plain_content: JsonValue = None
    ) -> None:
        """
    ...
    def update_guidance(self, guidance: JsonValue) -> None:
        """
    ...
    def update_request_fields(self, request_fields: JsonValue) -> None:
        """
