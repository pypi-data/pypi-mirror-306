...
from lion_core.abc import BaseManager, Observable
from lion_core.communication.mail import Mail, Package, PackageCategory
...
from lion_core.types import ID, LnID
...
class MailManager(BaseManager):
    ...
    def delete_source(self, source_id: LnID) -> None:
        """
    ...
    def collect(self, sender: LnID) -> None:
    ...
    def send(self, recipient: LnID) -> None:
