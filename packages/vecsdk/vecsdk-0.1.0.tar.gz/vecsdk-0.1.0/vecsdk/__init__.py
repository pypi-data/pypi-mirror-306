...
from protofiles.vectorization_pb2 import VectorizeRequestSet, KeyValuePairSet, KeyValuePair, StringOrFloatValue, Setting
from protofiles.vectorization_pb2_grpc import VectorizationServiceStub
...
class VectorizationServer:
    ...
    def __call__(self, data: dict, index: str = "", settings: VectorizationSettings = VectorizationSettings()) -> VectorGroup:
