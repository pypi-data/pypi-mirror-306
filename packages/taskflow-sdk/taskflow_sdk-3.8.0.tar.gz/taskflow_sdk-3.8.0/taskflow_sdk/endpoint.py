...
with warnings.catch_warnings():
    ...
    from taskflow_sdk.cli.arguments import add_endpoint_arguments
    from taskflow_sdk.constants import DEFAULT_KEEP_ALIVE_TIMEOUT, DEFAULT_SERVER_PORT
    from taskflow_sdk.executor import ActionExecutor
    from taskflow_sdk.interfaces import ActionExecutionRejection, ActionNotFoundException
    from taskflow_sdk.plugin import plugin_manager
    from taskflow_sdk.tracing.utils import get_tracer_and_context, set_span_attributes
...
def create_app(
    ...
    """
    app = Sanic("taskflow_sdk", configure_logging=False)
