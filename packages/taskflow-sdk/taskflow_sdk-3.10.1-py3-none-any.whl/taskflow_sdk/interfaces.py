...
if typing.TYPE_CHECKING:  # pragma: no cover
    from taskflow_sdk.executor import CollectingDispatcher
    from taskflow_sdk.types import DomainDict, TrackerState
...
class Tracker:
    ...
    def slots_to_validate(self) -> Dict[Text, Any]:
        ...
        for event in reversed(self.events):
            # The `FormAction` in Taskflow Open Source will append all slot candidates
    ...
    async def run(
        ...
        Args:
            ...
            tracker: the state tracker for the current
                ...
                `taskflow_sdk.Tracker` property.
            domain: the bot's domain
        Returns:
            A dictionary of `taskflow_sdk.events.Event` instances that is
...
class ActionMissingDomainException(Exception):
    ...
    def __init__(self, action_name: Text, message: Optional[Text] = None) -> None:
        ...
        self.message = (
            ...
            "https://taskflow.com/docs/taskflow-pro/action-server/"
        )
