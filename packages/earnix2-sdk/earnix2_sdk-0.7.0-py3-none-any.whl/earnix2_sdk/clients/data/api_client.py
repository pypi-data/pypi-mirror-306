...
import earnix2_sdk.clients.data.models
from earnix2_sdk.clients.data import rest
from earnix2_sdk.clients.data.api_response import ApiResponse
from earnix2_sdk.clients.data.api_response import T as ApiResponseT
from earnix2_sdk.clients.data.configuration import Configuration
from earnix2_sdk.clients.data.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(earnix2_sdk.clients.data.models, klass)
