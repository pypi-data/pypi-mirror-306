...
class S3Connection(Connection):
    ...
    access_key_id: Annotated[str, Field(min_length=16, strict=True, max_length=128)] = (
        Field(alias="accessKeyId")
    )
    secret_access_key: Annotated[
        str, Field(min_length=16, strict=True, max_length=1024)
    ] = Field(alias="secretAccessKey")
    endpoint: Annotated[str, Field(strict=True, max_length=500)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3Connection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3Connection from a dict"""
        if obj is None:
            return None
