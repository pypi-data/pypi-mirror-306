...
class SemanticChange(BaseModel):
    summary: Optional[str] = Field(
        default=None,
        description="Very short summary of the semantic change, including the high-level change summary and the column name.",
    )
    description: str = Field(
        ...,
        description="Provides a one-sentence description explaining the meaning change.",
    )
    field: Optional[str] = Field(
        default=None, description="The field name that has changed."
    )
...
class CheckDataAssetNoContractResponse(BaseModel):
    ...
    semanticChanges: Optional[List[SemanticChange]] = None
...
class SqlQueries(BaseModel):
    old: str = Field(..., description="The old sql used to generate the asset")
    new: str = Field(..., description="The new sql used to generate the asset")
...
class PySparkAsset(BaseModel):
    ...
    sql_queries: Optional[SqlQueries] = Field(
        default=None, description="The old and new sql used to generate the asset"
    )
