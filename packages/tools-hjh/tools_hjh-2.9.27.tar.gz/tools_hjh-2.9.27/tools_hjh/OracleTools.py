...
def main():
    s = "nvl(to_number(to_char(sysdate,'yyyymmdd')),'')"
    fun = 'nvl'
    rs = get_fun_content(s, fun)
    print(rs)
            ...
            if col['default_value'] != None:
                ...
                if col['virtual'] == 'NO':
                    ...
                    for col in metadata['columns']:
                        ...
                        if '"' + col_name.upper() + '"' in str(col['default_value']):
                            col['default_value'] = col['default_value'].replace(col_name.upper(), col_name.lower())
