...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72714);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(93414),
    __webpack_require__(75864),
  ...
  let baseMods = [
      __webpack_require__(13723),
  __webpack_require__(40410),
  __webpack_require__(87060),
  __webpack_require__(84553),
  __webpack_require__(51525),
  __webpack_require__(39282),
  __webpack_require__(63960),
  
      (__webpack_require__(98769)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(73841)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(66015),
  
      (__webpack_require__(299)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(30306)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(71488)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(74596)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(81479)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(54525)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(67634)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(30315),
  __webpack_require__(45631),
  __webpack_require__(6686),
  
      (__webpack_require__(55940)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(28912),
  __webpack_require__(15912),
  __webpack_require__(11203),
  
      (__webpack_require__(23011)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(28378),
  __webpack_require__(28535),
  __webpack_require__(28508),
  __webpack_require__(20568),
  __webpack_require__(74716),
  __webpack_require__(81004),
  __webpack_require__(2952),
  __webpack_require__(73427),
  __webpack_require__(89107),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(50512),
  
      (__webpack_require__(25945)["default"].filter)(({id}) => [
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(81996),
  __webpack_require__(98528),
  
      (__webpack_require__(92289)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(30829)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(67456)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(59729).NotebookApp);
...
//# sourceMappingURL=8781.9e8a12a243dae2c0f2d4.js.map?v=9e8a12a243dae2c0f2d4