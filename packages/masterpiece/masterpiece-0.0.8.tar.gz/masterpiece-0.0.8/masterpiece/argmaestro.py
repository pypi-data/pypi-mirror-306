...
class ArgMaestro:
    ...
    of the registered classes. Each startup argument is of form '--classname_attrname'.
    Note: currently supports only int, str, bool and float.
    """
    ...
    def add_class_arguments(self, clazz: Type[MasterPiece]) -> None:
        ...
        for attr, attr_type in type_hints.items():
            if not attr.startswith("_") and not callable(getattr(clazz, attr, None)):
        ...
        for class_name, clazz in self.args.items():
            ...
            for arg, value in args_dict.items():
                ...
                if arg.startswith(prefix):
                    ...
                    # print(f"parsed arg {arg}, value {value}")
