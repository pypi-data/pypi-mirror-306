...
class CopyToPg(CopyTo):
    ...
    Class to insert data into a PostgreSQL table using asynchronous copy functionality.
        ...
        if self.truncate is True:
            ...
            while retry_count <= max_retries:
                try:
                    ...
                    if "canceling statement due to statement timeout" in str(e) or "another operation is in progress" in str(e):
                        retry_count += 1
