...
class TestIndexes:
    ...
    def test_method_create(self, client: Objective) -> None:
        index = client.indexes.create(
            configuration={"fields": {"searchable": {"allow": ["string", "string", "string"]}}},
        )
    ...
    def test_method_create_with_all_params(self, client: Objective) -> None:
        index = client.indexes.create(
            configuration={
                "fields": {
                    "searchable": {"allow": ["string", "string", "string"]},
                    "crawlable": {"allow": ["string", "string", "string"]},
                    "fast_filters": ["string", "string", "string"],
                    "filterable": {"allow": ["string", "string", "string"]},
    ...
    def test_method_finetune(self, client: Objective) -> None:
        index = client.indexes.finetune(
            index_id="idx_123",
            feedback=[{"query": "query"}, {"query": "query"}, {"query": "query"}],
        )
