...
class TargetComponents(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["component_categories", b"component_categories", "component_ids", b"component_ids", "components", b"components"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["component_categories", b"component_categories", "component_ids", b"component_ids", "components", b"components"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["components", b"components"]) -> typing.Literal["component_ids", "component_categories"] | None: ...
