...
from chalk.utils.duration import CHALK_MAX_TIMEDELTA, Duration, parse_chalk_duration_s
...
def group_by_windowed(
    *buckets: str,
    ...
    See more at https://docs.chalk.ai/docs/aggregations#grouped-materialized-window-aggregations
