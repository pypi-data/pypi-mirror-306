...
"""
    ...
    def _supplemental_validate_underscore_expression(
        ...
        *,
        ...
        """
        local_features_by_name: Optional[Dict[str, Feature[Any, Any]]] = None

        def get_local_features_by_name() -> Dict[str, Feature[Any, Any]]:
            nonlocal local_features_by_name
            if local_features_by_name is not None:
                return local_features_by_name
            local_features_by_name = {}
        ...
        if isinstance(underscore, UnderscoreAttr) and isinstance(underscore._chalk__parent, UnderscoreRoot):
            ...
            if underscore._chalk__attr not in get_local_features_by_name():
        ...
        if isinstance(underscore, UnderscoreBinaryOp):
            self._supplemental_validate_underscore_expression(
