...
class FovusApiAdapter:
    ...
    def make_dynamic_changes_to_create_job_request(self, request, is_silenced: bool):
        ...
        self._confirm_enable_preemptible_support(request, is_silenced)

    def _confirm_enable_preemptible_support(self, request, is_silenced: bool):
