...
class InsertIntoS3Cmd(AbstractSql):
    ...
    def _get_s3_cmd(self, key_id: str = '*', secret: str = '*') -> str:
        ...
        return f"""s3('{url}', '{key_id}', '{secret}', '{file_format}', '{compression}')"""

    def to_sql(self) -> str:
        s3_cmd = self._get_s3_cmd(self._s3_settings.access_key_id, self._s3_settings.secret_access_key)
...
class InsertFromS3Cmd(AbstractSql):
    ...
    def to_sql(self) -> str:
        ...
        s3_cmd = self._get_s3_cmd(key_id, secret)
