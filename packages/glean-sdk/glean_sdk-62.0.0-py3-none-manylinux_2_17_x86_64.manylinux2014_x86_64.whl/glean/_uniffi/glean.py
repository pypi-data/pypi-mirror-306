...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_glean_core_checksum_constructor_objectmetric_new() != 21012:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_pingtype_new() != 4622:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class PingType:
    _pointer: ctypes.c_void_p
    def __init__(self, name: "str",include_client_id: "bool",send_if_empty: "bool",precise_timestamps: "bool",include_info_sections: "bool",enabled: "bool",schedules_pings: "typing.List[str]",reason_codes: "typing.List[str]"):
