...
setup(
    name='lzx_pypi_test',  # 必填，项目的名字，用户根据这个名字安装，pip install SpiderKeeper-new
    version='1.1.0',  # 必填，项目的版本，建议遵循语义化版本规范
    author='lzx1728',  # 项目的作者
    ...
    author_email='282814234@qq.com',  # 作者的有效邮箱地址
