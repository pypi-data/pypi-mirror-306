...
To see only the selected ones in the `message_ids` tree view of the
helpdesk tickets form view.
...
The buttons to filter the messages are found in the top of the
`message_ids`, with icons representing the three diferent types of
messages. Keep selected those you want to see, and unselect the ones you
want to hide.
