...
def lif_schema_from_dict(s: Any) -> LIFSchema:
    return LIFSchema.from_dict(s)


def lif_schema_to_dict(x: LIFSchema) -> Any:
    return to_class(LIFSchema, x)
