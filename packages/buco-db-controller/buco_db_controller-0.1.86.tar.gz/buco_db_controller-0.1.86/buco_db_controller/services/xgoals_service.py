...
class XGoalsService:
    ...
    def get_xgoals_over_season(self, team_id: int, league_id: int, season: int, calc: str = 'avg') -> list[XGoals]:
    ...
    def get_h2h_xgoals(self, team1_id: int, team2_id: int, league_id: int, season: int, calc: str = 'avg') -> list[XGoals]:
