...
class Paths: 
    ...
    ## directory that this software/repo is in
    ## not necessarily the same as user's current path 
    MAIN = os.path.dirname(os.path.abspath(__file__)) 

    SOFTWARE = f'{MAIN}/software'
    MODELS = f'{MAIN}/models' 

class Scripts: 

    PLINK2 = f'{Paths.SOFTWARE}/plink2'
    BGENIX = f'{Paths.SOFTWARE}/bgen/build/apps/bgenix'
    GWAS = f'{Paths.SOFTWARE}/regenie/regenie'

    SUMMARY_TWAS = f'{Paths.SOFTWARE}/MetaXcan/software/SPrediXcan.py'
    GENOTYPE_TWAS = f'{Paths.SOFTWARE}/MetaXcan/software/PrediXcanAssociation.py'
    GREX_PREDICTION = f'{Paths.SOFTWARE}/MetaXcan/software/Predict.py'

    FUS_LDSC = f'{Paths.SOFTWARE}/ldsc/munge_sumstats.py'
    FUS_TWAS = f'{Paths.SOFTWARE}/fusion_twas/FUSION.assoc_test.R'
