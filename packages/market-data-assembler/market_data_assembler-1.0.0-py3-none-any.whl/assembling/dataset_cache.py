...
from assembling.aggregation_config import AggregationConfigInstance
...
class DatasetCache:
    ...
    def __init__(self,
                 ...
                 aggregations: List[AggregationConfigInstance],
    ...
    def _get_short_info(self):
        return (f"from: {self.day_from.strftime('%Y-%m-%d')}, "
                ...
                f"aggregations: {[aggregator.get_info() for aggregator in self.aggregations]}, "
