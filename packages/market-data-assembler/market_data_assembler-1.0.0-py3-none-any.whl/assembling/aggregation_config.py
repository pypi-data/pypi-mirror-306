...
from aggregator.ohlc_aggregator import OHLCAggregator
...
class AggregationConfigInstance:
    ...
    @staticmethod
    def find_main_aggregation_config(instances: List['AggregationConfigInstance']) -> 'AggregationConfigInstance':
