...
vector_database_trafaret = t.Dict(
    {
        ...
        t.Key("metada_columns", optional=True, default=None): t.Or(t.Null, t.List(t.String)),
...
class VectorDatabase(APIObject):
    ...
    def __init__(
        ...
        metada_columns: Optional[List[str]],
        ...
        self.metada_columns = metada_columns
