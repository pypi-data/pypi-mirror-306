...
evaluation_dataset_metric_aggregation_trafaret = t.Dict(
    {
        ...
        t.Key("dataset_name"): t.Or(t.String, t.Null),
        t.Key("chat_id"): t.String,
        t.Key("chat_name"): t.String,
...
class EvaluationDatasetMetricAggregation(APIObject):
    ...
    def create(
        ...
        return response_data.json()["job_id"]
    ...
    def list(
        ...
        current_configuration_only : bool, optional
        ...
        non_errored_only : bool, optional
