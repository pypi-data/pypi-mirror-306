...
class _RealtimeOrPromptBase(FeatureView):
    ...
    def _use_feature_param(self) -> bool:
        ...
        return bool(self._args.realtime_args.attributes) or bool(self._args.realtime_args.calculations)
...
class RealtimeFeatureView(_RealtimeOrPromptBase):
        ...
        if schema:
            ...
            for feature in features:
                if isinstance(feature, Attribute):
                    ...
                    realtime_args.calculations.append(feature._to_proto(input_schema))
                else:
    ...
    def _get_schemas(self) -> _Schemas:
        if self._use_feature_param():
            ...
            calculation_schema = {
                calculation.name: data_types.data_type_from_proto(calculation.column_dtype)
