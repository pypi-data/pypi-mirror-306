...
class Inference(_message.Message):
    ...
    tags: _containers.ScalarMap[str, str]
    def __init__(self, input_columns: _Optional[_Iterable[_Union[_schema__client_pb2.Column, _Mapping]]] = ..., output_column: _Optional[_Union[_schema__client_pb2.Column, _Mapping]] = ..., model_artifact: _Optional[_Union[_model_artifact_service__client_pb2.ModelArtifactInfo, _Mapping]] = ..., description: _Optional[str] = ..., tags: _Optional[_Mapping[str, str]] = ...) -> None: ...
