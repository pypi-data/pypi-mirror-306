...
class TransformServerGroupState(_message.Message):
    ...
    TSG_SERVICE_ACCOUNT_SECRET_KEY_FIELD_NUMBER: _ClassVar[int]
    autoscaling_policy: AutoscalingPolicy
    environment_id: str
