...
class DeltaMaintenanceParameters(_message.Message):
    ...
    def __init__(self, generate_manifest: bool = ..., period_end: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., execute_compaction: bool = ..., vacuum: bool = ..., execute_sorting: bool = ..., vacuum_retention_hours: _Optional[int] = ...) -> None: ...
