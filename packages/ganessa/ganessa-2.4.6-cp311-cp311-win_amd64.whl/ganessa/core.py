...
#****f* Functions/cmd, addcmdw, execute_, cmdfile
# SYNTAX
#   * istat = cmd(scmd)
...
#   * string id: id of the next element in the selection
#   * tupe of float or str retvals: values of the attributes for the pipe (as many as attributes in attrs)
# HISTORY
...
#****f* Functions/linkattr, nodeattr, tankattr, linkattrs, nodeattrs, tankattrs, attr_, attrs_, meanattr, linkattrv, tankattrv
# PURPOSE
