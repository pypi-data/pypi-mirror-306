...
"""
Fuzzy is a method of partial approximation and quantifying a logic
based on the same. The logic can also be applied to sequences of
string to find an approximate solution - like scoring two sequences
