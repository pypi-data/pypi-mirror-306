...
import logging, socket, requests, json, sysconfig, os, etiket_client
...
def authenticate_with_console() -> None:
    ...
    if not auth_methods:
        print("Failed to retrieve institutions and associated auth methods. Please try again later.")
        return
