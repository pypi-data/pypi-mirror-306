...
[![PyPI](https://img.shields.io/pypi/v/byteapp_akt.svg)](https://pypi.org/project/byteapp_akt/)
[![Downloads](https://pepy.tech/badge/byteapp_akt)](https://pepy.tech/project/byteapp_akt)
[![Documentation Status](https://readthedocs.org/projects/byteapp_akt/badge/)](https://byteapp_akt.akfamily.xyz/)
[![Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
[![byteapp_akt](https://img.shields.io/badge/Data%20Science-AKShare-green)](https://github.com/akfamily/byteapp_akt)
[![Actions Status](https://github.com/akfamily/byteapp_akt/workflows/build/badge.svg)](https://github.com/akfamily/byteapp_akt/actions)
[![MIT Licence](https://img.shields.io/badge/license-MIT-blue)](https://github.com/akfamily/byteapp_akt/blob/master/LICENSE)
[![](https://img.shields.io/github/forks/akfamily/byteapp_akt)](https://github.com/akfamily/byteapp_akt)
[![](https://img.shields.io/github/stars/akfamily/byteapp_akt)](https://github.com/akfamily/byteapp_akt)
[![](https://img.shields.io/github/issues/akfamily/byteapp_akt)](https://github.com/akfamily/byteapp_akt)
...
[AKTools](https://github.com/akfamily/byteapp_akt) 是一款用于快速搭建 [AKShare](https://github.com/akfamily/byteapp_ak) HTTP API 的工具，通过 [AKTools](https://github.com/akfamily/byteapp_akt)
可以利用一行命令来启动 HTTP 服务，从而让原本专属服务于 Python 用户的开源财经数据接口库 [AKShare](https://github.com/akfamily/byteapp_ak) 的使用
突破编程语言的限制。无论您使用的是 C/C++、Java、Go、Rust、Ruby、PHP、JavaScript、R、Matlab、Stata 等编程语言或软件都可以快速、轻松获取财经数据，助力您更好地展开研究和开发工作。

**[AKTools 中文文档](https://byteapp_akt.readthedocs.io/)**

## Installation

```shell
pip install byteapp_akt
```

## Upgrade

```shell
pip install byteapp_akt --upgrade -i https://pypi.org/simple  # AKTools's version should great than 0.0.70
```

## AKShare

[Please visit AKShare's Documentation](https://byteapp_ak.akfamily.xyz/)
...
1. just type the cmd/bash command: `python -m byteapp_akt`
