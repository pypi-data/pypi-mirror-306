...
mb.add_agent(
    agt_type_class="Diversion_AgType",
    agt_name="DivAgt",
    api=mb.api.RiverDiv,
...
hydrocnhs.write_model(
    model_best, os.path.join(ga.cali_wd, "Best_HydroABMModel_gwlf_KGE.yaml")
)
