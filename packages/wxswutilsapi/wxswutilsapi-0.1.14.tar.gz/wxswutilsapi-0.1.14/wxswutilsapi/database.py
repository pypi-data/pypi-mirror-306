...
class database:
    ...
    def query_table_with_time_diff(db_path, table_name, filter_time, limit=20, max_minutes=30, fields=None):
        """
        查询表中的数据，按照时间差过滤并返回结果。
        ...
        # 执行查询
        cursor.execute(sql, (filter_time, max_minutes, filter_time, limit))
