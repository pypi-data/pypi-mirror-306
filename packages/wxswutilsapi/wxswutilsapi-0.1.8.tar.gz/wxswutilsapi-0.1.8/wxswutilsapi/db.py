...
DATABASE = "your_database.db"  # 这里替换为实际的数据库文件名
            ...
            "fields": [
                {
                    ...
                    "is_auto_increment": 是否为自增主键（True/False，仅用于INTEGER类型字段）
                },
              ...
            ],
            "FOREIGNKEY": [
        ...
        with sqlite3.connect(DATABASE) as conn:
            ...
            for table_def in table_definitions:
                ...
                for field in fields:
                    ...
                    is_auto_increment = "AUTOINCREMENT" if field["is_auto_increment"] else ""
