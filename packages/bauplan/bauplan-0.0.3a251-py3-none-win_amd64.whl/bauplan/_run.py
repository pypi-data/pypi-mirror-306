...
from ._bpln_proto.commander.service.v2.subscribe_runner_pb2 import RunnerInfo
from ._common import (
    BAUPLAN_VERSION,
    CLIENT_HOSTNAME,
    Constants,
...
def _handle_log_stream(
    state: GenericState,
    log_stream: Iterable[RunnerInfo],
    debug: Optional[bool],
    verbose: Optional[bool],
) -> GenericState:
...
class _Run(_OperationContainer):
    ...
    def rerun(
        ...
        job = JobId(id=plan_response.job_response_common.job_id)
