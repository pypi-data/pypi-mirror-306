...
class OpenPipeApi:
    ...
    def get_criterion_judgement(
        self, *, criterion_id: str, input: GetCriterionJudgementRequestInput, output: GetCriterionJudgementRequestOutput
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=jsonable_encoder({"criterion_id": criterion_id, "input": input, "output": output}),
            headers=self._client_wrapper.get_headers(),
            timeout=240,
        )
        if 200 <= _response.status_code < 300:
