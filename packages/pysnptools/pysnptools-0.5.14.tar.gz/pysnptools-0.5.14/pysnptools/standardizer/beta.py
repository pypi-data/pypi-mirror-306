...
class Beta(Standardizer):
    ...
    **Constructor:**
    ...
    def standardize(
        ...
        num_threads=None,
    ):  # !!!later why is the 2nd argument called 'snpdata' here, but 'snps' in unit.py?
        ...
        stats = self._standardize_unit_and_beta(
            val,
            is_beta=True,
            a=self.a,
            b=self.b,
        ...
        if return_trained:
            ...
            assert hasattr(
                snpdata, "val"
            ), "return_trained=True must be used with SnpData"
