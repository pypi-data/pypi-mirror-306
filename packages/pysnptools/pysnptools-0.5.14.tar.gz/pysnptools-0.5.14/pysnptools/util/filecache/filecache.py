...
class FileCache(object):
    ...
    def _fixup(cache_value, default_subfolder="filecache"):
        ...
        raise Exception(
            "Do not know how to make a FileCache from '{0}'".format(cache_value)
        )
    ...
    def open_write(self, file_name, size=0, updater=None):
        ...
        """
        directory, simple_file_name = self._split(file_name)
        return directory._simple_open_write(
...
if __name__ == "__main__":
    ...
    if False:
        ...
        file_cache = PeerToPeer(
            common_directory="peertopeer1/common",
