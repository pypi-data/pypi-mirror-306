...
from buildgrid.server.enums import LogRecordLevel, MetricCategories, OperationStage
from buildgrid.server.exceptions import PermissionDeniedError
...
class Server:
    ...
    def _publish_scheduler_metrics_for_instance(self, instance_name: str) -> None:
        with instance_context(instance_name):
            ...
            # Jobs
            for stage_value, n_jobs in scheduler_metrics[MetricCategories.JOBS.value].items():
                stage = OperationStage(stage_value)
