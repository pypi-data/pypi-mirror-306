...
def create_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument('connections', type=connection, nargs='?', default=connection('external,any'), help=f'a comma separated list of connections which should be considered for activation: {possible_connections}')
