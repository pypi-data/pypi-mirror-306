...
class DatasetsApi:
    ...
    @validate_arguments
    def datasets_controller_append_to_array_field(self, pid : Annotated[StrictStr, Field(..., description="Id of the dataset to be modified")], field_name : Annotated[StrictStr, Field(..., description="Name of the field to be updated")], data : Annotated[conlist(StrictStr), Field(..., description="Json object with the fields to be updated and their values")], **kwargs) -> DatasetClass:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_create(self, datasets_controller_create_request : Annotated[DatasetsControllerCreateRequest, Field(..., description="Input fields for the dataset to be created")], **kwargs) -> DatasetClass:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_find_by_id(self, pid : Annotated[StrictStr, Field(..., description="Id of the dataset to return")], **kwargs) -> DatasetClass:  # noqa: E501
    ...
    @validate_arguments
    def datasets_controller_find_by_id_and_update(self, pid : Annotated[StrictStr, Field(..., description="Id of the dataset to modify")], datasets_controller_find_by_id_and_update_request : Annotated[DatasetsControllerFindByIdAndUpdateRequest, Field(..., description="Fields that needs to be updated in the dataset. Only the fields that needs to be updated have to be passed in.")], **kwargs) -> DatasetClass:  # noqa: E501
