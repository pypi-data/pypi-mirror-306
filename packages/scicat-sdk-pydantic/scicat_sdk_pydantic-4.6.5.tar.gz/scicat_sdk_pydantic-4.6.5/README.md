...
import time
import scicat-sdk-pydantic
from scicat-sdk-pydantic.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = scicat-sdk-pydantic.Configuration(
    host = "http://localhost"
)
...
with scicat-sdk-pydantic.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = scicat-sdk-pydantic.AdminApi(api_client)
