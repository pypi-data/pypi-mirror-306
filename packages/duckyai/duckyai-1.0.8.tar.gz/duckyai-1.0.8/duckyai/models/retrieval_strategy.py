...
class RetrievalStrategy(BaseModel):
    ...
    store_type: StrictStr = Field(description="vector or full_text")
    ...
    __properties: ClassVar[List[str]] = ["k", "store_type", "alpha", "rerank"]

    @field_validator('store_type')
    def store_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['vector', 'full_text']):
            raise ValueError("must be one of enum values ('vector', 'full_text')")
        return value
