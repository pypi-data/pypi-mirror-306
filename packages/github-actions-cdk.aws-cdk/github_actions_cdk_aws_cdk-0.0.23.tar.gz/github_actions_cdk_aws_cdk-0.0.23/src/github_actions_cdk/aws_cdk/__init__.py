...
class AwsCdkAdapter(
    ...
    def __init__(
        ...
        *,
        ...
        skip_diff_protection: typing.Optional[builtins.bool] = None,
        ...
        :param additional_checks: (experimental) Enables additional checks, such as version verification for external actions. Default: false
        :param continue_on_error_annotations: (experimental) Allows continuation on error annotations if set to true. Default: false
        :param outdir: (experimental) Directory for storing synthesized workflow files. Default: "./.github/workflows"
        :param skip_diff_protection: (experimental) Skips protection against workflow file diffs if set to true. Default: false
        :param skip_validation: (experimental) Skips workflow validation if set to true. Default: false
        ...
        props = _github_actions_cdk_5328d874.ProjectProps(
            ...
            outdir=outdir,
            skip_diff_protection=skip_diff_protection,
...
class AwsCredentials(
    ...
    def from_git_hub_secrets(
        ...
        *,
        ...
        :param access_key_id: (experimental) The name of the GitHub secret that holds the AWS access key ID. Defaults to "AWS_ACCESS_KEY_ID".
        :param secret_access_key: (experimental) The name of the GitHub secret that holds the AWS secret access key. Defaults to "AWS_SECRET_ACCESS_KEY".
        :param session_token: (experimental) The name of the GitHub secret that holds the AWS session token, if applicable.
    ...
    def from_open_id_connect(
        ...
        *,
        ...
        :param role_session_name: (experimental) Optional role session name to use when assuming the role.
...
class AwsCredentialsProvider(
    ...
    '''(experimental) Abstract base class representing a provider for AWS credentials.
    ...
    def credential_steps(
        ...
        '''(experimental) Generates steps to configure AWS credentials for a GitHub Actions job.
    ...
    def permission_level(self) -> _github_actions_cdk_5328d874.PermissionLevel:
        ...
        :return: The permission level that this provider requires.
...
@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.CustomProviderProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CustomProviderProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties required for a custom Docker registry.

        :param password_key: (experimental) Environment variable key for the registry password.
        :param registry: (experimental) The registry URL.
        :param username_key: (experimental) Environment variable key for the registry username.

        :stability: experimental
        :remarks: Configures the necessary properties for authenticating to a non-standard or third-party Docker registry.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0c607f38a4631538419fb1f17b427fe89c0e0eb7a8afeeb5914e23e0b6fde573)
    ...
    def password_key(self) -> builtins.str:
        '''(experimental) Environment variable key for the registry password.
    ...
    def username_key(self) -> builtins.str:
        '''(experimental) Environment variable key for the registry username.
    ...
    def __repr__(self) -> str:
        return "CustomProviderProps(%s)" % ", ".join(
...
class DockerCredentials(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="@github-actions-cdk/aws-cdk.DockerCredentials",
):
    '''(experimental) Base class for providing Docker credentials to various registry types.
    ...
    def custom_registry(
        ...
        *,
        ...
        '''(experimental) Creates a ``DockerCredentials`` instance for a custom Docker registry.

        :param password_key: (experimental) Environment variable key for the registry password.
        :param registry: (experimental) The registry URL.
        :param username_key: (experimental) Environment variable key for the registry username.

        :return: An instance of ``CustomProvider`` configured with the specified properties.

        :stability: experimental
        '''
        props = CustomProviderProps(
            password_key=password_key, registry=registry, username_key=username_key
        )

        return typing.cast("DockerCredentials", jsii.sinvoke(cls, "customRegistry", [props]))
    ...
    def docker_hub(
        ...
        *,
        ...
        '''(experimental) Creates a ``DockerCredentials`` instance for DockerHub.

        :param personal_access_token_key: (experimental) Environment variable key for the DockerHub access token. Defaults to "DOCKERHUB_TOKEN".
        :param username_key: (experimental) Environment variable key for the DockerHub username. Defaults to "DOCKERHUB_USERNAME".

        :return: An instance of ``DockerHubCredentials`` configured with the specified properties.

        :stability: experimental
        '''
        props = DockerHubCredentialsProps(
            personal_access_token_key=personal_access_token_key,
            username_key=username_key,
        )

        return typing.cast("DockerCredentials", jsii.sinvoke(cls, "dockerHub", [props]))

    @jsii.member(jsii_name="ecr")
    @builtins.classmethod
    def ecr(cls, *, registry: builtins.str) -> "DockerCredentials":
        '''(experimental) Creates a ``DockerCredentials`` instance for AWS ECR.

        :param registry: (experimental) The ECR registry URL, required for connecting to a specific AWS ECR instance.

        :return: An instance of ``EcrCredentials`` configured with the specified properties.

        :stability: experimental
        '''
        props = EcrCredentialsProps(registry=registry)

        return typing.cast("DockerCredentials", jsii.sinvoke(cls, "ecr", [props]))

    @jsii.member(jsii_name="ghcr")
    @builtins.classmethod
    def ghcr(cls) -> "DockerCredentials":
        '''(experimental) Creates a ``DockerCredentials`` instance for GitHub Container Registry (GHCR).

        :return: An instance of ``GhcrCredentials``.

        :stability: experimental
        '''
        return typing.cast("DockerCredentials", jsii.sinvoke(cls, "ghcr", []))
    ...
    def credential_steps(
        ...
        '''(experimental) Returns Docker login steps required for the specified job.

        :param job: - The GitHub Actions job for which Docker login steps are generated.

        :return: An array of ``RegularStep`` instances for Docker authentication.
...
class _DockerCredentialsProxy(DockerCredentials):
    @jsii.member(jsii_name="credentialSteps")
    def credential_steps(
        self,
        job: _github_actions_cdk_5328d874.Job,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__78828d729afa4f9e7cd58aa5af314e4c4a9c80a711d8d1a44546c0bfe9c13d75)
            check_type(argname="argument job", value=job, expected_type=type_hints["job"])
        return typing.cast(typing.List[_github_actions_cdk_5328d874.RegularStep], jsii.invoke(self, "credentialSteps", [job]))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the abstract class
typing.cast(typing.Any, DockerCredentials).__jsii_proxy_class__ = lambda : _DockerCredentialsProxy


@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.DockerHubCredentialsProps",
    jsii_struct_bases=[],
    name_mapping={
...
class DockerHubCredentialsProps:
    def __init__(
        self,
        *,
        personal_access_token_key: typing.Optional[builtins.str] = None,
        ...
        '''(experimental) Properties required for DockerHub credentials.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1c5b9f71b027e48da35cebf0341e118069eaed951709d14c1e5bd257a337ed2a)
    ...
    def personal_access_token_key(self) -> typing.Optional[builtins.str]:
        '''(experimental) Environment variable key for the DockerHub access token.

        Defaults to "DOCKERHUB_TOKEN".
    ...
    def username_key(self) -> typing.Optional[builtins.str]:
        '''(experimental) Environment variable key for the DockerHub username.

        Defaults to "DOCKERHUB_USERNAME".
    ...
    def __repr__(self) -> str:
        return "DockerHubCredentialsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.EcrCredentialsProps",
    jsii_struct_bases=[],
    name_mapping={"registry": "registry"},
)
class EcrCredentialsProps:
    def __init__(self, *, registry: builtins.str) -> None:
        '''(experimental) Properties required for AWS ECR credentials.

        :param registry: (experimental) The ECR registry URL, required for connecting to a specific AWS ECR instance.

        :stability: experimental
        :remarks: Used to configure ECR credentials for authenticating against an AWS Elastic Container Registry.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__22a4849357611326ea438d136088470c2205733181828222780c941c2375f125)
            check_type(argname="argument registry", value=registry, expected_type=type_hints["registry"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "registry": registry,
        }
    ...
    @builtins.property
    def registry(self) -> builtins.str:
        '''(experimental) The ECR registry URL, required for connecting to a specific AWS ECR instance.
    ...
    def __repr__(self) -> str:
        return "EcrCredentialsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class GitHubActionsPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        synth: "Synth",
        build_container: typing.Optional[typing.Union[_github_actions_cdk_5328d874.ContainerOptions, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        docker_credentials: typing.Optional[typing.Sequence[DockerCredentials]] = None,
        ...
        post_publish: typing.Optional["IJobPhase"] = None,
        pre_build: typing.Optional["IJobPhase"] = None,
        pre_publish: typing.Optional["IJobPhase"] = None,
    ) -> None:
        ...
        :param aws_credentials: (experimental) AWS credentials provider for actions requiring AWS authentication.
        :param synth: (experimental) Synthesizer for the CDK application.
        :param build_container: (experimental) Container configuration for the build environment.
        :param concurrency: (experimental) Configuration for concurrency control of workflow runs.
        :param docker_credentials: (experimental) Docker credentials required for registry authentication within the workflow.
        :param job_settings: (experimental) Optional configuration settings for individual jobs within the pipeline.
        :param single_publisher_per_asset_type: (experimental) Enables a single publishing job per asset type within the workflow. Default: false
        :param version_overrides: (experimental) Version overrides for specific GitHub Actions used in the workflow.
        :param workflow_env: (experimental) Environment variables to be included in the workflow.
        :param workflow_filename: (experimental) Name of the generated workflow file (without extension). Default: "deploy"
        :param workflow_name: (experimental) Optional name for the GitHub Actions workflow. Default: "Deploy"
        :param workflow_outdir: (experimental) Directory path where workflow YAML files will be generated. Default: ".github/workflows"
        :param post_build: (experimental) Optional phase for the synth job to execute after the main build steps.
        :param post_publish: (experimental) Optional phase for publish jobs to execute after the main publish steps.
        :param pre_build: (experimental) Optional phase for the synth job to execute before the main build steps.
        :param pre_publish: (experimental) Optional phase for publish jobs to execute before the main publish steps.
    ...
    def add_stage(
        ...
        *,
        ...
        :param job_settings: (experimental) Optional settings to configure the jobs within the stage.
...
class GitHubSecretsProviderProps:
    ...
    def session_token(self) -> typing.Optional[builtins.str]:
        '''(experimental) The name of the GitHub secret that holds the AWS session token, if applicable.
...
@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.JobSettings",
    jsii_struct_bases=[],
    name_mapping={"condition": "condition", "environment": "environment"},
)
class JobSettings:
    def __init__(
        self,
        *,
        ...
        '''(experimental) Settings to configure specific job options in the pipeline workflow.

        :param condition: (experimental) Optional condition that determines if the job should run.
        :param environment: (experimental) Specifies the environment configuration for the job.
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e4441d0cb283cc49379138494e1068837d70d9021a46bfc044746429edb9ecb4)
    ...
    def condition(self) -> typing.Optional[builtins.str]:
        '''(experimental) Optional condition that determines if the job should run.
    ...
    @builtins.property
    def environment(self) -> typing.Optional[_github_actions_cdk_5328d874.Environment]:
        '''(experimental) Specifies the environment configuration for the job.
...
class PipelineJob(
    ...
    def __init__(
        ...
        *,
        ...
        runner: typing.Optional[_github_actions_cdk_5328d874.Runner] = None,
        ...
        :param docker_credentials: (experimental) Docker credentials required for authenticating with Docker registries.
        :param version_overrides: (experimental) Optional version overrides for specific GitHub Actions.
        :param condition: (experimental) Conditional expression to determine if the job should run (equivalent to ``if`` in GitHub Actions). Supports GitHub Actions expressions, e.g., ``${{ success() }}``.
        ...
        :param runner: (experimental) Runner environment, e.g., "ubuntu-latest".
    ...
    def docker_credentials(self) -> typing.Optional[typing.List[DockerCredentials]]:
        '''(experimental) Docker credentials required for registry authentication within the workflow.
        ...
        '''
        return typing.cast(typing.Optional[typing.List[DockerCredentials]], jsii.get(self, "dockerCredentials"))
...
class PipelineJobProps(_github_actions_cdk_5328d874.JobProps):
    ...
    @builtins.property
    def condition(self) -> typing.Optional[builtins.str]:
        '''(experimental) Conditional expression to determine if the job should run (equivalent to ``if`` in GitHub Actions).
    ...
    @builtins.property
    def runner(self) -> typing.Optional[_github_actions_cdk_5328d874.Runner]:
        '''(experimental) Runner environment, e.g., "ubuntu-latest".

        :stability: experimental
        '''
        result = self._values.get("runner")
        return typing.cast(typing.Optional[_github_actions_cdk_5328d874.Runner], result)
    ...
    @builtins.property
    def docker_credentials(self) -> typing.Optional[typing.List[DockerCredentials]]:
        '''(experimental) Docker credentials required for authenticating with Docker registries.
        ...
        return typing.cast(typing.Optional[typing.List[DockerCredentials]], result)
...
@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.PipelinePhases",
    jsii_struct_bases=[],
    name_mapping={
...
class PipelinePhases:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Interface representing optional job phases for a build and publish jobs ot the pipeline.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0b52e286bca6d3e100dee44b1b29700803b52468eeb333e1a539ed3934866be4)
            check_type(argname="argument post_build", value=post_build, expected_type=type_hints["post_build"])
            check_type(argname="argument post_publish", value=post_publish, expected_type=type_hints["post_publish"])
            check_type(argname="argument pre_build", value=pre_build, expected_type=type_hints["pre_build"])
            check_type(argname="argument pre_publish", value=pre_publish, expected_type=type_hints["pre_publish"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if post_build is not None:
            self._values["post_build"] = post_build
        if post_publish is not None:
            self._values["post_publish"] = post_publish
        if pre_build is not None:
            self._values["pre_build"] = pre_build
        if pre_publish is not None:
            self._values["pre_publish"] = pre_publish

    @builtins.property
    def post_build(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional phase for the synth job to execute after the main build steps.
    ...
    @builtins.property
    def post_publish(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional phase for publish jobs to execute after the main publish steps.

        :stability: experimental
        '''
        result = self._values.get("post_publish")
        return typing.cast(typing.Optional[IJobPhase], result)

    @builtins.property
    def pre_build(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional phase for the synth job to execute before the main build steps.
    ...
    @builtins.property
    def pre_publish(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional phase for publish jobs to execute before the main publish steps.

        :stability: experimental
        '''
        result = self._values.get("pre_publish")
        return typing.cast(typing.Optional[IJobPhase], result)
...
class PipelineWorkflow(
    ...
    def __init__(
        ...
        *,
        ...
        build_container: typing.Optional[typing.Union[_github_actions_cdk_5328d874.ContainerOptions, typing.Dict[builtins.str, typing.Any]]] = None,
        job_settings: typing.Optional[typing.Union[JobSettings, typing.Dict[builtins.str, typing.Any]]] = None,
        phases: typing.Optional[typing.Union[PipelinePhases, typing.Dict[builtins.str, typing.Any]]] = None,
        single_publisher_per_asset_type: typing.Optional[builtins.bool] = None,
        ...
        :param build_container: (experimental) Container configuration for the build environment.
        :param job_settings: (experimental) Optional configuration settings for individual jobs within the pipeline.
        :param phases: (experimental) Optional phases to execute before or after main build and publish steps.
    ...
    def _create_synth_job(
        ...
        return typing.cast(None, jsii.invoke(self, "createSynthJob", [id, needs, synth]))

    @builtins.property
    @jsii.member(jsii_name="assetHashMap")
    def _asset_hash_map(self) -> typing.Mapping[builtins.str, builtins.str]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.Mapping[builtins.str, builtins.str], jsii.get(self, "assetHashMap"))

    @builtins.property
    @jsii.member(jsii_name="pipelineJobProps")
    def _pipeline_job_props(self) -> PipelineJobProps:
        '''
        :stability: experimental
        '''
        return typing.cast(PipelineJobProps, jsii.get(self, "pipelineJobProps"))

    @builtins.property
    @jsii.member(jsii_name="stackOptions")
    def _stack_options(self) -> typing.Mapping[builtins.str, "StackOptions"]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.Mapping[builtins.str, "StackOptions"], jsii.get(self, "stackOptions"))
    ...
    def _build_container(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_github_actions_cdk_5328d874.ContainerOptions], jsii.get(self, "buildContainer"))

    @builtins.property
    @jsii.member(jsii_name="jobSettings")
    def _job_settings(self) -> typing.Optional[JobSettings]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.Optional[JobSettings], jsii.get(self, "jobSettings"))

    @builtins.property
    @jsii.member(jsii_name="phases")
    def _phases(self) -> typing.Optional[PipelinePhases]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.Optional[PipelinePhases], jsii.get(self, "phases"))

    @builtins.property
    @jsii.member(jsii_name="runner")
    def _runner(self) -> typing.Optional[_github_actions_cdk_5328d874.Runner]:
        '''
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_github_actions_cdk_5328d874.Runner], jsii.get(self, "runner"))


@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.PipelineWorkflowProps",
    jsii_struct_bases=[_github_actions_cdk_5328d874.WorkflowProps, PipelineJobProps],
    name_mapping={
...
class PipelineWorkflowProps(
    _github_actions_cdk_5328d874.WorkflowProps,
    PipelineJobProps,
):
    def __init__(
        self,
        *,
        ...
        if isinstance(build_container, dict):
            build_container = _github_actions_cdk_5328d874.ContainerOptions(**build_container)
        if isinstance(job_settings, dict):
            job_settings = JobSettings(**job_settings)
        if isinstance(phases, dict):
            phases = PipelinePhases(**phases)
        if __debug__:
    ...
    def build_container(
        ...
        '''(experimental) Container configuration for the build environment.
    ...
    def job_settings(self) -> typing.Optional[JobSettings]:
        '''(experimental) Optional configuration settings for individual jobs within the pipeline.
    ...
    @builtins.property
    def phases(self) -> typing.Optional[PipelinePhases]:
        '''(experimental) Optional phases to execute before or after main build and publish steps.
        ...
        return typing.cast(typing.Optional[PipelinePhases], result)
...
class PublishPipelineJob(
    ...
    def __init__(
        ...
        *,
        ...
        :param post_publish: (experimental) Optional post-publish phase steps.
        :param pre_publish: (experimental) Optional pre-publish phase steps.
        :param aws_credentials: (experimental) Provider for AWS credentials to be used within this job.
        :param cdkout_dir: (experimental) Directory path where CDK output files are located.
        :param docker_credentials: (experimental) Docker credentials required for authenticating with Docker registries.
        :param version_overrides: (experimental) Optional version overrides for specific GitHub Actions.
    ...
    @jsii.member(jsii_name="containsDockerAsset")
    def contains_docker_asset(self) -> builtins.bool:
        '''
        :stability: experimental
        '''
        return typing.cast(builtins.bool, jsii.invoke(self, "containsDockerAsset", []))
...
class PublishPipelineJobProps(PipelineJobProps):
    ...
    @builtins.property
    def post_publish(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional post-publish phase steps.
    ...
    @builtins.property
    def pre_publish(self) -> typing.Optional[IJobPhase]:
        '''(experimental) Optional pre-publish phase steps.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"capabilities": "capabilities", "job_settings": "jobSettings"},
)
class StackOptions:
    def __init__(
        self,
        *,
        ...
        :param job_settings: (experimental) Job-specific settings for configuring environment and conditions.
    ...
    @builtins.property
    def job_settings(self) -> typing.Optional[JobSettings]:
        '''(experimental) Job-specific settings for configuring environment and conditions.
...
class StageOptions:
    ...
    @builtins.property
    def job_settings(self) -> typing.Optional[JobSettings]:
        '''(experimental) Optional settings to configure the jobs within the stage.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[PipelinePhases],
    name_mapping={
        "post_build": "postBuild",
        "post_publish": "postPublish",
        "pre_build": "preBuild",
...
class GitHubActionsPipelineProps(PipelinePhases):
    def __init__(
        self,
        *,
        post_build: typing.Optional[IJobPhase] = None,
        ...
        '''(experimental) Properties for configuring a GitHub Actions-based deployment pipeline.
    ...
    @builtins.property
    def aws_credentials(self) -> AwsCredentialsProvider:
        '''(experimental) AWS credentials provider for actions requiring AWS authentication.
    ...
    def synth(self) -> Synth:
        '''(experimental) Synthesizer for the CDK application.
    ...
    @builtins.property
    def single_publisher_per_asset_type(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Enables a single publishing job per asset type within the workflow.
    ...
    def version_overrides(
        ...
        '''(experimental) Version overrides for specific GitHub Actions used in the workflow.
    ...
    def workflow_env(
        ...
        '''(experimental) Environment variables to be included in the workflow.
    ...
    def workflow_filename(self) -> typing.Optional[builtins.str]:
        '''(experimental) Name of the generated workflow file (without extension).
    ...
    def workflow_outdir(self) -> typing.Optional[builtins.str]:
        '''(experimental) Directory path where workflow YAML files will be generated.
...
def _typecheckingstub__0c607f38a4631538419fb1f17b427fe89c0e0eb7a8afeeb5914e23e0b6fde573(
    *,
    password_key: builtins.str,
    registry: builtins.str,
    username_key: builtins.str,
...
def _typecheckingstub__78828d729afa4f9e7cd58aa5af314e4c4a9c80a711d8d1a44546c0bfe9c13d75(
    job: _github_actions_cdk_5328d874.Job,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1c5b9f71b027e48da35cebf0341e118069eaed951709d14c1e5bd257a337ed2a(
    *,
    personal_access_token_key: typing.Optional[builtins.str] = None,
    username_key: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__22a4849357611326ea438d136088470c2205733181828222780c941c2375f125(
    *,
    registry: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__e4441d0cb283cc49379138494e1068837d70d9021a46bfc044746429edb9ecb4(
    *,
    condition: typing.Optional[builtins.str] = None,
    environment: typing.Optional[typing.Union[_github_actions_cdk_5328d874.Environment, typing.Dict[builtins.str, typing.Any]]] = None,
) -> None:
...
def _typecheckingstub__0b52e286bca6d3e100dee44b1b29700803b52468eeb333e1a539ed3934866be4(
    *,
    post_build: typing.Optional[IJobPhase] = None,
    post_publish: typing.Optional[IJobPhase] = None,
    pre_build: typing.Optional[IJobPhase] = None,
