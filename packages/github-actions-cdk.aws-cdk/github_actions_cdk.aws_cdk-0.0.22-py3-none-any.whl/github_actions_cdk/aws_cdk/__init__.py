...
class AwsCredentials(
    ...
    def from_git_hub_secrets(
        ...
        *,
        ...
        return typing.cast("IAwsCredentialsProvider", jsii.sinvoke(cls, "fromGitHubSecrets", [props]))
    ...
    def from_open_id_connect(
        ...
        *,
        ...
        return typing.cast("IAwsCredentialsProvider", jsii.sinvoke(cls, "fromOpenIdConnect", [props]))
...
class CustomProviderProps:
    def __init__(
        ...
        *,
        ...
        usages: typing.Optional[typing.Sequence["DockerCredentialsUsage"]] = None,
    ) -> None:
        ...
        :param usages: (experimental) Usage scopes for the credentials.
    ...
    @builtins.property
    def usages(self) -> typing.Optional[typing.List["DockerCredentialsUsage"]]:
        '''(experimental) Usage scopes for the credentials.

        :stability: experimental
        '''
        result = self._values.get("usages")
        return typing.cast(typing.Optional[typing.List["DockerCredentialsUsage"]], result)
...
class DockerCredentials(
    ...
    def __init__(
        ...
        '''(experimental) Initializes Docker credentials with specified usage scopes.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7e498391c6f22657c2ba2523a1d52246df7e4e9dd16f215147eb460b21a59f77)
            check_type(argname="argument usages", value=usages, expected_type=type_hints["usages"])
    ...
    def custom_registry(
        ...
        *,
        ...
        '''(experimental) Factory method for custom registry credentials.
    ...
    def docker_hub(
        ...
        *,
        ...
        '''(experimental) Factory method for DockerHub credentials.
    ...
    def ecr(
        ...
        *,
        ...
        '''(experimental) Factory method for AWS ECR credentials.

        :param registry: (experimental) The ECR registry URL.
        :param usages: (experimental) Usage scopes for the credentials.

        :stability: experimental
        '''
        props = EcrCredentialsProps(registry=registry, usages=usages)
    ...
    def ghcr(
        ...
        *,
        ...
        '''(experimental) Factory method for GitHub Container Registry (GHCR) credentials.

        :param usages: (experimental) Usage scopes for the credentials.

        :stability: experimental
        '''
        props = GhcrCredentialsProps(usages=usages)

        return typing.cast("DockerCredentials", jsii.sinvoke(cls, "ghcr", [props]))
    ...
    def _usages(self) -> typing.Optional[typing.List["DockerCredentialsUsage"]]:
        '''(experimental) - The usage scopes for the credentials (optional).

        :stability: experimental
        '''
        return typing.cast(typing.Optional[typing.List["DockerCredentialsUsage"]], jsii.get(self, "usages"))
...
@jsii.enum(jsii_type="@github-actions-cdk/aws-cdk.DockerCredentialsUsage")
class DockerCredentialsUsage(enum.Enum):
    '''(experimental) Enumeration of Docker credential usage scenarios within a pipeline.
    ...
    SYNTH = "SYNTH"
    '''(experimental) Credentials used for synthesis and build steps.

    :stability: experimental
    '''
    ASSET_PUBLISHING = "ASSET_PUBLISHING"
    '''(experimental) Credentials used for publishing assets (e.g., Docker images).
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"registry": "registry", "usages": "usages"},
)
class EcrCredentialsProps:
    ...
    @builtins.property
    def registry(self) -> builtins.str:
        '''(experimental) The ECR registry URL.
...
@jsii.data_type(
    jsii_type="@github-actions-cdk/aws-cdk.GhcrCredentialsProps",
    jsii_struct_bases=[],
    name_mapping={"usages": "usages"},
)
class GhcrCredentialsProps:
    def __init__(
        self,
        *,
        usages: typing.Optional[typing.Sequence[DockerCredentialsUsage]] = None,
    ) -> None:
        '''(experimental) Properties required for GitHub Container Registry (GHCR) credentials.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1c23576eac9f4bb21d3c017e6d618cc217c6a3f80d56b105d2e1ea014fd29b61)
            check_type(argname="argument usages", value=usages, expected_type=type_hints["usages"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if usages is not None:
            self._values["usages"] = usages
    ...
    def __repr__(self) -> str:
        return "GhcrCredentialsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class GitHubActionsPipeline(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        aws_credentials: "IAwsCredentialsProvider",
        synth: "Synth",
...
@jsii.interface(jsii_type="@github-actions-cdk/aws-cdk.IAwsCredentialsProvider")
class IAwsCredentialsProvider(typing_extensions.Protocol):
    '''(experimental) Interface representing a provider for AWS credentials.
...
class _IAwsCredentialsProviderProxy:
    '''(experimental) Interface representing a provider for AWS credentials.
    ...
    __jsii_type__: typing.ClassVar[str] = "@github-actions-cdk/aws-cdk.IAwsCredentialsProvider"
    ...
    def credential_steps(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2018a58bdb2e8f99e0613c1993dba047cd69dd67183527d61626cb9a9ea9901a)
            check_type(argname="argument job", value=job, expected_type=type_hints["job"])
...
typing.cast(typing.Any, IAwsCredentialsProvider).__jsii_proxy_class__ = lambda : _IAwsCredentialsProviderProxy
...
class PipelineJob(
    ...
    def aws_credentials(self) -> IAwsCredentialsProvider:
        '''(experimental) AWS credentials provider associated with this job.

        :stability: experimental
        '''
        return typing.cast(IAwsCredentialsProvider, jsii.get(self, "awsCredentials"))
...
class PipelineJobProps(_github_actions_cdk_5328d874.JobProps):
    ...
    def aws_credentials(self) -> IAwsCredentialsProvider:
        ...
        return typing.cast(IAwsCredentialsProvider, result)
...
class PipelineWorkflow(
    ...
    def _create_publish_job(
        ...
        if __debug__:
            ...
            check_type(argname="argument pre_publish", value=pre_publish, expected_type=type_hints["pre_publish"])
            check_type(argname="argument post_publish", value=post_publish, expected_type=type_hints["post_publish"])
        return typing.cast(None, jsii.invoke(self, "createPublishJob", [id, needs, assets, pre_publish, post_publish]))
...
def _typecheckingstub__7e498391c6f22657c2ba2523a1d52246df7e4e9dd16f215147eb460b21a59f77(
    usages: typing.Optional[typing.Sequence[DockerCredentialsUsage]] = None,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__1c23576eac9f4bb21d3c017e6d618cc217c6a3f80d56b105d2e1ea014fd29b61(
    *,
    usages: typing.Optional[typing.Sequence[DockerCredentialsUsage]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__2018a58bdb2e8f99e0613c1993dba047cd69dd67183527d61626cb9a9ea9901a(
    job: _github_actions_cdk_5328d874.Job,
    region: builtins.str,
    assume_role_arn: typing.Optional[builtins.str] = None,
) -> None:
