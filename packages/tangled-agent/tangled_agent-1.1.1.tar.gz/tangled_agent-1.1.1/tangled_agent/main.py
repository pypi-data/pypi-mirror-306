...
"""
    ...
    parser.add_argument('--log-level', type=str, default='PRETTY', help='The logging level to use (PRETTY, DEBUG, INFO, WARNING, ERROR, CRITICAL).')
    return parser
...
def main():
    ...
    if args.game_id is not None:
        ...
        print(f"game_display: {game_display}")
        play_remote_game(args.game_id, 
                         ...
                         update_display=game_display.display_status if game_display else None)
    else:
        ...
        play_local_game(player1, player2, game, update_display=game_display.display_status if game_display else None)
