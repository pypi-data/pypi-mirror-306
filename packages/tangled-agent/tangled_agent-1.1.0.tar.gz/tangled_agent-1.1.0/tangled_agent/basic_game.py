...
def play_local_game(player1: GameAgentBase, player2: GameAgentBase, game: Game):
    """
    ...
    GamePlayerBase.start_game(LocalGamePlayer, player1, player2, game)

def play_remote_game(game_id: str, host: str, player: GameAgentBase, force_new_credentials: bool = False, **kwargs): 
    """
    ...
    GamePlayerBase.start_game(RemoteGamePlayer, player, game_id, host, force_new_credentials=force_new_credentials, **kwargs)
