...
setup(
    ...
    python_requires='>=3.7',  # Updated to require Python 3.7+
    install_requires=[],
    extras_require={  # Optional
        'tensorflow': ['tensorflow>=2.0.0'],  # Updated TF requirement
        'tensorflow-gpu': ['tensorflow-gpu>=2.0.0'],  # Updated TF-GPU requirement
        'tf-nightly': ['tf-nightly'],
        'torch': ['torch>=1.13.0'],  # Updated PyTorch requirement
        'pytorch-nightly': ['pytorch-nightly'],
        'testing': [
            'absl-py>=0.1.6',
            'mock>=3.0.5',
            'pytest',  # Replaced nose with pytest as it's more modern
        ]
    },
