...
import dvrpsim.elements.checker as decision_checker
...
class Model:
    ...
    :ivar Any                probdata:    problem data
    :ivar Dict[str,Any]      static_data: static data
    ...
    def __init__( self ) -> None:
        ...
        self.static_data:Dict[str,Any] = { 'vehicles': {}, 'locations': {} }
    ...
    def run( self ) -> None:
        ...
        #    logging.error( f'could not finish simulation due to the following error: {error}' )
