...
class Supervisor:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            print(rich_warning('Please set credentail variables before next AMSDAL run'))
            return False

        except AmsdalAuthConnectionError:
            print(rich_error('Cannot connect to AMSDAL authentication service. Please try again in a moment.'))
            return False

        except AmsdalCloudError as e:
            print(rich_error(f'{e}'))
            return False
