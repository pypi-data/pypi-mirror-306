...
def list_migrations(
    ...
    *,
    ...
    _all_applied_migrations = store.fetch_migrations()
    ...
    if _app_migration_files:
        ...
        print(rich_info("You don't have any migrations in your app"))
