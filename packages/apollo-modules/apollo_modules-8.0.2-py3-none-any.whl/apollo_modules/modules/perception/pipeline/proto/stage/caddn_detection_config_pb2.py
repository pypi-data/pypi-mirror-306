...
_CADDNDETECTIONCONFIG = DESCRIPTOR.message_types_by_name['CaddnDetectionConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CADDNDETECTIONCONFIG._serialized_start=98
  _CADDNDETECTIONCONFIG._serialized_end=120
