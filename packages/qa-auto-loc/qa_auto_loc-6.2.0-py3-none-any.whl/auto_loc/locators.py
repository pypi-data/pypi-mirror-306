...
def get_xpath(driver, element):
    ...
    def generate_primary_xpath():
        ...
        if data_e2e:
            return add_index_if_needed(f"//{tag}[@data-e2e='{data_e2e}']")
        elif test_id:
            return add_index_if_needed(f"//{tag}[@test-id='{test_id}']")
        else:
                        ...
                        if element_class:
                            ...
                            while parent:
                                ...
                                if parent_id and not is_dynamic_attribute(parent_id):
                                    return add_index_if_needed(f"//{parent.tag_name.lower()}[@id='{parent_id}']", paragraph)
