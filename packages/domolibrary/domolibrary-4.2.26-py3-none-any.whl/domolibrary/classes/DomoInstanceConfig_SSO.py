...
# %% auto 0
__all__ = ['SSOConfig_InstantiationError', 'SSOConfig_UpdateError', 'SSO_Config', 'update', 'SSO_OIDC_Config', 'SSO_SAML_Config',
           'SSO']
...
import domolibrary.utils.convert as dmcd
...
async def update(
    ...
    **kwargs,
    ...
    self.set_attribute(self, **kwargs)
    ...
    res = await sso_routes.update_sso_config(
        auth=self.auth,
    ...
    for n_key, current_value in asdict(new_config).items():
        ...
        self.set_attribute(self, {n_key, current_value})

    if errors_obj:
        raise SSOConfig_UpdateError(res=res, errors_obj=errors_obj, cls_instance=self)
...
class SSO_OIDC_Config(SSO_Config):
    ...
    def _from_json(cls, auth: dmda.DomoAuth, obj: dict):
        ...
        new_obj = {
            dmcd.convert_str_to_snake_case(key, is_pascal=True): value
    ...
    def to_json(self, is_include_undefined: bool = False):
        ...
        return sso_routes.generate_sso_oidc_body(
