...
def test_tdigest_reset(r: valkey.Redis):
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_merge(r: valkey.Redis):
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_min_and_max(r: valkey.Redis):
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_quantile(r: valkey.Redis):
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_cdf(r: valkey.Redis):
    assert r.tdigest().create("tDigest", 100)
    # insert data-points into sketch
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_trimmed_mean(r: valkey.Redis):
    assert r.tdigest().create("tDigest", 100)
    # insert data-points into sketch
    assert r.tdigest().add("tDigest", list(range(1, 10)))
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_rank(r: valkey.Redis):
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_revrank(r: valkey.Redis):
    assert r.tdigest().create("t-digest", 500)
    assert r.tdigest().add("t-digest", list(range(0, 20)))
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_byrank(r: valkey.Redis):
    assert r.tdigest().create("t-digest", 500)
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_tdigest_byrevrank(r: valkey.Redis):
    assert r.tdigest().create("t-digest", 500)
    assert r.tdigest().add("t-digest", list(range(1, 11)))
