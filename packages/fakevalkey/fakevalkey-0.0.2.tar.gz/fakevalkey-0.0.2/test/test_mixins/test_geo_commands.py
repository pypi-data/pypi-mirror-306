...
def test_geoadd_ch(r: valkey.Redis):
...
def test_geoadd(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geoadd_xx(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geohash(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geopos(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geodist(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geodist_units(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_geodist_missing_one_member(r: valkey.Redis):
    values = (2.1909389952632, 41.433791470673, "place1")
    r.geoadd("barcelona", values)
...
def test_georadius(r: valkey.Redis, long: float, lat: float, radius: float, extra: Dict[str, Any], expected):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_georadiusbymember(r: valkey.Redis, member: str, radius: float, extra: Dict[str, Any], expected):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_georadius_with(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
@pytest.mark.unsupported_server_types("dragonfly")
def test_georadius_count(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        "place1",
...
def test_georadius_errors(r: valkey.Redis):
    values = (
        13.361389,
        38.115556,
        "Palermo",
    ...
    with pytest.raises(valkey.DataError):  # Unsupported unit
        r.georadius("barcelona", 2.191, 41.433, 3000, unit="dsf")
    with pytest.raises(valkey.ResponseError):  # Unsupported unit
        testtools.raw_command(
...
def test_geosearch(r: valkey.Redis):
    values = (
        2.1909389952632,
        41.433791470673,
        b"place1",
