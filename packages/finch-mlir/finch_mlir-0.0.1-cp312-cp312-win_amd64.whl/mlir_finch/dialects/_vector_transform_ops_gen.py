...
def apply_patterns_vector_drop_unit_dims_with_shape_cast(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyDropUnitDimWithShapeCastPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_vector_elementwise_to_vector(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyFoldElementwiseToVectorPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_vector_interleave_to_shuffle(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyInterleaveToShufflePatternsOp(loc=loc, ip=ip))
...
def apply_patterns_vector_lower_bitcast(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyLowerBitCastPatternsOp(loc=loc, ip=ip))
