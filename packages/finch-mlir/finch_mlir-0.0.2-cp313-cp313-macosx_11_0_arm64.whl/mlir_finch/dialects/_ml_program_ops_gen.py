...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, arg_attrs=None, res_attrs=None, sym_visibility=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_402')) else
      _ods_ir.AttrBuilder.get('anonymous_402')(function_type, context=_ods_context))
...
def global_load_const(result, global_, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GlobalLoadConstOp(result=result, global_=global_, loc=loc, ip=ip))
...
def global_load_graph(result, produce_token, global_, consume_tokens, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(GlobalLoadGraphOp(result=result, produceToken=produce_token, global_=global_, consumeTokens=consume_tokens, loc=loc, ip=ip))
...
def global_(sym_name, type_, *, is_mutable=None, value=None, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalOp(sym_name=sym_name, type_=type_, is_mutable=is_mutable, value=value, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def global_store_graph(produce_token, global_, value, consume_tokens, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GlobalStoreGraphOp(produceToken=produce_token, global_=global_, value=value, consumeTokens=consume_tokens, loc=loc, ip=ip))
...
def global_store(global_, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalStoreOp(global_=global_, value=value, loc=loc, ip=ip))
...
def subgraph(sym_name, function_type, *, arg_attrs=None, res_attrs=None, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(SubgraphOp(sym_name=sym_name, function_type=function_type, arg_attrs=arg_attrs, res_attrs=res_attrs, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def token(token, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TokenOp(token=token, loc=loc, ip=ip))
