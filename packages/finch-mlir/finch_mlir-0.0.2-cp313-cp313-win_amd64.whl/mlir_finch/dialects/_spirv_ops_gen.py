...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, sym_name, function_control, *, arg_attrs=None, res_attrs=None, linkage_attributes=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1749')) else
      _ods_ir.AttrBuilder.get('anonymous_1749')(function_type, context=_ods_context))
...
def GroupNonUniformBallotFindLSB(result, execution_scope, value, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GroupNonUniformBallotFindLSBOp(result=result, execution_scope=execution_scope, value=value, loc=loc, ip=ip))
...
def GroupNonUniformBallotFindMSB(result, execution_scope, value, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GroupNonUniformBallotFindMSBOp(result=result, execution_scope=execution_scope, value=value, loc=loc, ip=ip))
...
class KHRCooperativeMatrixLengthOp(_ods_ir.OpView):
  ...
  def __init__(self, cooperative_matrix_type, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1587')) else
      _ods_ir.AttrBuilder.get('anonymous_1587')(cooperative_matrix_type, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
