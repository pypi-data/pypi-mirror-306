...
def code_to_pdf(input_file: str, output_pdf: str):
    ...
    title_html = f'<h6 style="font-family: Menlo, monospace; font-size: 16px; color: #6e6e6e; margin-bottom: 0; id="{filename}""># {filename}</h6>'
...
def create_pdfignore_if_not_exists():
    """Cek apakah file .pdfignore ada, jika tidak buat dengan isi default."""
    ...
    def tree_to_html(d, indent=0):
        ...
        for key, value in sorted(d.items()):
            ...
            if isinstance(value, dict):
                ...
                hyperlink = f'<a href="#{key_fix}">{value}</a>'
                html += f'<div style="margin-left: {indent * 20}px;">{key_fix} .......................... {hyperlink}</div>'
        return html
