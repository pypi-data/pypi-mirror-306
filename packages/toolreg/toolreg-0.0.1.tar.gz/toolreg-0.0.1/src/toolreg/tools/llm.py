...
from toolreg.tools import html, inspection
...
def generate_openai_schema(func: Callable[..., Any]) -> dict[str, Any]:
    ...
    signature = inspection.get_signature(func)
    if not signature.parameters:
        msg = "Function must have at least one parameter"
        raise ValueError(msg)

    description = inspection.get_doc(func)
...
def llm_analyze_image(
    ...
    **kwargs: Any,
    ...
    image_str = html.url_to_b64(image_url) if encode_b64 else image_url
