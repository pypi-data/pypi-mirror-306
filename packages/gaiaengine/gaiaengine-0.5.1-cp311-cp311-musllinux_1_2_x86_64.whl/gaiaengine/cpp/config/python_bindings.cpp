...
PYBIND11_MODULE(gaiaengine, m) {
  ...
  // impostors
  Impostor::pythonBindings(m);
  MovingImpostor::pythonBindings(m);
  ImpostorAsset::pythonBindings(m);
  MovingImpostorAsset::pythonBindings(m);
  ImpostorManager::pythonBindings(m);
  ImpostorSelector::pythonBindings(m);

  // terrain
  Terrain::pythonBindings(m);
  Heightmap::pythonBindings(m);
  HeightmapCamera::pythonBindings(m);
  HeightmapSelector::pythonBindings(m);
  Skybox::pythonBindings(m);
