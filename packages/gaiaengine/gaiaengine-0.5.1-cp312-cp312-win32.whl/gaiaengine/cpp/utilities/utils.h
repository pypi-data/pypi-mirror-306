...
namespace ut {
  ...
  // Convert to a rectangle where x = left, y = top, z = right, w = bottom
  void convertToPositiveRectangle(glm::ivec4& rect);
  // Expects a positive rectangle returned by the function above
