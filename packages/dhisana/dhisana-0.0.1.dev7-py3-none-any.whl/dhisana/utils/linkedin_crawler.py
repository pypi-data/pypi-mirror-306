...
from dhisana.utils.agent_tools import get_structured_output
...
async def get_html_content_from_url(page, url):
    """
...
def parse_html_content(html_content):
    """
    Parse HTML content and extract the text, removing scripts and styles.
    """
    if not html_content:
        return ""
...
async def extract_from_page(page, url, response_type):
    ...
    content_text = await get_html_content_from_url(page, url)
    if not content_text:
        return None, 'FAIL'
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        job_profiles = [
            "https://www.linkedin.com/in/madhukard/",
        ...
        sales_navigator_insights = [
            "https://www.linkedin.com/in/madhukard/details/sales-lead-insights-details/",
        ...
        insights_csv_file_path = '/tmp/sales_navigator_insights.csv'
