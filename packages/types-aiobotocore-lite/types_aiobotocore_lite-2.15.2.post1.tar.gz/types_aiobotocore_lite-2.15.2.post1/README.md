...
[aiobotocore 2.15.2](https://github.com/aio-libs/aiobotocore) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 390 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 390 services in
  separate packages.
