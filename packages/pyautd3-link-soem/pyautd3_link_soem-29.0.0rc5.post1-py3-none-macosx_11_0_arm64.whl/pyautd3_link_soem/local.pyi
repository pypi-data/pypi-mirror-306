...
class _SOEMBuilder(LinkBuilder[SOEM]):
    ...
    def _resolve_link(self: _SOEMBuilder, handle: HandlePtr, ptr: ControllerPtr) -> SOEM: ...
    def with_ifname(self: _SOEMBuilder, ifname: str) -> _SOEMBuilder: ...
    def with_buf_size(self: _SOEMBuilder, buf_size: int) -> _SOEMBuilder: ...
    def with_send_cycle(self: _SOEMBuilder, send_cycle: timedelta) -> _SOEMBuilder: ...
    def with_sync0_cycle(self: _SOEMBuilder, sync0_cycle: timedelta) -> _SOEMBuilder: ...
    ...
    def with_sync_tolerance(self: _SOEMBuilder, sync_tolerance: timedelta) -> _SOEMBuilder: ...
    def with_sync_timeout(self: _SOEMBuilder, sync_timeout: timedelta) -> _SOEMBuilder: ...
    def with_state_check_interval(self: _SOEMBuilder, state_check_interval: timedelta) -> _SOEMBuilder: ...
    ...
    @property
    def send_cycle(self: _SOEMBuilder) -> timedelta: ...
    @property
    def sync0_cycle(self: _SOEMBuilder) -> timedelta: ...
    @property
    ...
    @property
    def sync_tolerance(self: _SOEMBuilder) -> timedelta: ...
    @property
    def sync_timeout(self: _SOEMBuilder) -> timedelta: ...
    @property
    def state_check_interval(self: _SOEMBuilder) -> timedelta: ...
    @property
...
class SOEM(Link):
    def __init__(self: SOEM, handle: HandlePtr, ptr: LinkPtr, err_handler: None) -> None: ...
    @staticmethod
