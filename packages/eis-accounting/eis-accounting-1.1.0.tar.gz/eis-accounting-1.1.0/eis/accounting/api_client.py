...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BookingProcessesApi()
        api_instance.create_booking_process  # this is an instance of the class Endpoint
        api_instance.create_booking_process()  # this invokes api_instance.create_booking_process.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_booking_process.callable or self.callable in this class
