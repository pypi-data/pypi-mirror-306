...
def report_aluminum_beam_column(matl: AluMaterial, sect: SteelSection_AISC05_US, load: MemberForce, length: SteelLength, eff_len: EffectiveLength, factor: AluMomentModificationFactor) -> ResultBytes:
    dll = load_dll()
