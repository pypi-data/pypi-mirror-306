...
from moapy.data_pre import SectionForce, EffectiveLength, Force, Moment, Length, enUnitForce, enUnitLength, enUnitMoment
...
def report_ec3_beam_column(matl: SteelMaterial_EC, sect: SteelSection_EN10365, load: SectionForce, length: SteelLength_EC, eff_len: EffectiveLength, factor: SteelMomentModificationFactor_EC) -> ResultBytes:
    dll = load_dll()
...
def calc_ec3_beam_column(matl: SteelMaterial_EC, sect: SteelSection_EN10365, load: SectionForce, length: SteelLength_EC, eff_len: EffectiveLength, factor: SteelMomentModificationFactor_EC) -> dict:
    dll = load_dll()
