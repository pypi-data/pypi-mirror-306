...
from moapy.data_pre import (
    SectionForce, UnitLoads, EffectiveLength, Force, Moment, Length, enUnitForce, enUnitLength, enUnitMoment
)
...
def test_report_EC3_beamcolumn():
    return steel_bc.report_ec3_beam_column(SteelMaterial_EC(), SteelSection_EN10365(), SectionForce(), SteelLength_EC(), EffectiveLength(), SteelMomentModificationFactor_EC())
