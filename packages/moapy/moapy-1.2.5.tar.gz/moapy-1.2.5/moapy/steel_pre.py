...
class SteelLength(MBaseModel):
    ...
    Steel DB Length
    """
    l_x: Length = Field(default=Length(value=3000.0, unit=enUnitLength.MM), title="Lx", description="Unbraced length(x-direction)")
    l_y: Length = Field(default=Length(value=3000.0, unit=enUnitLength.MM), title="Ly", description="Unbraced length(y-direction)")
    l_b: Length = Field(default=Length(value=3000.0, unit=enUnitLength.MM), title="Lb", description="Lateral unbraced length")
...
class SteelLength_EC(SteelLength):
    ...
    Steel DB Length
    """
    l_t: Length = Field(default=Length(value=3000.0, unit=enUnitLength.MM), title="Lt", description="Torsional Buckling Length")
...
class SteelSection(MBaseModel):
    ...
    name: str = Field(default='H 400x200x8/13', description="Section Name")
...
class SteelMaterial(MBaseModel):
    ...
    Steel DB Material
    """
    code: str = Field(default='KS18(S)', description="Material Code", readOnly=True)
    name: str = Field(default='SS275', description="Material Name")
...
class SteelMaterial_EC(SteelMaterial):
    ...
    name: str = Field(default='S275', description="Material of steel member", enum=enum_to_list(enSteelMaterial_EN10025))
...
class BoltMaterial(MBaseModel):
    ...
    Bolt Material
    """
    name: str = Field(default='F10T', description="Bolt Material Name")
...
class SteelMember(MBaseModel):
    ...
    Steel Member
    """
    sect: SteelSection = Field(default=SteelSection(), description="Section")
    matl: SteelMaterial = Field(default=SteelMaterial(), description="Material")
...
class SteelConnectMember(MBaseModel):
    ...
    """
    supporting: SteelMember = Field(default=SteelMember(), description="Supporting Member")
    supported: SteelMember = Field(default=SteelMember(), description="Supported Member")
...
class SteelConnectMember_EC(SteelConnectMember):
    ...
    Steel Connect Member
    """
    supporting: SteelMember_EC = Field(default=SteelMember_EC(), title="Supporting member", description="Supporting Member")
    supported: SteelMember_EC = Field(default=SteelMember_EC(), title="Supported member", description="Supported Member")
...
class SteelBolt(MBaseModel):
    ...
    matl: BoltMaterial = Field(default=BoltMaterial(), title="bolt material", description="Material of bolt")
...
class ShearConnector(MBaseModel):
    ...
    ShearConnector
    """
    bolt: SteelBolt = Field(default=SteelBolt(), description="stud bolt")
    num: int = Field(default=1, description="stud column")
    space: Length = Field(default=Length(value=300.0, unit=enUnitLength.MM), description="stud spacing")
    length: Length = Field(default=Length(value=100.0, unit=enUnitLength.MM), description="stud length")
...
class SteelPlateMember(MBaseModel):
    ...
    """
    matl: SteelMaterial = Field(default=SteelMaterial(), description="Material")
    bolt_num: int = Field(default=4, description="Number of Bolts")
    thk: Length = Field(default=Length(value=6.0, unit=enUnitLength.MM), description="Thickness")
