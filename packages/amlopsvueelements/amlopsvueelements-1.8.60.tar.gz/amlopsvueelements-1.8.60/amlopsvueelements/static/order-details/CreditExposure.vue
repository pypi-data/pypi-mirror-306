<template>
  <div
    ...
    class="w-full flex flex-col items-center py-[2.25rem] px-[0.75rem]"
  >
    <Loading v-if="isLoading" />
    <p v-if="!isLoading && !creditExposure" class="text-base-800 text-[13px] text-center mx-auto">
      No credit exposure data available
    </p>
  </div>
  <div v-else class="credit-wrap flex w-full">
    <div
