...
export interface IComplianceChecks {
  sanctions: {
    is_client_sanctions_confirmed: boolean;
    is_client_sanctions_needs_review: boolean;
    is_operator_sanctions_confirmed: boolean;
    is_operator_sanctions_needs_review: boolean;
    is_aircraft_sanctions_confirmed: boolean;
    is_aircraft_sanctions_needs_review: boolean;
    is_uplift_country_sanctions_confirmed: boolean;
    is_destination_country_sanctions_confirmed: boolean;
  };
  supplier_restrictions: {
    aircraft_sanction_type_id: null | number;
    aircraft_sanction_type_name: null | string;
    aircraft_sanctions_document_id: null | number;
    aircraft_sanctions_document_url: null | string;
    registration_sanction_type_id: null | number;
    registration_sanction_type_name: null | string;
    registration_sanction_document_id: null | number;
    registration_sanction_document_url: null | string;
    uplift_airport_sanction_type_id: null | number;
    uplift_airport_sanction_type_name: null | string;
    uplift_airport_sanction_document_id: null | number;
    uplift_airport_sanction_document_url: null | string;
    destination_airport_sanction_type_id: null | number;
    destination_airport_sanction_type_name: null | string;
    destination_airport_sanction_document_id: null | number;
    destination_airport_sanction_document_url: null | string;
    uplift_country_sanction_type_id: null | number;
    uplift_country_sanction_type_name: null | string;
    uplift_country_sanction_document_id: null | number;
    uplift_country_sanction_document_url: null | string;
    destination_country_sanction_type_id: null | number;
    destination_country_sanction_type_name: null | string;
    destination_country_sanction_document_id: null | number;
    destination_country_sanction_document_url: null | string;
  };
}
...
export interface IOrderBase {
  ...
  compliance_checks?: IComplianceChecks;
