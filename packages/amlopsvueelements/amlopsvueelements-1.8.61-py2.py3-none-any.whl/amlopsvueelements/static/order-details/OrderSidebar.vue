  ...
  >
    ...
    <div class="order-sidebar-content w-full flex flex-col">
      ...
      <ScrollBar class="my-[0.75rem] grow">
        ...
        <div v-else-if="activeTab.name === 'Chat'" class="order-sidebar-content-data">
          <Chat />
        </div>
...
import { ActivityLog, Chat } from '../datacomponent';
...
import type { IOrder, IOrderNote } from 'shared/types';
