...
def parse_labels(model_labels: List[Dict],
    ...
    for label in model_labels:
        ...
        all_labels.append(label_instance.dict(exclude_none=True))

    for parent_name, parent_id in parent_name2id.items():
        label_names.add(parent_name)
        all_labels.append(Label(id=parent_id, name=parent_name, modelName=model_name).dict(exclude_none=True))
