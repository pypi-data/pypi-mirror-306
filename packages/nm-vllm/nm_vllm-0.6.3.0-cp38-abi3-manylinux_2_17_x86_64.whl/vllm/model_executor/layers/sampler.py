...
if envs.VLLM_USE_NM_FLASHINFER_SAMPLER and find_spec("vllm._nm_C"):
    # yapf: disable
    from vllm._nm_ops import (
        sampling_from_probs as flashinfer_sampling_from_probs)
    from vllm._nm_ops import top_k_renorm_prob as flashinfer_top_k_renorm_prob
    from vllm._nm_ops import (
        top_k_top_p_sampling_from_probs as flashinfer_top_k_top_p_sampling)
    from vllm._nm_ops import top_p_renorm_prob as flashinfer_top_p_renorm_prob

    # yapf: enable
elif envs.VLLM_USE_FLASHINFER_SAMPLER and find_spec("flashinfer"):
    # yapf: disable
