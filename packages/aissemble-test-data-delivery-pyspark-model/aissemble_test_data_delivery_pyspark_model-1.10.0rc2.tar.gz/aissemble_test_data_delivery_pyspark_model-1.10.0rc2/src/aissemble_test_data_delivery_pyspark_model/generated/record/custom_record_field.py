...
class CustomRecordField(Enum):
    """
    Enum to represent the fields of a CustomRecord record.
    ...
    @classmethod
    def get_fields_with_drift_policy(cls) -> List[CustomRecordField]:
        """
        Returns the list of fields that have a drift policy.
        """
        fields_with_drift_policy = []
        for field in CustomRecordField:
    ...
    @classmethod
    def get_fields_with_ethics_policy(cls) -> List[CustomRecordField]:
        """
    ...
    @classmethod
    def get_fields_with_protection_policy(cls) -> List[CustomRecordField]:
        """
