...
class BinaryRecordSchemaBase(ABC):
    """
    Base implementation of the PySpark schema for BinaryRecord.

    GENERATED CODE - DO NOT MODIFY (add your customizations in BinaryRecord).
    ...
    def __init__(self):
        ...
        self.add(BinaryRecordSchemaBase.BINARY_FIELD_COLUMN, BinaryType(), True)
    ...
    def cast(self, dataset: DataFrame) -> DataFrame:
        ...
        """
        binary_field_type = self.get_data_type(BinaryRecordSchemaBase.BINARY_FIELD_COLUMN)

        return dataset \
            .withColumn(BinaryRecordSchemaBase.BINARY_FIELD_COLUMN, dataset[BinaryRecordSchemaBase.BINARY_FIELD_COLUMN].cast(binary_field_type))
