...
class CustomRecordSchemaBase(ABC):
    """
    Base implementation of the PySpark schema for CustomRecord.
    ...
    def __init__(self):
        ...
        self.add(CustomRecordSchemaBase.CUSTOM_FIELD_COLUMN, StringType(), True)
    ...
    def cast(self, dataset: DataFrame) -> DataFrame:
        ...
        """
        custom_field_type = self.get_data_type(CustomRecordSchemaBase.CUSTOM_FIELD_COLUMN)

        return dataset \
            .withColumn(CustomRecordSchemaBase.CUSTOM_FIELD_COLUMN, dataset[CustomRecordSchemaBase.CUSTOM_FIELD_COLUMN].cast(custom_field_type))
