...
class TrackHandler(object):
    ...
    def get_session_df(self, interval_ms=100):
        scu = self.scu
        ...
        return scu.get_session_as_df(interval_ms=interval_ms, session=self.session_id)
...
#        log('logger state ')
    ...
    def start(self, az_start=None, el_start=None, band_start=None, az_speed=None, el_speed=None, send_default_configs=False, interlock_acknowledge_on_start=False, **kwargs):
        ...
        Args:
            ...
            interlock_acknowledge_on_start (bool, optional): Whether or not to send an interlock acknowledged command to the scu after startup. Defaults to False.
        """
...
if __name__ == '__main__':
    ...
    # log("main")
    dish = scu('http://10.96.66.10:8080/', use_socket=True, wait_done_by_uuid=True)
    dish.show()
