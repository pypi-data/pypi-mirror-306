    ...
    def load(cls, identity_name: str, columns: list = None):
        ...
        try:
            ...
            if model_type == "content":
                ...
                if identity_name.startswith("content.fnguide.ftp.financial") \
                    ...
                    logger.info(f"Temporary, fnguide entity id is converted to dataguide ccid")
            ...
            if columns != None:
                logger.info(
                "Parameter 'columns' does not used."
            )
