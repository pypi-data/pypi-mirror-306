...
class BackendInit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["locale_folder_path", b"locale_folder_path", "preferred_langs", b"preferred_langs", "server", b"server"]) -> None: ...
...
class I18nBackendInit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["locale_folder_path", b"locale_folder_path", "preferred_langs", b"preferred_langs"]) -> None: ...
...
class BackendError(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_help_page", b"_help_page", "help_page", b"help_page"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_help_page", b"_help_page", "backtrace", b"backtrace", "context", b"context", "help_page", b"help_page", "kind", b"kind", "message", b"message"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_help_page", b"_help_page"]) -> typing.Literal["help_page"] | None: ...
