...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('ax', 'plt', 'fig', 'ress', 'printrates', 'pre', 'tol', 'mat', 'plotrates', 'maxiter', 'display', 'callback', 'iterations', '_final_residual', 'clear_output', 'its', 'atol', 'residuals', 'callback_sol', 'sol')
