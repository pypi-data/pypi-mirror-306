...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', 'time', '_lin_solver_cls', 'c', 'gfu_old', 'dt', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', 'time', 'gfa_old', 'gfv_old', '_lin_solver_cls', 'c', 'gfu_old', 'dt', '_lin_solver_args')
