...
class StreamedChatCompletionChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to call."""
...
class StreamedChatCompletionChoiceToolCallsTypedDict(TypedDict):
    index: int
    r"""The index of tool call being generated."""
    id: str
    r"""The ID of the tool call."""
    type: StreamedChatCompletionChoiceType
    r"""The type of the tool."""
    function: StreamedChatCompletionChoiceFunctionTypedDict


class StreamedChatCompletionChoiceToolCalls(BaseModel):
    index: int
    r"""The index of tool call being generated."""
    ...
    function: StreamedChatCompletionChoiceFunction
...
class DeltaTypedDict(TypedDict):
    ...
    tool_calls: NotRequired[StreamedChatCompletionChoiceToolCallsTypedDict]
...
class Delta(BaseModel):
    ...
    tool_calls: Optional[StreamedChatCompletionChoiceToolCalls] = None


class StreamedChatCompletionChoiceTypedDict(TypedDict):
    index: int
    r"""The index of the choice in the list of generated choices."""
    delta: DeltaTypedDict
    finish_reason: NotRequired[Nullable[str]]
    r"""Termination condition of the generation. `stop` means the API returned the full chat completion generated by the model without running into any limits. `length` means the generation exceeded `max_tokens` or the conversation exceeded the max context length."""
