...
class Interpreter(Interpreter):
    ...
    def scaleTo(self,obj,scaleX,scaleY):
        ...
        for view in views:         
            ...
            if(hitbox_type == 'ADVANCED'):
                ...
                print('scaling hitboxes ', obj['id'],scaleX,scaleY)
                ...
                print('translating hitboxes ', obj['id'],tX,tY)
                self.translateDraws(hitboxes,tX,tY)
    ...
    def poscond_obj_muda_view(self,poscond_obj_muda_view):
        ...
        if not found:
            print(self.dict_vars[object_id]['value']['views'])
