...
class WithPathSlashRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> WithPathSlashRequestBuilder:
        """
        ...
        return WithPathSlashRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithPathSlashRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
