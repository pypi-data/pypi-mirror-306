...
if TYPE_CHECKING:
    from ..models.api_keys.list_api_keys.api_key import ApiKey

@dataclass
class ApikeyGetResponse(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApikeyGetResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ApikeyGetResponse
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "Items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(ApiKey)),
