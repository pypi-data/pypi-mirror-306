...
@dataclass
class PullzoneGetResponse(AdditionalDataHolder, Parsable):
    ...
    # The Items property
    items: Optional[List[PullZone]] = None
    # The TotalItems property
    total_items: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PullzoneGetResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PullzoneGetResponse
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "Items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(PullZone)),
