...
class LoadFreeCertificateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[LoadFreeCertificateRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        [LoadFreeCertificate API Docs](https://docs.bunny.net/reference/pullzonepublic_loadfreecertificate)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> LoadFreeCertificateRequestBuilder:
        """
    ...
    @dataclass
    class LoadFreeCertificateRequestBuilderGetRequestConfiguration(RequestConfiguration[LoadFreeCertificateRequestBuilderGetQueryParameters]):
        """
