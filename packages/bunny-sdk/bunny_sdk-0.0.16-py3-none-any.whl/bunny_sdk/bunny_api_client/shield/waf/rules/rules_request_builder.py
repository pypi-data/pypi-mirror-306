...
if TYPE_CHECKING:
    ...
    from ....models.shield.waf_rule_main_group_model import WafRuleMainGroupModel
...
class RulesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/shield/waf/rules", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[List[WafRuleMainGroupModel]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[List[WafRuleMainGroupModel]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, WafRuleMainGroupModel, error_mapping)
