...
if TYPE_CHECKING:
    from ....models.shield.get_waf_profiles_response import GetWafProfilesResponse
...
class ProfilesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/shield/waf/profiles", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetWafProfilesResponse]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[GetWafProfilesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetWafProfilesResponse, error_mapping)
