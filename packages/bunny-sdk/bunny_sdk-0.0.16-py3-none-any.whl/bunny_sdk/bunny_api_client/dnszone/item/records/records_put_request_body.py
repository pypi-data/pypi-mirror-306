...
if TYPE_CHECKING:
    from .records_put_request_body_enviromental_variables import RecordsPutRequestBody_EnviromentalVariables

@dataclass
class RecordsPutRequestBody(AdditionalDataHolder, Parsable):
    ...
    enviromental_variables: Optional[List[RecordsPutRequestBody_EnviromentalVariables]] = None
    # The Flags property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecordsPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecordsPutRequestBody
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "EnviromentalVariables": lambda n : setattr(self, 'enviromental_variables', n.get_collection_of_object_values(RecordsPutRequestBody_EnviromentalVariables)),
