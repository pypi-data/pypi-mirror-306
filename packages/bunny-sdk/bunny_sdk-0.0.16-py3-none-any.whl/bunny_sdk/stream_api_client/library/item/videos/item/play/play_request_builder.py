...
if TYPE_CHECKING:
    from ......models.manage_videos.get_video_play_data.video_play_data import VideoPlayData

class PlayRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PlayRequestBuilderGetQueryParameters]] = None) -> Optional[VideoPlayData]:
        ...
        Returns: Optional[VideoPlayData]
        """
        ...
        return await self.request_adapter.send_async(request_info, VideoPlayData, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[PlayRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        [GetVideoPlayData API Docs](https://docs.bunny.net/reference/video_getvideoplaydata)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> PlayRequestBuilder:
        """
    ...
    @dataclass
    class PlayRequestBuilderGetRequestConfiguration(RequestConfiguration[PlayRequestBuilderGetQueryParameters]):
        """
