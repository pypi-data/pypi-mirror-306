...
@dataclass
class CreateWafRateLimitRuleModel_variableTypes(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreateWafRateLimitRuleModel_variableTypes:
        """
