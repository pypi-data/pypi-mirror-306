...
if TYPE_CHECKING:
    ...
    from .pull_zone_routing_filters import PullZone_RoutingFilters

@dataclass
class PullZone(AdditionalDataHolder, Parsable):
    ...
    africa_discount: Optional[int] = None
    ...
    asia_oceania_discount: Optional[int] = None
    ...
    cache_version: Optional[float] = None
    ...
    dns_zone_id: Optional[int] = None
    # The Pull Zone specific pricing discount for EU and US region.
    e_u_u_s_discount: Optional[int] = None
    ...
    monthly_bandwidth_used: Optional[int] = None
    ...
    optimizer_pricing: Optional[float] = None
    ...
    origin_link_value: Optional[str] = None
    ...
    routing_filters: Optional[List[PullZone_RoutingFilters]] = None
    ...
    south_america_discount: Optional[int] = None
    ...
    zone_security_key: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PullZone:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "AfricaDiscount": lambda n : setattr(self, 'africa_discount', n.get_int_value()),
            "AllowedReferrers": lambda n : setattr(self, 'allowed_referrers', n.get_collection_of_primitive_values(str)),
            "AsiaOceaniaDiscount": lambda n : setattr(self, 'asia_oceania_discount', n.get_int_value()),
            ...
            "CacheVersion": lambda n : setattr(self, 'cache_version', n.get_float_value()),
            "CnameDomain": lambda n : setattr(self, 'cname_domain', n.get_str_value()),
            ...
            "DnsRecordId": lambda n : setattr(self, 'dns_record_id', n.get_int_value()),
            "DnsRecordValue": lambda n : setattr(self, 'dns_record_value', n.get_str_value()),
            "DnsZoneId": lambda n : setattr(self, 'dns_zone_id', n.get_int_value()),
            "EUUSDiscount": lambda n : setattr(self, 'e_u_u_s_discount', n.get_int_value()),
            ...
            "Hostnames": lambda n : setattr(self, 'hostnames', n.get_collection_of_object_values(Hostname)),
            ...
            "MonthlyBandwidthUsed": lambda n : setattr(self, 'monthly_bandwidth_used', n.get_int_value()),
            ...
            "OptimizerPricing": lambda n : setattr(self, 'optimizer_pricing', n.get_float_value()),
            ...
            "OriginLinkValue": lambda n : setattr(self, 'origin_link_value', n.get_str_value()),
            ...
            "RoutingFilters": lambda n : setattr(self, 'routing_filters', n.get_collection_of_enum_values(PullZone_RoutingFilters)),
            ...
            "SouthAmericaDiscount": lambda n : setattr(self, 'south_america_discount', n.get_int_value()),
            ...
            "ZoneSecurityKey": lambda n : setattr(self, 'zone_security_key', n.get_str_value()),
        }
        return fields
