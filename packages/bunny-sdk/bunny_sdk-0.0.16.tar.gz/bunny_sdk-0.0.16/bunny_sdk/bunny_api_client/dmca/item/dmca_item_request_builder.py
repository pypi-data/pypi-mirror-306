...
class DmcaItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/dmca/{id}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> DmcaItemRequestBuilder:
        """
        ...
        return DmcaItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class DmcaItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
