...
from xiaoqiangclub.api.message_push.email_sender import EmailSender
from xiaoqiangclub.api.message_push.wechat_sender import WeChatSender
from xiaoqiangclub.api.message_push.dingtalk_sender import DingTalkSender
from xiaoqiangclub.api.message_push.bark_sender import BarkSender
from xiaoqiangclub.api.message_push.telegram_sender import TelegramSender
from xiaoqiangclub.api.message_push.igot_sender import IGotSender
from xiaoqiangclub.api.message_push.push_plus_sender import PushPlusSender
from xiaoqiangclub.api.message_push.an_push_sender import AnPushSender
from xiaoqiangclub.api.message_push.feishu_sender import FeishuSender
from xiaoqiangclub.api.message_push.discord_sender import DiscordSender
from xiaoqiangclub.api.message_push.whatsapp_sender import WhatsAppSender
...
class MessagePush:
    ...
    def send_messages_sync(
        ...
        """
        return _send_sync(AsyncMessagePush.send_messages, email_args, wechat_args, dingtalk_args, bark_args,
    ...
    def send_messages_with_config_sync(config_path: str, message: str, title: Optional[str] = None,
        ...
        :param url: 消息链接（可选）
        """
        return _send_sync(AsyncMessagePush.send_messages_with_config, config_path, message, title, url)
    ...
    @staticmethod
    async def push_plus_async(token: str, message: str):
        """
        异步方式发送push_plus消息
    ...
    @staticmethod
    def push_plus(token: str, message: str):
        """
        同步方式发送push_plus消息
    ...
    @staticmethod
    async def an_push_async(token: str, title: str, message: str, url: str = None):
        """
        异步方式发送an_push消息
    ...
    @staticmethod
    def an_push(token: str, title: str, message: str, url: str = None):
        """
        同步方式发送an_push消息
    ...
    async def send_messages_async(
        ...
        :param whatsapp_args: WhatsApp参数
        """
        return _send_async(AsyncMessagePush.send_messages, email_args, wechat_args, dingtalk_args, bark_args,
                           telegram_args,
    ...
    async def send_messages_with_config_async(config_path: str, message: str, title: Optional[str] = None,
        ...
        :param url: 消息链接（可选）
        """
        return _send_async(AsyncMessagePush.send_messages_with_config, config_path, message, title, url)
