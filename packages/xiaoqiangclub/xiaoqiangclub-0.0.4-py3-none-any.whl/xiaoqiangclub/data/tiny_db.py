...
class TinyDBManager:
    ...
    def query(self, conditions: Dict, table_name: str = 'default') -> Optional[List[Dict]]:
        """
        查询表中符合条件的数据
    ...
    def update(self, query: Dict, new_data: Union[Dict, List[Dict]], table_name: str = 'default') -> Optional[List[int]]:
        """
        更新符合条件的数据
