...
class MouseKeyboardClipboardListener:
    ...
    def example_hotkey_callback(self):
        ...
        print(f'{self.listen_name} -> 热键被触发！')
    ...
    def stop_all_listening(self):
        ...
        print(f'{self.listen_name} -> 所有监听已停止')
    ...
    def stop_mouse_listener(self):
        ...
        if self.mouse_listener:
            ...
            self.mouse_listener = None
            print(f'{self.listen_name} -> 鼠标监听已停止')
    ...
    def stop_keyboard_listener(self):
        ...
        if self.keyboard_listener:
            ...
            self.keyboard_listener = None
            print(f'{self.listen_name} -> 键盘监听已停止')
    ...
    def stop_clipboard_listener(self):
        ...
        if self.clipboard_thread:
            self.clipboard_thread.join()  # 等待剪贴板监听线程结束
            self.clipboard_thread = None
            print(f'{self.listen_name} -> 剪贴板监听已停止')
    ...
    def stop_hotkey_listener(self):
        ...
        if self.hotkey_listener:
            ...
            self.hotkey_listener = None
            print(f'{self.listen_name} -> 热键监听已停止')
