...
def write_file(file_path: str, content: Union[dict, str], mode: str = 'w', encoding: str = 'utf-8'):
    """
    写入内容到文件
...
async def read_file_async(file_path: str, mode: str = 'r', encoding: str = 'utf-8') -> Union[dict, str, None]:
    """
    异步读取文件内容
