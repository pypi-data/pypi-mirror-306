...
def _arrow2367(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2368(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2369(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2367, ROCrate_decoder_1), map(_arrow2368, ROCrate_decoder_2), map(_arrow2369, ROCrate_decoder_3)]))
...
def _arrow2371(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2372(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2374(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2371, ISAJson_decoder_1), map(_arrow2372, ISAJson_decoder_2), map(_arrow2374, ISAJson_decoder_3)]))
