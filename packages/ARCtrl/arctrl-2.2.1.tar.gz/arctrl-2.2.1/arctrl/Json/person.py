...
def encoder(person: Person) -> IEncodable:
    ...
    def _arrow2055(value: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2059(value_2: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2063(value_4: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2066(value_6: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2069(value_8: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2072(value_10: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2076(value_12: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2078(value_14: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2080(value_16: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2081(oa: OntologyAnnotation, person: Any=person) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2082(comment: Comment, person: Any=person) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("firstName", _arrow2055, person.FirstName), try_include("lastName", _arrow2059, person.LastName), try_include("midInitials", _arrow2063, person.MidInitials), try_include("orcid", _arrow2066, person.ORCID), try_include("email", _arrow2069, person.EMail), try_include("phone", _arrow2072, person.Phone), try_include("fax", _arrow2076, person.Fax), try_include("address", _arrow2078, person.Address), try_include("affiliation", _arrow2080, person.Affiliation), try_include_seq("roles", _arrow2081, person.Roles), try_include_seq("comments", _arrow2082, person.Comments)]))
...
def _arrow2095(get: IGetters) -> Person:
    def _arrow2084(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("orcid", string)

    def _arrow2085(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("lastName", string)

    def _arrow2086(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("firstName", string)

    def _arrow2087(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("midInitials", string)

    def _arrow2088(__unit: None=None) -> str | None:
    ...
    def _arrow2093(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2094(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2084(), _arrow2085(), _arrow2086(), _arrow2087(), _arrow2088(), _arrow2089(), _arrow2090(), _arrow2091(), _arrow2092(), _arrow2093(), _arrow2094())


decoder: Decoder_1[Person] = object(_arrow2095)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2099(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2097()), ("@id", _arrow2099()), ("name", ObjectExpr2100()), ("@context", context_jsonvalue)])
...
def _arrow2102(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2102)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2113(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2115(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2117(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2119(value_12: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2121(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2123(value_16: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2124(affiliation: str, oa: Any=oa) -> IEncodable:
        return ROCrate_Affiliation_encoder(affiliation)

    def _arrow2125(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2126(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2106()), ("@type", ObjectExpr2107()), try_include("orcid", _arrow2109, oa.ORCID), try_include("firstName", _arrow2111, oa.FirstName), try_include("lastName", _arrow2113, oa.LastName), try_include("midInitials", _arrow2115, oa.MidInitials), try_include("email", _arrow2117, oa.EMail), try_include("phone", _arrow2119, oa.Phone), try_include("fax", _arrow2121, oa.Fax), try_include("address", _arrow2123, oa.Address), try_include("affiliation", _arrow2124, oa.Affiliation), try_include_seq("roles", _arrow2125, oa.Roles), try_include_seq("comments", _arrow2126, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2142(get: IGetters) -> Person:
    def _arrow2131(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("orcid", string)

    def _arrow2132(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("lastName", string)

    def _arrow2133(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("firstName", string)

    def _arrow2134(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("midInitials", string)
    ...
    def _arrow2139(__unit: None=None) -> str | None:
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("affiliation", ROCrate_Affiliation_decoder)

    def _arrow2140(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow2141(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2131(), _arrow2132(), _arrow2133(), _arrow2134(), _arrow2135(), _arrow2136(), _arrow2137(), _arrow2138(), _arrow2139(), _arrow2140(), _arrow2141())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2142)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2146(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2144()), try_include("name", _arrow2146, name), ("@context", context_minimal_json_value)]))
...
def _arrow2150(get: IGetters) -> str:
    def _arrow2149(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2149(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2150)))
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2154(value: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2156(value_2: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2158(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2160(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2162(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2164(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2166(value_12: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2168(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2170(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2171(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2172(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2154, ROCrate_genID(person_2)), try_include("firstName", _arrow2156, person_2.FirstName), try_include("lastName", _arrow2158, person_2.LastName), try_include("midInitials", _arrow2160, person_2.MidInitials), try_include("email", _arrow2162, person_2.EMail), try_include("phone", _arrow2164, person_2.Phone), try_include("fax", _arrow2166, person_2.Fax), try_include("address", _arrow2168, person_2.Address), try_include("affiliation", _arrow2170, person_2.Affiliation), try_include_seq("roles", _arrow2171, person_2.Roles), try_include_seq("comments", _arrow2172, person_2.Comments)]))
    ...
    if id_map is not None:
        def _arrow2174(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return ROCrate_genID(p_1)

        return encode(_arrow2174, f, person, id_map)
...
def _arrow2190(get: IGetters) -> Person:
    ...
    def _arrow2187(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_17: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("roles", arg_17)

    def _arrow2189(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Person_setOrcidFromComments(Person(None, _arrow2175(), _arrow2176(), _arrow2177(), _arrow2178(), _arrow2179(), _arrow2182(), _arrow2183(), _arrow2184(), _arrow2187(), _arrow2189()))


ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2190)
