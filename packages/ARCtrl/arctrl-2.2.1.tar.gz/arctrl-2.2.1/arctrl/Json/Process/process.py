...
def _arrow2432(get: IGetters) -> Process:
    ...
    def _arrow2422(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2424(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2426(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("date", string)

    def _arrow2427(__unit: None=None) -> FSharpList[ProcessInput] | None:
        arg_13: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("inputs", arg_13)

    def _arrow2429(__unit: None=None) -> FSharpList[ProcessOutput] | None:
        arg_15: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ROCrate_decoder_4)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("outputs", arg_15)

    def _arrow2430(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2420(), _arrow2421(), _arrow2422(), _arrow2424(), _arrow2425(), _arrow2426(), None, None, _arrow2427(), _arrow2429(), _arrow2430())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2432)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2437(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2439(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2440(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2441(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2443(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2445(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2446(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2447(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2448(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2437, ROCrate_genID(oa_1)), try_include("name", _arrow2439, oa_1.Name), try_include("executesProtocol", _arrow2440, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2441, oa_1.ParameterValues), try_include("performer", _arrow2443, oa_1.Performer), try_include("date", _arrow2445, oa_1.Date), try_include("previousProcess", _arrow2446, oa_1.PreviousProcess), try_include("nextProcess", _arrow2447, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2448, oa_1.Inputs), try_include_list_opt("outputs", _arrow2449, oa_1.Outputs), try_include_list_opt("comments", _arrow2450, oa_1.Comments)]))
