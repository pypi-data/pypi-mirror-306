...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2311(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2315(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2311()), ("@type", list_1_1(singleton(ObjectExpr2312()))), ("additionalType", ObjectExpr2313()), try_include("name", _arrow2315, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2320(get: IGetters) -> Source:
    ...
    def _arrow2317(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("@id", Decode_uri)

    def _arrow2318(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("name", string)

    def _arrow2319(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
        arg_9: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(ROCrate_decoder_1)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("characteristics", arg_9)

    return Source(_arrow2317(), _arrow2318(), _arrow2319())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2320)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2324(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2326(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2327(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2324, ROCrate_genID(oa_1)), try_include("name", _arrow2326, oa_1.Name), try_include_list_opt("characteristics", _arrow2327, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2329(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
...
def _arrow2333(get: IGetters) -> Source:
    ...
    def _arrow2332(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2330(), _arrow2331(), _arrow2332())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2333)
