...
from comet_ml import cloud_storage_utils, logging_messages, semantic_version, utils
from comet_ml.api_objects import setup_client
from comet_ml.api_objects.api_objects_helpers import experiment_key_from_uri
from comet_ml.assets import data_writers
from comet_ml.config import get_api_key, get_config
from comet_ml.exceptions import CometException, RemoteModelDownloadException
from comet_ml.file_downloader import (
    DownloadResultHolder,
    FileDownloadManager,
    FileDownloadManagerMonitor,
)
from comet_ml.logging_messages import DEPRECATED_EXPAND_MODEL_DOWNLOAD
...
class Model:
    ...
    def _start_remote_asset_download(
        ...
        if parsed_url.scheme not in ["s3", "gs"]:
            LOGGER.warning(
                logging_messages.MODEL_REMOTE_ASSET_DOWNLOAD_UNSUPPORTED_URI
                % remote_uri
            )
            return None
