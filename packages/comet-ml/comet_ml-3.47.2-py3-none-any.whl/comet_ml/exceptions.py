...
class ImagesUploadLimitReachedException(CometException):
    def __str__(self):
        return UPLOAD_LIMIT_REACHED.format(asset_type="images")


class EmbeddingsUploadLimitReachedException(CometException):
    def __str__(self):
        return UPLOAD_LIMIT_REACHED.format(asset_type="embeddings")


class HistogramsUploadLimitReachedException(CometException):
    def __str__(self):
        return UPLOAD_LIMIT_REACHED.format(asset_type="histograms")
