...
class OfflineExperiment(BaseExperiment):
    ...
    def set_offline_zip_uploader(self, upload_callback: UploadCallback) -> None:
        ...
        invoked to upload the offline ZIP archive created. The callback
        function receives the file path to the offline ZIP archive and
        perform the upload before the job ends.
        ...
        Notes:
            - The callback function is invoked at the end of the job.
...
class OfflineSender(object):
    ...
    def _collect_model_name_if_appropriate(self, message: Dict[str, Any]) -> None:
        ...
        if additional_params is None or message["upload_type"] != "model-element":
