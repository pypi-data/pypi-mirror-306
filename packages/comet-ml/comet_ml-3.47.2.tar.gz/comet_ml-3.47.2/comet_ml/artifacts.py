...
from .connection_helpers import get_cached_comet_http_session
...
def _log_artifact(artifact: Artifact, experiment: Any) -> LoggedArtifact:
    ...
    success_prepared_request = _prepare_update_artifact_version_state(
        experiment.rest_api_client, artifact_version_id, experiment.id, state="CLOSED"
    )
    ...
    logged_artifact = _get_artifact(
        rest_api_client=experiment.rest_api_client,
        get_artifact_params={
