...
from contrast.agent.inventory import cloud_providers
...
def initialize():
    ...
    with module.init_lock:
        ...
        if module.settings.config.get("server.discover_cloud_resource"):
            cloud_providers.report_resource_id(module.reporting_client)
