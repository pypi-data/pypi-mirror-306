...
# def YOUTUBE(url,namefile,resolution):
#     headers = {
#         'accept': '*/*',
#         'accept-language': 'en-US,en;q=0.9,vi-VN;q=0.8,vi;q=0.7',
#         'cache-control': 'no-cache',
#         'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
#         # 'cookie': '_ga=GA1.1.1397582284.1729944582; _ga_PSRPB96YVC=GS1.1.1730517724.2.1.1730518006.0.0.0',
#         'dnt': '1',
#         'origin': 'https://www.y2mate.com',
#         'pragma': 'no-cache',
#         'priority': 'u=1, i',
#         'referer': 'https://www.y2mate.com/vi876',
#         'sec-ch-ua': '"Chromium";v="130", "Google Chrome";v="130", "Not?A_Brand";v="99"',
#         'sec-ch-ua-mobile': '?0',
#         'sec-ch-ua-platform': '"Windows"',
#         'sec-fetch-dest': 'empty',
...
#         'q_auto': '0',
#     }
#     response = requests.post('https://www.y2mate.com/mates/vi876/analyzeV2/ajax',  headers=headers, data=data).text
#     resolutionlist = [i for i in re.findall('{"size".*?}',response)]
#     vid = response.split('"vid":"')[1].split('",')[0]
#     for i in resolutionlist:
#         if resolution in i:
#             k = i.split('"k":"')[1].split('"}')[0]
#     if k=='':
#         print('Video Không Hỗ Trợ Độ Phân Giải Này ! ')
#         return 0
#     else:
#         data = {
#             'vid': vid,
#             'k': k,
#         }
#         URLDOWNLOAD = requests.post('https://www.y2mate.com/mates/convertV2/index',data=data,headers=headers).json()
#         url = URLDOWNLOAD['dlink']
#         dowload = requests.get(url,headers=headers,stream=True)
