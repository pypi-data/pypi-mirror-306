...
from synthetic_data.data import ContinuousDataTransformer
...
class GaussianMultivariateSynthesizer:
    ...
    def synthesize(
        ...
        *,
        ...
        synthetic_data.to_csv(self.output_path / "GaussianMultivariate.csv", index=False)
        logger.info("Synthetic data saved to %s", self.output_path / "GaussianMultivariate.csv")
