...
def get_version_string() -> str:
    """
    get the version of byteapp_ak
    :return: version number
    :rtype: str, e.g. '0.6.24'
    """
    with open("byteapp_ak/__init__.py", "rb") as _f:
...
setuptools.setup(
    ...
    url="https://github.com/akfamily/byteapp_ak",
    ...
    extras_require={
        # 这些是额外的依赖集合，可以通过 'pip install byteapp_ak[full]' 安装
        "full": [
            "akqmt",
        ],
        # 这些是额外的依赖集合，可以通过 'pip install byteapp_ak[qmt]' 安装
        "qmt": [
            "akqmt",
        ],
    },
