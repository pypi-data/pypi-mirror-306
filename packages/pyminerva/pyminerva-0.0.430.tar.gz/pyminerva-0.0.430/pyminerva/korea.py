...
def get_korfia_derivates(product_type, proId, isuCd, isuCd2, from_date, to_date):
    ...
    # 통계>기본통계>채권>세부안내>채권수익률>장외채권수익률
def get_korfia_treasury_yields_by_date(product_type, proId, isuCd, isuCd2, from_date, to_date):
    url = 'http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd'
    data = {
    ...
    df = pd.DataFrame(data)
    df.columns = ['국고채 1년','국고채 3년','국고채 5년','국고채 10년','국고채 20년','국고채 30년','국민주택 1종 5년',\
