...
PATH_TO_TEST_FIXTURES = 'tests/jf_git/fixtures/ado'
...
def get_adapter(redact_names_and_urls: bool = False, strip_text_content: bool = False):
    config = get_git_config(redact_names_and_urls=redact_names_and_urls, strip_text_content=strip_text_content)
