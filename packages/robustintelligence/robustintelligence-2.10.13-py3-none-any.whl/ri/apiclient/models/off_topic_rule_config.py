...
class OffTopicRuleConfig(BaseModel):
    ...
    in_domain_intents_sensitivity: Optional[RuleSensitivity] = Field(default=None, alias="inDomainIntentsSensitivity")
    restricted_intents: Optional[List[StrictStr]] = Field(default=None, alias="restrictedIntents")
    restricted_intents_sensitivity: Optional[RuleSensitivity] = Field(default=None, alias="restrictedIntentsSensitivity")
