...
class UpdateMonitorRequestMonitor(BaseModel):
    ...
    risk_category_type: Optional[RiskCategoryType] = Field(default=None, alias="riskCategoryType")
    test_category: Optional[TestCategoryType] = Field(default=None, alias="testCategory")
