...
class GetResultsResponse(BaseModel):
    ...
    job_status: Optional[JobStatus] = Field(default=None, alias="jobStatus")
    ...
    results: Optional[List[GenerativeValidationResult]] = Field(default=None, description="The list of generative testing results.")
    __properties: ClassVar[List[str]] = ["hasMore", "jobId", "jobStatus", "nextPageToken", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GenerativeValidationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
