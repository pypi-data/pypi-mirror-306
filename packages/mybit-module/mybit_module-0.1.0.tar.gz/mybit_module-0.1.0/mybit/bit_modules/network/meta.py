...
UNSPENT_TYPES = {
    ...
    'p2wpkh': {'segwit': True, 'vsize': 68}, # Segwit native - Bech32 P2WPKH
    'p2wsh': {
        'segwit': True,
        'vsize': 105,
...
class Unspent:
    ...
    __slots__ = ('amount', 'script', 'txid', 'txindex', 'type', 'vsize', 'segwit', 'sequence')

    def __init__(self, amount, script, txid, txindex, type='p2pkh', vsize=None, segwit=None,
    ...
    def __repr__(self):
        return 'Unspent(amount={}, script={}, txid={}, txindex={}, segwit={}, sequence={})'.format(
            repr(self.amount),
            repr(self.script),
            repr(self.txid),
            repr(self.txindex),
