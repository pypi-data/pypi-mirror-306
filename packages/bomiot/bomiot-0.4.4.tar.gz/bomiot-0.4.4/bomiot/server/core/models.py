...
class JobList(models.Model):
    job_id = models.CharField(max_length=255, blank=True, verbose_name="Job ID")
    trigger = models.CharField(max_length=255, blank=True, verbose_name="Trigger")
    executor = models.CharField(max_length=255, verbose_name="Job Function")
    description = models.TextField(null=True, blank=True, verbose_name="Description")
    configuration = models.TextField(null=True, blank=True, verbose_name="Configuration")
    modified = models.BooleanField(blank=True, default=False, verbose_name="Modified")
    created_time = models.DateTimeField(auto_now_add=True, verbose_name="Create Time")
    updated_time = models.DateTimeField(auto_now=True, blank=True, null=True, verbose_name="Update Time")
