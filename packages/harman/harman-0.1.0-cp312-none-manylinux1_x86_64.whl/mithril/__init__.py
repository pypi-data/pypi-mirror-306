...
from .backends.backend import Backend, NotInstalledBackendMock
from .core import (
    DataType,
    bool,
    double,
...
try:
    ...
    JaxBackend = NotInstalledBackendMock  # type: ignore
