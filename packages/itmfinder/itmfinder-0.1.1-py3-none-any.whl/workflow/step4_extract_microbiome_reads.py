...
def extract_microbiome_reads(sample_info, is_single_end=False, TID=None):
    ...
    if is_single_end:
        extract_reads_i(kraken_file=kraken_output, seq_file1=fastq_r1, output_file1=output_r1, taxid=TID, report_file=report_file)
    else:
        fastq_r2 = fastq_r1.replace("_R1", "_R2")
        output_r2 = output_r1.replace("_1", "_2")
        extract_reads_i(kraken_file=kraken_output, seq_file1=fastq_r1, seq_file2=fastq_r2, output_file1=output_r1, output_file2=output_r2, taxid=TID, report_file=report_file)
...
def step4_extract_microbiome_reads(path3_hr, path4_ku1, path5_mr, batch_size=1, is_single_end=False, TID=None):
    ...
    print(" >>> Step-4 Extract Microbiome Reads...  ")
