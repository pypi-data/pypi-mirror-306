...
from itmfinder.itm_helper.kreport2mpa import kreport2mpai
...
def process_sample(sample_id, paths, db_ku, num_threads, force):
    ...
    kreport2mpai(report_path=kraken_report, output_path=os.path.join(path7_ku2, f"{sample_id}.kraken.mpa.txt"))
...
def step6_kraken2Bracken(path6_rcr, path7_ku2, path8_bracken, db_ku, num_threads=8, force=False):
    ...
    print(" >>> Step-6 Perform taxonomic classification using Kraken2...  ")
