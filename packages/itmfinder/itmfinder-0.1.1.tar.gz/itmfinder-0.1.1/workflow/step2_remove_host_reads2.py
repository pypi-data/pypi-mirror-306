...
def step2_remove_host_reads2(path3_hr, path3_hr2, db_bowtie2, suffix1="_host_remove_R1.fastq.gz", num_threads=8, batch_size=1, se=False):
    """
    ...
    print(" >>> Step-2 Remove host gene reads secondly...  ")
...
def main():
    ...
    step2_remove_host_reads2(args.path3_hr, args.path3_hr2, args.db_bowtie2, args.suffix1, args.num_threads, args.batch_size, args.se)
