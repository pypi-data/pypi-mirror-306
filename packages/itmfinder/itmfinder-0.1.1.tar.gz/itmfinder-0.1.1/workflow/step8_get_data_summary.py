...
def step8_get_data_summary(path2_fastp, path3_hr, path7_ku2, path6_rcr, out_dir):
    ...
    print(" >>> Step-8 Generate Data Summary...  ")
...
def main():
    ...
    step8_get_data_summary(args.path2_fastp, args.path3_hr, args.path7_ku2, args.path6_rcr, args.out_dir)
