...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 468, 1526))
...
#if QT_CONFIG(tooltip)
        self.check_Bordo.setToolTip(QCoreApplication.translate("ProcessTab", u"If activated the first vector is placed at 1/2 of spacing from the image border", None))
#endif // QT_CONFIG(tooltip)
