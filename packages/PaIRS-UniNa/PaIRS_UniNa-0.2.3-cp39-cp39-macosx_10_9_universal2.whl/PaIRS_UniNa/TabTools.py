        ...
        try:
            ...
            try:
                ...
                if FlagNewPar and (self.TABpar.flagRun!=0 or len(self.TABpar.link)>0):
                    ...
                    self.setTABpar(FlagAdjustPar=True,FlagBridge=self.FlagBridge,FlagCallback=False)
            except:
...
#*************************************************** Undo/redo
    ...
    def display_controls(self):
        ...
        if self.onlyReadLabel:
            ...
            FlagReset=self.TABpar.flagRun not in (0,-2) and len(self.TABpar.link)==0
            ...
            if FlagProcessTree and (FlagLabel or FlagReset or FlagCopy or FlagLink):
