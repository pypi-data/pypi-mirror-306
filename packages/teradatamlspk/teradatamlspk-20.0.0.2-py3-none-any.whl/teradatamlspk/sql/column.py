...
from teradatamlspk.sql.types import TimestampNTZType
...
class Column:
    ...
    def cast(self, dataType, format=None):
        ...
        if isinstance(dataType, TimestampNTZType) and isinstance(self._tdml_column._type, (VARCHAR, CHAR)):
            return Column(tdml_column=self._tdml_column.to_timestamp(format))
