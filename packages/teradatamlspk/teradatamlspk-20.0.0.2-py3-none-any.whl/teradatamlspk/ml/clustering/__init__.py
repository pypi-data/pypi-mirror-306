...
BisectingKMeansModel = type("BisectingKMeansModel", (_ClusteringModelMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})
BisectingKMeansSummary = type("BisectingKMeansSummary", (_Metrics, ), {})

KMeans = type("KMeans", (Params, _ClusteringMethods ), {})
KMeansModel = type("KMeansModel", (_ClusteringModelMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item), "hasSummary": True})
KMeansSummary = type("KMeansSummary", (_Metrics, ), {})

GaussianMixture = type("GaussianMixture", (Params, _ClusteringMethods ), {})
GaussianMixtureModel = type("GaussianMixtureModel", (_ClusteringModelMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item), "hasSummary": True})
GaussianMixtureSummary = type("GaussianMixtureSummary", (_Metrics, ), {})

LDA = type("LDA", (Params, ), {})
LDAModel = type("LDAModel", (_GenericMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})
