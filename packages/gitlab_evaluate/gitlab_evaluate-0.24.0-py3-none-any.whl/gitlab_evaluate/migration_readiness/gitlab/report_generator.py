    ...
    def get_projects_to_review(self, row_start_index):
        projects_to_review = [
            ('Outlier Projects', utils.get_if(utils.get_counta(self.flagged_projects.get_name(), 'A')+'=0', 0, utils.get_counta(self.flagged_projects.get_name(), 'A')+'-1'),
             utils.get_if(utils.get_countif(self.flagged_projects.get_name(), 'group', 'D')+'=0', 0, utils.get_countif(self.flagged_projects.get_name(), 'group', 'D'))),
            ('Pipelines > 5,000', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'I'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'I')),
            ('Issues > 5,000', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'K'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'K')),
            ('Branches > 1,000', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'M'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'M')),
            ('Commits > 50,000', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'O'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'O')),
            ('Merge Requests > 5,000', utils.get_countif(self.raw_output.get_name(), 'Tru*',
             'Q'), utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'Q')),
            ('Storage Size > 20 GB', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'S'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'S')),
            ('Repo Size > 5 GB', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'U'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'U')),
            ('Object Size', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'X'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'X')),
            ('Job Artifacts', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'Z'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'Z')),
            ('Snippets', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'AB'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'AB')),
            ('Uploads', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'AD'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'AD')),
            ('Tags > 5000', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'AF'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'AF')),
            ('Export Size > 5 GB', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'AK'),
             utils.get_countifs(self.raw_output.get_name(), 'group', 'D', 'Tru*', 'AK')),
            ('Export Size > 10 GB', utils.get_countif(self.raw_output.get_name(), 'Tru*', 'AL'),
