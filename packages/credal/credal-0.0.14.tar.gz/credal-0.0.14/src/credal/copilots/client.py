...
class CopilotsClient:
    ...
    def create_conversation(
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"agentId": agent_id, "userEmail": user_email},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            ...
            try:
                if 200 <= _response.status_code < 300:
                    ...
                    for _sse in _event_source.iter_sse():
                        try:
                            yield pydantic_v1.parse_obj_as(StreamingChunk, json.loads(_sse.data))  # type: ignore
                        except:
                            pass
                    return
                _response.read()
    ...
    def add_collection_to_copilot(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"copilotId": copilot_id, "collectionId": collection_id},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def update_configuration(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"copilotId": copilot_id, "configuration": configuration},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def delete_copilot(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v0/copilots/deleteCopilot", method="DELETE", json={"id": id}, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
