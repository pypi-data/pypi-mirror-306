    ...
    def check_resource_authorization_for_user(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"resourceIdentifier": resource_identifier, "userEmail": user_email, "disableCache": disable_cache},
    ...
    def check_bulk_resources_authorization_for_user(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"resourceIdentifiers": resource_identifiers, "userEmail": user_email, "disableCache": disable_cache},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def list_cached_authorized_resources_for_user(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"userEmail": user_email, "resourceType": resource_type, "limit": limit, "offset": offset},
            request_options=request_options,
            omit=OMIT,
        )
        try:
