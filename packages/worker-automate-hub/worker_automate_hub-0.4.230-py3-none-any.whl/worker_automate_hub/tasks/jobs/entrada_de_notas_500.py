    ...
    try:
        ...
        try:
            ...
            if button_location:
                ...
                raise FileNotFoundError("Botão 'Pesquisar' não encontrado.")
        ...
        if window_location:
            ...
            try:
                ...
                if button_location:
                    ...
                    raise FileNotFoundError("Botão 'Importar' não encontrado.")
            except FileNotFoundError:
                window_rect = main_window.rectangle()
                console.print(f"Area que sera utulizada para o screenshot {window_rect}...\n")
        ...
        console.print(f"Valor capturado {valores_restantes}, inserindo no campo Valor em Pagamento pelo Caixa... \n")
