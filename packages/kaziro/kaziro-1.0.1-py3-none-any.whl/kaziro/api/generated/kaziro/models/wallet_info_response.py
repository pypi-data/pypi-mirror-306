...
class WalletInfoResponse(BaseModel):
    ...
    wallets: List[Wallet] = Field(description="Wallet information")
    __properties: ClassVar[List[str]] = ["success", "message", "wallets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"success": obj.get("success"), "message": obj.get("message"), "wallets": [Wallet.from_dict(_item) for _item in obj["wallets"]] if obj.get("wallets") is not None else None}
        )
        return _obj
