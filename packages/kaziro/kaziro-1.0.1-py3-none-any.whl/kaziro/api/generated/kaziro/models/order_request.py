...
class OrderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order_type", "size", "market_id", "request_id", "probability"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"order_type": obj.get("order_type"), "size": obj.get("size"), "market_id": obj.get("market_id"), "request_id": obj.get("request_id"), "probability": obj.get("probability")}
        )
        return _obj
