...
class MarketPriceHistoryResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"markets": [MarketOHLCData.from_dict(_item) for _item in obj["markets"]] if obj.get("markets") is not None else None})
        return _obj
