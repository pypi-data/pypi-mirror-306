...
class PositionResponse(BaseModel):
    ...
    positions: List[PositionWithMarketAndOrders] = Field(description="List of historical or open positions")
    page: Optional[StrictInt] = Field(default=None, description="Current page number")
    __properties: ClassVar[List[str]] = ["positions", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"positions": [PositionWithMarketAndOrders.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None, "page": obj.get("page")}
        )
        return _obj
