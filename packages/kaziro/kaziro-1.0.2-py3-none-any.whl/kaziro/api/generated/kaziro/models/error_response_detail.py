...
class ErrorResponseDetail(BaseModel):
    ...
    message: StrictStr
    __properties: ClassVar[List[str]] = ["status", "status_code", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"status": obj.get("status") if obj.get("status") is not None else "error", "status_code": obj.get("status_code"), "message": obj.get("message")})
        return _obj
