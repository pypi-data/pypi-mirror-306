...
class Kaziro:
    ...
    class User:
        ...
        def retrieve(self, user_ids: Optional[List[str]] = None, usernames: Optional[List[str]] = None) -> UserProfileResponse:
    ...
    class Order:
        ...
        def retrieve(
            ...
            return self.api.get_open_orders_endpoint_v1_exchange_order_retrieve_get(order_ids, market_ids, outcome, filter_user, include_markets)
