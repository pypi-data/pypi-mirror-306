...
class AtomFactory():
  ...
  # create event Atoms
  def createElement(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return ElementAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createRollin(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return RollinAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createPopup(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return PopupAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createClickable(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return ClickableAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createFrame(self,title,selector,value='in',parent_selector=None,timeout=None,selector_template=None):
    return FrameAtom(title,selector,value,parent_selector,timeout,selector_template)
  
  # create writer Atoms
  def createInput(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return InputAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createTextArea(self,title,selector,value=None,LF_count=1,parent_selector=None,timeout=None,selector_template=None):
    return TextAreaAtom(title,selector,value,LF_count,parent_selector,timeout,selector_template)

  def createJSTextArea(self,title,selector,value=None,LF_count=1,parent_selector=None,timeout=None,selector_template=None):
    return JSTextAreaAtom(title,selector,value,LF_count,parent_selector,timeout,selector_template)

  def createFile(self,title,selector,value=None,wait_time=5,parent_selector=None,timeout=None,selector_template=None):
    return FileAtom(title,selector,value,wait_time,parent_selector,timeout,selector_template)

  def createSelect(self,title,selector,value=True,parent_selector=None,timeout=None,selector_template=None):
    return SelectAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createChoice(self,title,selector,value=True,parent_selector=None,timeout=None,selector_template=None):
    return ChoiceAtom(title,selector,value,parent_selector,timeout,selector_template)

  # reader atoms
  def createText(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return TextAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createValue(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return ValueAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createAttr(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
    return AttrAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createShot(self,title,selector=None,value=None,parent_selector=None,timeout=None,selector_template=None):
    return ShotAtom(title,selector,value,parent_selector,timeout,selector_template)

  def createCss(self,title,selector,value=None,parent_selector=None,timeout=None,selector_template=None):
