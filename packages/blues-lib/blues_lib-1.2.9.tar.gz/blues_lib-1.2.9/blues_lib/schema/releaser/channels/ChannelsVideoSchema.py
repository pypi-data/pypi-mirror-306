...
class ChannelsVideoSchema(VideoReleaserSchema):
  ...
  def create_fill_atom(self):
    atoms = [
      ...
      self.atom_factory.createClickable('select a activity','.activity-filter-wrap .option-item:nth-of-type(2)',selector_template='.activity-filter-wrap .option-item:nth-of-type(${activity_nth})'),
