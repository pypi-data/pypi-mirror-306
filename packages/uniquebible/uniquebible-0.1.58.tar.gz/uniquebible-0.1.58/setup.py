...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            f"uba={package}.uba:stream",
            f"ubaapi={package}.uba:api",
            f"ubahttp={package}.uba:http",
            f"ubassh={package}.uba:ssh",
            f"ubatelnet={package}.uba:telnet",
            f"ubaterm={package}.uba:term",
        ],
    },
