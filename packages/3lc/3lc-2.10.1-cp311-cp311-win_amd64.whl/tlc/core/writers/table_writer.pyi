...
class TableWriter:
    ...
    url: Incomplete
    def __init__(self, table_name: str = ..., dataset_name: str = ..., project_name: str = ..., description: str = '', column_schemas: Mapping[str, _SampleTypeStructure] | None = None, if_exists: Literal['overwrite', 'rename', 'raise'] = 'rename', root_url: Url | str | None = None, input_tables: list[Url] | None = None, *, table_url: Url | str | None = None) -> None:
