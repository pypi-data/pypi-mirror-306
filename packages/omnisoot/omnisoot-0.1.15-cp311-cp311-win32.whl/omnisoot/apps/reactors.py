...
class PlugFlowReactor(ReactorAbstract, CPFRSoot):
    ...
    def start(self):
        ...
        if self.check_soot_array(inlet_soot):
            ...
            y0 = np.hstack((0.0, self.get_norm_mdot(), self.inlet.T, self.inlet.P, self.inlet.Y, inlet_soot));
...
class PerfectlyStirredReactor(ReactorAbstract, CPSRSoot):
    ...
    ## Inflow parameters
    @property
    def soot_mass_flux_in(self) -> float:
        return (
            (
    ...
    @property
    def total_carbon_flux_in(self) -> float:
        return (
            (
                np.sum(
    ...
    @property
    def gas_carbon_flux_in(self) -> float:
        return (
            (
                np.sum(
                    self.soot_wrapper.soot_gas.MW_carbon_array / self.soot_wrapper.soot_gas.MW_array * self.Y_in
    ...
    @property
    def soot_carbon_flux_in(self) -> float:
        return (
            (
                self.soot_carbon_mass_in
            )
    ...
    @property
    def total_hydrogen_flux_in(self) -> float:
        return (
            (
                np.sum(
    ...
    @property
    def gas_hydrogen_flux_in(self) -> float:
        return (
            (
                np.sum(
                    self.soot_wrapper.soot_gas.MW_hydrogen_array / self.soot_wrapper.soot_gas.MW_array * self.Y_in
    ...
    @property
    def soot_hydrogen_flux_in(self) -> float:
        return (
            (
                self.soot_hydrogen_mass_in
            )
    ...
    ## Outflow parameters
    @property
    def soot_mass_flux_out(self) -> float:
        return (
            (
                self.soot_wrapper.particle_dynamics_model.carbon_mass()
                + self.soot_wrapper.particle_dynamics_model.hydrogen_mass()
    ...
    @property
    def total_carbon_flux_out(self) -> float:
        return (
                (self.soot_gas.elemental_mass_fraction('C') +
    ...
    @property
    def gas_hydrogen_flux_out(self) -> float:
        return (
