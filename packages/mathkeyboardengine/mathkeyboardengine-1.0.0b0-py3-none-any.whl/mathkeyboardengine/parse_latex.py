...
from mathkeyboardengine import AscendingBranchingNode, DecimalSeparatorNode, DescendingBranchingNode, DigitNode, KeyboardMemory, MatrixNode, RoundBracketsNode, StandardBranchingNode, StandardLeafNode, insert, insert_with_encapsulate_current, move_right
from mathkeyboardengine._helpers.coalesce import coalesce
from mathkeyboardengine._helpers.first_or_none import first_or_none
from mathkeyboardengine._helpers.get_bracket_pair_content import get_bracket_pair_content
from mathkeyboardengine.LatexParserConfiguration import LatexParserConfiguration
...
def parse_latex(latex: Union[str, None], latexparserconfiguration: Union[LatexParserConfiguration, None] = None) -> KeyboardMemory:
    ...
    while x != '':
        ...
        various = [('^{', lambda: AscendingBranchingNode('', '^{', '}')), ('_{', lambda: DescendingBranchingNode('', '_{', '}'))]
