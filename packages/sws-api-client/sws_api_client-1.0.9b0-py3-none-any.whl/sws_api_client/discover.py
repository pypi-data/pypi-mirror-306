...
class Discover:
    ...
    def call(self, method: str, endpoint: str, path: str, params: dict = None, headers: dict = None, data: dict = None, options: dict = None) -> dict:
        if not endpoint:
    ...
    def post(self, endpoint, path: str, data: dict = None, params: dict = None, headers: dict = None, options:dict = None) -> dict|requests.Response:
        return self.call("POST", endpoint, path, params=params, headers=headers, data=data, options=options)
