...
class Datasets:
    ...
    def import_data_chunk(self, dataset_id: str, file_path: str, sessionId: Optional[int] = None) -> dict:
        ...
        response = self.sws_client.discoverable.post('is_api', url, data=data, files=files)
    ...
    def import_data_concurrent(self, dataset_id: str, file_path: str, sessionId: Optional[int] = None, chunk_size: int = 10000, max_workers: int = 5) -> None:
        """Splits the CSV and imports chunks concurrently with limited workers, showing a progress bar."""
        ...
        with tqdm(total=total_chunks, desc="Importing chunks", unit="chunk") as pbar:
            # Step 3: Use ThreadPoolExecutor to manage parallel imports
            with ThreadPoolExecutor(max_workers=max_workers) as executor:
                ...
                # Step 4: Collect and manage job statuses
        ...
        # Step 5: Wait for all jobs to complete and clean up temporary files
