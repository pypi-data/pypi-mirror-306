...
class VectorConstIProjMatrix(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _gstlearn.VectorConstIProjMatrix_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _gstlearn.VectorConstIProjMatrix___nonzero__(self)

    def __bool__(self):
        return _gstlearn.VectorConstIProjMatrix___bool__(self)

    def __len__(self):
        return _gstlearn.VectorConstIProjMatrix___len__(self)

    def __getslice__(self, i, j):
        return _gstlearn.VectorConstIProjMatrix___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _gstlearn.VectorConstIProjMatrix___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _gstlearn.VectorConstIProjMatrix___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _gstlearn.VectorConstIProjMatrix___delitem__(self, *args)

    def __getitem__(self, *args):
        return _gstlearn.VectorConstIProjMatrix___getitem__(self, *args)

    def __setitem__(self, *args):
        return _gstlearn.VectorConstIProjMatrix___setitem__(self, *args)

    def pop(self):
        return _gstlearn.VectorConstIProjMatrix_pop(self)

    def append(self, x):
        return _gstlearn.VectorConstIProjMatrix_append(self, x)

    def empty(self):
        return _gstlearn.VectorConstIProjMatrix_empty(self)

    def size(self):
        return _gstlearn.VectorConstIProjMatrix_size(self)

    def swap(self, v):
        return _gstlearn.VectorConstIProjMatrix_swap(self, v)

    def begin(self):
        return _gstlearn.VectorConstIProjMatrix_begin(self)

    def end(self):
        return _gstlearn.VectorConstIProjMatrix_end(self)

    def rbegin(self):
        return _gstlearn.VectorConstIProjMatrix_rbegin(self)

    def rend(self):
        return _gstlearn.VectorConstIProjMatrix_rend(self)

    def clear(self):
        return _gstlearn.VectorConstIProjMatrix_clear(self)

    def get_allocator(self):
        return _gstlearn.VectorConstIProjMatrix_get_allocator(self)

    def pop_back(self):
        return _gstlearn.VectorConstIProjMatrix_pop_back(self)

    def erase(self, *args):
        return _gstlearn.VectorConstIProjMatrix_erase(self, *args)

    def __init__(self, *args):
        _gstlearn.VectorConstIProjMatrix_swiginit(self, _gstlearn.new_VectorConstIProjMatrix(*args))

    def push_back(self, x):
        return _gstlearn.VectorConstIProjMatrix_push_back(self, x)

    def front(self):
        return _gstlearn.VectorConstIProjMatrix_front(self)

    def back(self):
        return _gstlearn.VectorConstIProjMatrix_back(self)

    def assign(self, n, x):
        return _gstlearn.VectorConstIProjMatrix_assign(self, n, x)

    def resize(self, *args):
        return _gstlearn.VectorConstIProjMatrix_resize(self, *args)

    def insert(self, *args):
        return _gstlearn.VectorConstIProjMatrix_insert(self, *args)

    def reserve(self, n):
        return _gstlearn.VectorConstIProjMatrix_reserve(self, n)

    def capacity(self):
        return _gstlearn.VectorConstIProjMatrix_capacity(self)
    __swig_destroy__ = _gstlearn.delete_VectorConstIProjMatrix

# Register VectorConstIProjMatrix in _gstlearn:
_gstlearn.VectorConstIProjMatrix_swigregister(VectorConstIProjMatrix)
...
class VVectorConstIProjMatrix(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _gstlearn.VVectorConstIProjMatrix_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _gstlearn.VVectorConstIProjMatrix___nonzero__(self)

    def __bool__(self):
        return _gstlearn.VVectorConstIProjMatrix___bool__(self)

    def __len__(self):
        return _gstlearn.VVectorConstIProjMatrix___len__(self)

    def __getslice__(self, i, j):
        return _gstlearn.VVectorConstIProjMatrix___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _gstlearn.VVectorConstIProjMatrix___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _gstlearn.VVectorConstIProjMatrix___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _gstlearn.VVectorConstIProjMatrix___delitem__(self, *args)

    def __getitem__(self, *args):
        return _gstlearn.VVectorConstIProjMatrix___getitem__(self, *args)

    def __setitem__(self, *args):
        return _gstlearn.VVectorConstIProjMatrix___setitem__(self, *args)

    def pop(self):
        return _gstlearn.VVectorConstIProjMatrix_pop(self)

    def append(self, x):
        return _gstlearn.VVectorConstIProjMatrix_append(self, x)

    def empty(self):
        return _gstlearn.VVectorConstIProjMatrix_empty(self)

    def size(self):
        return _gstlearn.VVectorConstIProjMatrix_size(self)

    def swap(self, v):
        return _gstlearn.VVectorConstIProjMatrix_swap(self, v)

    def begin(self):
        return _gstlearn.VVectorConstIProjMatrix_begin(self)

    def end(self):
        return _gstlearn.VVectorConstIProjMatrix_end(self)

    def rbegin(self):
        return _gstlearn.VVectorConstIProjMatrix_rbegin(self)

    def rend(self):
        return _gstlearn.VVectorConstIProjMatrix_rend(self)

    def clear(self):
        return _gstlearn.VVectorConstIProjMatrix_clear(self)

    def get_allocator(self):
        return _gstlearn.VVectorConstIProjMatrix_get_allocator(self)

    def pop_back(self):
        return _gstlearn.VVectorConstIProjMatrix_pop_back(self)

    def erase(self, *args):
        return _gstlearn.VVectorConstIProjMatrix_erase(self, *args)

    def __init__(self, *args):
        _gstlearn.VVectorConstIProjMatrix_swiginit(self, _gstlearn.new_VVectorConstIProjMatrix(*args))

    def push_back(self, x):
        return _gstlearn.VVectorConstIProjMatrix_push_back(self, x)

    def front(self):
        return _gstlearn.VVectorConstIProjMatrix_front(self)

    def back(self):
        return _gstlearn.VVectorConstIProjMatrix_back(self)

    def assign(self, n, x):
        return _gstlearn.VVectorConstIProjMatrix_assign(self, n, x)

    def resize(self, *args):
        return _gstlearn.VVectorConstIProjMatrix_resize(self, *args)

    def insert(self, *args):
        return _gstlearn.VVectorConstIProjMatrix_insert(self, *args)

    def reserve(self, n):
        return _gstlearn.VVectorConstIProjMatrix_reserve(self, n)

    def capacity(self):
        return _gstlearn.VVectorConstIProjMatrix_capacity(self)
    __swig_destroy__ = _gstlearn.delete_VVectorConstIProjMatrix

# Register VVectorConstIProjMatrix in _gstlearn:
_gstlearn.VVectorConstIProjMatrix_swigregister(VVectorConstIProjMatrix)
...
def variogram_pgs(db, varioparam, ruleprop, flag_rho=False, opt_correl=2):
...
def simsph_mesh(mesh, model, sphepar, seed=54523, verbose=False):
...
class EKrigOpt(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EKrigOpt_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EKrigOpt_getAllDescr()
...
def EKrigOpt_getSize():
    return _gstlearn.EKrigOpt_getSize()

def EKrigOpt_getIterator():
    return _gstlearn.EKrigOpt_getIterator()

def EKrigOpt_printAll():
    return _gstlearn.EKrigOpt_printAll()

def EKrigOpt_getAllKeys():
    return _gstlearn.EKrigOpt_getAllKeys()

def EKrigOpt_getAllDescr():
    return _gstlearn.EKrigOpt_getAllDescr()

def EKrigOpt_existsKey(key):
    return _gstlearn.EKrigOpt_existsKey(key)

def EKrigOpt_existsValue(value):
    return _gstlearn.EKrigOpt_existsValue(value)

def EKrigOpt_fromKey(key):
    return _gstlearn.EKrigOpt_fromKey(key)

def EKrigOpt_fromValue(value):
    return _gstlearn.EKrigOpt_fromValue(value)

def EKrigOpt_fromKeys(keys):
    return _gstlearn.EKrigOpt_fromKeys(keys)

def EKrigOpt_fromValues(values):
    return _gstlearn.EKrigOpt_fromValues(values)
cvar = _gstlearn.cvar
...
class ESPDECalcMode(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ESPDECalcMode_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ESPDECalcMode_getAllDescr()
...
def ESPDECalcMode_getSize():
    return _gstlearn.ESPDECalcMode_getSize()

def ESPDECalcMode_getIterator():
    return _gstlearn.ESPDECalcMode_getIterator()

def ESPDECalcMode_printAll():
    return _gstlearn.ESPDECalcMode_printAll()

def ESPDECalcMode_getAllKeys():
    return _gstlearn.ESPDECalcMode_getAllKeys()

def ESPDECalcMode_getAllDescr():
    return _gstlearn.ESPDECalcMode_getAllDescr()

def ESPDECalcMode_existsKey(key):
    return _gstlearn.ESPDECalcMode_existsKey(key)

def ESPDECalcMode_existsValue(value):
    return _gstlearn.ESPDECalcMode_existsValue(value)

def ESPDECalcMode_fromKey(key):
    return _gstlearn.ESPDECalcMode_fromKey(key)

def ESPDECalcMode_fromValue(value):
    return _gstlearn.ESPDECalcMode_fromValue(value)

def ESPDECalcMode_fromKeys(keys):
    return _gstlearn.ESPDECalcMode_fromKeys(keys)

def ESPDECalcMode_fromValues(values):
    return _gstlearn.ESPDECalcMode_fromValues(values)
...
class EAnam(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EAnam_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EAnam_getAllDescr()
...
def EAnam_getIterator():
    return _gstlearn.EAnam_getIterator()

def EAnam_printAll():
    return _gstlearn.EAnam_printAll()

def EAnam_getAllKeys():
    return _gstlearn.EAnam_getAllKeys()

def EAnam_getAllDescr():
    return _gstlearn.EAnam_getAllDescr()

def EAnam_existsKey(key):
    return _gstlearn.EAnam_existsKey(key)

def EAnam_existsValue(value):
    return _gstlearn.EAnam_existsValue(value)

def EAnam_fromKey(key):
    return _gstlearn.EAnam_fromKey(key)

def EAnam_fromValue(value):
    return _gstlearn.EAnam_fromValue(value)

def EAnam_fromKeys(keys):
    return _gstlearn.EAnam_fromKeys(keys)

def EAnam_fromValues(values):
    return _gstlearn.EAnam_fromValues(values)
...
class ECst(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ECst_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ECst_getAllDescr()
...
def ECst_getAllDescr():
    return _gstlearn.ECst_getAllDescr()

def ECst_existsKey(key):
    return _gstlearn.ECst_existsKey(key)

def ECst_existsValue(value):
    return _gstlearn.ECst_existsValue(value)

def ECst_fromKey(key):
    return _gstlearn.ECst_fromKey(key)

def ECst_fromValue(value):
    return _gstlearn.ECst_fromValue(value)

def ECst_fromKeys(keys):
    return _gstlearn.ECst_fromKeys(keys)

def ECst_fromValues(values):
    return _gstlearn.ECst_fromValues(values)
...
class EDbg(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EDbg_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EDbg_getAllDescr()
...
def EDbg_getAllDescr():
    return _gstlearn.EDbg_getAllDescr()

def EDbg_existsKey(key):
    return _gstlearn.EDbg_existsKey(key)

def EDbg_existsValue(value):
    return _gstlearn.EDbg_existsValue(value)

def EDbg_fromKey(key):
    return _gstlearn.EDbg_fromKey(key)

def EDbg_fromValue(value):
    return _gstlearn.EDbg_fromValue(value)

def EDbg_fromKeys(keys):
    return _gstlearn.EDbg_fromKeys(keys)

def EDbg_fromValues(values):
    return _gstlearn.EDbg_fromValues(values)
...
class ELaw(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ELaw_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ELaw_getAllDescr()
...
def ELaw_getAllDescr():
    return _gstlearn.ELaw_getAllDescr()

def ELaw_existsKey(key):
    return _gstlearn.ELaw_existsKey(key)

def ELaw_existsValue(value):
    return _gstlearn.ELaw_existsValue(value)

def ELaw_fromKey(key):
    return _gstlearn.ELaw_fromKey(key)

def ELaw_fromValue(value):
    return _gstlearn.ELaw_fromValue(value)

def ELaw_fromKeys(keys):
    return _gstlearn.ELaw_fromKeys(keys)

def ELaw_fromValues(values):
    return _gstlearn.ELaw_fromValues(values)
...
class EShape(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EShape_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EShape_getAllDescr()
...
def EShape_getIterator():
    return _gstlearn.EShape_getIterator()

def EShape_printAll():
    return _gstlearn.EShape_printAll()

def EShape_getAllKeys():
    return _gstlearn.EShape_getAllKeys()

def EShape_getAllDescr():
    return _gstlearn.EShape_getAllDescr()

def EShape_existsKey(key):
    return _gstlearn.EShape_existsKey(key)

def EShape_existsValue(value):
    return _gstlearn.EShape_existsValue(value)

def EShape_fromKey(key):
    return _gstlearn.EShape_fromKey(key)

def EShape_fromValue(value):
    return _gstlearn.EShape_fromValue(value)

def EShape_fromKeys(keys):
    return _gstlearn.EShape_fromKeys(keys)

def EShape_fromValues(values):
    return _gstlearn.EShape_fromValues(values)
...
class EConvDir(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EConvDir_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EConvDir_getAllDescr()
...
def EConvDir_getSize():
    return _gstlearn.EConvDir_getSize()

def EConvDir_getIterator():
    return _gstlearn.EConvDir_getIterator()

def EConvDir_printAll():
    return _gstlearn.EConvDir_printAll()

def EConvDir_getAllKeys():
    return _gstlearn.EConvDir_getAllKeys()

def EConvDir_getAllDescr():
    return _gstlearn.EConvDir_getAllDescr()

def EConvDir_existsKey(key):
    return _gstlearn.EConvDir_existsKey(key)

def EConvDir_existsValue(value):
    return _gstlearn.EConvDir_existsValue(value)

def EConvDir_fromKey(key):
    return _gstlearn.EConvDir_fromKey(key)

def EConvDir_fromValue(value):
    return _gstlearn.EConvDir_fromValue(value)

def EConvDir_fromKeys(keys):
    return _gstlearn.EConvDir_fromKeys(keys)

def EConvDir_fromValues(values):
    return _gstlearn.EConvDir_fromValues(values)
...
class ECalcVario(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ECalcVario_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ECalcVario_getAllDescr()
...
def ECalcVario_getSize():
    return _gstlearn.ECalcVario_getSize()

def ECalcVario_getIterator():
    return _gstlearn.ECalcVario_getIterator()

def ECalcVario_printAll():
    return _gstlearn.ECalcVario_printAll()

def ECalcVario_getAllKeys():
    return _gstlearn.ECalcVario_getAllKeys()

def ECalcVario_getAllDescr():
    return _gstlearn.ECalcVario_getAllDescr()

def ECalcVario_existsKey(key):
    return _gstlearn.ECalcVario_existsKey(key)

def ECalcVario_existsValue(value):
    return _gstlearn.ECalcVario_existsValue(value)

def ECalcVario_fromKey(key):
    return _gstlearn.ECalcVario_fromKey(key)

def ECalcVario_fromValue(value):
    return _gstlearn.ECalcVario_fromValue(value)

def ECalcVario_fromKeys(keys):
    return _gstlearn.ECalcVario_fromKeys(keys)

def ECalcVario_fromValues(values):
    return _gstlearn.ECalcVario_fromValues(values)
...
class EConvType(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EConvType_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EConvType_getAllDescr()
...
def EConvType_getSize():
    return _gstlearn.EConvType_getSize()

def EConvType_getIterator():
    return _gstlearn.EConvType_getIterator()

def EConvType_printAll():
    return _gstlearn.EConvType_printAll()

def EConvType_getAllKeys():
    return _gstlearn.EConvType_getAllKeys()

def EConvType_getAllDescr():
    return _gstlearn.EConvType_getAllDescr()

def EConvType_existsKey(key):
    return _gstlearn.EConvType_existsKey(key)

def EConvType_existsValue(value):
    return _gstlearn.EConvType_existsValue(value)

def EConvType_fromKey(key):
    return _gstlearn.EConvType_fromKey(key)

def EConvType_fromValue(value):
    return _gstlearn.EConvType_fromValue(value)

def EConvType_fromKeys(keys):
    return _gstlearn.EConvType_fromKeys(keys)

def EConvType_fromValues(values):
    return _gstlearn.EConvType_fromValues(values)
...
class ECov(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ECov_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ECov_getAllDescr()
...
def ECov_getAllDescr():
    return _gstlearn.ECov_getAllDescr()

def ECov_existsKey(key):
    return _gstlearn.ECov_existsKey(key)

def ECov_existsValue(value):
    return _gstlearn.ECov_existsValue(value)

def ECov_fromKey(key):
    return _gstlearn.ECov_fromKey(key)

def ECov_fromValue(value):
    return _gstlearn.ECov_fromValue(value)

def ECov_fromKeys(keys):
    return _gstlearn.ECov_fromKeys(keys)

def ECov_fromValues(values):
    return _gstlearn.ECov_fromValues(values)
...
class ETape(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ETape_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ETape_getAllDescr()
...
def ETape_getIterator():
    return _gstlearn.ETape_getIterator()

def ETape_printAll():
    return _gstlearn.ETape_printAll()

def ETape_getAllKeys():
    return _gstlearn.ETape_getAllKeys()

def ETape_getAllDescr():
    return _gstlearn.ETape_getAllDescr()

def ETape_existsKey(key):
    return _gstlearn.ETape_existsKey(key)

def ETape_existsValue(value):
    return _gstlearn.ETape_existsValue(value)

def ETape_fromKey(key):
    return _gstlearn.ETape_fromKey(key)

def ETape_fromValue(value):
    return _gstlearn.ETape_fromValue(value)

def ETape_fromKeys(keys):
    return _gstlearn.ETape_fromKeys(keys)

def ETape_fromValues(values):
    return _gstlearn.ETape_fromValues(values)
...
class ELoadBy(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ELoadBy_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ELoadBy_getAllDescr()
...
def ELoadBy_getIterator():
    return _gstlearn.ELoadBy_getIterator()

def ELoadBy_printAll():
    return _gstlearn.ELoadBy_printAll()

def ELoadBy_getAllKeys():
    return _gstlearn.ELoadBy_getAllKeys()

def ELoadBy_getAllDescr():
    return _gstlearn.ELoadBy_getAllDescr()

def ELoadBy_existsKey(key):
    return _gstlearn.ELoadBy_existsKey(key)

def ELoadBy_existsValue(value):
    return _gstlearn.ELoadBy_existsValue(value)

def ELoadBy_fromKey(key):
    return _gstlearn.ELoadBy_fromKey(key)

def ELoadBy_fromValue(value):
    return _gstlearn.ELoadBy_fromValue(value)

def ELoadBy_fromKeys(keys):
    return _gstlearn.ELoadBy_fromKeys(keys)

def ELoadBy_fromValues(values):
    return _gstlearn.ELoadBy_fromValues(values)
...
class ELoc(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ELoc_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ELoc_getAllDescr()
...
def ELoc_getAllDescr():
    return _gstlearn.ELoc_getAllDescr()

def ELoc_existsKey(key):
    return _gstlearn.ELoc_existsKey(key)

def ELoc_existsValue(value):
    return _gstlearn.ELoc_existsValue(value)

def ELoc_fromKey(key):
    return _gstlearn.ELoc_fromKey(key)

def ELoc_fromValue(value):
    return _gstlearn.ELoc_fromValue(value)

def ELoc_fromKeys(keys):
    return _gstlearn.ELoc_fromKeys(keys)

def ELoc_fromValues(values):
    return _gstlearn.ELoc_fromValues(values)
...
class EOperator(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EOperator_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EOperator_getAllDescr()
...
def EOperator_getSize():
    return _gstlearn.EOperator_getSize()

def EOperator_getIterator():
    return _gstlearn.EOperator_getIterator()

def EOperator_printAll():
    return _gstlearn.EOperator_printAll()

def EOperator_getAllKeys():
    return _gstlearn.EOperator_getAllKeys()

def EOperator_getAllDescr():
    return _gstlearn.EOperator_getAllDescr()

def EOperator_existsKey(key):
    return _gstlearn.EOperator_existsKey(key)

def EOperator_existsValue(value):
    return _gstlearn.EOperator_existsValue(value)

def EOperator_fromKey(key):
    return _gstlearn.EOperator_fromKey(key)

def EOperator_fromValue(value):
    return _gstlearn.EOperator_fromValue(value)

def EOperator_fromKeys(keys):
    return _gstlearn.EOperator_fromKeys(keys)

def EOperator_fromValues(values):
    return _gstlearn.EOperator_fromValues(values)
...
class EPowerPT(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EPowerPT_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EPowerPT_getAllDescr()
...
def EPowerPT_getSize():
    return _gstlearn.EPowerPT_getSize()

def EPowerPT_getIterator():
    return _gstlearn.EPowerPT_getIterator()

def EPowerPT_printAll():
    return _gstlearn.EPowerPT_printAll()

def EPowerPT_getAllKeys():
    return _gstlearn.EPowerPT_getAllKeys()

def EPowerPT_getAllDescr():
    return _gstlearn.EPowerPT_getAllDescr()

def EPowerPT_existsKey(key):
    return _gstlearn.EPowerPT_existsKey(key)

def EPowerPT_existsValue(value):
    return _gstlearn.EPowerPT_existsValue(value)

def EPowerPT_fromKey(key):
    return _gstlearn.EPowerPT_fromKey(key)

def EPowerPT_fromValue(value):
    return _gstlearn.EPowerPT_fromValue(value)

def EPowerPT_fromKeys(keys):
    return _gstlearn.EPowerPT_fromKeys(keys)

def EPowerPT_fromValues(values):
    return _gstlearn.EPowerPT_fromValues(values)
...
class ERule(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ERule_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ERule_getAllDescr()
...
def ERule_getIterator():
    return _gstlearn.ERule_getIterator()

def ERule_printAll():
    return _gstlearn.ERule_printAll()

def ERule_getAllKeys():
    return _gstlearn.ERule_getAllKeys()

def ERule_getAllDescr():
    return _gstlearn.ERule_getAllDescr()

def ERule_existsKey(key):
    return _gstlearn.ERule_existsKey(key)

def ERule_existsValue(value):
    return _gstlearn.ERule_existsValue(value)

def ERule_fromKey(key):
    return _gstlearn.ERule_fromKey(key)

def ERule_fromValue(value):
    return _gstlearn.ERule_fromValue(value)

def ERule_fromKeys(keys):
    return _gstlearn.ERule_fromKeys(keys)

def ERule_fromValues(values):
    return _gstlearn.ERule_fromValues(values)
...
class EConsElem(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EConsElem_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EConsElem_getAllDescr()
...
def EConsElem_getSize():
    return _gstlearn.EConsElem_getSize()

def EConsElem_getIterator():
    return _gstlearn.EConsElem_getIterator()

def EConsElem_printAll():
    return _gstlearn.EConsElem_printAll()

def EConsElem_getAllKeys():
    return _gstlearn.EConsElem_getAllKeys()

def EConsElem_getAllDescr():
    return _gstlearn.EConsElem_getAllDescr()

def EConsElem_existsKey(key):
    return _gstlearn.EConsElem_existsKey(key)

def EConsElem_existsValue(value):
    return _gstlearn.EConsElem_existsValue(value)

def EConsElem_fromKey(key):
    return _gstlearn.EConsElem_fromKey(key)

def EConsElem_fromValue(value):
    return _gstlearn.EConsElem_fromValue(value)

def EConsElem_fromKeys(keys):
    return _gstlearn.EConsElem_fromKeys(keys)

def EConsElem_fromValues(values):
    return _gstlearn.EConsElem_fromValues(values)
...
class EConsType(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EConsType_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EConsType_getAllDescr()
...
def EConsType_getSize():
    return _gstlearn.EConsType_getSize()

def EConsType_getIterator():
    return _gstlearn.EConsType_getIterator()

def EConsType_printAll():
    return _gstlearn.EConsType_printAll()

def EConsType_getAllKeys():
    return _gstlearn.EConsType_getAllKeys()

def EConsType_getAllDescr():
    return _gstlearn.EConsType_getAllDescr()

def EConsType_existsKey(key):
    return _gstlearn.EConsType_existsKey(key)

def EConsType_existsValue(value):
    return _gstlearn.EConsType_existsValue(value)

def EConsType_fromKey(key):
    return _gstlearn.EConsType_fromKey(key)

def EConsType_fromValue(value):
    return _gstlearn.EConsType_fromValue(value)

def EConsType_fromKeys(keys):
    return _gstlearn.EConsType_fromKeys(keys)

def EConsType_fromValues(values):
    return _gstlearn.EConsType_fromValues(values)
...
class EModelProperty(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EModelProperty_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EModelProperty_getAllDescr()
...
def EModelProperty_getSize():
    return _gstlearn.EModelProperty_getSize()

def EModelProperty_getIterator():
    return _gstlearn.EModelProperty_getIterator()

def EModelProperty_printAll():
    return _gstlearn.EModelProperty_printAll()

def EModelProperty_getAllKeys():
    return _gstlearn.EModelProperty_getAllKeys()

def EModelProperty_getAllDescr():
    return _gstlearn.EModelProperty_getAllDescr()

def EModelProperty_existsKey(key):
    return _gstlearn.EModelProperty_existsKey(key)

def EModelProperty_existsValue(value):
    return _gstlearn.EModelProperty_existsValue(value)

def EModelProperty_fromKey(key):
    return _gstlearn.EModelProperty_fromKey(key)

def EModelProperty_fromValue(value):
    return _gstlearn.EModelProperty_fromValue(value)

def EModelProperty_fromKeys(keys):
    return _gstlearn.EModelProperty_fromKeys(keys)

def EModelProperty_fromValues(values):
    return _gstlearn.EModelProperty_fromValues(values)
...
class EMorpho(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EMorpho_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EMorpho_getAllDescr()
...
def EMorpho_getIterator():
    return _gstlearn.EMorpho_getIterator()

def EMorpho_printAll():
    return _gstlearn.EMorpho_printAll()

def EMorpho_getAllKeys():
    return _gstlearn.EMorpho_getAllKeys()

def EMorpho_getAllDescr():
    return _gstlearn.EMorpho_getAllDescr()

def EMorpho_existsKey(key):
    return _gstlearn.EMorpho_existsKey(key)

def EMorpho_existsValue(value):
    return _gstlearn.EMorpho_existsValue(value)

def EMorpho_fromKey(key):
    return _gstlearn.EMorpho_fromKey(key)

def EMorpho_fromValue(value):
    return _gstlearn.EMorpho_fromValue(value)

def EMorpho_fromKeys(keys):
    return _gstlearn.EMorpho_fromKeys(keys)

def EMorpho_fromValues(values):
    return _gstlearn.EMorpho_fromValues(values)
...
class ENeigh(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ENeigh_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ENeigh_getAllDescr()
...
def ENeigh_getIterator():
    return _gstlearn.ENeigh_getIterator()

def ENeigh_printAll():
    return _gstlearn.ENeigh_printAll()

def ENeigh_getAllKeys():
    return _gstlearn.ENeigh_getAllKeys()

def ENeigh_getAllDescr():
    return _gstlearn.ENeigh_getAllDescr()

def ENeigh_existsKey(key):
    return _gstlearn.ENeigh_existsKey(key)

def ENeigh_existsValue(value):
    return _gstlearn.ENeigh_existsValue(value)

def ENeigh_fromKey(key):
    return _gstlearn.ENeigh_fromKey(key)

def ENeigh_fromValue(value):
    return _gstlearn.ENeigh_fromValue(value)

def ENeigh_fromKeys(keys):
    return _gstlearn.ENeigh_fromKeys(keys)

def ENeigh_fromValues(values):
    return _gstlearn.ENeigh_fromValues(values)
...
class ESpaceType(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ESpaceType_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ESpaceType_getAllDescr()
...
def ESpaceType_getSize():
    return _gstlearn.ESpaceType_getSize()

def ESpaceType_getIterator():
    return _gstlearn.ESpaceType_getIterator()

def ESpaceType_printAll():
    return _gstlearn.ESpaceType_printAll()

def ESpaceType_getAllKeys():
    return _gstlearn.ESpaceType_getAllKeys()

def ESpaceType_getAllDescr():
    return _gstlearn.ESpaceType_getAllDescr()

def ESpaceType_existsKey(key):
    return _gstlearn.ESpaceType_existsKey(key)

def ESpaceType_existsValue(value):
    return _gstlearn.ESpaceType_existsValue(value)

def ESpaceType_fromKey(key):
    return _gstlearn.ESpaceType_fromKey(key)

def ESpaceType_fromValue(value):
    return _gstlearn.ESpaceType_fromValue(value)

def ESpaceType_fromKeys(keys):
    return _gstlearn.ESpaceType_fromKeys(keys)

def ESpaceType_fromValues(values):
    return _gstlearn.ESpaceType_fromValues(values)
...
class ESelectivity(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ESelectivity_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ESelectivity_getAllDescr()
...
def ESelectivity_getSize():
    return _gstlearn.ESelectivity_getSize()

def ESelectivity_getIterator():
    return _gstlearn.ESelectivity_getIterator()

def ESelectivity_printAll():
    return _gstlearn.ESelectivity_printAll()

def ESelectivity_getAllKeys():
    return _gstlearn.ESelectivity_getAllKeys()

def ESelectivity_getAllDescr():
    return _gstlearn.ESelectivity_getAllDescr()

def ESelectivity_existsKey(key):
    return _gstlearn.ESelectivity_existsKey(key)

def ESelectivity_existsValue(value):
    return _gstlearn.ESelectivity_existsValue(value)

def ESelectivity_fromKey(key):
    return _gstlearn.ESelectivity_fromKey(key)

def ESelectivity_fromValue(value):
    return _gstlearn.ESelectivity_fromValue(value)

def ESelectivity_fromKeys(keys):
    return _gstlearn.ESelectivity_fromKeys(keys)

def ESelectivity_fromValues(values):
    return _gstlearn.ESelectivity_fromValues(values)
...
class EStatOption(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EStatOption_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EStatOption_getAllDescr()
...
def EStatOption_getSize():
    return _gstlearn.EStatOption_getSize()

def EStatOption_getIterator():
    return _gstlearn.EStatOption_getIterator()

def EStatOption_printAll():
    return _gstlearn.EStatOption_printAll()

def EStatOption_getAllKeys():
    return _gstlearn.EStatOption_getAllKeys()

def EStatOption_getAllDescr():
    return _gstlearn.EStatOption_getAllDescr()

def EStatOption_existsKey(key):
    return _gstlearn.EStatOption_existsKey(key)

def EStatOption_existsValue(value):
    return _gstlearn.EStatOption_existsValue(value)

def EStatOption_fromKey(key):
    return _gstlearn.EStatOption_fromKey(key)

def EStatOption_fromValue(value):
    return _gstlearn.EStatOption_fromValue(value)

def EStatOption_fromKeys(keys):
    return _gstlearn.EStatOption_fromKeys(keys)

def EStatOption_fromValues(values):
    return _gstlearn.EStatOption_fromValues(values)
...
class EDirGen(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EDirGen_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EDirGen_getAllDescr()
...
def EDirGen_getIterator():
    return _gstlearn.EDirGen_getIterator()

def EDirGen_printAll():
    return _gstlearn.EDirGen_printAll()

def EDirGen_getAllKeys():
    return _gstlearn.EDirGen_getAllKeys()

def EDirGen_getAllDescr():
    return _gstlearn.EDirGen_getAllDescr()

def EDirGen_existsKey(key):
    return _gstlearn.EDirGen_existsKey(key)

def EDirGen_existsValue(value):
    return _gstlearn.EDirGen_existsValue(value)

def EDirGen_fromKey(key):
    return _gstlearn.EDirGen_fromKey(key)

def EDirGen_fromValue(value):
    return _gstlearn.EDirGen_fromValue(value)

def EDirGen_fromKeys(keys):
    return _gstlearn.EDirGen_fromKeys(keys)

def EDirGen_fromValues(values):
    return _gstlearn.EDirGen_fromValues(values)
...
class EGaussInv(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EGaussInv_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EGaussInv_getAllDescr()
...
def EGaussInv_getSize():
    return _gstlearn.EGaussInv_getSize()

def EGaussInv_getIterator():
    return _gstlearn.EGaussInv_getIterator()

def EGaussInv_printAll():
    return _gstlearn.EGaussInv_printAll()

def EGaussInv_getAllKeys():
    return _gstlearn.EGaussInv_getAllKeys()

def EGaussInv_getAllDescr():
    return _gstlearn.EGaussInv_getAllDescr()

def EGaussInv_existsKey(key):
    return _gstlearn.EGaussInv_existsKey(key)

def EGaussInv_existsValue(value):
    return _gstlearn.EGaussInv_existsValue(value)

def EGaussInv_fromKey(key):
    return _gstlearn.EGaussInv_fromKey(key)

def EGaussInv_fromValue(value):
    return _gstlearn.EGaussInv_fromValue(value)

def EGaussInv_fromKeys(keys):
    return _gstlearn.EGaussInv_fromKeys(keys)

def EGaussInv_fromValues(values):
    return _gstlearn.EGaussInv_fromValues(values)
...
class ECalcMember(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ECalcMember_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ECalcMember_getAllDescr()
...
def ECalcMember_getSize():
    return _gstlearn.ECalcMember_getSize()

def ECalcMember_getIterator():
    return _gstlearn.ECalcMember_getIterator()

def ECalcMember_printAll():
    return _gstlearn.ECalcMember_printAll()

def ECalcMember_getAllKeys():
    return _gstlearn.ECalcMember_getAllKeys()

def ECalcMember_getAllDescr():
    return _gstlearn.ECalcMember_getAllDescr()

def ECalcMember_existsKey(key):
    return _gstlearn.ECalcMember_existsKey(key)

def ECalcMember_existsValue(value):
    return _gstlearn.ECalcMember_existsValue(value)

def ECalcMember_fromKey(key):
    return _gstlearn.ECalcMember_fromKey(key)

def ECalcMember_fromValue(value):
    return _gstlearn.ECalcMember_fromValue(value)

def ECalcMember_fromKeys(keys):
    return _gstlearn.ECalcMember_fromKeys(keys)

def ECalcMember_fromValues(values):
    return _gstlearn.ECalcMember_fromValues(values)
...
class EPostUpscale(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EPostUpscale_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EPostUpscale_getAllDescr()
...
def EPostUpscale_getSize():
    return _gstlearn.EPostUpscale_getSize()

def EPostUpscale_getIterator():
    return _gstlearn.EPostUpscale_getIterator()

def EPostUpscale_printAll():
    return _gstlearn.EPostUpscale_printAll()

def EPostUpscale_getAllKeys():
    return _gstlearn.EPostUpscale_getAllKeys()

def EPostUpscale_getAllDescr():
    return _gstlearn.EPostUpscale_getAllDescr()

def EPostUpscale_existsKey(key):
    return _gstlearn.EPostUpscale_existsKey(key)

def EPostUpscale_existsValue(value):
    return _gstlearn.EPostUpscale_existsValue(value)

def EPostUpscale_fromKey(key):
    return _gstlearn.EPostUpscale_fromKey(key)

def EPostUpscale_fromValue(value):
    return _gstlearn.EPostUpscale_fromValue(value)

def EPostUpscale_fromKeys(keys):
    return _gstlearn.EPostUpscale_fromKeys(keys)

def EPostUpscale_fromValues(values):
    return _gstlearn.EPostUpscale_fromValues(values)
...
class EPostStat(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.EPostStat_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.EPostStat_getAllDescr()
...
def EPostStat_getSize():
    return _gstlearn.EPostStat_getSize()

def EPostStat_getIterator():
    return _gstlearn.EPostStat_getIterator()

def EPostStat_printAll():
    return _gstlearn.EPostStat_printAll()

def EPostStat_getAllKeys():
    return _gstlearn.EPostStat_getAllKeys()

def EPostStat_getAllDescr():
    return _gstlearn.EPostStat_getAllDescr()

def EPostStat_existsKey(key):
    return _gstlearn.EPostStat_existsKey(key)

def EPostStat_existsValue(value):
    return _gstlearn.EPostStat_existsValue(value)

def EPostStat_fromKey(key):
    return _gstlearn.EPostStat_fromKey(key)

def EPostStat_fromValue(value):
    return _gstlearn.EPostStat_fromValue(value)

def EPostStat_fromKeys(keys):
    return _gstlearn.EPostStat_fromKeys(keys)

def EPostStat_fromValues(values):
    return _gstlearn.EPostStat_fromValues(values)
...
class ETests(AEnum):
    ...
    @staticmethod
    def getAllKeys():
        return _gstlearn.ETests_getAllKeys()

    @staticmethod
    def getAllDescr():
        return _gstlearn.ETests_getAllDescr()
...
def ETests_getIterator():
    return _gstlearn.ETests_getIterator()

def ETests_printAll():
    return _gstlearn.ETests_printAll()

def ETests_getAllKeys():
    return _gstlearn.ETests_getAllKeys()

def ETests_getAllDescr():
    return _gstlearn.ETests_getAllDescr()

def ETests_existsKey(key):
    return _gstlearn.ETests_existsKey(key)

def ETests_existsValue(value):
    return _gstlearn.ETests_existsValue(value)

def ETests_fromKey(key):
    return _gstlearn.ETests_fromKey(key)

def ETests_fromValue(value):
    return _gstlearn.ETests_fromValue(value)

def ETests_fromKeys(keys):
    return _gstlearn.ETests_fromKeys(keys)

def ETests_fromValues(values):
    return _gstlearn.ETests_fromValues(values)
...
def ASerializable_buildFileName(status, filename, ensureDirExist=False):
    return _gstlearn.ASerializable_buildFileName(status, filename, ensureDirExist)

def ASerializable_getHomeDirectory(*args, **kwargs):
    return _gstlearn.ASerializable_getHomeDirectory(*args, **kwargs)

def ASerializable_getWorkingDirectory():
    return _gstlearn.ASerializable_getWorkingDirectory()

def ASerializable_getTestData(subdir, filename):
    return _gstlearn.ASerializable_getTestData(subdir, filename)

def ASerializable_getFileIdentity(filename, verbose=False):
    return _gstlearn.ASerializable_getFileIdentity(filename, verbose)

def ASerializable_setContainerName(*args, **kwargs):
    return _gstlearn.ASerializable_setContainerName(*args, **kwargs)

def ASerializable_unsetContainerName():
    return _gstlearn.ASerializable_unsetContainerName()

def ASerializable_setPrefixName(prefixName):
    return _gstlearn.ASerializable_setPrefixName(prefixName)

def ASerializable_unsetPrefixName():
    return _gstlearn.ASerializable_unsetPrefixName()

def ASerializable_getContainerName():
    return _gstlearn.ASerializable_getContainerName()

def ASerializable_getPrefixName():
    return _gstlearn.ASerializable_getPrefixName()

def ASerializable_createDirectory(dir):
    return _gstlearn.ASerializable_createDirectory(dir)

def ASerializable_getExecDirectory():
    return _gstlearn.ASerializable_getExecDirectory()

def ASerializable_getDirectory(path):
    return _gstlearn.ASerializable_getDirectory(path)
...
def NamingConvention_create(*args, **kwargs):
    return _gstlearn.NamingConvention_create(*args, **kwargs)
...
def Grid_gridIndices(nx, string, startFromZero=True, invert=True, verbose=False):
    return _gstlearn.Grid_gridIndices(nx, string, startFromZero, invert, verbose)

def Grid_generateMirrorIndex(nx, ix):
    return _gstlearn.Grid_generateMirrorIndex(nx, ix)
...
def areEqual(v1, v2, eps=1.e-10):
    return _gstlearn.areEqual(v1, v2, eps)
...
def CSVformat_create(*args, **kwargs):
    return _gstlearn.CSVformat_create(*args, **kwargs)
...
def OptDbg_queryByKey(name):
    return _gstlearn.OptDbg_queryByKey(name)

def OptDbg_defineByKey(name):
    return _gstlearn.OptDbg_defineByKey(name)

def OptDbg_undefineByKey(name):
    return _gstlearn.OptDbg_undefineByKey(name)

def OptDbg_query(option, discardForce=False):
    return _gstlearn.OptDbg_query(option, discardForce)

def OptDbg_define(option):
    return _gstlearn.OptDbg_define(option)

def OptDbg_undefine(option):
    return _gstlearn.OptDbg_undefine(option)

def OptDbg_defineAll():
    return _gstlearn.OptDbg_defineAll()

def OptDbg_undefineAll():
    return _gstlearn.OptDbg_undefineAll()

def OptDbg_display():
    return _gstlearn.OptDbg_display()

def OptDbg_setCurrentIndex(cur_index):
    return _gstlearn.OptDbg_setCurrentIndex(cur_index)

def OptDbg_isReferenceDefined():
    return _gstlearn.OptDbg_isReferenceDefined()

def OptDbg_setReference(index):
    return _gstlearn.OptDbg_setReference(index)

def OptDbg_getReference():
    return _gstlearn.OptDbg_getReference()

def OptDbg_force():
    return _gstlearn.OptDbg_force()

def OptDbg_getCurrentIndex():
    return _gstlearn.OptDbg_getCurrentIndex()
...
def OptCst_query(option):
    return _gstlearn.OptCst_query(option)

def OptCst_queryByKey(name):
    return _gstlearn.OptCst_queryByKey(name)

def OptCst_define(option, value):
    return _gstlearn.OptCst_define(option, value)

def OptCst_defineByKey(name, value):
    return _gstlearn.OptCst_defineByKey(name, value)
...
def OptCustom_query(name, valdef=0.):
    return _gstlearn.OptCustom_query(name, valdef)

def OptCustom_define(name, value):
    return _gstlearn.OptCustom_define(name, value)

def OptCustom_undefine(name):
    return _gstlearn.OptCustom_undefine(name)

def OptCustom_display():
    return _gstlearn.OptCustom_display()
...
class VectorHelper(object):
    ...
    @staticmethod
    def isSame(*args):
        return _gstlearn.VectorHelper_isSame(*args)
    ...
    @staticmethod
    def substractInPlace(in1, in2, outv):
        return _gstlearn.VectorHelper_substractInPlace(in1, in2, outv)
...
def VectorHelper_initVVInt(nval1, nval2, value=0):
    return _gstlearn.VectorHelper_initVVInt(nval1, nval2, value)

def VectorHelper_initVInt(*args):
    return _gstlearn.VectorHelper_initVInt(*args)

def VectorHelper_initVDouble(*args):
    return _gstlearn.VectorHelper_initVDouble(*args)

def VectorHelper_initVVDouble(*args):
    return _gstlearn.VectorHelper_initVVDouble(*args)

def VectorHelper_initVString(ntab, names):
    return _gstlearn.VectorHelper_initVString(ntab, names)

def VectorHelper_display(*args):
    return _gstlearn.VectorHelper_display(*args)

def VectorHelper_dump(title, vect):
    return _gstlearn.VectorHelper_dump(title, vect)

def VectorHelper_toStringAsSpan(vec):
    return _gstlearn.VectorHelper_toStringAsSpan(vec)

def VectorHelper_toStringAsVD(vec):
    return _gstlearn.VectorHelper_toStringAsVD(vec)

def VectorHelper_toStringAsVVD(vec):
    return _gstlearn.VectorHelper_toStringAsVVD(vec)

def VectorHelper_toStringAsVS(vec):
    return _gstlearn.VectorHelper_toStringAsVS(vec)

def VectorHelper_toStringAsVI(vec):
    return _gstlearn.VectorHelper_toStringAsVI(vec)

def VectorHelper_displayStats(title, vect):
    return _gstlearn.VectorHelper_displayStats(title, vect)

def VectorHelper_displayRange(*args):
    return _gstlearn.VectorHelper_displayRange(*args)

def VectorHelper_displayNNZ(title, vect, nclass=10):
    return _gstlearn.VectorHelper_displayNNZ(title, vect, nclass)

def VectorHelper_maximum(*args):
    return _gstlearn.VectorHelper_maximum(*args)

def VectorHelper_minimum(*args):
    return _gstlearn.VectorHelper_minimum(*args)

def VectorHelper_product(*args):
    return _gstlearn.VectorHelper_product(*args)

def VectorHelper_countUndefined(vec):
    return _gstlearn.VectorHelper_countUndefined(vec)

def VectorHelper_countDefined(vec):
    return _gstlearn.VectorHelper_countDefined(vec)

def VectorHelper_hasUndefined(vec):
    return _gstlearn.VectorHelper_hasUndefined(vec)

def VectorHelper_extensionDiagonal(mini, maxi):
    return _gstlearn.VectorHelper_extensionDiagonal(mini, maxi)

def VectorHelper_count(vec):
    return _gstlearn.VectorHelper_count(vec)

def VectorHelper_cumul(*args):
    return _gstlearn.VectorHelper_cumul(*args)

def VectorHelper_mean(vec):
    return _gstlearn.VectorHelper_mean(vec)

def VectorHelper_variance(vec, scaleByN=False):
    return _gstlearn.VectorHelper_variance(vec, scaleByN)

def VectorHelper_stdv(vec, scaleByN=False):
    return _gstlearn.VectorHelper_stdv(vec, scaleByN)

def VectorHelper_normL1(vec):
    return _gstlearn.VectorHelper_normL1(vec)

def VectorHelper_norminf(vec):
    return _gstlearn.VectorHelper_norminf(vec)

def VectorHelper_median(vec):
    return _gstlearn.VectorHelper_median(vec)

def VectorHelper_normDistance(veca, vecb):
    return _gstlearn.VectorHelper_normDistance(veca, vecb)

def VectorHelper_correlation(veca, vecb):
    return _gstlearn.VectorHelper_correlation(veca, vecb)

def VectorHelper_quantiles(vec, probas):
    return _gstlearn.VectorHelper_quantiles(vec, probas)

def VectorHelper_isConstant(*args):
    return _gstlearn.VectorHelper_isConstant(*args)

def VectorHelper_isSame(*args):
    return _gstlearn.VectorHelper_isSame(*args)

def VectorHelper_sequence(*args):
    return _gstlearn.VectorHelper_sequence(*args)

def VectorHelper_fill(*args):
    return _gstlearn.VectorHelper_fill(*args)

def VectorHelper_fillUndef(vec, repl):
    return _gstlearn.VectorHelper_fillUndef(vec, repl)

def VectorHelper_add(veca, vecb):
    return _gstlearn.VectorHelper_add(veca, vecb)

def VectorHelper_addInPlace(*args):
    return _gstlearn.VectorHelper_addInPlace(*args)

def VectorHelper_addSquareInPlace(dest, src):
    return _gstlearn.VectorHelper_addSquareInPlace(dest, src)

def VectorHelper_subtract(*args):
    return _gstlearn.VectorHelper_subtract(*args)

def VectorHelper_subtractInPlace(*args):
    return _gstlearn.VectorHelper_subtractInPlace(*args)

def VectorHelper_multiplyInPlace(vec, v):
    return _gstlearn.VectorHelper_multiplyInPlace(vec, v)

def VectorHelper_multiplyConstant(vec, v):
    return _gstlearn.VectorHelper_multiplyConstant(vec, v)

def VectorHelper_multiplyConstantInPlace(vec, v, vecout):
    return _gstlearn.VectorHelper_multiplyConstantInPlace(vec, v, vecout)

def VectorHelper_multiplyConstantSelfInPlace(vec, v):
    return _gstlearn.VectorHelper_multiplyConstantSelfInPlace(vec, v)

def VectorHelper_addMultiplyConstantInPlace(*args):
    return _gstlearn.VectorHelper_addMultiplyConstantInPlace(*args)

def VectorHelper_divideConstant(vec, v):
    return _gstlearn.VectorHelper_divideConstant(vec, v)

def VectorHelper_copy(*args):
    return _gstlearn.VectorHelper_copy(*args)

def VectorHelper_addConstant(*args):
    return _gstlearn.VectorHelper_addConstant(*args)

def VectorHelper_mean1AndMean2ToStdev(mean1, mean2, std, number):
    return _gstlearn.VectorHelper_mean1AndMean2ToStdev(mean1, mean2, std, number)

def VectorHelper_normalize(*args):
    return _gstlearn.VectorHelper_normalize(*args)

def VectorHelper_normalizeFromGaussianDistribution(vec, mini=0., maxi=1.):
    return _gstlearn.VectorHelper_normalizeFromGaussianDistribution(vec, mini, maxi)

def VectorHelper_normalScore(*args, **kwargs):
    return _gstlearn.VectorHelper_normalScore(*args, **kwargs)

def VectorHelper_qnormVec(vec):
    return _gstlearn.VectorHelper_qnormVec(vec)

def VectorHelper_pnormVec(vec):
    return _gstlearn.VectorHelper_pnormVec(vec)

def VectorHelper_concatenate(veca, vecb):
    return _gstlearn.VectorHelper_concatenate(veca, vecb)

def VectorHelper_power(vec, power):
    return _gstlearn.VectorHelper_power(vec, power)

def VectorHelper_inverse(vec):
    return _gstlearn.VectorHelper_inverse(vec)

def VectorHelper_divideInPlace(*args):
    return _gstlearn.VectorHelper_divideInPlace(*args)

def VectorHelper_crossProduct3D(veca, vecb):
    return _gstlearn.VectorHelper_crossProduct3D(veca, vecb)

def VectorHelper_crossProduct3DInPlace(a, b, v):
    return _gstlearn.VectorHelper_crossProduct3DInPlace(a, b, v)

def VectorHelper_cumsum(vecin, flagAddZero, revert=False):
    return _gstlearn.VectorHelper_cumsum(vecin, flagAddZero, revert)

def VectorHelper_cumulateInPlace(vec):
    return _gstlearn.VectorHelper_cumulateInPlace(vec)

def VectorHelper_cumulate(veca, vecb, coeff=1., addval=0.):
    return _gstlearn.VectorHelper_cumulate(veca, vecb, coeff, addval)

def VectorHelper_getMostSignificant(vec, tol=1.e-6, nmax=-1):
    return _gstlearn.VectorHelper_getMostSignificant(vec, tol, nmax)

def VectorHelper_simulateUniform(n=1, mini=0., maxi=1.):
    return _gstlearn.VectorHelper_simulateUniform(n, mini, maxi)

def VectorHelper_simulateBernoulli(n=1, proba=0.5, vone=1., velse=0.):
    return _gstlearn.VectorHelper_simulateBernoulli(n, proba, vone, velse)

def VectorHelper_simulateGaussian(n=1, mean=0., sigma=1.):
    return _gstlearn.VectorHelper_simulateGaussian(n, mean, sigma)

def VectorHelper_sampleRanks(ntotal, proportion=0., number=0, seed=242141, optSort=0):
    return _gstlearn.VectorHelper_sampleRanks(ntotal, proportion, number, seed, optSort)

def VectorHelper_normalizeCodir(ndim, codir):
    return _gstlearn.VectorHelper_normalizeCodir(ndim, codir)

def VectorHelper_isInList(vec, item):
    return _gstlearn.VectorHelper_isInList(vec, item)

def VectorHelper_sort(*args):
    return _gstlearn.VectorHelper_sort(*args)

def VectorHelper_sortInPlace(*args):
    return _gstlearn.VectorHelper_sortInPlace(*args)

def VectorHelper_isSorted(vec, ascending=True):
    return _gstlearn.VectorHelper_isSorted(vec, ascending)

def VectorHelper_unique(*args):
    return _gstlearn.VectorHelper_unique(*args)

def VectorHelper_orderRanks(*args):
    return _gstlearn.VectorHelper_orderRanks(*args)

def VectorHelper_sortRanks(vecin, ascending=True, size=-1):
    return _gstlearn.VectorHelper_sortRanks(vecin, ascending, size)

def VectorHelper_reorder(*args):
    return _gstlearn.VectorHelper_reorder(*args)

def VectorHelper_revert(*args):
    return _gstlearn.VectorHelper_revert(*args)

def VectorHelper_sample(vecin, indKeep):
    return _gstlearn.VectorHelper_sample(vecin, indKeep)

def VectorHelper_arrangeInPlace(*args):
    return _gstlearn.VectorHelper_arrangeInPlace(*args)

def VectorHelper_filter(vecin, vmin=-1234567, vmax=-1234567, ascending=True):
    return _gstlearn.VectorHelper_filter(vecin, vmin, vmax, ascending)

def VectorHelper_complement(vec, sel):
    return _gstlearn.VectorHelper_complement(vec, sel)

def VectorHelper_rangeVals(vec):
    return _gstlearn.VectorHelper_rangeVals(vec)

def VectorHelper_unflattenInPlace(vd, vvd):
    return _gstlearn.VectorHelper_unflattenInPlace(vd, vvd)

def VectorHelper_flatten(*args):
    return _gstlearn.VectorHelper_flatten(*args)

def VectorHelper_unflatten(*args):
    return _gstlearn.VectorHelper_unflatten(*args)

def VectorHelper_flattenInPlace(*args):
    return _gstlearn.VectorHelper_flattenInPlace(*args)

def VectorHelper_linearCombinationInPlace(val1, vd1, val2, vd2, outv):
    return _gstlearn.VectorHelper_linearCombinationInPlace(val1, vd1, val2, vd2, outv)

def VectorHelper_innerProduct(*args):
    return _gstlearn.VectorHelper_innerProduct(*args)

def VectorHelper_linearCombinationVVDInPlace(*args):
    return _gstlearn.VectorHelper_linearCombinationVVDInPlace(*args)

def VectorHelper_suppressTest(vecin):
    return _gstlearn.VectorHelper_suppressTest(vecin)

def VectorHelper_extractInPlace(vecin, vecout, start):
    return _gstlearn.VectorHelper_extractInPlace(vecin, vecout, start)

def VectorHelper_mergeInPlace(vecin, vecout, start):
    return _gstlearn.VectorHelper_mergeInPlace(vecin, vecout, start)

def VectorHelper_transformVD(tab, oper_choice=1):
    return _gstlearn.VectorHelper_transformVD(tab, oper_choice)

def VectorHelper_squeezeAndStretchInPlaceForward(vecin, vecout, origin, mesh, top, bot):
    return _gstlearn.VectorHelper_squeezeAndStretchInPlaceForward(vecin, vecout, origin, mesh, top, bot)

def VectorHelper_squeezeAndStretchInPlaceBackward(vecin, vecout, origin, mesh, top, bot):
    return _gstlearn.VectorHelper_squeezeAndStretchInPlaceBackward(vecin, vecout, origin, mesh, top, bot)

def VectorHelper_whereMinimum(tab):
    return _gstlearn.VectorHelper_whereMinimum(tab)

def VectorHelper_whereMaximum(tab):
    return _gstlearn.VectorHelper_whereMaximum(tab)

def VectorHelper_whereElement(tab, target):
    return _gstlearn.VectorHelper_whereElement(tab, target)

def VectorHelper_norm(*args):
    return _gstlearn.VectorHelper_norm(*args)

def VectorHelper_reduceOne(vecin, index):
    return _gstlearn.VectorHelper_reduceOne(vecin, index)

def VectorHelper_reduce(vecin, vindex):
    return _gstlearn.VectorHelper_reduce(vecin, vindex)

def VectorHelper_compress(vecin, vindex):
    return _gstlearn.VectorHelper_compress(vecin, vindex)

def VectorHelper_substractInPlace(in1, in2, outv):
    return _gstlearn.VectorHelper_substractInPlace(in1, in2, outv)

def VectorHelper_truncateDecimalsInPlace(vec, ndec):
    return _gstlearn.VectorHelper_truncateDecimalsInPlace(vec, ndec)

def VectorHelper_truncateDigitsInPlace(vec, ndec):
    return _gstlearn.VectorHelper_truncateDigitsInPlace(vec, ndec)

def VectorHelper_simulateGaussianInPlace(*args):
    return _gstlearn.VectorHelper_simulateGaussianInPlace(*args)
...
def Plane_poissonPlanesGenerate(dbgrid, np):
    return _gstlearn.Plane_poissonPlanesGenerate(dbgrid, np)
...
def PolyLine2D_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.PolyLine2D_createFromNF(neutralFilename, verbose)

def PolyLine2D_create(*args, **kwargs):
    return _gstlearn.PolyLine2D_create(*args, **kwargs)
...
def GeometryHelper_rotationGetSinCos(angle, cosa, sina):
    return _gstlearn.GeometryHelper_rotationGetSinCos(angle, cosa, sina)

def GeometryHelper_rotationMatrixIdentityInPlace(ndim, rot):
    return _gstlearn.GeometryHelper_rotationMatrixIdentityInPlace(ndim, rot)

def GeometryHelper_rotation2DMatrixInPlace(angle, rot):
    return _gstlearn.GeometryHelper_rotation2DMatrixInPlace(angle, rot)

def GeometryHelper_rotation3DMatrixInPlace(alpha, beta, gamma, rot):
    return _gstlearn.GeometryHelper_rotation3DMatrixInPlace(alpha, beta, gamma, rot)

def GeometryHelper_rotationMatrixInPlace(ndim, angles, rot):
    return _gstlearn.GeometryHelper_rotationMatrixInPlace(ndim, angles, rot)

def GeometryHelper_rotationMatrix(ndim, angles):
    return _gstlearn.GeometryHelper_rotationMatrix(ndim, angles)

def GeometryHelper_rotationGetAnglesInPlace(*args):
    return _gstlearn.GeometryHelper_rotationGetAnglesInPlace(*args)

def GeometryHelper_rotationCopy(ndim, rotin, rotout):
    return _gstlearn.GeometryHelper_rotationCopy(ndim, rotin, rotout)

def GeometryHelper_rotationIsIdentity(ndim, rot, eps=1.e-10):
    return _gstlearn.GeometryHelper_rotationIsIdentity(ndim, rot, eps)

def GeometryHelper_EulerToRotation(*args, **kwargs):
    return _gstlearn.GeometryHelper_EulerToRotation(*args, **kwargs)

def GeometryHelper_rotationGetRandomDirection(ct, st, a, codir):
    return _gstlearn.GeometryHelper_rotationGetRandomDirection(ct, st, a, codir)

def GeometryHelper_rotationGetDirection2D(angles, codir):
    return _gstlearn.GeometryHelper_rotationGetDirection2D(angles, codir)

def GeometryHelper_rotationGetDirectionDefault(ndim, codir):
    return _gstlearn.GeometryHelper_rotationGetDirectionDefault(ndim, codir)

def GeometryHelper_rotationGetAnglesFromCodirInPlace(codir, angles):
    return _gstlearn.GeometryHelper_rotationGetAnglesFromCodirInPlace(codir, angles)

def GeometryHelper_rotationGetAngles(codir, flagResize=False):
    return _gstlearn.GeometryHelper_rotationGetAngles(codir, flagResize)

def GeometryHelper_rotationToEuler(*args, **kwargs):
    return _gstlearn.GeometryHelper_rotationToEuler(*args, **kwargs)

def GeometryHelper_distancePointToSegment(x0, y0, x1, y1, x2, y2, xd, yd, nint):
    return _gstlearn.GeometryHelper_distancePointToSegment(x0, y0, x1, y1, x2, y2, xd, yd, nint)

def GeometryHelper_segmentIntersect(xd1, yd1, xe1, ye1, xd2, yd2, xe2, ye2, xint, yint):
    return _gstlearn.GeometryHelper_segmentIntersect(xd1, yd1, xe1, ye1, xd2, yd2, xe2, ye2, xint, yint)

def GeometryHelper_geodeticAngularDistance(long1, lat1, long2, lat2, radius=1.):
    return _gstlearn.GeometryHelper_geodeticAngularDistance(long1, lat1, long2, lat2, radius)

def GeometryHelper_geodeticAngles(long1, lat1, long2, lat2, long3, lat3, a, b, c, A, B, C):
    return _gstlearn.GeometryHelper_geodeticAngles(long1, lat1, long2, lat2, long3, lat3, a, b, c, A, B, C)

def GeometryHelper_geodeticTrianglePerimeter(long1, lat1, long2, lat2, long3, lat3):
    return _gstlearn.GeometryHelper_geodeticTrianglePerimeter(long1, lat1, long2, lat2, long3, lat3)

def GeometryHelper_geodeticTriangleSurface(long1, lat1, long2, lat2, long3, lat3):
    return _gstlearn.GeometryHelper_geodeticTriangleSurface(long1, lat1, long2, lat2, long3, lat3)

def GeometryHelper_isInSphericalTriangle(coor, surface, pts1, pts2, pts3, wgts, eps=1.e-6):
    return _gstlearn.GeometryHelper_isInSphericalTriangle(coor, surface, pts1, pts2, pts3, wgts, eps)

def GeometryHelper_isInSphericalTriangleOptimized(coor, ptsa, ptsb, ptsc, wgts, eps=1.e-6):
    return _gstlearn.GeometryHelper_isInSphericalTriangleOptimized(coor, ptsa, ptsb, ptsc, wgts, eps)

def GeometryHelper_convertLongLat(longitude, latitude, dilate=1., radius_arg=1.):
    return _gstlearn.GeometryHelper_convertLongLat(longitude, latitude, dilate, radius_arg)

def GeometryHelper_convertCart2Sph(x, y, z, rlong, rlat, radius_arg=1.):
    return _gstlearn.GeometryHelper_convertCart2Sph(x, y, z, rlong, rlat, radius_arg)

def GeometryHelper_convertSph2Cart(rlong, rlat, x, y, z, radius_arg=1.):
    return _gstlearn.GeometryHelper_convertSph2Cart(rlong, rlat, x, y, z, radius_arg)

def GeometryHelper_gradXYToRotmat(dzoverdx, dzoverdy):
    return _gstlearn.GeometryHelper_gradXYToRotmat(dzoverdx, dzoverdy)

def GeometryHelper_getDirectionsInR3(U):
    return _gstlearn.GeometryHelper_getDirectionsInR3(U)

def GeometryHelper_getDirectionsInRn(U):
    return _gstlearn.GeometryHelper_getDirectionsInRn(U)

def GeometryHelper_formatAngle(anglein, basis=360.):
    return _gstlearn.GeometryHelper_formatAngle(anglein, basis)

def GeometryHelper_formatAngles(anglesin, basis=360.):
    return _gstlearn.GeometryHelper_formatAngles(anglesin, basis)

def GeometryHelper_rayTriangleIntersect(dir, v0, v1, v2):
    return _gstlearn.GeometryHelper_rayTriangleIntersect(dir, v0, v1, v2)

def GeometryHelper_sphBarCoord(sphPts, apices, meshes):
    return _gstlearn.GeometryHelper_sphBarCoord(sphPts, apices, meshes)

def GeometryHelper_getCosineAngularTolerance(tolang):
    return _gstlearn.GeometryHelper_getCosineAngularTolerance(tolang)

def GeometryHelper_getEllipse(center, rx, ry, theta, count=360):
    return _gstlearn.GeometryHelper_getEllipse(center, rx, ry, theta, count)
...
def Rotation_isMatrixRotation(rotmat, verbose):
    return _gstlearn.Rotation_isMatrixRotation(rotmat, verbose)
...
def BiTargetCheckBench_create(idim_bench, width):
    return _gstlearn.BiTargetCheckBench_create(idim_bench, width)
...
def BiTargetCheckCell_create(dbgrid=None):
    return _gstlearn.BiTargetCheckCell_create(dbgrid)
...
def BiTargetCheckDistance_create(*args, **kwargs):
    return _gstlearn.BiTargetCheckDistance_create(*args, **kwargs)
...
def BiTargetCheckFaults_create(faults):
    return _gstlearn.BiTargetCheckFaults_create(faults)
...
def BiTargetCheckCode_create(optcode=1, tolcode=1.e-6):
    return _gstlearn.BiTargetCheckCode_create(optcode, tolcode)
...
def BiTargetCheckDate_create(deltamin, deltamax):
    return _gstlearn.BiTargetCheckDate_create(deltamin, deltamax)
...
def BiTargetCheckGeometry_create(*args, **kwargs):
    return _gstlearn.BiTargetCheckGeometry_create(*args, **kwargs)
...
def Faults_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Faults_createFromNF(neutralFilename, verbose)
...
def SpaceTarget_create(*args, **kwargs):
    return _gstlearn.SpaceTarget_create(*args, **kwargs)
...
def MatrixSparse_create(*args):
    return _gstlearn.MatrixSparse_create(*args)

def MatrixSparse_createFromTriplet(NF_T, nrow=0, ncol=0, opt_eigen=-1):
    return _gstlearn.MatrixSparse_createFromTriplet(NF_T, nrow, ncol, opt_eigen)

def MatrixSparse_addMatMat(x, y, cx=1., cy=1.):
    return _gstlearn.MatrixSparse_addMatMat(x, y, cx, cy)

def MatrixSparse_diagVec(vec, opt_eigen=-1):
    return _gstlearn.MatrixSparse_diagVec(vec, opt_eigen)

def MatrixSparse_diagConstant(number, value=1., opt_eigen=-1):
    return _gstlearn.MatrixSparse_diagConstant(number, value, opt_eigen)

def MatrixSparse_diagMat(A, oper_choice, opt_eigen=-1):
    return _gstlearn.MatrixSparse_diagMat(A, oper_choice, opt_eigen)

def MatrixSparse_glue(A1, A2, flagShiftRow, flagShiftCol):
    return _gstlearn.MatrixSparse_glue(A1, A2, flagShiftRow, flagShiftCol)

def MatrixSparse_glueInPlace(A1, A2, flagShiftRow, flagShiftCol):
    return _gstlearn.MatrixSparse_glueInPlace(A1, A2, flagShiftRow, flagShiftCol)

def MatrixSparse_dumpElements(title, ifrom, ito):
    return _gstlearn.MatrixSparse_dumpElements(title, ifrom, ito)
...
def MatrixRectangular_create(*args):
    return _gstlearn.MatrixRectangular_create(*args)

def MatrixRectangular_createFromVVD(X):
    return _gstlearn.MatrixRectangular_createFromVVD(X)

def MatrixRectangular_createFromVD(X, nrow, ncol, byCol=False, invertColumnOrder=False):
    return _gstlearn.MatrixRectangular_createFromVD(X, nrow, ncol, byCol, invertColumnOrder)

def MatrixRectangular_glue(A1, A2, flagShiftRow, flagShiftCol):
    return _gstlearn.MatrixRectangular_glue(A1, A2, flagShiftRow, flagShiftCol)

def MatrixRectangular_sample(*args, **kwargs):
    return _gstlearn.MatrixRectangular_sample(*args, **kwargs)
...
def MatrixSquareGeneral_createFromVVD(X):
    return _gstlearn.MatrixSquareGeneral_createFromVVD(X)

def MatrixSquareGeneral_createFromVD(X, nrow, byCol=False, invertColumnOrder=False):
    return _gstlearn.MatrixSquareGeneral_createFromVD(X, nrow, byCol, invertColumnOrder)
...
class MatrixSquareSymmetric(AMatrixSquare):
    ...
    @staticmethod
    def createFromVD(X, nrow):
        return _gstlearn.MatrixSquareSymmetric_createFromVD(X, nrow)
...
def MatrixSquareSymmetric_createFromVVD(X):
    return _gstlearn.MatrixSquareSymmetric_createFromVVD(X)

def MatrixSquareSymmetric_createFromVD(X, nrow):
    return _gstlearn.MatrixSquareSymmetric_createFromVD(X, nrow)

def MatrixSquareSymmetric_createFromTLTU(neq, tl):
    return _gstlearn.MatrixSquareSymmetric_createFromTLTU(neq, tl)

def MatrixSquareSymmetric_createFromTriangle(mode, neq, tl):
    return _gstlearn.MatrixSquareSymmetric_createFromTriangle(mode, neq, tl)

def MatrixSquareSymmetric_createRandomDefinitePositive(neq, seed=13242):
    return _gstlearn.MatrixSquareSymmetric_createRandomDefinitePositive(neq, seed)

def MatrixSquareSymmetric_sample(A, rowKeep, flagInvert=False):
    return _gstlearn.MatrixSquareSymmetric_sample(A, rowKeep, flagInvert)

def MatrixSquareSymmetric__constraintsConcatenateMat(nae, nai, neq, active, tabemat, tabimat, tabout):
    return _gstlearn.MatrixSquareSymmetric__constraintsConcatenateMat(nae, nai, neq, active, tabemat, tabimat, tabout)

def MatrixSquareSymmetric__constraintsConcatenateVD(nae, nai, active, tabemat, tabimat, tabout):
    return _gstlearn.MatrixSquareSymmetric__constraintsConcatenateVD(nae, nai, active, tabemat, tabimat, tabout)

def MatrixSquareSymmetric__constraintsCount(nai, active):
    return _gstlearn.MatrixSquareSymmetric__constraintsCount(nai, active)
...
def MatrixFactory_prodMatMat(x, y, transposeX=False, transposeY=False):
    return _gstlearn.MatrixFactory_prodMatMat(x, y, transposeX, transposeY)

def MatrixFactory_createMatrixSquare(x, nrow):
    return _gstlearn.MatrixFactory_createMatrixSquare(x, nrow)

def MatrixFactory_createReduce(*args, **kwargs):
    return _gstlearn.MatrixFactory_createReduce(*args, **kwargs)

def MatrixFactory_createReduceOne(x, selRow=-1, selCol=-1, flagKeepRow=True, flagKeepCol=True):
    return _gstlearn.MatrixFactory_createReduceOne(x, selRow, selCol, flagKeepRow, flagKeepCol)

def MatrixFactory_createGlue(a1, a2, flagShiftRow, flagShiftCol):
    return _gstlearn.MatrixFactory_createGlue(a1, a2, flagShiftRow, flagShiftCol)
...
def MatrixInt_createFromVI(X, nrow, ncol, byCol=False):
    return _gstlearn.MatrixInt_createFromVI(X, nrow, ncol, byCol)

def MatrixInt_createFromVVI(X):
    return _gstlearn.MatrixInt_createFromVVI(X)
...
def Table_create(nrow=0, ncol=0):
    return _gstlearn.Table_create(nrow, ncol)

def Table_createFromNames(rownames, colnames):
    return _gstlearn.Table_createFromNames(rownames, colnames)

def Table_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Table_createFromNF(neutralFilename, verbose)

def Table_createFromTable(table):
    return _gstlearn.Table_createFromTable(table)
...
def AMesh_dumpNeighborhood(Vmesh, nline_max=1):
    return _gstlearn.AMesh_dumpNeighborhood(Vmesh, nline_max)
...
def MeshEStandard_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.MeshEStandard_createFromNF(neutralFilename, verbose)

def MeshEStandard_createFromExternal(apices, meshes, verbose=False):
    return _gstlearn.MeshEStandard_createFromExternal(apices, meshes, verbose)
...
def MeshETurbo_create(*args, **kwargs):
    return _gstlearn.MeshETurbo_create(*args, **kwargs)

def MeshETurbo_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.MeshETurbo_createFromNF(neutralFilename, verbose)

def MeshETurbo_createFromGrid(dbgrid, flag_polarized=False, verbose=False, mode=1):
    return _gstlearn.MeshETurbo_createFromGrid(dbgrid, flag_polarized, verbose, mode)

def MeshETurbo_createFromGridInfo(grid, flag_polarized=False, verbose=False, mode=1):
    return _gstlearn.MeshETurbo_createFromGridInfo(grid, flag_polarized, verbose, mode)

def MeshETurbo_createFromCova(cova, field, ratio, nbExt=0, useSel=True, flagNoStatRot=False, verbose=False):
    return _gstlearn.MeshETurbo_createFromCova(cova, field, ratio, nbExt, useSel, flagNoStatRot, verbose)
...
def MeshSpherical_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.MeshSpherical_createFromNF(neutralFilename, verbose)

def MeshSpherical_create(*args, **kwargs):
    return _gstlearn.MeshSpherical_create(*args, **kwargs)
...
def MeshSphericalExt_spde_mesh_load(*args, **kwargs):
    return _gstlearn.MeshSphericalExt_spde_mesh_load(*args, **kwargs)
...
def Chebychev_createFromCoeffs(coeffs):
    return _gstlearn.Chebychev_createFromCoeffs(coeffs)
...
class ShiftOpCs(ALinearOp):
    ...
    def normalizeLambdaBySills(self, arg2):
        return _gstlearn.ShiftOpCs_normalizeLambdaBySills(self, arg2)

    @staticmethod
    def create(amesh, cova, dbout=None, verbose=False):
        return _gstlearn.ShiftOpCs_create(amesh, cova, dbout, verbose)

    @staticmethod
    def createFromSparse(S, TildeC, Lambda, cova, verbose=False):
        return _gstlearn.ShiftOpCs_createFromSparse(S, TildeC, Lambda, cova, verbose)

    def initFromMesh(self, amesh, cova, dbout=None, flagAdvection=False, verbose=False):
        return _gstlearn.ShiftOpCs_initFromMesh(self, amesh, cova, dbout, flagAdvection, verbose)

    def initGradFromMesh(self, amesh, cova, verbose=False, tol=1.e-10):
        return _gstlearn.ShiftOpCs_initGradFromMesh(self, amesh, cova, verbose, tol)

    def initFromCS(self, S, TildeC, Lambda, cova, verbose=False):
        return _gstlearn.ShiftOpCs_initFromCS(self, S, TildeC, Lambda, cova, verbose)
    ...
    def getNCovAnisoGradParam(self):
        return _gstlearn.ShiftOpCs_getNCovAnisoGradParam(self)

    def prodTildeC(self, x, y, power):
        return _gstlearn.ShiftOpCs_prodTildeC(self, x, y, power)

    def prodLambda(self, x, y, power):
        return _gstlearn.ShiftOpCs_prodLambda(self, x, y, power)

    def prodLambdaOnSqrtTildeC(self, inv, outv, puis=2):
        return _gstlearn.ShiftOpCs_prodLambdaOnSqrtTildeC(self, inv, outv, puis)
    ...
    def getTildeCGrad(self, iapex, igparam):
        return _gstlearn.ShiftOpCs_getTildeCGrad(self, iapex, igparam)
...
def ShiftOpCs_create(amesh, cova, dbout=None, verbose=False):
    return _gstlearn.ShiftOpCs_create(amesh, cova, dbout, verbose)

def ShiftOpCs_createFromSparse(S, TildeC, Lambda, cova, verbose=False):
    return _gstlearn.ShiftOpCs_createFromSparse(S, TildeC, Lambda, cova, verbose)
...
class PrecisionOp(ASimulable):
    ...
    @staticmethod
    def create(mesh, cova, verbose=False):
        return _gstlearn.PrecisionOp_create(mesh, cova, verbose)
...
def PrecisionOp_createFromShiftOp(shiftop=None, cova=None, verbose=False):
    return _gstlearn.PrecisionOp_createFromShiftOp(shiftop, cova, verbose)

def PrecisionOp_create(mesh, cova, verbose=False):
    return _gstlearn.PrecisionOp_create(mesh, cova, verbose)
...
class PrecisionOpCs(PrecisionOp):
    ...
    def __init__(self, *args):
        _gstlearn.PrecisionOpCs_swiginit(self, _gstlearn.new_PrecisionOpCs(*args))
    __swig_destroy__ = _gstlearn.delete_PrecisionOpCs

    def getLogDeterminant(self, nbsimu=1):
        return _gstlearn.PrecisionOpCs_getLogDeterminant(self, nbsimu)
...
class IProjMatrix(object):
    ...
    def __init__(self):
        if self.__class__ == IProjMatrix:
            _self = None
        else:
            _self = self
        _gstlearn.IProjMatrix_swiginit(self, _gstlearn.new_IProjMatrix(_self, ))
    __swig_destroy__ = _gstlearn.delete_IProjMatrix

    def point2mesh(self, inv, outv):
        return _gstlearn.IProjMatrix_point2mesh(self, inv, outv)

    def mesh2point(self, inv, outv):
        return _gstlearn.IProjMatrix_mesh2point(self, inv, outv)
...
def ProjMatrix_create(db, a_mesh, rankZ=-1, verbose=False):
    return _gstlearn.ProjMatrix_create(db, a_mesh, rankZ, verbose)

class ProjMulti(IProjMatrix):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
def ProjMultiMatrix_create(vectproj, nvariable):
    return _gstlearn.ProjMultiMatrix_create(vectproj, nvariable)

def ProjMultiMatrix_createFromDbAndMeshes(db, meshes, verbose=False):
    return _gstlearn.ProjMultiMatrix_createFromDbAndMeshes(db, meshes, verbose)
...
class ProjConvolution(IProjMatrix):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
def OptimCostBinary_setPreCondParams(chebncmax=10001, chebtol=5.e-3):
    return _gstlearn.OptimCostBinary_setPreCondParams(chebncmax, chebtol)
...
def NeighUnique_create(flag_xvalid=False, space=None):
    return _gstlearn.NeighUnique_create(flag_xvalid, space)

def NeighUnique_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.NeighUnique_createFromNF(neutralFilename, verbose)
...
def NeighImage_create(image, skip=0, space=None):
    return _gstlearn.NeighImage_create(image, skip, space)

def NeighImage_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.NeighImage_createFromNF(neutralFilename, verbose)
...
def NeighMoving_create(*args, **kwargs):
    return _gstlearn.NeighMoving_create(*args, **kwargs)

def NeighMoving_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.NeighMoving_createFromNF(neutralFilename, verbose)
...
def NeighBench_create(flag_xvalid=False, width=0, space=None):
    return _gstlearn.NeighBench_create(flag_xvalid, width, space)

def NeighBench_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.NeighBench_createFromNF(neutralFilename, verbose)
...
def NeighCell_create(flag_xvalid=False, nmini=1, space=None):
    return _gstlearn.NeighCell_create(flag_xvalid, nmini, space)

def NeighCell_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.NeighCell_createFromNF(neutralFilename, verbose)
...
def AVario_getCalculType(calcul_name):
    return _gstlearn.AVario_getCalculType(calcul_name)
...
def VarioParam_createOmniDirection(*args, **kwargs):
    return _gstlearn.VarioParam_createOmniDirection(*args, **kwargs)

def VarioParam_createMultiple(*args, **kwargs):
    return _gstlearn.VarioParam_createMultiple(*args, **kwargs)

def VarioParam_createMultipleFromGrid(*args, **kwargs):
    return _gstlearn.VarioParam_createMultipleFromGrid(*args, **kwargs)

def VarioParam_createFromSpaceDimension(*args, **kwargs):
    return _gstlearn.VarioParam_createFromSpaceDimension(*args, **kwargs)

def VarioParam_createSeveral2D(*args, **kwargs):
    return _gstlearn.VarioParam_createSeveral2D(*args, **kwargs)
...
class Vario(AVario, ASerializable):
    ...
    def getMaximumDistance(self, idir):
...
def Vario_create(varioparam):
    return _gstlearn.Vario_create(varioparam)

def Vario_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Vario_createFromNF(neutralFilename, verbose)

def Vario_createRegularizeFromModel(model, varioparam, ext, ndisc, angles, asCov=False):
    return _gstlearn.Vario_createRegularizeFromModel(model, varioparam, ext, ndisc, angles, asCov)

def Vario_createTransformZToY(varioZ, anam):
    return _gstlearn.Vario_createTransformZToY(varioZ, anam)

def Vario_createTransformYToZ(varioY, anam):
    return _gstlearn.Vario_createTransformYToZ(varioY, anam)

def Vario_createReduce(varioIn, varcols, dircols, asSymmetric=False):
    return _gstlearn.Vario_createReduce(varioIn, varcols, dircols, asSymmetric)

def Vario_computeFromDb(*args, **kwargs):
    return _gstlearn.Vario_computeFromDb(*args, **kwargs)
...
def DirParam_create(*args, **kwargs):
    return _gstlearn.DirParam_create(*args, **kwargs)

def DirParam_createOmniDirection(*args, **kwargs):
    return _gstlearn.DirParam_createOmniDirection(*args, **kwargs)

def DirParam_createFromGrid(*args, **kwargs):
    return _gstlearn.DirParam_createFromGrid(*args, **kwargs)

def DirParam_createMultiple(ndir, npas=10, dpas=1., toldis=0.5, angref=0., space=None):
    return _gstlearn.DirParam_createMultiple(ndir, npas, dpas, toldis, angref, space)

def DirParam_createSeveral2D(angles, npas=10, dpas=1., toldis=0.5, tolang=1.234e30, space=None):
    return _gstlearn.DirParam_createSeveral2D(angles, npas, dpas, toldis, tolang, space)

def DirParam_createMultipleInSpace(npas, dpas=1., space=None):
    return _gstlearn.DirParam_createMultipleInSpace(npas, dpas, space)
...
class Model(AStringable, ASerializable, ICloneable):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    def evalCovMatrix(self, *args, **kwargs):
        return _gstlearn.Model_evalCovMatrix(self, *args, **kwargs)

    def evalCovMatrixSymmetric(self, *args, **kwargs):
        return _gstlearn.Model_evalCovMatrixSymmetric(self, *args, **kwargs)

    def evalCovMatrixSparse(self, *args, **kwargs):
        return _gstlearn.Model_evalCovMatrixSparse(self, *args, **kwargs)
    ...
    def evalDriftMatrix(self, *args, **kwargs):
        return _gstlearn.Model_evalDriftMatrix(self, *args, **kwargs)
...
def Model_createFromEnvironment(nvar, ndim=2):
    return _gstlearn.Model_createFromEnvironment(nvar, ndim)

def Model_createNugget(nvar, ndim=2, sill=1.):
    return _gstlearn.Model_createNugget(nvar, ndim, sill)

def Model_createFromParam(*args, **kwargs):
    return _gstlearn.Model_createFromParam(*args, **kwargs)

def Model_createFromDb(db):
    return _gstlearn.Model_createFromDb(db)

def Model_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Model_createFromNF(neutralFilename, verbose)

def Model_gofDisplay(*args, **kwargs):
    return _gstlearn.Model_gofDisplay(*args, **kwargs)

def Model_initCovList(covranks):
    return _gstlearn.Model_initCovList(covranks)
...
class Option_VarioFit(AStringable):
    ...
    def getFlagCheckBounds(self):
        return _gstlearn.Option_VarioFit_getFlagCheckBounds(self)

    def setFlagCheckBounds(self, flagCheckBounds):
...
def ConsItem_create(*args, **kwargs):
    return _gstlearn.ConsItem_create(*args, **kwargs)

def ConsItem_createFromParamId(*args, **kwargs):
    return _gstlearn.ConsItem_createFromParamId(*args, **kwargs)

def ConsItem_define(*args, **kwargs):
    return _gstlearn.ConsItem_define(*args, **kwargs)
...
def CovParamId_create(*args, **kwargs):
    return _gstlearn.CovParamId_create(*args, **kwargs)
...
def ParamId_create(*args, **kwargs):
    return _gstlearn.ParamId_create(*args, **kwargs)
...
class CovAniso(ACov, ICloneable):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    def evalCor(self, p1, p2, mode=None, ivar=0, jvar=0):
        return _gstlearn.CovAniso_evalCor(self, p1, p2, mode, ivar, jvar)
    ...
    def isOptimizationInitialized(self, db=None):
        return _gstlearn.CovAniso_isOptimizationInitialized(self, db)

    def _optimizationPreProcess(self, p):
        return _gstlearn.CovAniso__optimizationPreProcess(self, p)

    def optimizationSetTargetByIndex(self, iech):
        return _gstlearn.CovAniso_optimizationSetTargetByIndex(self, iech)
    ...
    def copyCovContext(self, ctxt):
        return _gstlearn.CovAniso_copyCovContext(self, ctxt)

    def setNoStatFactor(self, noStatFactor):
        return _gstlearn.CovAniso_setNoStatFactor(self, noStatFactor)
    ...
    def attachNoStatDb(self, db):
        return _gstlearn.CovAniso_attachNoStatDb(self, db)
    ...
    def makeSillNoStatDb(self, namecol, ivar=0, jvar=0, db=None):
        return _gstlearn.CovAniso_makeSillNoStatDb(self, namecol, ivar, jvar, db)
    ...
    def makeSillNoStatFunctional(self, func, ivar=0, jvar=0):
        return _gstlearn.CovAniso_makeSillNoStatFunctional(self, func, ivar, jvar)
    ...
    def makeSillStationary(self, ivar=0, jvar=0):
        return _gstlearn.CovAniso_makeSillStationary(self, ivar, jvar)
    ...
    def makeStationary(self):
        return _gstlearn.CovAniso_makeStationary(self)
    ...
    def getNSills(self):
        return _gstlearn.CovAniso_getNSills(self)
    ...
    def isNoStatForVariance(self):
        return _gstlearn.CovAniso_isNoStatForVariance(self)
    ...
    def nostatUpdate(self, covint):
        return _gstlearn.CovAniso_nostatUpdate(self, covint)
    ...
    def informMeshByMesh(self, amesh):
        return _gstlearn.CovAniso_informMeshByMesh(self, amesh)

    def informMeshByApex(self, amesh):
        return _gstlearn.CovAniso_informMeshByApex(self, amesh)

    def informCoords(self, coords, econs, iv1=0, iv2=0):
        return _gstlearn.CovAniso_informCoords(self, coords, econs, iv1, iv2)

    def informDbIn(self, dbin):
        return _gstlearn.CovAniso_informDbIn(self, dbin)

    def informDbOut(self, dbout):
        return _gstlearn.CovAniso_informDbOut(self, dbout)
    ...
    def informMeshByMeshForSills(self, amesh):
        return _gstlearn.CovAniso_informMeshByMeshForSills(self, amesh)

    def informMeshByApexForSills(self, amesh):
        return _gstlearn.CovAniso_informMeshByApexForSills(self, amesh)

    def informDbInForSills(self, dbin):
        return _gstlearn.CovAniso_informDbInForSills(self, dbin)

    def informDbOutForSills(self, dbout):
        return _gstlearn.CovAniso_informDbOutForSills(self, dbout)

    def updateCovByPoints(self, icas1, iech1, icas2, iech2):
        return _gstlearn.CovAniso_updateCovByPoints(self, icas1, iech1, icas2, iech2)

    def updateCovByMesh(self, imesh, aniso=True):
        return _gstlearn.CovAniso_updateCovByMesh(self, imesh, aniso)

    def getValue(self, econs, iv1, iv2):
        return _gstlearn.CovAniso_getValue(self, econs, iv1, iv2)
...
def CovAniso_createIsotropic(ctxt, type, range, sill=1., param=1., flagRange=True):
    return _gstlearn.CovAniso_createIsotropic(ctxt, type, range, sill, param, flagRange)

def CovAniso_createAnisotropic(*args, **kwargs):
    return _gstlearn.CovAniso_createAnisotropic(*args, **kwargs)

def CovAniso_createIsotropicMulti(ctxt, type, range, sills, param=1., flagRange=True):
    return _gstlearn.CovAniso_createIsotropicMulti(ctxt, type, range, sills, param, flagRange)

def CovAniso_createAnisotropicMulti(*args, **kwargs):
    return _gstlearn.CovAniso_createAnisotropicMulti(*args, **kwargs)
...
class CovGneiting(ACov, ICloneable):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _gstlearn.CovGneiting_swiginit(self, _gstlearn.new_CovGneiting(*args))
    __swig_destroy__ = _gstlearn.delete_CovGneiting

    def clone(self):
        return _gstlearn.CovGneiting_clone(self)

    def isConsistent(self, space):
        return _gstlearn.CovGneiting_isConsistent(self, space)

    def eval(self, p1, p2, ivar=0, jvar=0, mode=None):
        return _gstlearn.CovGneiting_eval(self, p1, p2, ivar, jvar, mode)

    def getNVariables(self):
        return _gstlearn.CovGneiting_getNVariables(self)

    def optimizationSetTargetByIndex(self, iech):
        return _gstlearn.CovGneiting_optimizationSetTargetByIndex(self, iech)

# Register CovGneiting in _gstlearn:
_gstlearn.CovGneiting_swigregister(CovGneiting)
...
def CovContext_create(nvar, ndim):
    return _gstlearn.CovContext_create(nvar, ndim)
...
def CovCalcMode_create(*args, **kwargs):
    return _gstlearn.CovCalcMode_create(*args, **kwargs)
...
def CovDiffusionAdvection_create(*args, **kwargs):
    return _gstlearn.CovDiffusionAdvection_create(*args, **kwargs)
...
def CovHelper_getAllCovariances(ndim=2, minorder=-1, hasrange=False, flagSimtub=False, flagSimuSpectral=False):
    return _gstlearn.CovHelper_getAllCovariances(ndim, minorder, hasrange, flagSimtub, flagSimuSpectral)
...
def DriftM_createByIdentifier(driftname):
    return _gstlearn.DriftM_createByIdentifier(driftname)
...
def DriftF_createByIdentifier(driftname):
    return _gstlearn.DriftF_createByIdentifier(driftname)
...
def DriftFactory_createDriftByRank(rank, rank_fex):
    return _gstlearn.DriftFactory_createDriftByRank(rank, rank_fex)

def DriftFactory_createDriftBySymbol(symbol):
    return _gstlearn.DriftFactory_createDriftBySymbol(symbol)

def DriftFactory_createDriftByIdentifier(driftname):
    return _gstlearn.DriftFactory_createDriftByIdentifier(driftname)

def DriftFactory_createDriftListFromIRF(*args, **kwargs):
    return _gstlearn.DriftFactory_createDriftListFromIRF(*args, **kwargs)

def DriftFactory_createDriftListForGradients(*args, **kwargs):
    return _gstlearn.DriftFactory_createDriftListForGradients(*args, **kwargs)
...
class SPDE(object):
    ...
    def computeLogLikelihood(self, nbsimu=1):
        return _gstlearn.SPDE_computeLogLikelihood(self, nbsimu)
    ...
    def getPrecisionOpCs(self, i=0):
        return _gstlearn.SPDE_getPrecisionOpCs(self, i)
...
def Style_documentedStandard(myArg):
    return _gstlearn.Style_documentedStandard(myArg)

def Style_documentedWithFormula(myArg):
    return _gstlearn.Style_documentedWithFormula(myArg)

def Style_unusedArgument(a):
    return _gstlearn.Style_unusedArgument(a)

def Style_myFunction(myArgInt, myArgDoubleDef=2.):
    return _gstlearn.Style_myFunction(myArgInt, myArgDoubleDef)
...
class Db(AStringable, ASerializable, ICloneable):
    ...
    def getSampleCoordinatesInPlace(self, iech, coor):
        return _gstlearn.Db_getSampleCoordinatesInPlace(self, iech, coor)
    ...
    def getAllCoordinatesMat(self):
        return _gstlearn.Db_getAllCoordinatesMat(self)
    ...
    def getArrayBySample(self, iech):
        return _gstlearn.Db_getArrayBySample(self, iech)
...
def Db_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Db_createFromNF(neutralFilename, verbose)

def Db_createFromSamples(*args, **kwargs):
    return _gstlearn.Db_createFromSamples(*args, **kwargs)

def Db_createFromCSV(*args, **kwargs):
    return _gstlearn.Db_createFromCSV(*args, **kwargs)

def Db_createFromBox(nech, coormin, coormax, seed=43241, flag_exact=True, flag_repulsion=False, range=0., beta=0., extend=0., flagAddSampleRank=True):
    return _gstlearn.Db_createFromBox(nech, coormin, coormax, seed, flag_exact, flag_repulsion, range, beta, extend, flagAddSampleRank)

def Db_createFromOnePoint(*args, **kwargs):
    return _gstlearn.Db_createFromOnePoint(*args, **kwargs)

def Db_createSamplingDb(*args, **kwargs):
    return _gstlearn.Db_createSamplingDb(*args, **kwargs)

def Db_createFromDbGrid(nech, dbgrid, seed=432423, flag_exact=True, flag_repulsion=False, range=0., beta=0., flagAddSampleRank=True):
    return _gstlearn.Db_createFromDbGrid(nech, dbgrid, seed, flag_exact, flag_repulsion, range, beta, flagAddSampleRank)

def Db_createReduce(*args, **kwargs):
    return _gstlearn.Db_createReduce(*args, **kwargs)

def Db_createFillRandom(*args, **kwargs):
    return _gstlearn.Db_createFillRandom(*args, **kwargs)

def Db_getNEloc():
    return _gstlearn.Db_getNEloc()

def Db_getMultipleSelectedIndices(*args, **kwargs):
    return _gstlearn.Db_getMultipleSelectedIndices(*args, **kwargs)

def Db_getMultipleSelectedVariables(*args, **kwargs):
    return _gstlearn.Db_getMultipleSelectedVariables(*args, **kwargs)

def Db_getSimRank(isimu, ivar, icase, nbsimu, nvar):
    return _gstlearn.Db_getSimRank(isimu, ivar, icase, nbsimu, nvar)
...
def DbGrid_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.DbGrid_createFromNF(neutralFilename, verbose)

def DbGrid_create(*args, **kwargs):
    return _gstlearn.DbGrid_create(*args, **kwargs)

def DbGrid_createCoveringDb(*args, **kwargs):
    return _gstlearn.DbGrid_createCoveringDb(*args, **kwargs)

def DbGrid_createFromPolygon(polygon, nodes, dcell, flagAddSampleRank=True):
    return _gstlearn.DbGrid_createFromPolygon(polygon, nodes, dcell, flagAddSampleRank)

def DbGrid_createCoarse(dbin, nmult, flagCell=True, flagAddSampleRank=True):
    return _gstlearn.DbGrid_createCoarse(dbin, nmult, flagCell, flagAddSampleRank)

def DbGrid_createRefine(dbin, nmult, flagCell=True, flagAddSampleRank=True):
    return _gstlearn.DbGrid_createRefine(dbin, nmult, flagCell, flagAddSampleRank)

def DbGrid_createFromGridExtend(gridIn, tops, bots, nxnew, verbose=False, eps=1.e-3):
    return _gstlearn.DbGrid_createFromGridExtend(gridIn, tops, bots, nxnew, verbose, eps)

def DbGrid_createFromGridShrink(gridIn, deletedRanks):
    return _gstlearn.DbGrid_createFromGridShrink(gridIn, deletedRanks)

def DbGrid_createGrid2D(*args, **kwargs):
    return _gstlearn.DbGrid_createGrid2D(*args, **kwargs)

def DbGrid_createSqueezeAndStretchForward(grid3Din, surf2D, nameTop, nameBot, names, nzout, thickmin=0.):
    return _gstlearn.DbGrid_createSqueezeAndStretchForward(grid3Din, surf2D, nameTop, nameBot, names, nzout, thickmin)

def DbGrid_createSqueezeAndStretchBackward(grid3Din, surf2D, nameTop, nameBot, names, nzout, z0out, dzout):
    return _gstlearn.DbGrid_createSqueezeAndStretchBackward(grid3Din, surf2D, nameTop, nameBot, names, nzout, z0out, dzout)

def DbGrid_createSubGrid(gridin, limits, flagAddCoordinates=False):
    return _gstlearn.DbGrid_createSubGrid(gridin, limits, flagAddCoordinates)

def DbGrid_createMultiple(dbin, nmult, flagAddSampleRank):
    return _gstlearn.DbGrid_createMultiple(dbin, nmult, flagAddSampleRank)

def DbGrid_createDivider(dbin, nmult, flagAddSampleRank):
    return _gstlearn.DbGrid_createDivider(dbin, nmult, flagAddSampleRank)
...
class DbLine(Db):
    ...
    def getLineSampleCount(self, iline):
        return _gstlearn.DbLine_getLineSampleCount(self, iline)
...
def DbLine_createFromSamples(*args, **kwargs):
    return _gstlearn.DbLine_createFromSamples(*args, **kwargs)

def DbLine_createFromSamplesById(*args, **kwargs):
    return _gstlearn.DbLine_createFromSamplesById(*args, **kwargs)

def DbLine_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.DbLine_createFromNF(neutralFilename, verbose)

def DbLine_createFillRandom(*args, **kwargs):
    return _gstlearn.DbLine_createFillRandom(*args, **kwargs)
...
def DbGraphO_createFromSamples(*args, **kwargs):
    return _gstlearn.DbGraphO_createFromSamples(*args, **kwargs)

def DbGraphO_createFromMatrix(*args, **kwargs):
    return _gstlearn.DbGraphO_createFromMatrix(*args, **kwargs)

def DbGraphO_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.DbGraphO_createFromNF(neutralFilename, verbose)
...
def DbMeshTurbo_create(*args, **kwargs):
    return _gstlearn.DbMeshTurbo_create(*args, **kwargs)

def DbMeshTurbo_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.DbMeshTurbo_createFromNF(neutralFilename, verbose)
...
def DbMeshStandard_create(*args, **kwargs):
    return _gstlearn.DbMeshStandard_create(*args, **kwargs)

def DbMeshStandard_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.DbMeshStandard_createFromNF(neutralFilename, verbose)

def DbMeshStandard_createFromExternal(*args, **kwargs):
    return _gstlearn.DbMeshStandard_createFromExternal(*args, **kwargs)
...
def DbStringFormat_create(*args, **kwargs):
    return _gstlearn.DbStringFormat_create(*args, **kwargs)

def DbStringFormat_createFromKeys(params, names, cols, useSel):
    return _gstlearn.DbStringFormat_createFromKeys(params, names, cols, useSel)

def DbStringFormat_createFromFlags(*args, **kwargs):
    return _gstlearn.DbStringFormat_createFromFlags(*args, **kwargs)
...
def DbHelper_findDuplicates(db1, db2, flag_same, verbose, opt_code, tolcode, dist, sel):
    return _gstlearn.DbHelper_findDuplicates(db1, db2, flag_same, verbose, opt_code, tolcode, dist, sel)

def DbHelper_centerPointToGrid(db_point, db_grid, eps_random=1.e-6):
    return _gstlearn.DbHelper_centerPointToGrid(db_point, db_grid, eps_random)

def DbHelper_normalizeVariables(db, oper, cols, center, stdv):
    return _gstlearn.DbHelper_normalizeVariables(db, oper, cols, center, stdv)

def DbHelper_dbgrid_filling(*args, **kwargs):
    return _gstlearn.DbHelper_dbgrid_filling(*args, **kwargs)

def DbHelper_db_duplicate(*args, **kwargs):
    return _gstlearn.DbHelper_db_duplicate(*args, **kwargs)

def DbHelper_db_compositional_transform(db, verbose, mode, type, number, iatt_in, iatt_out, numout):
    return _gstlearn.DbHelper_db_compositional_transform(db, verbose, mode, type, number, iatt_in, iatt_out, numout)

def DbHelper_dbgrid_sampling(dbin, nmult):
    return _gstlearn.DbHelper_dbgrid_sampling(dbin, nmult)

def DbHelper_db_grid1D_fill(*args, **kwargs):
    return _gstlearn.DbHelper_db_grid1D_fill(*args, **kwargs)
...
def AnamHermite_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.AnamHermite_createFromNF(neutralFilename, verbose)

def AnamHermite_create(nbpoly=0, flagBound=True, rCoef=1.):
    return _gstlearn.AnamHermite_create(nbpoly, flagBound, rCoef)
...
def AnamEmpirical_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.AnamEmpirical_createFromNF(neutralFilename, verbose)

def AnamEmpirical_create(ndisc=100, sigma2e=1.234e30):
    return _gstlearn.AnamEmpirical_create(ndisc, sigma2e)
...
def AnamDiscreteDD_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.AnamDiscreteDD_createFromNF(neutralFilename, verbose)

def AnamDiscreteDD_create(mu=1., scoef=0.):
    return _gstlearn.AnamDiscreteDD_create(mu, scoef)
...
def AnamDiscreteIR_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.AnamDiscreteIR_createFromNF(neutralFilename, verbose)

def AnamDiscreteIR_create(rcoef=0.):
    return _gstlearn.AnamDiscreteIR_create(rcoef)
...
def Polygons_createFromNF(neutralFilename, verbose=False):
    return _gstlearn.Polygons_createFromNF(neutralFilename, verbose)

def Polygons_createFromCSV(*args, **kwargs):
    return _gstlearn.Polygons_createFromCSV(*args, **kwargs)

def Polygons_createFromWKT(*args, **kwargs):
    return _gstlearn.Polygons_createFromWKT(*args, **kwargs)

def Polygons_createFromDb(db, dilate=0., verbose=False):
    return _gstlearn.Polygons_createFromDb(db, dilate, verbose)
...
def PolyElem_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.PolyElem_createFromNF(neutralFilename, verbose)
...
def Selectivity_create(ncut):
    return _gstlearn.Selectivity_create(ncut)

def Selectivity_createByCuts(zcut):
    return _gstlearn.Selectivity_createByCuts(zcut)

def Selectivity_createByCodes(*args, **kwargs):
    return _gstlearn.Selectivity_createByCodes(*args, **kwargs)

def Selectivity_createByKeys(*args, **kwargs):
    return _gstlearn.Selectivity_createByKeys(*args, **kwargs)

def Selectivity_createInterpolation(zcuts, selecin, verbose):
    return _gstlearn.Selectivity_createInterpolation(zcuts, selecin, verbose)

def Selectivity_getNQT():
    return _gstlearn.Selectivity_getNQT()
...
def Rule_create(rho=0.):
    return _gstlearn.Rule_create(rho)

def Rule_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.Rule_createFromNF(neutralFilename, verbose)

def Rule_createFromNames(nodnames, rho=0.):
    return _gstlearn.Rule_createFromNames(nodnames, rho)

def Rule_createFromCodes(nodes, rho=0.):
    return _gstlearn.Rule_createFromCodes(nodes, rho)

def Rule_createFromNumericalCoding(n_type, n_facs, rho=0.):
    return _gstlearn.Rule_createFromNumericalCoding(n_type, n_facs, rho)

def Rule_createFromFaciesCount(nfacies, rho=0.):
    return _gstlearn.Rule_createFromFaciesCount(nfacies, rho)
...
def RuleProp_createFromDb(*args, **kwargs):
    return _gstlearn.RuleProp_createFromDb(*args, **kwargs)

def RuleProp_createFromRule(*args, **kwargs):
    return _gstlearn.RuleProp_createFromRule(*args, **kwargs)

def RuleProp_createFromRuleAndDb(rule, dbprop):
    return _gstlearn.RuleProp_createFromRuleAndDb(rule, dbprop)

def RuleProp_createFromRules(*args, **kwargs):
    return _gstlearn.RuleProp_createFromRules(*args, **kwargs)

def RuleProp_createFromRulesAndDb(rule1, rule2, dbprop):
    return _gstlearn.RuleProp_createFromRulesAndDb(rule1, rule2, dbprop)
...
def CalcSimuTurningBands_isValidForTurningBands(model):
    return _gstlearn.CalcSimuTurningBands_isValidForTurningBands(model)
...
class SimuSpectral(object):
    ...
    def isValidForSpectral(self, model):
        return _gstlearn.SimuSpectral_isValidForSpectral(self, model)
...
def BooleanObject_generate(dbout, cdgrain, tokens, boolparam, eps=1.e-3):
    return _gstlearn.BooleanObject_generate(dbout, cdgrain, tokens, boolparam, eps)
...
def FracEnviron_createFromNF(neutralFilename, verbose=True):
    return _gstlearn.FracEnviron_createFromNF(neutralFilename, verbose)

def FracEnviron_create(xmax=0., ymax=0., deltax=0., deltay=0, mean=0., stdev=0.):
    return _gstlearn.FracEnviron_create(xmax, ymax, deltax, deltay, mean, stdev)
...
def FracList_fractureImport(*args, **kwargs):
    return _gstlearn.FracList_fractureImport(*args, **kwargs)
