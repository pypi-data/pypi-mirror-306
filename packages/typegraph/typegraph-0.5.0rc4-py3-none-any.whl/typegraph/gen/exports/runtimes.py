...
@dataclass
class SubstantialOperationTypeStart:
    pass

@dataclass
class SubstantialOperationTypeStartRaw:
    pass

@dataclass
class SubstantialOperationTypeStop:
    pass

@dataclass
class SubstantialOperationTypeSend:
    pass

@dataclass
class SubstantialOperationTypeSendRaw:
    pass

@dataclass
class SubstantialOperationTypeResources:
    pass

@dataclass
class SubstantialOperationTypeResults:
    pass

@dataclass
class SubstantialOperationTypeResultsRaw:
    pass

@dataclass
class SubstantialOperationTypeInternalLinkParentChild:
    pass

SubstantialOperationType = Union[SubstantialOperationTypeStart, SubstantialOperationTypeStartRaw, SubstantialOperationTypeStop, SubstantialOperationTypeSend, SubstantialOperationTypeSendRaw, SubstantialOperationTypeResources, SubstantialOperationTypeResults, SubstantialOperationTypeResultsRaw, SubstantialOperationTypeInternalLinkParentChild]

@dataclass
class SubstantialOperationData:
    func_arg: Optional[TypeId]
    func_out: Optional[TypeId]
...
class Runtimes:
    ...
    def prisma_delete_many(self, caller: wasmtime.Store, runtime: RuntimeId, model: TypeId) -> Result[FuncParams, Error]:
        ret = self.component.lift_callee62(caller, _clamp(runtime, 0, 4294967295), _clamp(model, 0, 4294967295))
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
    ...
    def prisma_execute(self, caller: wasmtime.Store, runtime: RuntimeId, query: str, param: TypeId, effect: Effect) -> Result[FuncParams, Error]:
        ...
        if isinstance(effect, EffectRead):
            ...
            raise TypeError("invalid variant specified for Effect")
        ret = self.component.lift_callee63(caller, _clamp(runtime, 0, 4294967295), ptr, len0, _clamp(param, 0, 4294967295), variant, variant4)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
    ...
    def prisma_query_raw(self, caller: wasmtime.Store, runtime: RuntimeId, query: str, param: Optional[TypeId], out: TypeId) -> Result[FuncParams, Error]:
        ...
        if param is None:
            ...
            variant = 1
            variant2 = _clamp(payload1, 0, 4294967295)
        ret = self.component.lift_callee64(caller, _clamp(runtime, 0, 4294967295), ptr, len0, variant, variant2, _clamp(out, 0, 4294967295))
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
    ...
    def prisma_link(self, caller: wasmtime.Store, data: PrismaLinkData) -> Result[TypeId, Error]:
        ...
        if field3 is None:
            ...
            variant21 = 1
            variant22 = int(payload20)
        ret = self.component.lift_callee65(caller, _clamp(field, 0, 4294967295), variant, variant6, variant7, variant10, variant11, variant16, variant17, variant18, variant21, variant22)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
    ...
    def prisma_migration(self, caller: wasmtime.Store, operation: PrismaMigrationOperation) -> Result[FuncParams, Error]:
        ret = self.component.lift_callee66(caller, (operation).value)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
    ...
    def register_temporal_runtime(self, caller: wasmtime.Store, data: TemporalRuntimeData) -> Result[RuntimeId, Error]:
        ...
        if field1 is None:
            ...
            variant8 = ptr6
            variant9 = len7
        ret = self.component.lift_callee67(caller, ptr, len2, ptr3, len4, variant, variant8, variant9)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[RuntimeId, Error]
        if load == 0:
    ...
    def generate_temporal_operation(self, caller: wasmtime.Store, runtime: RuntimeId, data: TemporalOperationData) -> Result[FuncParams, Error]:
        ...
        ret = self.component.lift_callee68(caller, _clamp(runtime, 0, 4294967295), variant, variant5, variant6, variant9, variant10, variant13, variant14, variant19)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
    ...
    def register_typegraph_materializer(self, caller: wasmtime.Store, operation: TypegraphOperation) -> Result[MaterializerId, Error]:
        ret = self.component.lift_callee70(caller, (operation).value)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[MaterializerId, Error]
        if load == 0:
    ...
    def register_substantial_runtime(self, caller: wasmtime.Store, data: SubstantialRuntimeData) -> Result[RuntimeId, Error]:
        ...
        ret = self.component.lift_callee71(caller, variant, variant6, variant7, result31, len32)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[RuntimeId, Error]
        if load == 0:
    ...
    def generate_substantial_operation(self, caller: wasmtime.Store, runtime: RuntimeId, data: SubstantialOperationData) -> Result[FuncParams, Error]:
        ...
        if isinstance(field1, SubstantialOperationTypeStart):
            variant17 = 0
        elif isinstance(field1, SubstantialOperationTypeStartRaw):
            variant17 = 1
        elif isinstance(field1, SubstantialOperationTypeStop):
            variant17 = 2
        elif isinstance(field1, SubstantialOperationTypeSend):
            variant17 = 3
        elif isinstance(field1, SubstantialOperationTypeSendRaw):
            variant17 = 4
        elif isinstance(field1, SubstantialOperationTypeResources):
            variant17 = 5
        elif isinstance(field1, SubstantialOperationTypeResults):
            variant17 = 6
        elif isinstance(field1, SubstantialOperationTypeResultsRaw):
            variant17 = 7
        elif isinstance(field1, SubstantialOperationTypeInternalLinkParentChild):
            variant17 = 8
        else:
            raise TypeError("invalid variant specified for SubstantialOperationType")
        ret = self.component.lift_callee72(caller, _clamp(runtime, 0, 4294967295), variant, variant3, variant6, variant7, variant17)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[FuncParams, Error]
        if load == 0:
            ...
            load20 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 12)
            expected = Ok(core.FuncParams(load18 & 0xffffffff, load19 & 0xffffffff, load20 & 0xffffffff))
        elif load == 1:
            load21 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 4)
            load22 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 8)
            ptr27 = load21
            len28 = load22
            result: List[str] = []
            for i29 in range(0, len28):
                base23 = ptr27 + i29 * 8
                load24 = _load(ctypes.c_int32, self.component._core_memory0, caller, base23, 0)
                load25 = _load(ctypes.c_int32, self.component._core_memory0, caller, base23, 4)
                ptr = load24
                len26 = load25
                list = _decode_utf8(self.component._core_memory0, caller, ptr, len26)
                result.append(list)
            expected = Err(core.Error(result))
        else:
            raise TypeError("invalid variant discriminant for expected")
    ...
    def register_kv_runtime(self, caller: wasmtime.Store, data: KvRuntimeData) -> Result[RuntimeId, Error]:
        ...
        field = record.url
        ptr, len0 = _encode_utf8(field, self.component._realloc0, self.component._core_memory0, caller)
        ret = self.component.lift_callee73(caller, ptr, len0)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[RuntimeId, Error]
        if load == 0:
    ...
    def kv_operation(self, caller: wasmtime.Store, base: BaseMaterializer, data: KvMaterializer) -> Result[MaterializerId, Error]:
        ...
        if isinstance(field0, EffectRead):
            ...
            raise TypeError("invalid variant specified for Effect")
        ret = self.component.lift_callee74(caller, _clamp(field, 0, 4294967295), variant, variant4, (data).value)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[MaterializerId, Error]
        if load == 0:
    ...
    def register_grpc_runtime(self, caller: wasmtime.Store, data: GrpcRuntimeData) -> Result[RuntimeId, Error]:
        ...
        ptr, len1 = _encode_utf8(field, self.component._realloc0, self.component._core_memory0, caller)
        ptr2, len3 = _encode_utf8(field0, self.component._realloc0, self.component._core_memory0, caller)
        ret = self.component.lift_callee75(caller, ptr, len1, ptr2, len3)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[RuntimeId, Error]
        if load == 0:
