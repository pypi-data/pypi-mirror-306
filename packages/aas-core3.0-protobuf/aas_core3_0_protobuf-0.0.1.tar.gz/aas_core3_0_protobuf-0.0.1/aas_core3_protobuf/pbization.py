...
def has_semantics_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _HAS_SEMANTICS_FROM_PB_CHOICE_MAP[
...
def extension_from_pb(that: types_pb.Extension) -> types.Extension:
    """
    ...
    return types.Extension(
        semantic_id=(
            reference_from_pb(that.semantic_id)
            if that.HasField("semantic_id")
            else None
        ),
        supplemental_semantic_ids=(
            list(map(reference_from_pb, that.supplemental_semantic_ids))
            if len(that.supplemental_semantic_ids) > 0
            else None
        ),
        name=that.name,
        value_type=(
            data_type_def_xsd_from_pb(that.value_type)
            if that.HasField("value_type")
            else None
        ),
        value=(that.value if that.HasField("value") else None),
        refers_to=(
            list(map(reference_from_pb, that.refers_to))
...
def has_extensions_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _HAS_EXTENSIONS_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def referable_from_pb_choice(that: types_pb.Referable_choice) -> types.Referable:
    """
    Parse ``that`` Protocol Buffer based on its runtime ``WhichOneof``.
    ...
    """
    get_concrete_instance_from_pb = _REFERABLE_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def identifiable_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _IDENTIFIABLE_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def modelling_kind_from_pb(that: types_pb.ModellingKind) -> types.ModellingKind:
    """
...
def has_kind_from_pb_choice(that: types_pb.HasKind_choice) -> types.HasKind:
    """
    Parse ``that`` Protocol Buffer based on its runtime ``WhichOneof``.
    ...
    """
    get_concrete_instance_from_pb = _HAS_KIND_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def has_data_specification_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _HAS_DATA_SPECIFICATION_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def administrative_information_from_pb(
    ...
    return types.AdministrativeInformation(
        ...
        version=(that.version if that.HasField("version") else None),
        revision=(that.revision if that.HasField("revision") else None),
        creator=(reference_from_pb(that.creator) if that.HasField("creator") else None),
        template_id=(that.template_id if that.HasField("template_id") else None),
    )
...
def qualifiable_from_pb_choice(that: types_pb.Qualifiable_choice) -> types.Qualifiable:
    """
    Parse ``that`` Protocol Buffer based on its runtime ``WhichOneof``.
    ...
    """
    get_concrete_instance_from_pb = _QUALIFIABLE_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def qualifier_kind_from_pb(that: types_pb.QualifierKind) -> types.QualifierKind:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def qualifier_from_pb(that: types_pb.Qualifier) -> types.Qualifier:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Qualifier(
        ...
        kind=(qualifier_kind_from_pb(that.kind) if that.HasField("kind") else None),
        type=that.type,
        value_type=data_type_def_xsd_from_pb(that.value_type),
        value=(that.value if that.HasField("value") else None),
        value_id=(
            reference_from_pb(that.value_id) if that.HasField("value_id") else None
        ),
    )
...
def asset_administration_shell_from_pb(
    ...
    return types.AssetAdministrationShell(
        extensions=(
            list(map(extension_from_pb, that.extensions))
            if len(that.extensions) > 0
            else None
        ),
        category=(that.category if that.HasField("category") else None),
        id_short=(that.id_short if that.HasField("id_short") else None),
        display_name=(
            list(map(lang_string_name_type_from_pb, that.display_name))
            if len(that.display_name) > 0
            else None
        ),
        description=(
            list(map(lang_string_text_type_from_pb, that.description))
            if len(that.description) > 0
            else None
        ),
        administration=(
            administrative_information_from_pb(that.administration)
        ...
        derived_from=(
            reference_from_pb(that.derived_from)
            if that.HasField("derived_from")
            else None
        ),
        asset_information=asset_information_from_pb(that.asset_information),
        submodels=(
            list(map(reference_from_pb, that.submodels))
...
def asset_information_from_pb(
    ...
    return types.AssetInformation(
        asset_kind=asset_kind_from_pb(that.asset_kind),
        global_asset_id=(
            that.global_asset_id if that.HasField("global_asset_id") else None
        ),
        specific_asset_ids=(
            list(map(specific_asset_id_from_pb, that.specific_asset_ids))
            if len(that.specific_asset_ids) > 0
            else None
        ),
        asset_type=(that.asset_type if that.HasField("asset_type") else None),
        default_thumbnail=(
            resource_from_pb(that.default_thumbnail)
...
def resource_from_pb(that: types_pb.Resource) -> types.Resource:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Resource(
        path=that.path,
        content_type=(that.content_type if that.HasField("content_type") else None),
    )
...
def asset_kind_from_pb(that: types_pb.AssetKind) -> types.AssetKind:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def specific_asset_id_from_pb(that: types_pb.SpecificAssetId) -> types.SpecificAssetID:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.SpecificAssetID(
        ...
        value=that.value,
        external_subject_id=(
            reference_from_pb(that.external_subject_id)
...
def submodel_from_pb(that: types_pb.Submodel) -> types.Submodel:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Submodel(
        ...
        id=that.id,
        kind=(modelling_kind_from_pb(that.kind) if that.HasField("kind") else None),
        semantic_id=(
            reference_from_pb(that.semantic_id)
            if that.HasField("semantic_id")
            else None
        ...
        qualifiers=(
            list(map(qualifier_from_pb, that.qualifiers))
        ...
        submodel_elements=(
            list(map(submodel_element_from_pb_choice, that.submodel_elements))
...
def submodel_element_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _SUBMODEL_ELEMENT_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def relationship_element_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _RELATIONSHIP_ELEMENT_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def relationship_element_from_pb(
    ...
    return types.RelationshipElement(
        ...
        first=reference_from_pb(that.first),
        second=reference_from_pb(that.second),
    )
...
def submodel_element_list_from_pb(
    ...
    return types.SubmodelElementList(
        ...
        order_relevant=(
            that.order_relevant if that.HasField("order_relevant") else None
        ),
        semantic_id_list_element=(
            reference_from_pb(that.semantic_id_list_element)
        ...
        value_type_list_element=(
            data_type_def_xsd_from_pb(that.value_type_list_element)
            if that.HasField("value_type_list_element")
            else None
        ),
        value=(
            list(map(submodel_element_from_pb_choice, that.value))
            if len(that.value) > 0
            else None
        ),
    )
...
def data_element_from_pb_choice(that: types_pb.DataElement_choice) -> types.DataElement:
    """
    Parse ``that`` Protocol Buffer based on its runtime ``WhichOneof``.
    ...
    """
    get_concrete_instance_from_pb = _DATA_ELEMENT_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def property_from_pb(that: types_pb.Property) -> types.Property:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
...
def multi_language_property_from_pb(
    ...
    return types.MultiLanguageProperty(
        ...
        value=(
            list(map(lang_string_text_type_from_pb, that.value))
            if len(that.value) > 0
            else None
        ),
        value_id=(
...
def range_from_pb(that: types_pb.Range) -> types.Range:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Range(
        ...
        value_type=data_type_def_xsd_from_pb(that.value_type),
        min=(that.min if that.HasField("min") else None),
        max=(that.max if that.HasField("max") else None),
    )
...
def reference_element_from_pb(
    ...
    return types.ReferenceElement(
        ...
        value=(reference_from_pb(that.value) if that.HasField("value") else None),
    )


def blob_from_pb(that: types_pb.Blob) -> types.Blob:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Blob(
        ...
        value=(bytearray(that.value) if that.HasField("value") else None),
        content_type=that.content_type,
    )


def file_from_pb(that: types_pb.File) -> types.File:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
...
def annotated_relationship_element_from_pb(
    ...
    return types.AnnotatedRelationshipElement(
        ...
        second=reference_from_pb(that.second),
        annotations=(
            list(map(data_element_from_pb_choice, that.annotations))
...
def entity_from_pb(that: types_pb.Entity) -> types.Entity:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Entity(
        ...
        statements=(
            list(map(submodel_element_from_pb_choice, that.statements))
            if len(that.statements) > 0
            else None
        ),
        entity_type=entity_type_from_pb(that.entity_type),
        global_asset_id=(
            that.global_asset_id if that.HasField("global_asset_id") else None
        ),
        specific_asset_ids=(
...
def entity_type_from_pb(that: types_pb.EntityType) -> types.EntityType:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def direction_from_pb(that: types_pb.Direction) -> types.Direction:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def state_of_event_from_pb(that: types_pb.StateOfEvent) -> types.StateOfEvent:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def event_payload_from_pb(that: types_pb.EventPayload) -> types.EventPayload:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.EventPayload(
        source=reference_from_pb(that.source),
        source_semantic_id=(
            reference_from_pb(that.source_semantic_id)
            if that.HasField("source_semantic_id")
            else None
        ),
        observable_reference=reference_from_pb(that.observable_reference),
        observable_semantic_id=(
            reference_from_pb(that.observable_semantic_id)
            if that.HasField("observable_semantic_id")
            else None
        ),
        topic=(that.topic if that.HasField("topic") else None),
        subject_id=(
            reference_from_pb(that.subject_id) if that.HasField("subject_id") else None
        ),
        time_stamp=that.time_stamp,
        payload=(bytearray(that.payload) if that.HasField("payload") else None),
    )
...
def event_element_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _EVENT_ELEMENT_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def basic_event_element_from_pb(
    ...
    return types.BasicEventElement(
        ...
        observed=reference_from_pb(that.observed),
        direction=direction_from_pb(that.direction),
        state=state_of_event_from_pb(that.state),
        message_topic=(that.message_topic if that.HasField("message_topic") else None),
        message_broker=(
            reference_from_pb(that.message_broker)
            if that.HasField("message_broker")
            else None
        ),
        last_update=(that.last_update if that.HasField("last_update") else None),
        min_interval=(that.min_interval if that.HasField("min_interval") else None),
        max_interval=(that.max_interval if that.HasField("max_interval") else None),
    )


def operation_from_pb(that: types_pb.Operation) -> types.Operation:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Operation(
        ...
        input_variables=(
            list(map(operation_variable_from_pb, that.input_variables))
            if len(that.input_variables) > 0
            else None
        ),
        output_variables=(
            list(map(operation_variable_from_pb, that.output_variables))
            if len(that.output_variables) > 0
            else None
        ),
        inoutput_variables=(
            list(map(operation_variable_from_pb, that.inoutput_variables))
...
def operation_variable_from_pb(
    ...
    """
    return types.OperationVariable(value=submodel_element_from_pb_choice(that.value))


def capability_from_pb(that: types_pb.Capability) -> types.Capability:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
...
def concept_description_from_pb(
    ...
    return types.ConceptDescription(
        ...
        is_case_of=(
            list(map(reference_from_pb, that.is_case_of))
...
def reference_types_from_pb(that: types_pb.ReferenceTypes) -> types.ReferenceTypes:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def reference_from_pb(that: types_pb.Reference) -> types.Reference:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Reference(
        type=reference_types_from_pb(that.type),
        referred_semantic_id=(
            reference_from_pb(that.referred_semantic_id)
            if that.HasField("referred_semantic_id")
            else None
        ),
        keys=list(map(key_from_pb, that.keys)),
    )


def key_from_pb(that: types_pb.Key) -> types.Key:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    """
    return types.Key(type=key_types_from_pb(that.type), value=that.value)
...
def key_types_from_pb(that: types_pb.KeyTypes) -> types.KeyTypes:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def data_type_def_xsd_from_pb(that: types_pb.DataTypeDefXsd) -> types.DataTypeDefXSD:
    """
    Parse ``that`` enum back from its Protocol Buffer representation.
...
def abstract_lang_string_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _ABSTRACT_LANG_STRING_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def lang_string_name_type_from_pb(
    ...
    """
    return types.LangStringNameType(language=that.language, text=that.text)
...
def lang_string_text_type_from_pb(
    ...
    """
    return types.LangStringTextType(language=that.language, text=that.text)


def environment_from_pb(that: types_pb.Environment) -> types.Environment:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.Environment(
        asset_administration_shells=(
            list(
                map(
                    asset_administration_shell_from_pb, that.asset_administration_shells
                )
            )
        ...
        submodels=(
            list(map(submodel_from_pb, that.submodels))
            if len(that.submodels) > 0
            else None
        ),
        concept_descriptions=(
            list(map(concept_description_from_pb, that.concept_descriptions))
...
def data_specification_content_from_pb_choice(
    ...
    """
    get_concrete_instance_from_pb = _DATA_SPECIFICATION_CONTENT_FROM_PB_CHOICE_MAP[
        that.WhichOneof("value")
    ]
...
def embedded_data_specification_from_pb(
    ...
    return types.EmbeddedDataSpecification(
        ...
        data_specification=reference_from_pb(that.data_specification),
    )
...
def level_type_from_pb(that: types_pb.LevelType) -> types.LevelType:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    """
    return types.LevelType(min=that.min, nom=that.nom, typ=that.typ, max=that.max)
...
def value_reference_pair_from_pb(
    ...
    return types.ValueReferencePair(
        value=that.value, value_id=reference_from_pb(that.value_id)
    )


def value_list_from_pb(that: types_pb.ValueList) -> types.ValueList:
    """
    Parse ``that`` Protocol Buffer to an instance of a concrete class.
    ...
    return types.ValueList(
        value_reference_pairs=list(
            map(value_reference_pair_from_pb, that.value_reference_pairs)
        )
    )
...
def lang_string_preferred_name_type_iec_61360_from_pb(
    ...
    return types.LangStringPreferredNameTypeIEC61360(
        language=that.language, text=that.text
    )
...
def lang_string_short_name_type_iec_61360_from_pb(
    ...
    """
    return types.LangStringShortNameTypeIEC61360(language=that.language, text=that.text)
...
def data_specification_iec_61360_from_pb(
    ...
    return types.DataSpecificationIEC61360(
        preferred_name=list(
            map(lang_string_preferred_name_type_iec_61360_from_pb, that.preferred_name)
        ),
        short_name=(
            list(map(lang_string_short_name_type_iec_61360_from_pb, that.short_name))
            if len(that.short_name) > 0
            else None
        ),
        unit=(that.unit if that.HasField("unit") else None),
        unit_id=(reference_from_pb(that.unit_id) if that.HasField("unit_id") else None),
        source_of_definition=(
            that.source_of_definition if that.HasField("source_of_definition") else None
        ),
        symbol=(that.symbol if that.HasField("symbol") else None),
        data_type=(
            data_type_iec_61360_from_pb(that.data_type)
            if that.HasField("data_type")
            else None
        ),
        definition=(
            list(map(lang_string_definition_type_iec_61360_from_pb, that.definition))
            if len(that.definition) > 0
            else None
        ),
        value_format=(that.value_format if that.HasField("value_format") else None),
        value_list=(
            value_list_from_pb(that.value_list) if that.HasField("value_list") else None
        ),
        value=(that.value if that.HasField("value") else None),
        level_type=(
            level_type_from_pb(that.level_type) if that.HasField("level_type") else None
        ),
    )
...
def from_pb(that: google.protobuf.message.Message) -> types.Class:
    """
...
class _PartialVisitorWithContext(types.AbstractVisitorWithContext[T]):
    ...
    def visit_extension_with_context(self, that: types.Extension, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_administrative_information_with_context(
        self, that: types.AdministrativeInformation, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_qualifier_with_context(self, that: types.Qualifier, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_asset_administration_shell_with_context(
        self, that: types.AssetAdministrationShell, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_asset_information_with_context(
        self, that: types.AssetInformation, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_resource_with_context(self, that: types.Resource, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_specific_asset_id_with_context(
        self, that: types.SpecificAssetID, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_submodel_with_context(self, that: types.Submodel, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_submodel_element_collection_with_context(
        self, that: types.SubmodelElementCollection, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_property_with_context(self, that: types.Property, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_range_with_context(self, that: types.Range, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_blob_with_context(self, that: types.Blob, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_file_with_context(self, that: types.File, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_annotated_relationship_element_with_context(
        self, that: types.AnnotatedRelationshipElement, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_entity_with_context(self, that: types.Entity, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_event_payload_with_context(
        self, that: types.EventPayload, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_operation_with_context(self, that: types.Operation, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_operation_variable_with_context(
        self, that: types.OperationVariable, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_capability_with_context(self, that: types.Capability, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_concept_description_with_context(
        self, that: types.ConceptDescription, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_reference_with_context(self, that: types.Reference, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_key_with_context(self, that: types.Key, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_lang_string_name_type_with_context(
        self, that: types.LangStringNameType, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_lang_string_text_type_with_context(
        self, that: types.LangStringTextType, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_environment_with_context(
        self, that: types.Environment, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_embedded_data_specification_with_context(
        self, that: types.EmbeddedDataSpecification, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_level_type_with_context(self, that: types.LevelType, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_value_reference_pair_with_context(
        self, that: types.ValueReferencePair, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_value_list_with_context(self, that: types.ValueList, context: T) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_lang_string_preferred_name_type_iec_61360_with_context(
        self, that: types.LangStringPreferredNameTypeIEC61360, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_lang_string_short_name_type_iec_61360_with_context(
        self, that: types.LangStringShortNameTypeIEC61360, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_lang_string_definition_type_iec_61360_with_context(
        self, that: types.LangStringDefinitionTypeIEC61360, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")

    def visit_data_specification_iec_61360_with_context(
        self, that: types.DataSpecificationIEC61360, context: T
    ) -> None:
        raise AssertionError(f"Unexpected visitation of {that.__class__}")


class _HasSemanticsToPbChoice(_PartialVisitorWithContext[types_pb.HasSemantics_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.relationship_element``
        according to ``that`` instance.
        """
        relationship_element_to_pb(that, context.relationship_element)
    ...
    def visit_annotated_relationship_element_with_context(
        ...
        annotated_relationship_element_to_pb(
            that, context.annotated_relationship_element
        )

    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
        """
        basic_event_element_to_pb(that, context.basic_event_element)

    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
        """
        blob_to_pb(that, context.blob)

    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
        """
        capability_to_pb(that, context.capability)

    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
        """
        entity_to_pb(that, context.entity)

    def visit_extension_with_context(
        self, that: types.Extension, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.extension``
        according to ``that`` instance.
        """
        extension_to_pb(that, context.extension)

    def visit_file_with_context(
        self, that: types.File, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
        """
        file_to_pb(that, context.file)

    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.multi_language_property``
        according to ``that`` instance.
        """
        multi_language_property_to_pb(that, context.multi_language_property)

    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
        """
        operation_to_pb(that, context.operation)

    def visit_property_with_context(
        self, that: types.Property, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
        """
        property_to_pb(that, context.property)

    def visit_qualifier_with_context(
        self, that: types.Qualifier, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.qualifier``
        according to ``that`` instance.
        """
        qualifier_to_pb(that, context.qualifier)

    def visit_range_with_context(
        self, that: types.Range, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
        """
        range_to_pb(that, context.range)

    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
        """
        reference_element_to_pb(that, context.reference_element)

    def visit_specific_asset_id_with_context(
        self, that: types.SpecificAssetID, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.specific_asset_id``
        according to ``that`` instance.
        """
        specific_asset_id_to_pb(that, context.specific_asset_id)

    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
        """
        submodel_to_pb(that, context.submodel)
    ...
    def visit_submodel_element_collection_with_context(
        ...
        according to ``that`` instance.
        """
        submodel_element_collection_to_pb(that, context.submodel_element_collection)

    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: types_pb.HasSemantics_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_list``
        according to ``that`` instance.
        """
        submodel_element_list_to_pb(that, context.submodel_element_list)
...
def has_semantics_to_pb_choice(
    that: types.HasSemantics, target: types_pb.HasSemantics_choice
) -> None:
    """
    ...
    """
    _HAS_SEMANTICS_TO_PB_CHOICE.visit_with_context(that, target)


def extension_to_pb(that: types.Extension, target: types_pb.Extension) -> None:
    """
    ...
    if that.semantic_id is not None:
        ...
        reference_to_pb(that.semantic_id, target.semantic_id)
    ...
    if that.supplemental_semantic_ids is not None:
        for supplemental_semantic_ids_item in that.supplemental_semantic_ids:
            ...
            reference_to_pb(
                supplemental_semantic_ids_item, supplemental_semantic_ids_item_pb
            )

    target.name = that.name

    if that.value_type is not None:
        target.value_type = data_type_def_xsd_to_pb(that.value_type)
    ...
    if that.refers_to is not None:
        for refers_to_item in that.refers_to:
            ...
            reference_to_pb(refers_to_item, refers_to_item_pb)


class _HasExtensionsToPbChoice(
    _PartialVisitorWithContext[types_pb.HasExtensions_choice]
):
    """Set the fields of the corresponding one-of value."""

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.relationship_element``
        according to ``that`` instance.
    ...
    def visit_asset_administration_shell_with_context(
        ...
        according to ``that`` instance.
        """
        asset_administration_shell_to_pb(that, context.asset_administration_shell)

    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
    ...
    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
    ...
    def visit_concept_description_with_context(
        self, that: types.ConceptDescription, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.concept_description``
        according to ``that`` instance.
        """
        concept_description_to_pb(that, context.concept_description)

    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.multi_language_property``
        according to ``that`` instance.
    ...
    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
    ...
    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
    ...
    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: types_pb.HasExtensions_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_list``
        according to ``that`` instance.
...
def has_extensions_to_pb_choice(
    that: types.HasExtensions, target: types_pb.HasExtensions_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _HAS_EXTENSIONS_TO_PB_CHOICE.visit_with_context(that, target)


class _ReferableToPbChoice(_PartialVisitorWithContext[types_pb.Referable_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.relationship_element``
        according to ``that`` instance.
    ...
    def visit_asset_administration_shell_with_context(
        self, that: types.AssetAdministrationShell, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.asset_administration_shell``
        according to ``that`` instance.
    ...
    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
    ...
    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
    ...
    def visit_concept_description_with_context(
        self, that: types.ConceptDescription, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.concept_description``
        according to ``that`` instance.
    ...
    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.multi_language_property``
        according to ``that`` instance.
    ...
    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
    ...
    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
    ...
    def visit_submodel_element_collection_with_context(
        self, that: types.SubmodelElementCollection, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_collection``
        according to ``that`` instance.
    ...
    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: types_pb.Referable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_list``
        according to ``that`` instance.
...
def referable_to_pb_choice(
    that: types.Referable, target: types_pb.Referable_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _REFERABLE_TO_PB_CHOICE.visit_with_context(that, target)


class _IdentifiableToPbChoice(_PartialVisitorWithContext[types_pb.Identifiable_choice]):
    """Set the fields of the corresponding one-of value."""
    ...
    def visit_concept_description_with_context(
        self, that: types.ConceptDescription, context: types_pb.Identifiable_choice
    ) -> None:
        """
        Set the fields of ``context.concept_description``
        according to ``that`` instance.
    ...
    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.Identifiable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
...
def identifiable_to_pb_choice(
    ...
    """
    _IDENTIFIABLE_TO_PB_CHOICE.visit_with_context(that, target)
...
def modelling_kind_to_pb(that: types.ModellingKind) -> types_pb.ModellingKind:
    """
...
class _HasKindToPbChoice(_PartialVisitorWithContext[types_pb.HasKind_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.HasKind_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
...
def has_kind_to_pb_choice(that: types.HasKind, target: types_pb.HasKind_choice) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _HAS_KIND_TO_PB_CHOICE.visit_with_context(that, target)


class _HasDataSpecificationToPbChoice(
    _PartialVisitorWithContext[types_pb.HasDataSpecification_choice]
):
    """Set the fields of the corresponding one-of value."""
    ...
    def visit_administrative_information_with_context(
        ...
        according to ``that`` instance.
        """
        administrative_information_to_pb(that, context.administrative_information)
    ...
    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
    ...
    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.HasDataSpecification_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
...
def has_data_specification_to_pb_choice(
    that: types.HasDataSpecification, target: types_pb.HasDataSpecification_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _HAS_DATA_SPECIFICATION_TO_PB_CHOICE.visit_with_context(that, target)


def administrative_information_to_pb(
    that: types.AdministrativeInformation, target: types_pb.AdministrativeInformation
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.embedded_data_specifications is not None:
        for embedded_data_specifications_item in that.embedded_data_specifications:
            embedded_data_specifications_item_pb = (
                target.embedded_data_specifications.add()
            )
            embedded_data_specification_to_pb(
                embedded_data_specifications_item, embedded_data_specifications_item_pb
            )
    ...
    if that.creator is not None:
        ...
        reference_to_pb(that.creator, target.creator)

    if that.template_id is not None:
        target.template_id = that.template_id


class _QualifiableToPbChoice(_PartialVisitorWithContext[types_pb.Qualifiable_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.relationship_element``
        according to ``that`` instance.
    ...
    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
    ...
    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
    ...
    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.multi_language_property``
        according to ``that`` instance.
    ...
    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
    ...
    def visit_submodel_with_context(
        self, that: types.Submodel, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel``
        according to ``that`` instance.
    ...
    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: types_pb.Qualifiable_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_list``
        according to ``that`` instance.
...
def qualifiable_to_pb_choice(
    that: types.Qualifiable, target: types_pb.Qualifiable_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _QUALIFIABLE_TO_PB_CHOICE.visit_with_context(that, target)
...
def qualifier_kind_to_pb(that: types.QualifierKind) -> types_pb.QualifierKind:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def qualifier_to_pb(that: types.Qualifier, target: types_pb.Qualifier) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.kind is not None:
        target.kind = qualifier_kind_to_pb(that.kind)
    ...
    if that.value_id is not None:
        ...
        reference_to_pb(that.value_id, target.value_id)


def asset_administration_shell_to_pb(
    that: types.AssetAdministrationShell, target: types_pb.AssetAdministrationShell
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.extensions is not None:
        for extensions_item in that.extensions:
            ...
            extension_to_pb(extensions_item, extensions_item_pb)
    ...
    if that.display_name is not None:
        for display_name_item in that.display_name:
            ...
            lang_string_name_type_to_pb(display_name_item, display_name_item_pb)

    if that.description is not None:
        for description_item in that.description:
            description_item_pb = target.description.add()
            lang_string_text_type_to_pb(description_item, description_item_pb)

    if that.administration is not None:
        # We clear so that the field is set even if all the properties are None.
        target.administration.Clear()

        administrative_information_to_pb(that.administration, target.administration)
    ...
    if that.derived_from is not None:
        ...
        reference_to_pb(that.derived_from, target.derived_from)

    # We clear so that the field is set even if all the properties are None.
    target.asset_information.Clear()

    asset_information_to_pb(that.asset_information, target.asset_information)

    if that.submodels is not None:
        for submodels_item in that.submodels:
            submodels_item_pb = target.submodels.add()
            reference_to_pb(submodels_item, submodels_item_pb)


def asset_information_to_pb(
    that: types.AssetInformation, target: types_pb.AssetInformation
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    .. code-block::
        ...
        # over the wire.
    """
    target.asset_kind = asset_kind_to_pb(that.asset_kind)
    ...
    if that.specific_asset_ids is not None:
        for specific_asset_ids_item in that.specific_asset_ids:
            ...
            specific_asset_id_to_pb(specific_asset_ids_item, specific_asset_ids_item_pb)
    ...
    if that.default_thumbnail is not None:
        ...
        resource_to_pb(that.default_thumbnail, target.default_thumbnail)


def resource_to_pb(that: types.Resource, target: types_pb.Resource) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def asset_kind_to_pb(that: types.AssetKind) -> types_pb.AssetKind:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def specific_asset_id_to_pb(
    that: types.SpecificAssetID, target: types_pb.SpecificAssetId
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.external_subject_id is not None:
        ...
        reference_to_pb(that.external_subject_id, target.external_subject_id)


def submodel_to_pb(that: types.Submodel, target: types_pb.Submodel) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.kind is not None:
        target.kind = modelling_kind_to_pb(that.kind)
    ...
    if that.qualifiers is not None:
        for qualifiers_item in that.qualifiers:
            ...
            qualifier_to_pb(qualifiers_item, qualifiers_item_pb)
    ...
    if that.submodel_elements is not None:
        for submodel_elements_item in that.submodel_elements:
            ...
            submodel_element_to_pb_choice(
                submodel_elements_item, submodel_elements_item_pb
            )


class _SubmodelElementToPbChoice(
    _PartialVisitorWithContext[types_pb.SubmodelElement_choice]
):
    """Set the fields of the corresponding one-of value."""

    def visit_relationship_element_with_context(
        self, that: types.RelationshipElement, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.relationship_element``
        according to ``that`` instance.
    ...
    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
    ...
    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_capability_with_context(
        self, that: types.Capability, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.capability``
        according to ``that`` instance.
    ...
    def visit_entity_with_context(
        self, that: types.Entity, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.entity``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_operation_with_context(
        self, that: types.Operation, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.operation``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
    ...
    def visit_submodel_element_list_with_context(
        self, that: types.SubmodelElementList, context: types_pb.SubmodelElement_choice
    ) -> None:
        """
        Set the fields of ``context.submodel_element_list``
        according to ``that`` instance.
...
def submodel_element_to_pb_choice(
    that: types.SubmodelElement, target: types_pb.SubmodelElement_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _SUBMODEL_ELEMENT_TO_PB_CHOICE.visit_with_context(that, target)


class _RelationshipElementToPbChoice(
    _PartialVisitorWithContext[types_pb.RelationshipElement_choice]
):
    """Set the fields of the corresponding one-of value."""
...
def relationship_element_to_pb_choice(
    that: types.RelationshipElement, target: types_pb.RelationshipElement_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _RELATIONSHIP_ELEMENT_TO_PB_CHOICE.visit_with_context(that, target)


def relationship_element_to_pb(
    that: types.RelationshipElement, target: types_pb.RelationshipElement
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    reference_to_pb(that.first, target.first)

    # We clear so that the field is set even if all the properties are None.
    target.second.Clear()

    reference_to_pb(that.second, target.second)
...
def submodel_element_list_to_pb(
    that: types.SubmodelElementList, target: types_pb.SubmodelElementList
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.semantic_id_list_element is not None:
        ...
        reference_to_pb(that.semantic_id_list_element, target.semantic_id_list_element)
    ...
    if that.value is not None:
        for value_item in that.value:
            ...
            submodel_element_to_pb_choice(value_item, value_item_pb)


def submodel_element_collection_to_pb(
    that: types.SubmodelElementCollection, target: types_pb.SubmodelElementCollection
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
class _DataElementToPbChoice(_PartialVisitorWithContext[types_pb.DataElement_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_blob_with_context(
        self, that: types.Blob, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.blob``
        according to ``that`` instance.
    ...
    def visit_file_with_context(
        self, that: types.File, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.file``
        according to ``that`` instance.
    ...
    def visit_multi_language_property_with_context(
        self, that: types.MultiLanguageProperty, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.multi_language_property``
        according to ``that`` instance.
    ...
    def visit_property_with_context(
        self, that: types.Property, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.property``
        according to ``that`` instance.
    ...
    def visit_range_with_context(
        self, that: types.Range, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.range``
        according to ``that`` instance.
    ...
    def visit_reference_element_with_context(
        self, that: types.ReferenceElement, context: types_pb.DataElement_choice
    ) -> None:
        """
        Set the fields of ``context.reference_element``
        according to ``that`` instance.
...
def data_element_to_pb_choice(
    that: types.DataElement, target: types_pb.DataElement_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _DATA_ELEMENT_TO_PB_CHOICE.visit_with_context(that, target)


def property_to_pb(that: types.Property, target: types_pb.Property) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def multi_language_property_to_pb(
    that: types.MultiLanguageProperty, target: types_pb.MultiLanguageProperty
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.value is not None:
        for value_item in that.value:
            value_item_pb = target.value.add()
            lang_string_text_type_to_pb(value_item, value_item_pb)
...
def range_to_pb(that: types.Range, target: types_pb.Range) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def reference_element_to_pb(
    that: types.ReferenceElement, target: types_pb.ReferenceElement
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.value is not None:
        ...
        reference_to_pb(that.value, target.value)


def blob_to_pb(that: types.Blob, target: types_pb.Blob) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def file_to_pb(that: types.File, target: types_pb.File) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def annotated_relationship_element_to_pb(
    ...
    if that.annotations is not None:
        for annotations_item in that.annotations:
            ...
            data_element_to_pb_choice(annotations_item, annotations_item_pb)


def entity_to_pb(that: types.Entity, target: types_pb.Entity) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.statements is not None:
        for statements_item in that.statements:
            ...
            submodel_element_to_pb_choice(statements_item, statements_item_pb)

    target.entity_type = entity_type_to_pb(that.entity_type)
...
def entity_type_to_pb(that: types.EntityType) -> types_pb.EntityType:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def direction_to_pb(that: types.Direction) -> types_pb.Direction:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def state_of_event_to_pb(that: types.StateOfEvent) -> types_pb.StateOfEvent:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def event_payload_to_pb(
    that: types.EventPayload, target: types_pb.EventPayload
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    reference_to_pb(that.source, target.source)

    if that.source_semantic_id is not None:
        # We clear so that the field is set even if all the properties are None.
        target.source_semantic_id.Clear()

        reference_to_pb(that.source_semantic_id, target.source_semantic_id)

    # We clear so that the field is set even if all the properties are None.
    target.observable_reference.Clear()

    reference_to_pb(that.observable_reference, target.observable_reference)

    if that.observable_semantic_id is not None:
        # We clear so that the field is set even if all the properties are None.
        target.observable_semantic_id.Clear()

        reference_to_pb(that.observable_semantic_id, target.observable_semantic_id)
    ...
    if that.subject_id is not None:
        ...
        reference_to_pb(that.subject_id, target.subject_id)
...
class _EventElementToPbChoice(_PartialVisitorWithContext[types_pb.EventElement_choice]):
    """Set the fields of the corresponding one-of value."""

    def visit_basic_event_element_with_context(
        self, that: types.BasicEventElement, context: types_pb.EventElement_choice
    ) -> None:
        """
        Set the fields of ``context.basic_event_element``
        according to ``that`` instance.
...
def event_element_to_pb_choice(
    that: types.EventElement, target: types_pb.EventElement_choice
) -> None:
    """
    Set the chosen value in ``target`` based on ``that`` instance.
    ...
    """
    _EVENT_ELEMENT_TO_PB_CHOICE.visit_with_context(that, target)


def basic_event_element_to_pb(
    that: types.BasicEventElement, target: types_pb.BasicEventElement
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    reference_to_pb(that.observed, target.observed)

    target.direction = direction_to_pb(that.direction)

    target.state = state_of_event_to_pb(that.state)
    ...
    if that.message_broker is not None:
        ...
        reference_to_pb(that.message_broker, target.message_broker)
...
def operation_to_pb(that: types.Operation, target: types_pb.Operation) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.input_variables is not None:
        for input_variables_item in that.input_variables:
            ...
            operation_variable_to_pb(input_variables_item, input_variables_item_pb)
    ...
    if that.output_variables is not None:
        for output_variables_item in that.output_variables:
            ...
            operation_variable_to_pb(output_variables_item, output_variables_item_pb)
    ...
    if that.inoutput_variables is not None:
        for inoutput_variables_item in that.inoutput_variables:
            ...
            operation_variable_to_pb(
                inoutput_variables_item, inoutput_variables_item_pb
            )


def operation_variable_to_pb(
    that: types.OperationVariable, target: types_pb.OperationVariable
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    .. code-block::
        ...
        # over the wire.
    """
    submodel_element_to_pb_choice(that.value, target.value)


def capability_to_pb(that: types.Capability, target: types_pb.Capability) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def concept_description_to_pb(
    that: types.ConceptDescription, target: types_pb.ConceptDescription
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.is_case_of is not None:
        for is_case_of_item in that.is_case_of:
            ...
            reference_to_pb(is_case_of_item, is_case_of_item_pb)
...
def reference_types_to_pb(that: types.ReferenceTypes) -> types_pb.ReferenceTypes:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def reference_to_pb(that: types.Reference, target: types_pb.Reference) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    .. code-block::
        ...
        # over the wire.
    """
    target.type = reference_types_to_pb(that.type)

    if that.referred_semantic_id is not None:
        # We clear so that the field is set even if all the properties are None.
        target.referred_semantic_id.Clear()

        reference_to_pb(that.referred_semantic_id, target.referred_semantic_id)

    for keys_item in that.keys:
        keys_item_pb = target.keys.add()
        key_to_pb(keys_item, keys_item_pb)


def key_to_pb(that: types.Key, target: types_pb.Key) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    .. code-block::
        ...
        # over the wire.
    """
    target.type = key_types_to_pb(that.type)
...
def key_types_to_pb(that: types.KeyTypes) -> types_pb.KeyTypes:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
def data_type_def_xsd_to_pb(that: types.DataTypeDefXSD) -> types_pb.DataTypeDefXsd:
    """
    Convert ``that`` enum to its Protocol Buffer representation.
...
class _AbstractLangStringToPbChoice(
    _PartialVisitorWithContext[types_pb.AbstractLangString_choice]
):
    """Set the fields of the corresponding one-of value."""
    ...
    def visit_lang_string_definition_type_iec_61360_with_context(
        ...
        lang_string_definition_type_iec_61360_to_pb(
            that, context.lang_string_definition_type_iec_61360
        )
    ...
    def visit_lang_string_name_type_with_context(
        ...
        according to ``that`` instance.
        """
        lang_string_name_type_to_pb(that, context.lang_string_name_type)
    ...
    def visit_lang_string_preferred_name_type_iec_61360_with_context(
        ...
        lang_string_preferred_name_type_iec_61360_to_pb(
            that, context.lang_string_preferred_name_type_iec_61360
        )
    ...
    def visit_lang_string_short_name_type_iec_61360_with_context(
        ...
        lang_string_short_name_type_iec_61360_to_pb(
            that, context.lang_string_short_name_type_iec_61360
        )
    ...
    def visit_lang_string_text_type_with_context(
        ...
        according to ``that`` instance.
        """
        lang_string_text_type_to_pb(that, context.lang_string_text_type)
...
def abstract_lang_string_to_pb_choice(
    ...
    """
    _ABSTRACT_LANG_STRING_TO_PB_CHOICE.visit_with_context(that, target)


def lang_string_name_type_to_pb(
    that: types.LangStringNameType, target: types_pb.LangStringNameType
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def lang_string_text_type_to_pb(
    that: types.LangStringTextType, target: types_pb.LangStringTextType
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def environment_to_pb(that: types.Environment, target: types_pb.Environment) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    if that.asset_administration_shells is not None:
        for asset_administration_shells_item in that.asset_administration_shells:
            asset_administration_shells_item_pb = (
                target.asset_administration_shells.add()
            )
            asset_administration_shell_to_pb(
                asset_administration_shells_item, asset_administration_shells_item_pb
            )

    if that.submodels is not None:
        for submodels_item in that.submodels:
            submodels_item_pb = target.submodels.add()
            submodel_to_pb(submodels_item, submodels_item_pb)
    ...
    if that.concept_descriptions is not None:
        for concept_descriptions_item in that.concept_descriptions:
            ...
            concept_description_to_pb(
                concept_descriptions_item, concept_descriptions_item_pb
            )


class _DataSpecificationContentToPbChoice(
    _PartialVisitorWithContext[types_pb.DataSpecificationContent_choice]
):
    """Set the fields of the corresponding one-of value."""
    ...
    def visit_data_specification_iec_61360_with_context(
        ...
        according to ``that`` instance.
        """
        data_specification_iec_61360_to_pb(that, context.data_specification_iec_61360)
...
def data_specification_content_to_pb_choice(
    ...
    """
    _DATA_SPECIFICATION_CONTENT_TO_PB_CHOICE.visit_with_context(that, target)


def embedded_data_specification_to_pb(
    that: types.EmbeddedDataSpecification, target: types_pb.EmbeddedDataSpecification
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    """
    data_specification_content_to_pb_choice(
        that.data_specification_content, target.data_specification_content
    )

    # We clear so that the field is set even if all the properties are None.
    target.data_specification.Clear()

    reference_to_pb(that.data_specification, target.data_specification)
...
def level_type_to_pb(that: types.LevelType, target: types_pb.LevelType) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def value_reference_pair_to_pb(
    that: types.ValueReferencePair, target: types_pb.ValueReferencePair
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
...
def value_list_to_pb(that: types.ValueList, target: types_pb.ValueList) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    for value_reference_pairs_item in that.value_reference_pairs:
        ...
        value_reference_pair_to_pb(
            value_reference_pairs_item, value_reference_pairs_item_pb
        )
...
def data_specification_iec_61360_to_pb(
    that: types.DataSpecificationIEC61360, target: types_pb.DataSpecificationIec61360
) -> None:
    """
    Set fields in ``target`` based on ``that`` instance.
    ...
    for preferred_name_item in that.preferred_name:
        ...
        lang_string_preferred_name_type_iec_61360_to_pb(
            preferred_name_item, preferred_name_item_pb
        )
    ...
    if that.short_name is not None:
        for short_name_item in that.short_name:
            ...
            lang_string_short_name_type_iec_61360_to_pb(
                short_name_item, short_name_item_pb
            )
    ...
    if that.unit_id is not None:
        ...
        reference_to_pb(that.unit_id, target.unit_id)
    ...
    if that.value_list is not None:
        ...
        value_list_to_pb(that.value_list, target.value_list)
    ...
    if that.level_type is not None:
        ...
        level_type_to_pb(that.level_type, target.level_type)


class _ToPbTransformer(types.AbstractTransformer[google.protobuf.message.Message]):
    """
    ...
    def transform_administrative_information(
        self, that: types.AdministrativeInformation
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_asset_administration_shell(
        self, that: types.AssetAdministrationShell
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_asset_information(
        self, that: types.AssetInformation
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_specific_asset_id(
        self, that: types.SpecificAssetID
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_relationship_element(
        self, that: types.RelationshipElement
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_submodel_element_list(
        self, that: types.SubmodelElementList
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_submodel_element_collection(
        self, that: types.SubmodelElementCollection
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_multi_language_property(
        self, that: types.MultiLanguageProperty
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_range(self, that: types.Range) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_reference_element(
        self, that: types.ReferenceElement
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_blob(self, that: types.Blob) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_file(self, that: types.File) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_annotated_relationship_element(
        self, that: types.AnnotatedRelationshipElement
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_entity(self, that: types.Entity) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_basic_event_element(
        self, that: types.BasicEventElement
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_operation_variable(
        self, that: types.OperationVariable
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_concept_description(
        self, that: types.ConceptDescription
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_key(self, that: types.Key) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_lang_string_name_type(
        self, that: types.LangStringNameType
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_lang_string_text_type(
        self, that: types.LangStringTextType
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_embedded_data_specification(
        self, that: types.EmbeddedDataSpecification
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_value_reference_pair(
        self, that: types.ValueReferencePair
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_lang_string_preferred_name_type_iec_61360(
        self, that: types.LangStringPreferredNameTypeIEC61360
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_lang_string_short_name_type_iec_61360(
        self, that: types.LangStringShortNameTypeIEC61360
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_lang_string_definition_type_iec_61360(
        self, that: types.LangStringDefinitionTypeIEC61360
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
    ...
    def transform_data_specification_iec_61360(
        self, that: types.DataSpecificationIEC61360
    ) -> google.protobuf.message.Message:
        """
        Convert ``that`` instance
