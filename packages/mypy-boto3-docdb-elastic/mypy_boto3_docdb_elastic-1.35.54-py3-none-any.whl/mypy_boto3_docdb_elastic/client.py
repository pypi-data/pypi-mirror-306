...
class DocDBElasticClient(BaseClient):
    ...
    def apply_pending_maintenance_action(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/docdb-elastic.html#DocDBElastic.Client.apply_pending_maintenance_action)
    ...
    def get_pending_maintenance_action(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/docdb-elastic.html#DocDBElastic.Client.get_pending_maintenance_action)
    ...
    def list_pending_maintenance_actions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/docdb-elastic.html#DocDBElastic.Client.list_pending_maintenance_actions)
