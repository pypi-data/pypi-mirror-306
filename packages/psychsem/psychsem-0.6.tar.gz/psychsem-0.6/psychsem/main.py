...
with fiona.Env(SHAPE_RESTORE_SHX='YES'):
    #importing data
    india_gpf=gpd.read_file(r'C:\Users\A\Downloads\india-polygon.shx')
#plot fig
...
import shutil
import cv2
sInputFieName =r'C:\Users\Documents\videoplayback.mp4'
sDataBaseDir=r'C:\Users\Documents\framgenoutput'
...
img_array = []
for filename in glob.glob(r'C:\Users\Documents\FramephotosInput\*.jpg'):
...
def plot_info(aname, a,r):        
    ...
    plt.show()
#=============================================================
sInputFileName=r'C:\Users\Moonlight\Documents\MSC IT\MSC IT\DSI sem3\Practical\sounds\Sound.wav'
print('=====================================================')
...
sOutputFileName=r'C:\Users\Moonlight\Documents\MSC IT\MSC IT\DSI sem3\Practical\sounds\HORUS-Audio-2ch.csv'
...
def visualize_csv(csv_path, image_shape):
    ...
    plt.show()
# Define file paths
image_path = r'C:\Users\outputIMGtoCSV\inputImg.jpg'  
csv_output_path = r'C:\Users\outputIMGtoCSV\ImageToCSV.csv'  
