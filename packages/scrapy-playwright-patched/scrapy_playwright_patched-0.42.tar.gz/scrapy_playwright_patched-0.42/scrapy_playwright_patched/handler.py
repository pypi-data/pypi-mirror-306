...
from scrapy_playwright_patched.headers import use_scrapy_headers
from scrapy_playwright_patched.page import PageMethod
from scrapy_playwright_patched._utils import (
...
logger = logging.getLogger("scrapy-playwright-patched")
