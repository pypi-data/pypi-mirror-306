...
NAME = 'sendgrid-ovh'
DESCRIPTION = 'Tool to easily manipulate OVH Zone and domain authenticate sendgrid automatically'
URL = 'https://github.com/mickaelperrin/sendgrid-ovh'
...
setup(
    ...
    keywords='OVH DNS zone sendgrid cli domain authentication',
    author=AUTHOR,
    author_email=EMAIL,
