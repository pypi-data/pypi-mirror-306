...
setup(
  name = 'invoicing-pdf-SC13',         #* Your package will have this name
  ...
  author = 'Smugcurve13',                   # Your name
  author_email = 'sambhavsoni14@gmail.com',  # Your email
  url = 'https://github.com/Smugcurve13',              # Homepage of your library (e.g. github or your website)
