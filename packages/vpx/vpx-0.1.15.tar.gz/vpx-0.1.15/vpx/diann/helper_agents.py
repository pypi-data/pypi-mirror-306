...
class DesignPlanner(Agent):
    def __init__(self, specification: str, verbose: bool = False, openai_api_key: str = "", anthropic_api_key: str = ""):
        super().__init__(
...
class Diann(Agent):
    def __init__(self, specification: str, solution_folder: str, problem_name: str = "ProbXXX", verbose: bool = False, openai_api_key: str = "", anthropic_api_key: str = ""):
        super().__init__(
        ...
        self.planner = DesignPlanner(specification, verbose, openai_api_key, anthropic_api_key)
    ...
    def save_rtl(self, rtl: str) -> None:
        ...
        # Save with timing commentsfrom dataclasses import dataclass
from typing import Optional
import os
import datetime
import re
...
class StandardizationAgent(Agent):
    def __init__(self, module: Dict[str, Any], context: str = "", verbose: bool = False, openai_api_key: str = "", anthropic_api_key: str = ""):
        super().__init__(
