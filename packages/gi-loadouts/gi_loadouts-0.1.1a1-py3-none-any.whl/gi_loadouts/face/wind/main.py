...
class MainWindow(Rule):
    ...
    def initialize_elements(self) -> None:
        ...
        self.setStyleSheet("#centwdgt {background-color: rgba(0, 0, 0, 128);}")
        self.centwdgt.setWindowOpacity(0.8)
        self.centwdgt.setAttribute(Qt.WA_TranslucentBackground)
        blur = QGraphicsBlurEffect()
        blur.setBlurRadius(15)
        self.centwdgt.setGraphicsEffect(blur)
