...
from .Alphabetspatterns import print_name
from .NumbersPattern import print_number
...
__all__ = ['Square_Pattern','Hollow_Square_Pattern', 'Square_With_Cross_Pattern', 'Left_Triangle_Star_Pattern',
           ...
           'Diamond_Star_Pattern', 'Hollow_Diamond_Star_Pattern', 'Hourglass_Star_Pattern', 'print_name',
           'print_number']
