...
class FunctionsObject:
    ...
    def phone_info(self, phone: str, region: str = 'ru'):
        """Пробив по номерку.\nphone: номер телефона в межд. формате. Пример: +7XXXXXXXXXX\nregion: страна номера. По умолчанию, `ru`.\nВозвращает словарь при удаче и `None` при неудаче."""
        import phonenumbers
        try:
            ...
            if not phonenumbers.is_possible_number(number):
                ...
                if not phonenumbers.is_valid_number(number):
                    ...
                    return {"country":phonenumbers.geocoder.description_for_number(number, "ru"), "carrier":phonenumbers.carrier.name_for_number(number, "ru"), 'tg_link':f'https://t.me/{phone}', 'whatsapp_link':f'https://wa.me/{phone[1:]}', 'viber_link':f'https://viber.click/{phone[1:]}'}
        except:
            return None
