...
_keys = ['code_form', 'sub_category', 'wmo_block_no', 'wmo_station_no', 'ship_or_mobile_land_id',
...
_309053_MAPPINGS = f"{THISDIR}{os.sep}resources{os.sep}309052_mapping.json"
...
def transform(client: OSClient, data: str, year: int, month: int) -> Iterator[dict]:
    ...
    for message in messages:
        ...
        rmk = f"{msg['code_form']}_{station_id}_{isodate}"
