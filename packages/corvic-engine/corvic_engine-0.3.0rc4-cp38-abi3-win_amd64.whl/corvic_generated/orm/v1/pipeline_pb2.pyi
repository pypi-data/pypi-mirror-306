...
class PipelineTransformation(_message.Message):
    __slots__ = ("chunk_pdf", "ocr_pdf", "sanitize_parquet", "processed_input_names")
    ...
    def __init__(self, chunk_pdf: _Optional[_Union[ChunkPdfPipelineTransformation, _Mapping]] = ..., ocr_pdf: _Optional[_Union[OcrPdfPipelineTransformation, _Mapping]] = ..., sanitize_parquet: _Optional[_Union[SanitizeParquetPipelineTransformation, _Mapping]] = ..., processed_input_names: _Optional[_Iterable[str]] = ...) -> None: ...
