...
from ...types.market import news_retrieve_params
from ...types.market.news_retrieve_response import NewsRetrieveResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"date": date}, news_retrieve_params.NewsRetrieveParams),
            ),
            cast_to=NewsRetrieveResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"date": date}, news_retrieve_params.NewsRetrieveParams),
            ),
            cast_to=NewsRetrieveResponse,
        )
