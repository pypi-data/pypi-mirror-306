...
from ...types.market import mover_retrieve_params
from ...types.market.mover_retrieve_response import MoverRetrieveResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    mover_retrieve_params.MoverRetrieveParams,
                ),
            ),
            cast_to=MoverRetrieveResponse,
        )
