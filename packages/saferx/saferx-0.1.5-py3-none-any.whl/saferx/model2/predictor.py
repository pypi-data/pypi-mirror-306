...
import sys
import saferx.model2.model  # 정확한 모듈 경로를 지정

# 'model2' 경로를 'saferx.model'로 매핑하여 가상의 경로 설정

# `model2.model`을 `saferx.model2.model`로 매핑
sys.modules['model2.model'] = saferx.model2.model
