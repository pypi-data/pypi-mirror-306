...
import sys
from . import dataloader as model2_dataloader
from . import model as model2_model

# 절대 경로 매핑 설정 (pickle 파일이 model2를 참조할 수 있도록)
sys.modules['model2.dataloader'] = model2_dataloader
sys.modules['model2.model'] = model2_model
