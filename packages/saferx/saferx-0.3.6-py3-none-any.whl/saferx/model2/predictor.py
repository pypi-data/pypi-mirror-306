...
class Predictor:
    def __init__(self, device, model_path=None):
        ...
        # sys.modules 설정을 load_model 안에서 처리
    ...
    def load_model(self, model_path):
        ...
        """
        # model2를 saferx.model2로 매핑하여 경로 문제 해결
        import safer_test.model2 as model2_module
        sys.modules['model2'] = model2_module
        sys.modules['saferx.model2'] = model2_module  # 추가 매핑
