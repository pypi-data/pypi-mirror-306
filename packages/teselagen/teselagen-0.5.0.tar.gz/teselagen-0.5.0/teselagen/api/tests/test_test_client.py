...
class TestTESTClient:
    ...
    def test_get_files(
        ...
        assert all(key in element.keys() for element in response for key in ['id', 'name', 'assay'])
    ...
    def test_upload_file(
        ...
        assert all(key in ['id', 'importStatus', 'name', 'assay'] for key in response)
    ...
    def test_upload_assays(
        ...
        number_of_current_assays = len(client.get_assays())
