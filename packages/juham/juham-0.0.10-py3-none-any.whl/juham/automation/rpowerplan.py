...
class RPowerPlan(Base):
    ...
    topic_in_net_energy_balance = Base.mqtt_root_topic + "/net_energy_balance"
    ...
    def __init__(self, name: str = "rpowerplan") -> None:
        ...
        self.heating_plan: list = []
        self.power_plan: list = []
        self.ranked_spot_prices: list = []
        self.ranked_solarpower: list = []
