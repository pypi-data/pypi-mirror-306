...
def run_a_tournament(
    ...
    **Not needed for submission.** You can use this function to test your agent.
    ...
    Args:
       AwesomeNegotiator: Negotiator type to be tested
    ...
    if small:
        anl2024_tournament(
            competitors=tuple([AwesomeNegotiator, Conceder]),
            n_scenarios=1,
        ...
        anl2024_tournament(
            competitors=tuple([AwesomeNegotiator] + list(DEFAULT_AN2024_COMPETITORS)),
