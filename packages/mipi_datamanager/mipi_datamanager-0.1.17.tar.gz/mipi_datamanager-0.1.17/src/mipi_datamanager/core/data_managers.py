...
def _load_user_setup():
    ...
    user_root = os.getcwd()
    setup_path = os.path.join(user_root, "mipi_setup.py")

    # Check if mipi_setup.py exists in the user's root folder
...
class DataManager:
    ...
    def __init__(self, frame: meta.Frame,
        ...
        self.jinja_repo_source = _get_repo_source(jinja_repo_source)
    ...
    def from_jinja_repo(cls, inner_path: str,
        ...
        """
        jinja_repo_source = _get_repo_source(jinja_repo_source)
    ...
    @classmethod
    def from_sql(cls, script_path: str, connection: odbc.Odbc, format_parameters_list: list = None,
                 frame_name: str = None,
                 jinja_repo_source: JinjaRepo = None,
                 store_deep_frames: bool = False, store_deep_base: bool = False,
                 default_format_func_dict: FormatDict | dict = None,
    ...
    @classmethod
    def from_jinja(cls, script_path: str, connection: odbc.Odbc,
                   jinja_parameters_dict: dict = None,
                   frame_name: str = None,
                   jinja_repo_source: JinjaRepo = None,
                   store_deep_frames: bool = False, store_deep_base: bool = False,
    ...
    def join_from_format_sql(self, script_path: str, connection: odbc.Odbc, on: str | tuple = None,
    ...
    def join_from_jinja(self, script_path: str, connection: odbc.Odbc, on: str | tuple = None,
                        how: JoinLiterals = "left",
                        jinja_parameters_dict: dict = None,
