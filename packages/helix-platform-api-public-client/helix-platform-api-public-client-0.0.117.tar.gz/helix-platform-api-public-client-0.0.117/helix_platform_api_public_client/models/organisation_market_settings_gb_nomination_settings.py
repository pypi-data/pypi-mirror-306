...
class OrganisationMarketSettingsGbNominationSettings(BaseModel):
    ...
    bmu_demand_code: Optional[constr(strict=True, max_length=11, min_length=11)] = Field(None, alias="bmuDemandCode")
    bmu_generation_code: Optional[constr(strict=True, max_length=11, min_length=11)] = Field(None, alias="bmuGenerationCode")
