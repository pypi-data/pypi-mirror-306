...
class NominationGatesOverviewResponseIntraDay(BaseModel):
    """
    NominationGatesOverviewResponseIntraDay
    """
    gate: IntraDayNominationGate = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NominationGatesOverviewResponseIntraDay:
        """Create an instance of NominationGatesOverviewResponseIntraDay from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NominationGatesOverviewResponseIntraDay:
        """Create an instance of NominationGatesOverviewResponseIntraDay from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NominationGatesOverviewResponseIntraDay.parse_obj(obj)

        _obj = NominationGatesOverviewResponseIntraDay.parse_obj({
            "gate": IntraDayNominationGate.from_dict(obj.get("gate")) if obj.get("gate") is not None else None,
