...
class NominationGatesOverviewResponseDayAhead(BaseModel):
    """
    NominationGatesOverviewResponseDayAhead
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NominationGatesOverviewResponseDayAhead:
        """Create an instance of NominationGatesOverviewResponseDayAhead from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NominationGatesOverviewResponseDayAhead:
        """Create an instance of NominationGatesOverviewResponseDayAhead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NominationGatesOverviewResponseDayAhead.parse_obj(obj)

        _obj = NominationGatesOverviewResponseDayAhead.parse_obj({
