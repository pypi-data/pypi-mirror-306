...
from pydantic import StrictBytes, StrictStr, constr, validator
...
class AttachmentApi:
    ...
    @validate_arguments
    def upload_attachment(self, file_name : constr(strict=True), file : Union[StrictBytes, StrictStr], **kwargs) -> Attachment:  # noqa: E501
    ...
    @validate_arguments
    def upload_attachment_with_http_info(self, file_name : constr(strict=True), file : Union[StrictBytes, StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """upload_attachment  # noqa: E501
