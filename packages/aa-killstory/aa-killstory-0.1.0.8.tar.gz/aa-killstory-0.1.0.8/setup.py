...
setup(
    name='aa-killstory',
    version='0.1.0.8',  # Mettez à jour le numéro de version si nécessaire
    packages=find_packages(),
    include_package_data=True,  # Important pour inclure les fichiers non Python
    package_data={
        'aa_killstory': [
            'templates/**/*',          # Inclut tous les fichiers dans les sous-dossiers
            'static/**/*',
            'migrations/**/*',
            'management/commands/*',    # Inclut explicitement les commandes
        ],
    },
    license='MIT License',
