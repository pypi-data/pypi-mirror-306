...
def SDL_GetRevision() -> str:
    return SDLFunc("SDL_GetRevision", None, c_char_p)().decode()

def SDL_GetPlatform() -> str:
...
def SDL_LogMessage(priority: int, msg: str):
...
def SDL_ShowSimpleMessageBox(flags: int, title: str, msg: str):
...
def SDL_RWFromFile(file: str, mode: str) -> SDL_RWops:
    return SDLFunc("SDL_RWFromFile", [c_char_p, c_char_p], _P(SDL_RWops))(file.encode(), mode.encode())
def SDL_RWFromMem(mem: bytes, size: int) -> SDL_RWops:
    return SDLFunc("SDL_RWFromMem", [c_char_p, c_int], _P(SDL_RWops))(mem, size)
def SDL_RWFromConstMem(mem: bytes, size: int) -> SDL_RWops:
    return SDLFunc("SDL_RWFromConstMem", [c_char_p, c_int], _P(SDL_RWops))(mem, size)
def SDL_RWclose(rw: SDL_RWops):
    SDLFunc("SDL_RWclose", [_P(SDL_RWops)], c_int)(rw)
def SDL_AllocRW() -> SDL_RWops:
    return SDLFunc("SDL_AllocRW", None, _P(SDL_RWops))()
def SDL_FreeRW(rw: SDL_RWops):
    SDLFunc("SDL_FreeRW", [_P(SDL_RWops)])(rw)
...
def SDL_SetClipboardText(text: str) -> bool: return bool(SDLFunc("SDL_SetClipboardText", [c_char_p], c_int)(text.encode()))
def SDL_GetClipboardText() -> str: return SDLFunc("SDL_GetClipboardText", None, c_char_p)().decode()
def SDL_HasClipboardText() -> bool: return bool(SDLFunc("SDL_HasClipboardText", None, SDL_bool)())

def SDL_SetPrimarySelectionText(text: str) -> bool: return bool(SDLFunc("SDL_SetPrimarySelectionText", [c_char_p], c_int)(text.encode()))
def SDL_GetPrimarySelectionText() -> str: return SDLFunc("SDL_GetPrimarySelectionText", None, c_char_p)().decode()
def SDL_HasPrimarySelectionText() -> bool: return bool(SDLFunc("SDL_HasPrimarySelectionText", None, SDL_bool)())
...
def SDL_CreateRGBSurface(flags: int, width: int, height: int, depth: int, r: int, g: int, b: int, a: int) -> SDL_Surface:
    return SDLFunc("SDL_CreateRGBSurface", [Uint32, c_int, c_int, c_int, Uint32, Uint32, Uint32, Uint32], _P(SDL_Surface))(flags, width, height, depth, r, g, b, a)
SDL_CreateRGBSurfaceWithFormat = SDLFunc("SDL_CreateRGBSurfaceWithFormat", [Uint32, c_int, c_int, c_int, Uint32], _P(SDL_Surface))
SDL_CreateRGBSurfaceFrom = SDLFunc("SDL_CreateRGBSurfaceFrom", [c_void_p, c_int, c_int, c_int, c_int, Uint32, Uint32, Uint32, Uint32], _P(SDL_Surface))
SDL_CreateRGBSurfaceWithFormatFrom = SDLFunc("SDL_CreateRGBSurfaceWithFormatFrom", [c_void_p, c_int, c_int, c_int, c_int, Uint32], _P(SDL_Surface))
...
def SDL_VideoInit(driver_name: str = None): return SDLFunc("SDL_VideoInit", [c_char_p], c_int)(driver_name)
