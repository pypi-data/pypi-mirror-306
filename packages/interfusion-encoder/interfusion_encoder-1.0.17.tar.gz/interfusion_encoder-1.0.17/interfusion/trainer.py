...
def generate_hard_negatives(model, data_samples, tokenizer, negatives, config, candidate_feature_size, job_feature_size, num_workers=4):
    """
    ...
    print("Create Dataset and DataLoader for candidate-negative pairs")
    dataset = CandidateNegativePairDataset(data_samples, negatives, use_sparse)
    dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=True)

    print("Prepare lists to collect data")
    all_candidate_ids = []
