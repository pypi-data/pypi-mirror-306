...
def trapecio_compuesto_iterativo(f, a, b, tol, iterMax):
    ...
    utilizando la regla del trapecio compuesta de forma iterativa.
    ...
    Sintaxis:
        I = trapecio_compuesto_iterativo(f, a, b, tol, iterMax)
    ...
    Notas:
    ------
    - Este método aplica la regla del trapecio en cada subintervalo, aumentando el número de subintervalos
    ...
    I_old = trapecio_compuesto(f, a, b, N)  # Aproximación inicial

    for k in range(iterMax):
        # Aumentar el número de subintervalos en 1
        N += 1
        I_new = trapecio_compuesto(f, a, b, N)  # Calcular nueva aproximación
