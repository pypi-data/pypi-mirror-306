...
from .integration import OldJiraServerIntegration
from .utils import build_user_choice


@control_silo_endpoint
class OldJiraServerSearchEndpoint(IntegrationEndpoint):
    ...
    def get(
        ...
        assert isinstance(installation, OldJiraServerIntegration), installation
