...
from auth.base import BaseAuth, NoAuth
from session.base import BaseSession, SessionConfig
from resources.base import Resource, ResourceConfig
from utils.request import RequestConfig, RequestMethod
    ...
    def __matmul__(self, target: t.Union[
        ...
        if isinstance(target, type):
            if not hasattr(target, '_resourcecfg'):
                from resources.decorators import resource
        ...
        from resources.decorators import MethodConfig
