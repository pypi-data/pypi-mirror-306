...
setup(
    ...
    description='Tryton module to add planning of bookings to cashbook.',
    long_description=long_description,
    long_description_content_type='text/x-rst',
    url='https://www.m-ds.de/',
    download_url='https://scmdev.m-ds.de/Tryton/Extra/cashbook_planner',
    ...
    keywords='tryton cashbook planner',
