...
def evaluate(
    ...
    *,
    ...
    try:
        ...
        print("Response:", response.text)  # Print the full error response
    ...
    try:
        ...
        response = requests.post(url=url_artifacts, json=serialized_artifacts, timeout=100)
        response.raise_for_status()
...
def get_artifacts(model_name, version):
    ...
    :return: model_uri
    """
    artifacts_complete = MlflowPlugin().get_model_uri(model_name=model_name, version=version)
