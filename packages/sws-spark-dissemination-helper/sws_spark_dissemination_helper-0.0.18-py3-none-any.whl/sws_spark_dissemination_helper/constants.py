...
class IcebergTables:
    ...
    def _create_iceberg_table(
        ...
        iceberg_id = f"{database}.{prefix}_{self.__dataset_id}_{suffix}"
        path = f"{scheme}/{prefix}_{self.__dataset_id}_{suffix}"
        csv_path = f"{CACHED_CSV_FOLDER}/{scheme}/{prefix}_{self.__dataset_id}_{suffix}/{self.__tag_name}.csv"
