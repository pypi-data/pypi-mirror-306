...
class SWSBronzeIcebergSparkHelper:
    ...
    def _prepare_element_uom(self) -> DataFrame:
        ...
        logging.info("self.codelist_type_mapping")
        logging.info(self.codelist_type_mapping)
        logging.info("self.dim_col_to_id_mapping")
        logging.info(self.dim_col_to_id_mapping)
        logging.info("self.dim_columns_w_time")
        logging.info(self.dim_columns_w_time)
    ...
    def _gen_denormalized_observation(self) -> DataFrame:
        ...
        df_intermediate = (
            ...
            .join(
                ...
                col("d.measuredElement") == col("e.element_code"),
                "left",
            )
            .drop("e.element_code")
        )
    ...
    def write_bronze_data_to_iceberg_and_csv(self) -> DataFrame:
        ...
        self.df_bronze.writeTo(self.iceberg_tables.BRONZE.iceberg_id)
