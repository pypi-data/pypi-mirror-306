...
LastEditTime: 2024-11-03 14:31:24
...
def download(var, time_s, time_e, lon_min=0, lon_max=359.92, lat_min=-80, lat_max=90,  depth=None, level_num=None, store_path=None, dataset_name=None, version_name=None):
    '''
    Description:
...
if __name__ == '__main__':
    download('v', '2013010100', '2013020100', lon_min=100, lon_max=150, lat_min=0,
