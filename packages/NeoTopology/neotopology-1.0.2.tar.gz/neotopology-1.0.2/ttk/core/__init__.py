from ttk.data import _SOLVENT_TYPES, _PROTEIN_RESIDUES, _WATER_RESIDUES, _AMINO_ACID_CODES, _SIMPLE_SOLVENT
...
from ttk.core.Bond import Bond, BondType, from_rdkit_bond, from_bond_float, from_bond_name
