...
class PythonValidator:
    ...
    def is_instance(element, cls: type):
        ...
        if not isinstance(cls, type):
            raise Exception(ErrorMessage.parameter_is_not_a_class('element'))
    ...
    @staticmethod
    def is_subclass(element, cls: type):
        """
        ...
        return issubclass(element, type)
    ...
    def is_string(element):
        ...
        """
        return PythonValidator.is_class(element, str)
    ...
    def is_enum_class(element: Union['YTAEnum', Enum]):
        """
        Check if the provided 'enum' is a Enum class or subclass.
        """
        if not PythonValidator.is_instance(element, Enum) and not PythonValidator.is_subclass(element, Enum):
            return False
