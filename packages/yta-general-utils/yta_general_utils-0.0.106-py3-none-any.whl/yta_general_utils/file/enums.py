# TODO: Please, solve cyclic import so I can use this YTAEnum
...
class FileType(Enum):
    ...
    file.
    """
    # TODO: This should be using the ImageFileExtension.get_all() 
    # method built in YTAEnum class, but cyclic import error...
    IMAGE = [ImageFileExtension.PNG, ImageFileExtension.JPEG, ImageFileExtension.JPG, ImageFileExtension.WEBP, ImageFileExtension.BMP]
    AUDIO = [AudioFileExtension.WAV, AudioFileExtension.MP3, AudioFileExtension.M4A] # TODO: Add more types
    VIDEO = [VideoFileExtension.MOV, VideoFileExtension.MP4, VideoFileExtension.MP4, ] # TODO: Add more types
