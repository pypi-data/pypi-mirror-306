...
def handle_output_filename(output_filename: Union[None, str], expected_extension: Union[None, AudioFileExtension, VideoFileExtension, ImageFileExtension, FileType]):
    ...
    if expected_extension:
        ...
        if not PythonValidator.is_class(expected_extension, str) and not PythonValidator.is_class(expected_extension, AudioFileExtension) and not PythonValidator.is_instance(expected_extension, AudioFileExtension) and not PythonValidator.is_class(expected_extension, ImageFileExtension) and not PythonValidator.is_instance(expected_extension, ImageFileExtension) and not PythonValidator.is_class(expected_extension, VideoFileExtension) and not PythonValidator.is_instance(expected_extension, VideoFileExtension):
