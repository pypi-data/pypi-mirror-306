...
class CustomFieldBase(models.Model):
    ...
    field_size = models.CharField(max_length=20, choices=CUSTOM_FIELD_SIZE, default=CUSTOM_FIELD_SIZE[0][0])
    ...
    status = models.CharField(max_length=20, choices=CUSTOM_FIELD_STATUS, default=CUSTOM_FIELD_STATUS[3][0])
