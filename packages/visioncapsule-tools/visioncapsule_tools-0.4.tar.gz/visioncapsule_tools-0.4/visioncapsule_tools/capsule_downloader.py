...
def build_vcap_list(vcap_local_list, vcap_table, thead):
    ...
    for vcap_rol in vcap_table:
        ...
        if selection_name != last_selection_name:
            ...
            vcap_choices.append(inquirer.Separator(SeparatorText))
        ...
        vcap_choices.append(inquirer.Separator("  " + vcap_text))
    ...
    questions = [
        {
            ...
            "validate": lambda answer: (
                "Thanks for using VisionCapsules." if len(answer) == 0 else True
            ),
        }
    ]
