...
setup(
    name='PyexQE',  # 包名
    version='0.0.1',  # 版本
    description="extension QE: toolkit package of Quantum ESPRESSO.",  # 包简介
    ...
    url='https://github.com/Bin-Cao/exQE',  # github或者自己的网站地址
    packages=find_packages(include=['PyexQE', 'PyexQE.*']),
    classifiers=[
