...
*MSPApi* | [**delete_user_groups_from_tenant_in_msp_portal**](docs/MSPApi.md#delete_user_groups_from_tenant_in_msp_portal) | **POST** /v1/msp/tenants/{tenantUid}/users/groups/delete | Remove user groups from CDO tenant in MSP Portal
*MSPApi* | [**delete_users_from_tenant_in_msp_portal**](docs/MSPApi.md#delete_users_from_tenant_in_msp_portal) | **POST** /v1/msp/tenants/{tenantUid}/users/delete | Remove users from CDO tenant in MSP Portal
...
*MSPApi* | [**get_msp_managed_tenant**](docs/MSPApi.md#get_msp_managed_tenant) | **GET** /v1/msp/tenants/{tenantUid} | Get CDO tenant managed by MSP Portal
