...
class Restack(BaseModel):
    ...
    async def create_service(self, workflows_path: Optional[str] = None, functions: Optional[List[Any]] = None, task_queue: Optional[str] = None,options: Optional[ServiceOptions] = None) -> Worker:
        try:
