...
def main():
    ...
    # Define the same arguments in launch.py to capture them
    ...
    # Construct the command to call app.py with all parsed arguments
    command = [sys.executable, "ebook2audiobook/app.py"]
