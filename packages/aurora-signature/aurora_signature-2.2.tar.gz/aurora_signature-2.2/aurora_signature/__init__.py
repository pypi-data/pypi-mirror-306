...
@click.option('-e', '--email', type=str, help='UserID')
def sign(input_file, output_file, api_token, tenant_id, pki, user_id=None, email=None):
    """Sign document"""
    logo = """
    +------------------------------+
    ...
    sign_pplg(input_file, output_file, api_token, tenant_id, pki, user_id, email)
