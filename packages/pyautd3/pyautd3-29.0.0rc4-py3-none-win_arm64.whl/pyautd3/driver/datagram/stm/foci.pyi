...
class FociSTM(DatagramS[FociSTMPtr], Datagram, Generic[C]):
    ...
    def __init__(self: FociSTM, config: SamplingConfig | Freq[float] | timedelta, iterable: Iterable[ArrayLike] | Iterable[ControlPoints1] | Iterable[ControlPoints2] | Iterable[ControlPoints3] | Iterable[ControlPoints4] | Iterable[ControlPoints5] | Iterable[ControlPoints6] | Iterable[ControlPoints7] | Iterable[ControlPoints8]) -> None: ...
    ...
    def with_timeout(self: FociSTM[C], timeout: timedelta | None) -> DatagramWithTimeout[FociSTM[C]]: ...
    ...
    @classmethod
    def nearest(cls, config: Freq[float] | timedelta, iterable: Iterable[ArrayLike] | Iterable[ControlPoints1] | Iterable[ControlPoints2] | Iterable[ControlPoints3] | Iterable[ControlPoints4] | Iterable[ControlPoints5] | Iterable[ControlPoints6] | Iterable[ControlPoints7] | Iterable[ControlPoints8]) -> FociSTM: ...
    @property
    def freq(self: FociSTM[C]) -> Freq[float]: ...
    @property
    def period(self: FociSTM[C]) -> timedelta: ...
    @property
