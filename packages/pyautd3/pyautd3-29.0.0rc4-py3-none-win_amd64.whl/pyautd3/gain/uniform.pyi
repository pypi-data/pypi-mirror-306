...
class Uniform(Gain):
    ...
    def with_cache(self: Uniform, ) -> Cache[Uniform]: ...
    def with_timeout(self: Uniform, timeout: timedelta | None) -> DatagramWithTimeout[Uniform]: ...
    def with_parallel_threshold(self: Uniform, threshold: int | None) -> DatagramWithParallelThreshold[Uniform]: ...
    def with_segment(self: Uniform, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Uniform]: ...
    @property
