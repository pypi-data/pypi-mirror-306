...
class GainSTM(DatagramS[GainSTMPtr], Datagram):
    ...
    def __init__(self: GainSTM, config: SamplingConfig | Freq[float] | timedelta, iterable: Iterable[Gain]) -> None: ...
    ...
    def with_timeout(self: GainSTM, timeout: timedelta | None) -> DatagramWithTimeout[GainSTM]: ...
