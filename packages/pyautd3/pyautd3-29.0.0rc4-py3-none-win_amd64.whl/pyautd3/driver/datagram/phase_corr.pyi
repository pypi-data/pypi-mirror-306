...
class PhaseCorrection(Datagram):
    ...
    def with_timeout(self: PhaseCorrection, timeout: timedelta | None) -> DatagramWithTimeout[PhaseCorrection]: ...
    def with_parallel_threshold(self: PhaseCorrection, threshold: int | None) -> DatagramWithParallelThreshold[PhaseCorrection]: ...
