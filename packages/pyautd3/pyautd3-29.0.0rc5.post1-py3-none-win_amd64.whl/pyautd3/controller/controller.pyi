...
class _Builder():
    ...
    def with_fallback_timeout(self: _Builder, fallback_timeout: timedelta) -> _Builder: ...
    def with_send_interval(self: _Builder, send_interval: timedelta) -> _Builder: ...
    def with_receive_interval(self: _Builder, receive_interval: timedelta) -> _Builder: ...
    ...
    @property
    def fallback_timeout(self: _Builder) -> timedelta: ...
    @property
    def send_interval(self: _Builder) -> timedelta: ...
    @property
    def receive_interval(self: _Builder) -> timedelta: ...
    @property
...
class Controller(Geometry, Generic[L]):
    ...
    _link: L
    _disposed: bool
    async def _open_impl_async(self: Controller[L], link_builder: LinkBuilder[L], timeout: timedelta | None = None) -> Controller[L]: ...
    ...
    def tick(self: Controller[L], tick: timedelta) -> None: ...
    @staticmethod
