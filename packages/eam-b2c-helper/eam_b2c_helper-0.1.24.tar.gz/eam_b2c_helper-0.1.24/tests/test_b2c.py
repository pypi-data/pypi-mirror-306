                ...
                'value': [
                    {
                        "displayName": "Conf Room Adams",
                        "id": "6ea91a8d-e32e-41a1-b7bd-d2d185eed0e0",
                        "identities": [{'issuerAssignedId': 'test+100@gmail.com'}]
                    },
                    {
                        "displayName": "MOD Administrator",
                        "id": "4562bcc8-c436-4f95-b7c0-4f8ce89dca5e",
                        "identities": [{'issuerAssignedId': 'test+101@gmail.com'}]
                    }
                ]
            },
            200
...
def test_get_users(mock_post, mock_get):
    ...
    assert B2C.get_users(company_id=12345, role_type=None, branch_id='master') == [
        {
            "displayName": "Conf Room Adams",
            "id": "6ea91a8d-e32e-41a1-b7bd-d2d185eed0e0",
            'identities': [{'issuerAssignedId': 'test+100@gmail.com'}]
    ...
    assert B2C.get_users(company_id=None, role_type='Test Role', branch_id='master') == [
        {
            "displayName": "Conf Room Adams",
            "id": "6ea91a8d-e32e-41a1-b7bd-d2d185eed0e0"
        },
    ...
    assert B2C.get_users(branch_id='master') == [
        {
            "displayName": "MOD Administrator",
            "id": "4562bcc8-c436-4f95-b7c0-4f8ce89dca5e",
            'mailNickname': 'test@test.com',
    ...
    assert B2C.get_users(company_id=12345, role_type=None, branch_id=100) == [
        {
            'displayName': 'Conf Room Adams',
            'id': '6ea91a8d-e32e-41a1-b7bd-d2d185eed0e0',
            'identities': [{'issuerAssignedId': 'test+100@gmail.com'}]
