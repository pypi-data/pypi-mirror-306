...
class Object(object):
    ...
    def compareByTypeAndPrimitiveAttributes(obj1, obj2):
        ...
        Parameters
        ----------
        obj1: Brick::Core::Object &
        obj2: Brick::Core::Object &
...
class Error(object):
    ...
    def createOnToken(error_code, token, source_id):
        r"""
        createOnToken(error_code_t error_code, Token token, std::string const & source_id) -> std::shared_ptr< Brick::Error >
    ...
    def createOnTokens(error_code, tokens, source_id):
        r"""
        createOnTokens(error_code_t error_code, TokenVector tokens, std::string const & source_id) -> std::shared_ptr< Brick::Error >

        Parameters
        ----------
        error_code: error_code_t
        tokens: std::vector< Brick::Token,std::allocator< Brick::Token > > const &
        source_id: std::string const &
    ...
    def create(*args):
        r"""
        create(error_code_t error_code, line_t from_line, col_t from_column, line_t to_line, line_t to_column, std::string const & source_id) -> std::shared_ptr< Brick::Error >
...
def Error_createOnToken(error_code, token, source_id):
    r"""
    Error_createOnToken(error_code_t error_code, Token token, std::string const & source_id) -> std::shared_ptr< Brick::Error >
...
def Error_createOnTokens(error_code, tokens, source_id):
    r"""
    Error_createOnTokens(error_code_t error_code, TokenVector tokens, std::string const & source_id) -> std::shared_ptr< Brick::Error >
...
def Error_create(*args):
    r"""
    Error_create(error_code_t error_code, line_t from_line, col_t from_column, line_t to_line, line_t to_column, std::string const & source_id) -> std::shared_ptr< Brick::Error >
...
class CycleFoundError(Error):
    ...
    def create(token, source_id, model_name, cyclic_nodes):
        r"""
        create(Token token, std::string const & source_id, std::string const & model_name, std::string const & cyclic_nodes) -> std::shared_ptr< Brick::CycleFoundError >
...
def CycleFoundError_create(token, source_id, model_name, cyclic_nodes):
    r"""
    CycleFoundError_create(Token token, std::string const & source_id, std::string const & model_name, std::string const & cyclic_nodes) -> std::shared_ptr< Brick::CycleFoundError >
...
class StringParameterError(Error):
    ...
    def createOnToken(error_code, token, source_id, string_parameter):
        r"""
        createOnToken(error_code_t error_code, Token token, std::string const & source_id, std::string const & string_parameter) -> std::shared_ptr< Brick::StringParameterError >
    ...
    def createOnTokens(error_code, tokens, source_id, string_parameter):
        r"""
        createOnTokens(error_code_t error_code, TokenVector tokens, std::string const & source_id, std::string const & string_parameter) -> std::shared_ptr< Brick::StringParameterError >
...
def StringParameterError_createOnToken(error_code, token, source_id, string_parameter):
    r"""
    StringParameterError_createOnToken(error_code_t error_code, Token token, std::string const & source_id, std::string const & string_parameter) -> std::shared_ptr< Brick::StringParameterError >
...
def StringParameterError_createOnTokens(error_code, tokens, source_id, string_parameter):
    r"""
    StringParameterError_createOnTokens(error_code_t error_code, TokenVector tokens, std::string const & source_id, std::string const & string_parameter) -> std::shared_ptr< Brick::StringParameterError >
...
class ReferencesAreReadOnly(StringParameterError):
    r"""Proxy of C++ Brick::ReferencesAreReadOnly class."""
    ...
    def create(line, column, reference, source_id):
        r"""
        create(line_t line, col_t column, std::string const & reference, std::string const & source_id) -> std::shared_ptr< Brick::ReferencesAreReadOnly >
...
def ReferencesAreReadOnly_create(line, column, reference, source_id):
    r"""
    ReferencesAreReadOnly_create(line_t line, col_t column, std::string const & reference, std::string const & source_id) -> std::shared_ptr< Brick::ReferencesAreReadOnly >
...
def loadModelFromFile(brick_file, modelname, brick_context):
    r"""
    loadModelFromFile(std::filesystem::path const & brick_file, std::optional< std::string > modelname, BrickContext brick_context) -> Brick::Core::ObjectPtr
...
def loadModelFromString(brick_string, modelname, brick_context):
    r"""
    loadModelFromString(std::string const & brick_string, std::optional< std::string > modelname, BrickContext brick_context) -> Brick::Core::ObjectPtr
...
def loadModelFromDocument(document, modelname, brick_context):
    r"""
    loadModelFromDocument(Brick::DocPtr const & document, std::optional< std::string > modelname, BrickContext brick_context) -> Brick::Core::ObjectPtr
...
def analyzeAndEvaluate(brick_context, document, modelname):
    r"""
    analyzeAndEvaluate(BrickContext brick_context, Brick::DocPtr const & document, std::optional< std::string > modelname) -> Brick::Core::ObjectPtr
