...
class Method(LightningModule):
    ...
    @staticmethod
    def optimizer_args_cls(optim_type: OptimizerType) -> type[OptimizerArgs]:
    ...
    def on_train_batch_start(self, batch: MultiViewBatch, batch_idx: int) -> None:
    ...
    def _log_example_views(self, train_batch: MultiViewBatch):
